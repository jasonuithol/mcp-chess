...
Source: https://www.chessprogramming.org/SIMD_and_SWAR_Techniques

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* SIMD and SWAR Techniques**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/SIMD.svg/330px-SIMD.svg.png)](/File:SIMD.svg)

[SIMD](https://en.wikipedia.org/wiki/SIMD) [[1]](#cite_note-1)
...
- [SSE5](/SSE5 "SSE5") by [AMD](/AMD "AMD") (proposed but not implemented, replaced by [XOP](/XOP "XOP") [[3]](#cite_note-3))
...
- [SVE](/index.php?title=SVE&action=edit&redlink=1 "SVE (page does not exist)") [[4]](#cite_note-4) and [SVE2](/index.php?title=SVE2&action=edit&redlink=1 "SVE2 (page does not exist)") [[5]](#cite_note-5) by [ARM](/index.php?title=ARM&action=edit&redlink=1 "ARM (page does not exist)")
...
- [VIS](/index.php?title=VIS&action=edit&redlink=1 "VIS (page does not exist)") [[6]](#cite_note-6) since [SPARC](/SPARC "SPARC") v9
- [RISC-V](/index.php?title=RISC-V&action=edit&redlink=1 "RISC-V (page does not exist)") vector-set extension [[7]](#cite_note-7)
...
- [AltiVec Technology - Programming Interface Manual](http://www.nxp.com/files/32bit/doc/ref_manual/ALTIVECPIM.pdf) (pdf) [[9]](#cite_note-9)
...
1. [↑](#cite_ref-1) [Flynn's taxonomy from Wikipedia](https://en.wikipedia.org/wiki/Flynn%27s_taxonomy)
2. [↑](#cite_ref-2) [The Aggregate: SWAR, SIMD Within A Register](http://www.aggregate.org/SWAR/) by [Hank Dietz](/Hank_Dietz "Hank Dietz")
3. [↑](#cite_ref-3) [SSE5 from Wikipedia](https://en.wikipedia.org/wiki/SSE5)
4. [↑](#cite_ref-4) [SVE from Wikipedia](https://en.wikipedia.org/wiki/AArch64#Scalable_Vector_Extension_(SVE))
5. [↑](#cite_ref-5) [SVE2 from Wikipedia](https://en.wikipedia.org/wiki/SVE)
6. [↑](#cite_ref-6) [VIS from Wikipedia](https://en.wikipedia.org/wiki/Visual_Instruction_Set)
7. [↑](#cite_ref-7) [RISC-V vector-set from Wikipedia](https://en.wikipedia.org/wiki/RISC-V#Vector_set)
8. [↑](#cite_ref-8) [Georg Hager's Blog | Random thoughts on High Performance Computing](https://blogs.fau.de/hager/)
9. [↑](#cite_ref-9) On December 7, 2015, [NXP Semiconductors](https://en.wikipedia.org/wiki/NXP_Semiconductors) completed its acquisition of Freescale, [Freescale from Wikipedia](https://en.wikipedia.org/wiki/Freescale_Semiconductor)
