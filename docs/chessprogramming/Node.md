...
Source: https://www.chessprogramming.org/Node

**[Home](/Main_Page "Main Page") \* [Search](/Search "Search") \* Node**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Bonatti-caput_et_cauda_draconis.PNG/330px-Bonatti-caput_et_cauda_draconis.PNG)](/File:Bonatti-caput_et_cauda_draconis.PNG)

The Dragon's Head and Tail [[1]](#cite_note-1)
...
- [Leftmost Node](/Leftmost_Node "Leftmost Node") - are always PV-nodes [[2]](#cite_note-2)
...
| [Frontier Node](/Frontier_Nodes "Frontier Nodes") | 1 | 0 | \* |
| [Pre Frontier Node](/Pre_Frontier_Node "Pre Frontier Node") | 2 | 1 | \* |
| [Quiescent Node](/Quiescent_Node "Quiescent Node") | <= 0 | |  |

- ) *There seems an ambiguity according to the definition of frontier versus horizon nodes.* [[3]](#cite_note-3) [[4]](#cite_note-4) .
...
1. [↑](#cite_ref-1) [The Dragon's Head and Tail](https://commons.wikimedia.org/wiki/File:Bonatti-caput_et_cauda_draconis.PNG) refer ascending and descending [Lunar nodes](https://en.wikipedia.org/wiki/Lunar_node), Image from [Guido Bonatti](https://en.wikipedia.org/wiki/Guido_Bonatti) (**1550**). *[Foroliviensis Mathematici De Astronomia Tractatvs X. : Vniuersum quod iudiciariam rationem Natiuitatum, Aeris, Tempestatum, attinet, comprehendentes. Adiectus est Cl. Ptolemaei liber Fructus, cum commentarijs vtilissimis Georgij Trapezunt](http://hardenberg.jalb.de/display_page.php?elementId=5363)*. pp. 119, from [Johannes a Lasco Bibliothek](https://de.wikipedia.org/wiki/Johannes_a_Lasco_Bibliothek) (JALB)
2. [↑](#cite_ref-2) That leftmost nodes are always PV-nodes, does not imply each PV-node is leftmost - since we have to deal with real search trees rather than minimal ones.
3. [↑](#cite_ref-3) [Re: simple node definitions question](https://www.stmintz.com/ccc/index.php?id=387518) post by [Robert Hyatt](/Robert_Hyatt "Robert Hyatt"), [CCC](/CCC "CCC"), September 13, 2004
4. [↑](#cite_ref-4) [Ernst A. Heinz](/Ernst_A._Heinz "Ernst A. Heinz") (**1998**). *[Extended Futility Pruning](http://people.csail.mit.edu/heinz/dt/node18.html).* [ICCA Journal, Vol. 21, No. 2](/ICGA_Journal#21_2 "ICGA Journal"), pp. 75-83
