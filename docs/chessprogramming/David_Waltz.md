...
Source: https://www.chessprogramming.org/David_Waltz

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* David Waltz**

[![](/images/b/bc/Davidlwaltz.jpg)](http://www.cs.columbia.edu/~waltz/)

David Waltz [[1]](#cite_note-1)
...
He held a Ph.D. on [computer vision](https://en.wikipedia.org/wiki/Computer_vision) from [Massachusetts Institute of Technology](/Massachusetts_Institute_of_Technology "Massachusetts Institute of Technology") - his thesis originated the field of [constraint propagation](https://en.wikipedia.org/wiki/Local_consistency) [[2]](#cite_note-2),
and he further originated the field of memory-based reasoning branch of [case-based reasoning](https://en.wikipedia.org/wiki/Case-based_reasoning) [[3]](#cite_note-3).
...
1. [↑](#cite_ref-1) [David Waltz's Home Page](http://www.cs.columbia.edu/~waltz/)
2. [↑](#cite_ref-2) David Waltz (**1972**). *[Generating Semantic Description from Drawings of Scenes with Shadows](http://dspace.mit.edu/handle/1721.1/41205)*. Ph.D. thesis, [MIT](/Massachusetts_Institute_of_Technology "Massachusetts Institute of Technology")
3. [↑](#cite_ref-3) [Craig Stanfill](https://www.linkedin.com/in/craig-stanfill-9a01b910/), David Waltz (**1986**). *Toward Memory-Based Reasoning*. [Communications of the ACM](/ACM#Communications "ACM"), Vol. 29, No. 12, [pdf](http://www1.cs.columbia.edu/~waltz/Papers/Torward%20Memory-Based%20Reasoning-ACM%201986.pdf)
4. [↑](#cite_ref-4) [Bradley Kuszmaul](/Bradley_Kuszmaul "Bradley Kuszmaul") (**1994**). *Synchronized MIMD Computing*. Ph. D. Thesis, [MIT](/Massachusetts_Institute_of_Technology "Massachusetts Institute of Technology"), [pdf](http://supertech.csail.mit.edu/papers/thesis-kuszmaul.pdf), pp. 146, Acknowledgements
5. [↑](#cite_ref-5) [dblp: David L. Waltz](https://dblp.uni-trier.de/pers/hd/w/Waltz:David_L=.html)
