...
Source: https://www.chessprogramming.org/HMCS4xC

**[Home](/Main_Page "Main Page") \* [Hardware](/Hardware "Hardware") \* HMCS4xC**
...
A stack of four registers (ST1-ST4) is used to call subroutines by the CAL instructions and to return by RTN [[1]](#cite_note-1).
...
1. [↑](#cite_ref-1) [Hitachi HD44801](https://cdn.datasheetspdf.com/pdf-down/H/D/4/HD44801_Hitachi.pdf) (pdf)
