...
Source: https://www.chessprogramming.org/Exacto

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Exacto**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Long_short_exact_sequences.png/330px-Long_short_exact_sequences.png)](/File:Long_short_exact_sequences.png)

Exact sequence [[1]](#cite_note-1)
...
1. [↑](#cite_ref-1) Shows how any [exact sequence](https://en.wikipedia.org/wiki/Exact_sequence) is weaved together from several overlapping short exact sequences, [Axel Boldt](https://en.wikipedia.org/wiki/User:AxelBoldt), February 2004, [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) Features based on source, [GitHub - d-sparks/exacto: Exacto Chess Engine](https://github.com/d-sparks/exacto)
