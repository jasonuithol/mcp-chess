...
1. [↑](#cite_ref-1) [LDDQU: Load Unaligned Integer 128 Bits (x86 Instruction Set Reference)](http://siyobik.info/index.php?module=x86&id=150)
2. [↑](#cite_ref-2) [Unaligned memory operands - US Patent 6721866 Description](http://www.patentstorm.us/patents/6721866/description.html)
3. [↑](#cite_ref-3) [How to Implement the FISTTP Streaming SIMD Extensions 3 Instruction - Intel® Software Network](http://software.intel.com/en-us/articles/how-to-implement-the-fisttp-streaming-simd-extensions-3-instruction/)
