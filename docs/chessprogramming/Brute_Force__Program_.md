...
Source: https://www.chessprogramming.org/Brute_Force_(Program)

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Brute Force**

[![](/images/2/20/BruteForceCover1.jpg)](http://80pagegiant.blogspot.de/2012/07/it-came-from-dollar-bin-brute-force.html)

Brute Force Issue 1 [[1]](#cite_note-1)

**Brute Force**,   
a chess program by [Louis Kessler](/Louis_Kessler "Louis Kessler") that participated in the [8th](/ACM_1977 "ACM 1977") and [9th](/ACM_1977 "ACM 1977") [North American Computer Chess Championships](/ACM_North_American_Computer_Chess_Championship "ACM North American Computer Chess Championship") in 1977 and 1978. Brute Force was a [Tech](/Tech "Tech") like program, including such features of an [iterative](/Iterative_Search "Iterative Search") [alpha-beta](/Alpha-Beta "Alpha-Beta") routine, a [quiescence routine](/Quiescence_Search "Quiescence Search") using [swap-off values](/SOMA#Swapoff "SOMA"), and an [evaluation function](/Evaluation_Function "Evaluation Function") based on the opponent's [mobility](/Mobility "Mobility") [[2]](#cite_note-2). At the [9th NACCC](/ACM_1977 "ACM 1977"), it suffered from an "[en passant bug](/En_passant#bugs "En passant")" twice [[3]](#cite_note-3), which turned out a wrong implementation due to Kessler's misinterpretation of the rules [[4]](#cite_note-4).
...
- [Brute Force (1947 film) from Wikipedia](https://en.wikipedia.org/wiki/Brute_Force_%281947_film%29) [[5]](#cite_note-5)
...
1. [↑](#cite_ref-1) "Brute Force Issue 1", [Marvel Comic](https://en.wikipedia.org/wiki/Marvel_Comics) edited by [Tom DeFalco](https://en.wikipedia.org/wiki/Tom_DeFalco), August 1990, Cover Image from [80 Page Giant: It Came From the Dollar Bin: Brute Force](http://80pagegiant.blogspot.de/2012/07/it-came-from-dollar-bin-brute-force.html) by [Trixter](https://www.blogger.com/profile/12386426230143297171), July 10, 2012
2. [↑](#cite_ref-2) [David Levy](/David_Levy "David Levy") (**1978**). *ACM '78*. [ICCA Newsletter, Vol. 1, No. 1](/ICGA_Journal#1_1 "ICGA Journal")
3. [↑](#cite_ref-3) [Pech für den Weltmeister?](https://www.computerwoche.de/a/pech-fuer-den-weltmeister,1191711), February 02, 1979, [Computerwoche](/Computerworld#Woche "Computerworld") 5/1979 (German)
4. [↑](#cite_ref-4) Quote by [Louis Kessler](/Louis_Kessler "Louis Kessler") from [A Memorial to BRUTE FORCE](http://www.lkessler.com/brutefor.shtml):
...
5. [↑](#cite_ref-5) [Chess In The Cinema - Chess scenes from the movie Brute Force (Burt Lancaster)](http://www.chess-in-the-cinema.de/showfilm.php?filmfile=4708.txt&pfad=4049)
