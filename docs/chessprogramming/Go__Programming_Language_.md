...
1. [↑](#cite_ref-1) [Effective Go - The Go Programming Language - Concurrency](https://golang.org/doc/effective_go.html#concurrency)
2. [↑](#cite_ref-2) [Go (programming language) from Wikipedia](https://en.wikipedia.org/wiki/Go_%28programming_language%29)
