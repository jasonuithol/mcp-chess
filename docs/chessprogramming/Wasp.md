...
Source: https://www.chessprogramming.org/Wasp

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Wasp**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Vespula_germanica_Richard_Bartz.jpg/250px-Vespula_germanica_Richard_Bartz.jpg)](/File:Vespula_germanica_Richard_Bartz.jpg)

Wasp [[1]](#cite_note-1)

**Wasp**,  
[John Stanback's](/John_Stanback "John Stanback") new [UCI](/UCI "UCI") compliant chess engine and complete rewrite of [Zarkov](/Zarkov "Zarkov"), first released short after [June solstice](https://en.wikipedia.org/wiki/June_solstice) 2016, announced [[2]](#cite_note-2) and hosted by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky") [[3]](#cite_note-3). As a [bitboard](/Bitboards "Bitboards") engine, Wasp is compiled for modern [64 bit CPU's](/X86-64 "X86-64") with [popcnt](/Population_Count "Population Count") and [bitscan](/BitScan "BitScan") instructions. Wasp **2.00**, released in April 2017, is able to use multiple [threads](/Thread "Thread") performing a [Lazy SMP](/Lazy_SMP "Lazy SMP") search [[4]](#cite_note-4).
In 2020, John Stanback played with tiny [neural networks](/Neural_Networks "Neural Networks") to learn how to [backpropagate](/Neural_Networks#Backpropagation "Neural Networks") errors using Wasp's [evaluation](/Evaluation "Evaluation") as the target, and then rewrote Wasp's evaluation function with fast [tuning](/Automated_Tuning "Automated Tuning") in mind, quite similar to the tiny NN approach [[5]](#cite_note-5). Along with Wasp **5.00**, released in November 2021, the evaluation function emerged to an [NNUE](/NNUE "NNUE") with 1830 inputs, 192 neurons in the first hidden layer, 16 neurons in the second hidden layer, and two neurons in the third hidden layer. It was trained using positions from games between Wasp and other engines of roughly similar strength [[6]](#cite_note-6).
...
1. [↑](#cite_ref-1) [Vespula](https://en.wikipedia.org/wiki/Vespula) is a small genus of social wasps, widely distributed in the [Northern Hemisphere](https://en.wikipedia.org/wiki/Northern_Hemisphere). Along with members of their sister genus [Dolichovespula](https://en.wikipedia.org/wiki/Dolichovespula), they are collectively known by the common name [yellow jackets](https://en.wikipedia.org/wiki/Yellow_jacket) (or yellow-jackets) in [North America](https://en.wikipedia.org/wiki/North_America). Vespula species have a shorter malar space and a more pronounced tendency to nest underground, but are otherwise nearly indistinguishable from Dolichovespula. As shown a [Vespula germanica](https://en.wikipedia.org/wiki/Vespula_germanica), [Image](https://commons.wikimedia.org/wiki/File:Vespula_germanica_Richard_Bartz.jpg) by [Richard Bartz](https://commons.wikimedia.org/wiki/User:Richard_Bartz), August 10, 2007, [CC BY-SA 2.5](https://creativecommons.org/licenses/by-sa/2.5/deed.en), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons), [Wasp from Wikipedia](https://en.wikipedia.org/wiki/Wasp)
2. [↑](#cite_ref-2) [Wasp 1.01 x64 by John Stanback released ...](http://www.talkchess.com/forum/viewtopic.php?t=60550) by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky"), [CCC](/CCC "CCC"), June 22, 2016
3. [↑](#cite_ref-3) [Frank's Chess Page, Wasp by John Stanback](http://www.amateurschach.de/main/_wasp.htm), June 22, 2016
4. [↑](#cite_ref-4) [Wasp 2.00 by John Stanback ... with Lazy SMP!](http://www.talkchess.com/forum/viewtopic.php?t=63783) by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky"), [CCC](/CCC "CCC"), April 21, 2017
5. [↑](#cite_ref-5) [Re: Wasp NN](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=75794&start=4) by [John Stanback](/John_Stanback "John Stanback"), [CCC](/CCC "CCC"), November 14, 2020
6. [↑](#cite_ref-6) [Wasp 5.00 released](https://www.talkchess.com/forum3/viewtopic.php?f=2&t=78687) by [John Stanback](/John_Stanback "John Stanback"), [CCC](/CCC "CCC"), November 18, 2021
7. [↑](#cite_ref-7) based on [Wasp Release Notes](http://www.amateurschach.de/main/wasp/release_notes_101.txt) by [John Stanback](/John_Stanback "John Stanback")
