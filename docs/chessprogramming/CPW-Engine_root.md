...
Source: https://www.chessprogramming.org/CPW-Engine_root

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* [CPW-Engine](/CPW-Engine "CPW-Engine") \* Root**
...
- [int move\_make(move);](/CPW-Engine_move(0x88) "CPW-Engine move(0x88)")
- [int move\_unmake(move);](/CPW-Engine_move(0x88) "CPW-Engine move(0x88)")
