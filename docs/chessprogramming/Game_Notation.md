...
Algebraic [figurine notation](/Algebraic_Chess_Notation#FAN "Algebraic Chess Notation") (FAN) uses graphical [piece](/Pieces "Pieces") symbols rather than national language dependent letters for pieces, early promoted by [Chess Informant](https://en.wikipedia.org/wiki/Chess_Informant). In an attempt of [Computer vision](https://en.wikipedia.org/wiki/Computer_vision), [Henry S. Baird](/Mathematician#HSBaird "Mathematician") and [Ken Thompson](/Ken_Thompson "Ken Thompson") used [optical character recognition](https://en.wikipedia.org/wiki/Optical_character_recognition) along with various heuristics and applying the rules of chess, to "read" the games of Informant's [Encyclopaedia of Chess Openings](https://en.wikipedia.org/wiki/Encyclopaedia_of_Chess_Openings) with high accuracy and a success rate of 99.995% on approximately one million characters (2850 games, 945 pages) [[2]](#cite_note-2). FAN is supported by various [chess GUIs](/GUI "GUI"), corresponding [chess symbols](https://en.wikipedia.org/wiki/Chess_symbols_in_Unicode) are available in [Unicode](https://en.wikipedia.org/wiki/Unicode) [[3]](#cite_note-3) [[4]](#cite_note-4).
...
- [JGN: A PGN Replacement](https://www.talkchess.com/forum3/viewtopic.php?f=7&t=78626) by [Dominik Klein](/Dominik_Klein "Dominik Klein"), [CCC](/CCC "CCC"), November 09, 2021 [[7]](#cite_note-7)
...
- [GitHub - fsmosca/chess-artist: A python script that can annotate chess games in pgn file ...](https://github.com/fsmosca/chess-artist) [[8]](#cite_note-8) » [Chess Artist](/Ferdinand_Mosca#ChessArtist "Ferdinand Mosca")

# References

1. [↑](#cite_ref-1) really?
2. [↑](#cite_ref-2) [Henry S. Baird](/Mathematician#HSBaird "Mathematician"), [Ken Thompson](/Ken_Thompson "Ken Thompson") (**1990**). *[Reading Chess](http://doc.cat-v.org/bell_labs/reading_chess/)*. [IEEE Transactions on Pattern Analysis and Machine Intelligence](/IEEE#TPAMI "IEEE"), Vol. 12, No. 6, [pdf](http://doc.cat-v.org/bell_labs/reading_chess/reading_chess.pdf)
3. [↑](#cite_ref-3) [Unicode values for chessmen](http://www.talkchess.com/forum/viewtopic.php?t=38318) by [Steven Edwards](/Steven_Edwards "Steven Edwards"), [CCC](/CCC "CCC"), March 07, 2011
4. [↑](#cite_ref-4) [Miscellaneous Symbols – Test for Unicode support in Web browsers](http://www.alanwood.net/unicode/miscellaneous_symbols.html)
5. [↑](#cite_ref-5) [JPEG BOBBY](http://www.echecs-photos.be/BobbyFischer-photos/index10.html)
6. [↑](#cite_ref-6) [Robert James Fischer vs Miguel Najdorf (1970)](http://www.chessgames.com/perl/chessgame?gid=1044320) from [chessgames.com](http://www.chessgames.com/index.html)
7. [↑](#cite_ref-7) [JSON from Wikipedia](https://en.wikipedia.org/wiki/JSON)
8. [↑](#cite_ref-8) [Chess Artist](http://www.talkchess.com/forum/viewtopic.php?t=61723) by [Ferdinand Mosca](/Ferdinand_Mosca "Ferdinand Mosca"), [CCC](/CCC "CCC"), October 15, 2016
