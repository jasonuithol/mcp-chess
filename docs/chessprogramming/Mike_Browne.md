...
Source: https://www.chessprogramming.org/Mike_Browne

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Mike Browne**
...
after winning the [Fredkin Intermediate Prize](/Edward_Fredkin#Prize "Edward Fredkin") for Deep Thought's Grandmaster-level performance. [[1]](#cite_note-1)
...
- Michael Browne (**1986**). *An Improved Algorithm for the Automatic Verification of Finite State Systems Using Temporal Logic*. [LICS 1986](https://dblp.uni-trier.de/db/conf/lics/lics86.html) [[4]](#cite_note-4)
...
- Michael Browne, [Edmund M. Clarke](/Mathematician#EMClarke "Mathematician"), [Orna Grumberg](/Mathematician#OGrumberg "Mathematician") (**1987**). *Characterizing Kripke Structures in Temporal Logic*. [TAPSOFT](https://dblp.uni-trier.de/db/conf/tapsoft/tapsoft87-1.html) [[5]](#cite_note-5)
...
1. [↑](#cite_ref-1) [Deep Thought team with Fredkin Intermediate Prize](http://www.computerhistory.org/chess/stl-430b9bbd52f71/) 1988, Gift of [Feng-hsiung Hsu](/Feng-hsiung_Hsu "Feng-hsiung Hsu") hosted by [The Computer History Museum](/The_Computer_History_Museum "The Computer History Museum")
2. [↑](#cite_ref-2) [Mike Browne's Publications at ACM Portal](http://portal.acm.org/author_page.cfm?id=81100010224)
3. [↑](#cite_ref-3) [dblp: Michael C. Browne](https://dblp.uni-trier.de/pers/hd/b/Browne:Michael_C=)
4. [↑](#cite_ref-4) [Temporal logic from Wikipedia](https://en.wikipedia.org/wiki/Temporal_logic)
5. [↑](#cite_ref-5) [Kripke structure (model checking) from Wikipedia](https://en.wikipedia.org/wiki/Kripke_structure_(model_checking))
