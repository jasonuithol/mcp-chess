...
Source: https://www.chessprogramming.org/MChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* MChess**
...
M-Chess Pro 3.5 (1993) [[1]](#cite_note-1)

# Descriptions

## 1991

from [ICCA Journal, Vol. 14, No. 2](/ICGA_Journal#14_2 "ICGA Journal") [[2]](#cite_note-2)

```
Written by Marty Hirsch, an expert IBM-PC programmer previously known for a program called AI-Chess, M-Chess is a new program that has taken 3 man-years to develop. By means of logical switches in the evaluator, the program dynamically selects a set of heuristics depending on the type of position (early opening, late opening, early middle game, late middle game, endgame, several specific endgames). Development is stressed in the opening, king safety and mobility in the middle game, and passed pawns and an active king in the endgame. A small hash table is used for pawn-structure evaluation. Positional evaluation can exceed the value of a pawn. The search techniques include check extensions and capture extensions, but no singular extensions. The main hash table is only used during the full-width portion of the search and does not record the best move from previous iterations. Move ordering is obtained from the principal variation and a modified history heuristic.
```

## 1995

from [ICCA Journal, Vol. 18, No. 2](/ICGA_Journal#14_2 "ICGA Journal") [[3]](#cite_note-3):
...
from the [ICGA](/ICGA "ICGA") tournament site [[4]](#cite_note-4):
...
[WMCCC 1995](/WMCCC_1995 "WMCCC 1995"), playoff, MChess Pro - [Chess Genius](/Chess_Genius "Chess Genius") [[5]](#cite_note-5)
...
1. [↑](#cite_ref-1) [Studie: Schachspielen mit ein 286er 12 MHz Laptop - Schachcomputer.info Community](http://www.schachcomputer.info/forum/showthread.php?t=3531) by [Spacious Mind](/The_Spacious_Mind "The Spacious Mind"), May 22, 2010 (German)
2. [↑](#cite_ref-2) [Don Beal](/Don_Beal "Don Beal") (**1991**). *Report on the 11th World Microcomputer Chess Championship*. [ICCA Journal, Vol. 14, No. 2](/ICGA_Journal#14_2 "ICGA Journal")
3. [↑](#cite_ref-3) [Hin-Kwok Tsang](http://www.ece.ust.hk/~eetsang/), [Don Beal](/Don_Beal "Don Beal") (**1995**). *The 8th World Computer-Chess Championship*. [ICCA Journal, Vol. 18, No. 2](/ICGA_Journal#14_2 "ICGA Journal")
4. [↑](#cite_ref-4) [MChess' ICGA Tournaments](https://www.game-ai-forum.org/icga-tournaments/program.php?id=38)
5. [↑](#cite_ref-5) [Paderborn 1995 - Chess - Round 12 - Game 1 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=56&round=12&id=1)
