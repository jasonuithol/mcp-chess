...
Source: https://www.chessprogramming.org/Ziggy_IS

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Ziggy**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/David-Bowie_Early.jpg/250px-David-Bowie_Early.jpg)](/File:David-Bowie_Early.jpg)

Ziggy Stardust [[1]](#cite_note-1)
...
and served as test-bed for search experiments as topic in Eiríksson's B.Sc. thesis *Investigation of Multi-Cut Pruning in Game-Tree Search* [[2]](#cite_note-2).
...
1. [↑](#cite_ref-1) [David Bowie](/Category:David_Bowie "Category:David Bowie") in the early 1970s, by Rik Walton, [Ziggy Stardust (character) from Wikipedia](https://en.wikipedia.org/wiki/Ziggy_Stardust_(character))
2. [↑](#cite_ref-2) [Hrafn Eiríksson](/Hrafn_Eir%C3%ADksson "Hrafn Eiríksson") (**2011**). *Investigation of Multi-Cut Pruning in Game-Tree Search*. B.Sc. thesis, [Reykjavík University](https://en.wikipedia.org/wiki/Reykjav%C3%ADk_University), [pdf](https://skemman.is/bitstream/1946/9180/1/research-report.pdf)
