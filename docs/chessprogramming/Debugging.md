...
Source: https://www.chessprogramming.org/Debugging

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* Debugging**

[![](/images/thumb/3/33/Max_und_moritz-05-12.jpg/300px-Max_und_moritz-05-12.jpg)](http://www.wilhelm-busch-seiten.de/werke/maxundmoritz/streich5.html)

Hin und her und rundherum  
Kriecht es, fliegt es mit Gebrumm [[1]](#cite_note-1)
...
Breakpoint opcode may be inserted inside the code at compile time, for instance with x86 [inline assembly](/Assembly#InlineAssembly "Assembly") or compiler intrinsic like *DebugBreak* [[2]](#cite_note-2) :
...
:   [Re: Testing and debugging chess engines](http://www.open-aurec.com/wbforum/viewtopic.php?f=4&t=5955&start=5) by [Tord Romstad](/Tord_Romstad "Tord Romstad"), [Winboard Forum](/Computer_Chess_Forums "Computer Chess Forums"), December 05, 2006
...
- [assert](http://www.talkchess.com/forum/viewtopic.php?t=65712) by [Folkert van Heusden](/Folkert_van_Heusden "Folkert van Heusden"), [CCC](/CCC "CCC"), November 13, 2017 [[5]](#cite_note-5)
...
1. [↑](#cite_ref-1) [Wilhelm-Busch](https://en.wikipedia.org/wiki/Wilhelm_Busch), [Max und Moritz - Fünfter Streich](http://www.wilhelm-busch-seiten.de/werke/maxundmoritz/streich5.html) from [Wilhelm-Busch Seiten von Jochen Schöpflin](http://www.wilhelm-busch-seiten.de/index.html) (German)
2. [↑](#cite_ref-2) [DebugBreak Function (Windows)](http://msdn.microsoft.com/en-us/library/ms679297%28VS.85%29.aspx) from [Develop for Windows 7 and Windows Vista | MSDN](http://msdn.microsoft.com/en-us/default.aspx)
3. [↑](#cite_ref-3)  [Re: Testing and debugging chess engines](http://www.open-aurec.com/wbforum/viewtopic.php?f=4&t=5955&start=5) by [Tord Romstad](/Tord_Romstad "Tord Romstad"), [Winboard Forum](/Computer_Chess_Forums "Computer Chess Forums"), December 05, 2006
4. [↑](#cite_ref-4) [Regression testing from Wikipedia](https://en.wikipedia.org/wiki/Regression_testing)
5. [↑](#cite_ref-5) [Assertion (software development) from Wikipedia](https://en.wikipedia.org/wiki/Assertion_(software_development))
