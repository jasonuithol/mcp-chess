...
**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* PeSTO**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/BasilkumPesto.jpg/330px-BasilkumPesto.jpg)](/File:BasilkumPesto.jpg)

Basil Pesto [[1]](#cite_note-1)

**PeSTO**,  
an experimental chess engine by [Ronald Friederich](/Ronald_Friederich "Ronald Friederich") with only minimal [chess knowledge](/Knowledge "Knowledge") implemented, and therefore depending on [alpha-beta search](/Alpha-Beta "Alpha-Beta") as much as possible [[2]](#cite_note-2).
