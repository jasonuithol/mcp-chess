...
Source: https://www.chessprogramming.org/Dabbaba

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Dabbaba**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Guidoriccio_mangonel.jpg/330px-Guidoriccio_mangonel.jpg)](/File:Guidoriccio_mangonel.jpg)

Stone-throwing machine [[1]](#cite_note-1)

**Dabbaba**,  
a chess playing program by [Jens Bæk Nielsen](/Jens_B%C3%A6k_Nielsen "Jens Bæk Nielsen"), written from May 1995 to November 1998 in [Turbo C](/C "C") to run on [PC's](/IBM_PC "IBM PC") under [DOS](/MS-DOS "MS-DOS") in graphics mode [[2]](#cite_note-2),
also able to play [chess variants](/Chess#Variants "Chess") like [Knightmate Chess](/Knightmate_Chess "Knightmate Chess") [[3]](#cite_note-3),
[Shatranj](/Shatranj "Shatranj") and many others [[4]](#cite_note-4).
During its [iterative search](/Iterative_Search "Iterative Search") [[5]](#cite_note-5) [[6]](#cite_note-6),
...
To avoid a [search explosion](/Search_Explosion "Search Explosion"), Dabbaba considers ply-distance to the [root](/Root "Root") and number of replies so that shallow lines are searched deeper than wide lines [[7]](#cite_note-7).
In May 2008, [Jim Ablett](/Jim_Ablett "Jim Ablett") released a [WinBoard](/WinBoard "WinBoard") version of Dabbaba [[8]](#cite_note-8),
and in August 2012, Jens Bæk Nielsen as well [[9]](#cite_note-9).
...
[![Dabbaba.gif](/images/e/e6/Dabbaba.gif)](http://www.jens-musik.dk/skak.htm)

Dabbaba Screen [[10]](#cite_note-10)
...
1. [↑](#cite_ref-1) A [stone-throwing machine](https://en.wikipedia.org/wiki/Siege_engine) set to defend a gate, in the fresco of [Guidoriccio da Fogliano](https://en.wikipedia.org/wiki/Guidoriccio_da_Fogliano) by [Simone Martini](https://en.wikipedia.org/wiki/Simone_Martini) (14th century), [Siege engine from Wikipedia](https://en.wikipedia.org/wiki/Siege_engine)
2. [↑](#cite_ref-2) [Turbo C Graphics - initgraph function](http://www.softwareandfinance.com/Turbo_C/Graphics/initgraph.html)
3. [↑](#cite_ref-3) [Re: agChess -- an agressive chess variant](http://www.talkchess.com/forum/viewtopic.php?t=22588&start=8) by [H.G.Muller](/Harm_Geert_Muller "Harm Geert Muller"), [CCC](/CCC "CCC"), July 26, 2008
4. [↑](#cite_ref-4) [The Chess Variant Pages - Dabbaba](http://www.chessvariants.org/programs.dir/dabbaba.html)
5. [↑](#cite_ref-5) [comp.lang.c FAQ list · Question 17.10](http://c-faq.com/style/stylewars.html)
6. [↑](#cite_ref-6) [Spaghetti code from Wikipedia](https://en.wikipedia.org/wiki/Spaghetti_code)
7. [↑](#cite_ref-7) [Dabbaba](http://www.jens-musik.dk/dabbaba.htm) by [Jens Bæk Nielsen](/Jens_B%C3%A6k_Nielsen "Jens Bæk Nielsen")
8. [↑](#cite_ref-8) [Dabbaba 0.98 with Winboard support available](http://www.talkchess.com/forum/viewtopic.php?t=21051) by [Jim Ablett](/Jim_Ablett "Jim Ablett"), [CCC](/CCC "CCC"), May 08, 2008
9. [↑](#cite_ref-9) [Dabbaba 6.50 has been released](http://www.talkchess.com/forum/viewtopic.php?t=44802) by [Graham Banks](/Graham_Banks "Graham Banks"), [CCC](/CCC "CCC"), August 15, 2012
10. [↑](#cite_ref-10) [Chess / Skak](http://www.jens-musik.dk/skak.htm) by [Jens Bæk Nielsen](/Jens_B%C3%A6k_Nielsen "Jens Bæk Nielsen")
