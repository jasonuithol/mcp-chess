...
Source: https://www.chessprogramming.org/Excalibur_LCD_Chess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Excalibur LCD Chess**

[![](/images/0/04/ExcaliburLCDChess.jpg)](/Excalibur_LCD_Chess#Video "Excalibur LCD Chess#Video")

Excalibur LCD Chess [[1]](#cite_note-1)

**Excalibur LCD Chess**, (Excalibur 375-1 LCD Computer Chess)  
a [dedicated travel chess computer](/Dedicated_Chess_Computers "Dedicated Chess Computers") by [Excalibur Electronics](/Excalibur_Electronics "Excalibur Electronics"), released in 2000 [[2]](#cite_note-2).
The computer consists of a [Samsung](https://en.wikipedia.org/wiki/Samsung_Electronics) KS57C21516 controller with a [SAM47](/SAM "SAM") 4-bit core [[3]](#cite_note-3) at 1.5 MHz with 16 KiB [ROM](/Memory#ROM "Memory") and 544 [nibbles](/Nibble "Nibble") of [RAM](/Memory#RAM "Memory"), and a [LCD](https://en.wikipedia.org/wiki/Liquid-crystal_display) board and button panel including the central eight-direction rocker button to [interact with the user](/GUI "GUI").
The program and the new housing was developed and designed by [Ron Nelson](/Ron_Nelson "Ron Nelson") during his [sabbatical](https://en.wikipedia.org/wiki/Sabbatical) in late 1999 [[4]](#cite_note-4).
The 4-bit program applies sophisticated [PV move](/PV-Move "PV-Move") and [killer move](/Killer_Move "Killer Move") [ordering heuristics](/Move_Ordering "Move Ordering") [[5]](#cite_note-5),
...
3. [↑](#cite_ref-3) [KS57C21132 Single-chip CMOS Microcontroller](https://www.digchip.com/datasheets/parts/datasheet/409/KS57C21516.php)
4. [↑](#cite_ref-4) [Ron Nelson](http://www.hiarcs.net/forums/viewtopic.php?t=6768&start=108) by [ChessChallenger](/Ron_Nelson "Ron Nelson"), [Hiarcs Forum](/Computer_Chess_Forums "Computer Chess Forums"), December 23, 2015
