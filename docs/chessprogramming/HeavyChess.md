...
Source: https://www.chessprogramming.org/HeavyChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* HeavyChess**

[![](/images/thumb/b/bc/HeavyChess.jpg/300px-HeavyChess.jpg)](https://www.flickr.com/photos/teosaurio/4531534307/in/photostream/)

Heavy Chess [[1]](#cite_note-1)

**HeavyChess**,  
an [UCI](/UCI "UCI") compliant [open source chess engine](/Category:Open_Source "Category:Open Source") by [Chispa](/Chispa "Chispa") author [Federico Andrés Corigliano](/Federico_Andr%C3%A9s_Corigliano "Federico Andrés Corigliano"), written in [C++](/Cpp "Cpp"), released in 2007 [[2]](#cite_note-2).

# Description

## Board Representation

HeavyChess is a [bitboard](/Bitboards "Bitboards") engine and uses compact [rotated bitboards](/Rotated_Bitboards "Rotated Bitboards") to determine [sliding piece attacks](/Sliding_Piece_Attacks "Sliding Piece Attacks"). It performs eight [byte lookups](/Population_Count#Lookup "Population Count") to [count populations](/Population_Count "Population Count"), and [bitscan](/BitScan "BitScan") by conditional 64k lookups, where the most significant bit on the chess board maps the least significant arithmetical one [[3]](#cite_note-3):
