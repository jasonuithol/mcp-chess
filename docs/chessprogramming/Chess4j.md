...
Source: https://www.chessprogramming.org/Chess4j

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* chess4j**
...
and first published in September 2012 [[1]](#cite_note-1).
...
Since version 3.2 released in March 2017, chess4j became a [bitboard](/Bitboards "Bitboards") engine, using [magic bitboards](/Magic_Bitboards "Magic Bitboards") to [generate moves](/Move_Generation "Move Generation") [[2]](#cite_note-2), now hosted on [GitHub](https://en.wikipedia.org/wiki/GitHub).
...
- [GitHub - jswaff/chess4j: a Java based chess engine](https://github.com/jswaff/chess4j) [[3]](#cite_note-3)
...
1. [↑](#cite_ref-1) [chess4j 1.0 is released!](http://www.jamesswafford.com/2012/09/15/chess4j-1-0-is-released/) by [James Swafford](/James_Swafford "James Swafford"), September 15, 2012
2. [↑](#cite_ref-2) [chess4j 3.2 is released (and it's magic)](http://www.talkchess.com/forum/viewtopic.php?t=63412) by [James Swafford](/James_Swafford "James Swafford"), [CCC](/CCC "CCC"), March 11, 2017
3. [↑](#cite_ref-3) [Re: chess4j 3.2 is released (and it's magic)](http://www.talkchess.com/forum/viewtopic.php?t=63412&start=4) by [Günther Simon](/G%C3%BCnther_Simon "Günther Simon"), [CCC](/CCC "CCC"), November 16, 2017
