...
Source: https://www.chessprogramming.org/Richard_Fikes

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Richard Fikes**

[![](/images/9/97/Richard_fikes.jpg)](https://engineering.stanford.edu/people/richard-fikes)

Richard Fikes [[1]](#cite_note-1)
...
His research is in the general area of [knowledge representation](https://en.wikipedia.org/wiki/Knowledge_representation_and_reasoning) and [heuristic](https://en.wikipedia.org/wiki/Heuristic) [problem solving](https://en.wikipedia.org/wiki/Problem_solving#Computer_Science_and_Algorithmics), he is co-developer of the [STRIPS automatic planning system](https://en.wikipedia.org/wiki/STRIPS), the [KIF (Knowledge Interchange Format)](https://en.wikipedia.org/wiki/Knowledge_Interchange_Format), the Ontolingua [ontology](https://en.wikipedia.org/wiki/Ontology_%28information_science%29) representation language [[2]](#cite_note-2) and [Web-based ontology](https://en.wikipedia.org/wiki/Web_Ontology_Language) development environment, the [OKBC (Open Knowledge Base Connectivity)](https://en.wikipedia.org/wiki/Open_Knowledge_Base_Connectivity) [API](https://en.wikipedia.org/wiki/Application_programming_interface) for knowledge servers, and [IntelliCorp's](https://en.wikipedia.org/wiki/IntelliCorp_%28software%29) [KEE](https://en.wikipedia.org/wiki/Knowledge_Engineering_Environment) system.
...
- [Robert Nado](/index.php?title=Robert_Nado&action=edit&redlink=1 "Robert Nado (page does not exist)"), Richard Fikes (**1987**). *[Semantically Sound Inheritance for a Formally Defined Frame Language with Defaults](https://dl.acm.org/citation.cfm?id=1863776)*. [AAAI 1987](/Conferences#AAAI-87 "Conferences") [[4]](#cite_note-4)

## 1990 ...

- Richard Fikes (**1990**). *AI and Software Engineering - Managing Exploratory Programming*. [AAAI 1990](/Conferences#AAAI-90 "Conferences"), [pdf](http://www.aaai.org/Papers/AAAI/1990/AAAI90-167.pdf) [[5]](#cite_note-5)
...
- Richard Fikes (**1996**). *Ontologies: What Are They, and Where's The Research?* [KR 1996](https://dblp.uni-trier.de/db/conf/kr/kr96.html) [[6]](#cite_note-6)
...
1. [↑](#cite_ref-1) [Richard Fikes | Engineering](https://engineering.stanford.edu/people/richard-fikes)
2. [↑](#cite_ref-2) [Ontolingua Home Page](http://www.ksl.stanford.edu/software/ontolingua/)
3. [↑](#cite_ref-3) [dblp: Richard Fikes](https://dblp.uni-trier.de/pers/hd/f/Fikes:Richard.html)
4. [↑](#cite_ref-4) [Frame language from Wikipedia](https://en.wikipedia.org/wiki/Frame_language)
5. [↑](#cite_ref-5) [Exploratory programming from Wikipedia](https://en.wikipedia.org/wiki/Exploratory_programming)
6. [↑](#cite_ref-6) [Ontology (information science) from Wikipedia](https://en.wikipedia.org/wiki/Ontology_(information_science))
