...
1. [↑](#cite_ref-1) [[1]](https://en.wikipedia.org/w/index.php?title=OpenCL&oldid=1226652394)Wikipedia contributors. (2024, June 1). OpenCL. In Wikipedia, The Free Encyclopedia. Retrieved 13:48, July 7, 2024
2. [↑](#cite_ref-2) [OpenGL, OpenCL deprecated in favor of Metal 2 in macOS 10.14 Mojave](https://appleinsider.com/articles/18/06/04/opengl-opencl-deprecated-in-favor-of-metal-2-in-macos-1014-mojave)
3. [↑](#cite_ref-3) [clspv](https://github.com/google/clspv) by [Google](/index.php?title=Google&action=edit&redlink=1 "Google (page does not exist)") on GitHub
4. [↑](#cite_ref-4) [Programming with OpenCL C | Writing a Data-Parallel Kernel Using OpenCL C | InformIT](http://www.informit.com/articles/article.aspx?p=1732873)
