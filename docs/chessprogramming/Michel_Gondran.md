...
1. [↑](#cite_ref-1) [Lu sur le Net : Trois questions à Michel Gondran](http://www.epi.asso.fr/revue/lu/l0406b.htm)
2. [↑](#cite_ref-2) [Académie Européenne Interdisciplinaire des Sciences](http://www.science-inter.com/)
3. [↑](#cite_ref-3) [Frenchess' ICGA Tournaments](https://www.game-ai-forum.org/icga-tournaments/program.php?id=183)
4. [↑](#cite_ref-4) [Michel Gondran - ACM author profile page](http://portal.acm.org/author_page.cfm?id=81100523486&coll=DL&dl=ACM&trk=0&cfid=26664898&cftoken=59411599)
5. [↑](#cite_ref-5) [dblp: Michel Gondran](http://www.informatik.uni-trier.de/~ley/db/indices/a-tree/g/Gondran:Michel.html)
6. [↑](#cite_ref-6) [Semiring from Wikipedia](https://en.wikipedia.org/wiki/Semiring)
7. [↑](#cite_ref-7) [Idempotence from Wikipedia](https://en.wikipedia.org/wiki/Idempotence)
8. [↑](#cite_ref-8) [Fuzzy set from Wikipedia](https://en.wikipedia.org/wiki/Fuzzy_set)
9. [↑](#cite_ref-9) [Ordinal optimization from Wikipedia](https://en.wikipedia.org/wiki/Ordinal_optimization)
