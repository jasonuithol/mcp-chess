...
[![Bitboard.gif](/images/3/37/Bitboard.gif)](http://www.onjava.com/pub/a/onjava/2005/02/02/bitsets.html?page=2)
...
For better generalization and to [avoid branches](/Avoiding_Branches "Avoiding Branches"), one may encapsulate [arrays](/Array "Array") of bitboards. For instance, inside the [Beowulf](/Beowulf "Beowulf") sources (sample from moves.c) one finds a lot of branches on [side to move](/Side_to_move "Side to move") to either fetch white or black piece bitboards, as already criticized by [Vincent Diepeveen](/Vincent_Diepeveen "Vincent Diepeveen") in 2001 [[2]](#cite_note-2) ...
