...
Source: https://www.chessprogramming.org/Touch

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Touch**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/1421_Sensory_Homunculus.jpg/330px-1421_Sensory_Homunculus.jpg)](/File:1421_Sensory_Homunculus.jpg)

A 2-D [Cortical sensory homunculus](https://en.wikipedia.org/wiki/Cortical_homunculus) [[1]](#cite_note-1)
...
from [Mark Uniacke's](/Mark_Uniacke "Mark Uniacke") report on the [4th Computer Olympiad 1992](/4th_Computer_Olympiad#Chess "4th Computer Olympiad") [[2]](#cite_note-2):

```
Search techniques used are minimal-window, alpha-beta with extensions for check evasion, mate threats, recaptures and forced moves. Move ordering is by history heuristic, killer heuristic, countermove heuristic and transposition and refutation-table moves. Positional values may range up to +/- 1 Pawn. Development time is 3 years on a part time basis. The program was created to test AI ideas rather than be tuned for chess competitions.
```
...
1. [↑](#cite_ref-1) Illustration from [Anatomy & Physiology](https://anatomyandphysiologyi.com/), [Connexions Web site](http://cnx.org/content/col11496/1.6/), June 19, 2013, [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
