...
Source: https://www.chessprogramming.org/Connected_Pawns

**[Home](/Main_Page "Main Page") \* [Evaluation](/Evaluation "Evaluation") \* [Pawn Structure](/Pawn_Structure "Pawn Structure") \* Connected Pawns**
...
[Stockfish](/Stockfish "Stockfish") gives a connected pawn bonus based on the rank of the phalanx or defending pawn [[1]](#cite_note-1).
...
1. [↑](#cite_ref-1) [Stockfish/pawns.cpp at master · official-stockfish/Stockfish · GitHub](https://github.com/official-stockfish/Stockfish/blob/master/src/pawns.cpp)
