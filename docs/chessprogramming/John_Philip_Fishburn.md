...
Source: https://www.chessprogramming.org/John_Philip_Fishburn

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* John Philip Fishburn**

**John Philip Fishburn**,  
an American computer scientist and electrical engineer from the [Bell Laboratories](/Bell_Laboratories "Bell Laboratories"). He defended his Ph.D. thesis in 1981 at the [University of Wisconsin-Madison](https://en.wikipedia.org/wiki/University_of_Wisconsin-Madison) on [distributed algorithms](https://en.wikipedia.org/wiki/Distributed_algorithm) including the [parallelization](/Parallel_Search "Parallel Search") of [Alpha-Beta](/Alpha-Beta "Alpha-Beta") under the supervision of [Raphael Finkel](/Raphael_Finkel "Raphael Finkel"). The routine *Calphabeta* in his thesis [[1]](#cite_note-1) is mentioned by [Tony Marsland](/Tony_Marsland "Tony Marsland") as base of a [Principal Variation Search](/Principal_Variation_Search "Principal Variation Search") implementation [[2]](#cite_note-2). In his 1983 paper *Another optimization of alpha-beta search*, John Philip Fishburn introduced [Fail-Soft](/Fail-Soft "Fail-Soft") [Alpha-Beta](/Alpha-Beta "Alpha-Beta") [[3]](#cite_note-3) [[4]](#cite_note-4).
...
- John P. Fishburn (**2016**). *Search-Based Opening Book Construction*. [pdf](https://drive.google.com/file/d/0B2pvWWlf39g-NWN0OUpkRE0tem8/view) [[6]](#cite_note-6), [2017 edition](https://drive.google.com/file/d/0B2pvWWlf39g-Z2ZmbHhtWTUwZFE/view) [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) John Philip Fishburn (**1981**). *Analysis of Speedup in Distributed Algorithms*. Ph.D. thesis, [University of Wisconsin-Madison](https://en.wikipedia.org/wiki/University_of_Wisconsin-Madison), [pdf](http://www.cs.wisc.edu/techreports/1981/TR431.pdf), *Calphabeta* at page 167
2. [↑](#cite_ref-2) [Tony Marsland](/Tony_Marsland "Tony Marsland") (**1983**). *Relative Efficiency of Alpha-beta Implementations*. [IJCAI 1983](/Conferences#IJCAI1983 "Conferences"), [pdf](http://webdocs.cs.ualberta.ca/~tony/OldPapers/IJCAI-83.pdf)
3. [↑](#cite_ref-3) John Philip Fishburn (**1983**). *[Another optimization of alpha-beta search](http://portal.acm.org/citation.cfm?id=1056623.1056628&coll=DL&dl=GUIDE&CFID=26266656&CFTOKEN=86225814)*. [SIGART Bulletin](/ACM#SIG "ACM"), No. 84, [pdf](https://drive.google.com/file/d/0B2pvWWlf39g-cjJpZkc1cDhfbkk/view)
...
5. [↑](#cite_ref-5) [dblp: John P. Fishburn](http://www.informatik.uni-trier.de/~ley/db/indices/a-tree/f/Fishburn:John_P=.html)
6. [↑](#cite_ref-6) [Search-Based Opening Book Construction](http://www.talkchess.com/forum/viewtopic.php?p=698871) by John Fishburn, [CCC](/CCC "CCC"), December 14, 2016
7. [↑](#cite_ref-7) [Search-Based Opening Book Construction](http://www.talkchess.com/forum/viewtopic.php?t=63862) by John Fishburn, [CCC](/CCC "CCC"), April 29, 2017
