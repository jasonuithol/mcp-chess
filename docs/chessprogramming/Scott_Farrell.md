...
Source: https://www.chessprogramming.org/Scott_Farrell

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Scott Farrell**

**Scott Farrell**,  
an Australian consultant, chess player [[1]](#cite_note-1), computer chess programmer and author of the private chess engine [Chompster](/Chompster "Chompster") [[2]](#cite_note-2), which is written in [Java](/Java "Java").
...
1. [↑](#cite_ref-1) [ACF Master File for September 2019](http://auschess.org.au/wp-content/uploads/2019/09/sepmst19.txt)
2. [↑](#cite_ref-2) [Private Engine List](http://computer-chess.org/doku.php?id=computer_chess:wiki:lists:private_engine_list) from [Computer-Chess Wiki](http://computer-chess.org/doku.php?id=home) by [Ron Murawski](/Ron_Murawski "Ron Murawski")
