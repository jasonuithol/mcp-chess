...
Source: https://www.chessprogramming.org/SEX_Algorithm

**[Home](/Main_Page "Main Page") \* [Search](/Search "Search") \* [Selectivity](/Selectivity "Selectivity") \* SEX Algorithm**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Sexual_cycle.svg/330px-Sexual_cycle.svg.png)](/File:Sexual_cycle.svg)

Life cycle of sexually reproducing organisms [[1]](#cite_note-1)
...
from *The SEX Algorithm in Computer Chess* 1989 [[2]](#cite_note-2) :
...
1. [↑](#cite_ref-1) [The sexual cycle](https://commons.wikimedia.org/wiki/File:Sexual_cycle.svg), image by [Stannered](http://commons.wikimedia.org/wiki/User:Stannered), March 30, 2007, [Sex from Wikipedia](https://en.wikipedia.org/wiki/Sex)
...
3. [↑](#cite_ref-3) The **swap-off value** of a [move](/Moves "Moves") is defined by its [SEE](/Static_Exchange_Evaluation "Static Exchange Evaluation") value.
...
4. [↑](#cite_ref-4) [Parker Chess](/Parker_Chess "Parker Chess") developed by [David Broughton](/David_Broughton "David Broughton")
5. [↑](#cite_ref-5) [ICCA1989 12 1 part.jpg](http://www.schach-computer.info/wiki/images/5/56/ICCA1989_12_1_part.jpg) from [Schachcomputer.info Wiki](http://www.schach-computer.info/wiki/index.php/Hauptseite_En)
