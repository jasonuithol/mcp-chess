...
Source: https://www.chessprogramming.org/Eigenmann_Rapid_Engine_Test
...
The **Eigenmann Rapid Engine Test** (ERET), designed by [Walter Eigenmann](/index.php?title=Walter_Eigenmann&action=edit&redlink=1 "Walter Eigenmann (page does not exist)"), is a collection of **111** test-positions covering a wide range of chess motives with unique solutions.
ERET was published in the *Glarean Magazin* in March 2017 [[1]](#cite_note-1). The number of correct solutions in 15 seconds per position is the result to roughly compare [engine skills](/Playing_Strength "Playing Strength").

# EPD Record

[Extended Position Description](/Extended_Position_Description "Extended Position Description") [[2]](#cite_note-2):
...
- [Neuer Stellungstest: Der Eigenmann Rapid Engine Test (ERET)](https://forum.computerschach.de/cgi-bin/mwf/topic_show.pl?tid=9355) by [Walter Eigenmann](/index.php?title=Walter_Eigenmann&action=edit&redlink=1 "Walter Eigenmann (page does not exist)"), [CSS Forum](/Computer_Chess_Forums "Computer Chess Forums"), February 28, 2017 (German)
- [Der ERET-Stellungstest im Ranglisten-Vergleich](https://forum.computerschach.de/cgi-bin/mwf/topic_show.pl?tid=9377) by [Walter Eigenmann](/index.php?title=Walter_Eigenmann&action=edit&redlink=1 "Walter Eigenmann (page does not exist)"), [CSS Forum](/Computer_Chess_Forums "Computer Chess Forums"), March 20, 2017 (German)
- [Neue Ergebnisse im ERET-Stellungstest](https://forum.computerschach.de/cgi-bin/mwf/topic_show.pl?tid=9387) by [Walter Eigenmann](/index.php?title=Walter_Eigenmann&action=edit&redlink=1 "Walter Eigenmann (page does not exist)"), [CSS Forum](/Computer_Chess_Forums "Computer Chess Forums"), March 25, 2017 (German)
- [ERET-Test-Suite: New Results](http://talkchess.com/forum3/viewtopic.php?f=2&t=68678) by [Walter Eigenmann](/index.php?title=Walter_Eigenmann&action=edit&redlink=1 "Walter Eigenmann (page does not exist)"), [CCC](/CCC "CCC"), October 17, 2018
- [New results in the ERET chess test](http://talkchess.com/forum3/viewtopic.php?f=2&t=70573) by [Walter Eigenmann](/index.php?title=Walter_Eigenmann&action=edit&redlink=1 "Walter Eigenmann (page does not exist)"), [CCC](/CCC "CCC"), April 23, 2019
- [ERET test results: Leela-Chess the new Number One...](http://talkchess.com/forum3/viewtopic.php?f=2&t=71166) by [Walter Eigenmann](/index.php?title=Walter_Eigenmann&action=edit&redlink=1 "Walter Eigenmann (page does not exist)"), [CCC](/CCC "CCC"), July 02, 2019

# External Links

- [Computer Chess: Test Problems for Programs (ERET) - Glarean Magazin](https://glarean-magazin.ch/2017/03/05/computerschach-testaufgaben-engines-eigenmann-rapid-engine-test-eret/)
- [eigenmann rapid engine test](https://www.glarean-verlag.ch/schach/Eigenmann%20Rapid%20Engine%20Test/ERET%20-%20PGN/Web/eigenmann%20rapid%20engine%20test.htm)

# References

1. [↑](#cite_ref-1) [Computer Chess: Test Problems for Programs (ERET) - Glarean Magazin](https://glarean-magazin.ch/2017/03/05/computerschach-testaufgaben-engines-eigenmann-rapid-engine-test-eret/)
2. [↑](#cite_ref-2) [The ERET position test as an EPD / FEN list](https://glarean-magazin.ch/2017/03/05/computerschach-testaufgaben-engines-eigenmann-rapid-engine-test-eret/)
