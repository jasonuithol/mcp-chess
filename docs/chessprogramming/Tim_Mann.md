...
Source: https://www.chessprogramming.org/Tim_Mann

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Tim Mann**

[![](/images/c/c4/Tim_mann_2004.jpg)](http://tim-mann.org/)

Tim Mann [[1]](#cite_note-1)

**Timothy (Tim) Mann**,  
an American computer scientist and programmer from [Palo Alto, California](https://en.wikipedia.org/wiki/Palo_Alto%2C_California). Tim Mann is the creator of [XBoard](/XBoard "XBoard") and its [Windows](/Windows "Windows") pendant [WinBoard](/WinBoard "WinBoard") [[2]](#cite_note-2) and its [Chess Engine Communication Protocol](/Chess_Engine_Communication_Protocol "Chess Engine Communication Protocol"). In 2002, along with [Robert Hyatt](/Robert_Hyatt "Robert Hyatt"), Tim Mann published the [ICGA Journal](/ICGA_Journal#25_1 "ICGA Journal") paper on a [lock-less transposition table implementation](/Shared_Hash_Table#Lockless "Shared Hash Table") for [parallel search](/Parallel_Search "Parallel Search") [[3]](#cite_note-3).

# XBoard

Tim Mann's quote from an Interview by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky"), April 2000 [[4]](#cite_note-4):
...
[Eval Tuning in Deep Thought](/Eval_Tuning_in_Deep_Thought "Eval Tuning in Deep Thought"), quote from Tim Mann's Chess Pages [[5]](#cite_note-5):
...
- [Arena, Interviews mit Prof. Dr. Robert Hyatt, Tim Mann und Martin Blume](http://web.archive.org/web/20020925204655fw_/http://www.playwitharena.com/directory/interviews/interviews.htm) by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky") for [ChessBits](/ChessBits "ChessBits"), No. 18, May 2002 ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine)) » [Protocols](/Protocols "Protocols"), [Robert Hyatt](/Robert_Hyatt "Robert Hyatt"), [Martin Blume](/Martin_Blume "Martin Blume") [[6]](#cite_note-6)

# References

1. [↑](#cite_ref-1) [Tim Mann's Home Page](http://tim-mann.org/)
2. [↑](#cite_ref-2) [rec.games.chess.computer GNU Chess and XBoard: Frequently Asked Questions](http://groups.google.de/group/rec.games.chess.computer/browse_frm/thread/ede2b5c699e38334?)
3. [↑](#cite_ref-3) [Robert Hyatt](/Robert_Hyatt "Robert Hyatt"), Tim Mann (**2002**). *[A lock-less transposition table implementation for parallel search chess engines](http://www.craftychess.com/hyatt/hashing.html).* [ICCA Journal, Vol. 25, No. 1](/ICGA_Journal#25_1 "ICGA Journal")
4. [↑](#cite_ref-4) [XBoard Project History](http://tim-mann.org/history.html)
5. [↑](#cite_ref-5) [Deep Thought from Tim Mann's Chess Pages](http://www.tim-mann.org/deepthought.html)
6. [↑](#cite_ref-6) [3 interviews about engine protocols with T. Mann, R. Hyatt and M. Blume](https://www.stmintz.com/ccc/index.php?id=245615) by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky"), [CCC](/CCC "CCC"), August 15, 2002
