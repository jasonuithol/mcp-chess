...
Source: https://www.chessprogramming.org/Forth

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* [Languages](/Languages "Languages") \* Forth**
...
Forth evolved from [Charles H. (Chuck) Moore's](https://en.wikipedia.org/wiki/Charles_H._Moore) programming system from 1958. Along with [Elizabeth Rather](https://en.wikipedia.org/wiki/Elizabeth_Rather), Chuck Moore founded the FORTH, Inc. [[1]](#cite_note-1) in 1973.
...
- [James Bowman](http://www.linkedin.com/pub/james-bowman/9/511/358) (**2010**). *J1: a small Forth CPU Core for FPGAs*. [EuroForth 2010](http://www.complang.tuwien.ac.at/anton/euroforth/ef10/), [pdf](http://www.excamera.com/files/j1.pdf) [[2]](#cite_note-2)
...
:   [Forth application benchmark suite (ZIP)](http://www.complang.tuwien.ac.at/forth/appbench.zip) contains both [FCP](/FCP "FCP") by [Ian Osgood](/Ian_Osgood "Ian Osgood") and [Brainless](/Brainless_(Forth) "Brainless (Forth)") by [David Kühling](/David_K%C3%BChling "David Kühling") [[3]](#cite_note-3)

- [comp.lang.forth](https://groups.google.com/forum/#!forum/comp.lang.forth)

# References

1. [↑](#cite_ref-1) [FORTH, Inc. - Embedded Systems Development, Software Tools, and Consulting Services](https://www.forth.com/)
2. [↑](#cite_ref-2) [The J1 Forth CPU — excamera](http://www.excamera.com/sphinx/fpga-j1.html)
3. [↑](#cite_ref-3) [brainless | Free Games software downloads at SourceForge.net](http://sourceforge.net/projects/forth-brainless/)
