...
Source: https://www.chessprogramming.org/Defenchess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Defenchess**
...
Defenchess evolved from the author's former engine *SCTR* [[1]](#cite_note-1), and had its tournament debut at [TCEC Season 11](/TCEC_Season_11 "TCEC Season 11") in 2018, where it won the [Fourth Division](/TCEC_Season_11#Fourth "TCEC Season 11") [[2]](#cite_note-2).
...
1. [↑](#cite_ref-1) [Re: SCTR 1.1d win64](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=65861&start=13) by CMCanavessi, [CCC](/CCC "CCC"), January 03, 2018
2. [↑](#cite_ref-2) [Defenchess wins TCEC Division 4](http://www.chessdom.com/defenchess-wins-tcec-division-4/), [Chessdom](/index.php?title=Chessdom&action=edit&redlink=1 "Chessdom (page does not exist)"), January 06, 2018
