...
Source: https://www.chessprogramming.org/Chess_for_Android

**[Home](/Main_Page "Main Page") \* [User Interface](/User_Interface "User Interface") \* [GUI](/GUI "GUI") \* Chess for Android**  
**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* [BikJump](/BikJump "BikJump") \* Chess for Android**

[![](/images/thumb/2/29/CfAtablet.jpg/240px-CfAtablet.jpg)](/File:CfAtablet.jpg)

Chess for Android on a Tablet

**Chess for Android**,   
written by [Aart Bik](/Aart_Bik "Aart Bik"), is a standalone chess application for [Android](/Android "Android"). The application is available for free at the Android Market [[1]](#cite_note-1) and consists of a chess engine (a [Java](/Java "Java") version derived from the [UCI engine](/Category:UCI "Category:UCI") [BikJump](/BikJump "BikJump") that is written in [C++](/Cpp "Cpp")) and a [GUI](/GUI "GUI").
...
Since version **5.6**, released in February 2018 [[2]](#cite_note-2), Chess for Android supports the [electronic chess board](/Sensory_Board "Sensory Board") of the [Millennium ChessGenius](/Millennium_ChessGenius "Millennium ChessGenius") [[3]](#cite_note-3). Since **5.7**, Chess for Android can connect to a [DGT Board](/DGT_Board "DGT Board"), since **5.9** to the [Certabo Chessboard](/Certabo_Chessboard "Certabo Chessboard") [[4]](#cite_note-4).
...
[![](/images/5/5c/CfA_setup.png)](/File:CfA_setup.png)

Setup Position

[![ChessForAndroid a chess.png](/images/5/58/ChessForAndroid_a_chess.png)](http://www.aartbik.com/MISC/android.html)

Screenshot of latest version

[![ChessForAndroidv1.png](/images/c/c4/ChessForAndroidv1.png)](http://www.aartbik.com/MISC/android.html)
...
1. [↑](#cite_ref-1) [Android Market - Apps by Aart Bik](https://market.android.com/developer?pub=Aart+Bik)
2. [↑](#cite_ref-2) [Re: Chess for Android v5.6](http://www.talkchess.com/forum/viewtopic.php?t=66692&start=3) by [Aart Bik](/Aart_Bik "Aart Bik"), [CCC](/CCC "CCC"), February 28, 2018
3. [↑](#cite_ref-3) [Connecting Chess for Android with the Millennium](http://www.aartbik.com/android_millennium.php) » [Millennium ChessGenius](/Millennium_ChessGenius "Millennium ChessGenius")
4. [↑](#cite_ref-4) [Chess for Android and Electronic ChessBoards](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=69257) by [Aart Bik](/Aart_Bik "Aart Bik"), [CCC](/CCC "CCC"), December 14, 2018
