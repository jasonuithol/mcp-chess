...
Source: https://www.chessprogramming.org/Rook_(Program)

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Rook (Program)**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/RooksBackOfSavrasov.jpg/330px-RooksBackOfSavrasov.jpg)](/File:RooksBackOfSavrasov.jpg)

Rooks have Returned [[1]](#cite_note-1)

**Rook**,  
a chess program by [Lars Karlsson](/Lars_Karlsson "Lars Karlsson") written in [Z80](/Z80 "Z80") [assembly](/Assembly "Assembly") for the *Data Board 4680* card computer [[2]](#cite_note-2) [[3]](#cite_note-3) and subsequently the [ABC 80](https://en.wikipedia.org/wiki/ABC_80), produced by [Dataindustrier AB](https://en.wikipedia.org/wiki/Dataindustrier_AB), the company founded in 1970 by Karlsson himself [[4]](#cite_note-4).
...
[WMCCC 1980](/WMCCC_1980 "WMCCC 1980"), round 4, [Gambiet 80](/Gambiet "Gambiet") - Rook 4.0 [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) [Alexei Savrasov](/index.php?title=Category:Alexei_Savrasov&action=edit&redlink=1 "Category:Alexei Savrasov (page does not exist)") - [Rooks have Returned](https://commons.wikimedia.org/wiki/File:RooksBackOfSavrasov.jpg), 1871, [Tretyakov Gallery](https://en.wikipedia.org/wiki/Tretyakov_Gallery), [Rook (bird) from Wikipedia](https://en.wikipedia.org/wiki/Rook_%28bird%29), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [Data Board 4680](https://dflund.se/~triad/diab/db4680.html)
3. [↑](#cite_ref-3) [DataBoard.4680.sida.1.JPG](http://abc80databasen.blinkenshell.org/scan/DataBoard.4680.sida.1.JPG) from [abc80databasen.blinkenshell.org/Scanningar](http://abc80databasen.blinkenshell.org/Scanningar.html)
4. [↑](#cite_ref-4) [Historien om DIAB - Dataindustrier AB](https://dflund.se/~triad/diab/) (Swedish)
5. [↑](#cite_ref-5) [Softwarehaus mbp arrangierte Match gegen den Computer:Schach-Mikro für Boris Spasskij kein Problem](https://www.computerwoche.de/a/softwarehaus-mbp-arrangierte-match-gegen-den-computer-schach-mikro-fuer-boris-spasskij-kein-problem,1186042), April 24, 1981, [Computerwoche](/Computerworld#Woche "Computerworld") 17/1981 (German)
6. [↑](#cite_ref-6) [Vem är den där Karlsson?](https://www.idg.se/2.10186/1.354495/vem-ar-den-dar-karlsson) by [Pär Rittsel](https://at.linkedin.com/in/rittsel/de), [IDG.se](https://en.wikipedia.org/wiki/International_Data_Group), November 21, 2010 (Swedish) Interview with [Lars Karlsson](/Lars_Karlsson "Lars Karlsson"), [MikroDatorn](https://en.wikipedia.org/wiki/MikroDatorn), January 1981, [Google Translate](https://en.wikipedia.org/wiki/Google_Translate)
7. [↑](#cite_ref-7) [London 1980 - Chess - Round 4 - Game 2 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=13&round=4&id=2)
