...
Source: https://www.chessprogramming.org/GUI

**[Home](/Main_Page "Main Page") \* [User Interface](/User_Interface "User Interface") \* Graphical User Interface**
...
[![IDIIOMGUI.jpg](/images/8/8e/IDIIOMGUI.jpg)](http://www.flickr.com/photos/10261668@N05/sets/72157600922175252/)
...
4. [↑](#cite_ref-4) Picture dated November 14, 1970, [Chess in Space - NASA 1970 First Chess Experiments](https://sites.google.com/site/caroluschess/modern-history/chess-in-space) from [Carolus Chess](https://sites.google.com/site/caroluschess/home)
5. [↑](#cite_ref-5) [14.Unique Computers: Flickr](http://www.flickr.com/photos/10261668@N05/sets/72157600922175252/) by [Chewbanta](/Steve_Blincoe "Steve Blincoe")
6. [↑](#cite_ref-6) [Don Bissell](http://dl.acm.org/author_page.cfm?id=81100488426&coll=DL&dl=ACM&trk=0&cfid=94733554&cftoken=96327999) (**1998**). *[Was the IDIIOM the First Stand-Alone CAD Platform?](http://www.computer.org/portal/web/csdl/doi/10.1109/85.667292)* [IEEE Annals of the History of Computing](https://en.wikipedia.org/wiki/IEEE_Annals_of_the_History_of_Computing), Vol. 20, No. 2
7. [↑](#cite_ref-7) [What's the role of the GUI?](http://www.talkchess.com/forum/viewtopic.php?t=21168) by Zlatnik, [CCC](/CCC "CCC"), May 15, 2008
8. [↑](#cite_ref-8) [Free chess graphical user interface (GUI) Arena for chess engines](http://www.playwitharena.com/)
9. [↑](#cite_ref-9) [Sjeng - chess, audio and misc. software](http://sjeng.org/deepsjeng.html)
10. [↑](#cite_ref-10) [Mikhail Donskoy](/Mikhail_Donskoy "Mikhail Donskoy") (**2001**). *How the Computer-Chess Methods Help to Build Better User Interfaces.* [Advances in Computer Games 9](/Advances_in_Computer_Games_9 "Advances in Computer Games 9")
11. [↑](#cite_ref-11) [Re: Object model for chess GUI?](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=58687&hilit=winboard#p653469) by [Steve Maughan](/Steve_Maughan "Steve Maughan"), [CCC](/CCC "CCC"), December 26, 2015 » [Protocols](/Protocols "Protocols")
12. [↑](#cite_ref-12) [Web based GUI for UCI chess engine: YouTube series](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=75352) by [Maksim Korzh](/Maksim_Korzh "Maksim Korzh"), [CCC](/CCC "CCC"), October 10, 2020
