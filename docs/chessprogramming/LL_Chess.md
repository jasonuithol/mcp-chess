...
Source: https://www.chessprogramming.org/LL_Chess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* LL Chess**
...
last modified in May 2001, still in it's beta stage [[1]](#cite_note-1).
...
The so called positional logic, the logic of material exchange between the two sides takes following [point values](/Point_Value "Point Value") into account, as given in Leonid's *Chess Introduction* [[2]](#cite_note-2).
...
2. [↑](#cite_ref-2) [Chess Introduction](http://www.theparticle.com/chess000.html) by [Leonid Liberman](/Leonid_Liberman "Leonid Liberman")
