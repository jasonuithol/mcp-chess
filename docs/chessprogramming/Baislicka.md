...
Source: https://www.chessprogramming.org/Baislicka

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Baislicka**

**Baislicka**,  
an [UCI](/UCI "UCI") compliant [open source chess engine](/Category:Open_Source "Category:Open Source") under the [MIT License](/Massachusetts_Institute_of_Technology#License "Massachusetts Institute of Technology") by [Robert Taylor](/index.php?title=Robert_Taylor&action=edit&redlink=1 "Robert Taylor (page does not exist)") [[1]](#cite_note-1), written in [C](/C "C"), first published in 2017.
...
1. [↑](#cite_ref-1) [Baislicka 1.0 64-bit in CCRL 40/40](https://ccrl.chessdom.com/ccrl/4040/cgi/engine_details.cgi?print=Details&eng=Baislicka%201.0%2064-bit#Baislicka_1_0_64-bit)
