...
Source: https://www.chessprogramming.org/Barbarossa

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Barbarossa**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Friedrich_I._Barbarossa.jpg/330px-Friedrich_I._Barbarossa.jpg)](/File:Friedrich_I._Barbarossa.jpg)

Barbarossa [[1]](#cite_note-1)
...
3. [↑](#cite_ref-3) [Abulafia, chess, Haskell and some (new?) ideas](http://www.talkchess.com/forum/viewtopic.php?t=43384) by [Nicu Ionita](/Nicu_Ionita "Nicu Ionita"), [CCC](/CCC "CCC"), April 20, 2012
4. [↑](#cite_ref-4) [Haskell (programming language) from Wikipedia](https://en.wikipedia.org/wiki/Haskell_%28programming_language%29)
5. [↑](#cite_ref-5) [Barbarossa/Magics.hs at master · nionita/Barbarossa · GitHub](https://github.com/nionita/Barbarossa/blob/master/Moves/Magics.hs)
6. [↑](#cite_ref-6) [Barbarossa/Albeta.hs at master · nionita/Barbarossa · GitHub](https://github.com/nionita/Barbarossa/blob/master/Search/Albeta.hs)
7. [↑](#cite_ref-7) [Haskell/Monad transformers - Wikibooks](http://en.wikibooks.org/wiki/Haskell/Monad_transformers)
8. [↑](#cite_ref-8) [Haskell/Understanding monads - Wikibooks](http://en.wikibooks.org/wiki/Haskell/Understanding_monads)
9. [↑](#cite_ref-9) [Kunihito Hoki](/Kunihito_Hoki "Kunihito Hoki"), [Tomoyuki Kaneko](/Tomoyuki_Kaneko "Tomoyuki Kaneko") (**2014**). *[Large-Scale Optimization for Evaluation Functions with Minimax Search](https://www.jair.org/papers/paper4217.html)*. [JAIR Vol. 49](https://www.jair.org/vol/vol49.html), [pdf](https://www.jair.org/media/4217/live-4217-7792-jair.pdf)
...
12. [↑](#cite_ref-12) [DSPSA eval weights for pawns · nionita/Barbarossa@b9ba4de · GitHub](https://github.com/nionita/Barbarossa/commit/b9ba4de3e3e324e2461a373c00b51f7651a514d9)
