...
Source: https://www.chessprogramming.org/Kai_Laskos

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Kai Laskos**

[![](/images/5/5a/KaiLaskos.jpg)](/File:KaiLaskos.jpg)

Kai Laskos [[1]](#cite_note-1)

**Kai Laskos**,   
a Romanian physicist and Ph.D. working on [theoretical physics](https://en.wikipedia.org/wiki/Theoretical_physics) at **IFIN HH**, the [Horia Hulubei](https://en.wikipedia.org/wiki/Horia_Hulubei) National Institute of Physics and Nuclear Engineering [[2]](#cite_note-2) in [Bucharest](https://en.wikipedia.org/wiki/Bucharest).
...
His professional expertise in [statistics](https://en.wikipedia.org/wiki/Statistics) made him a recognized computer chess and Go theorist [[3]](#cite_note-3)
...
- [Updated Dendrogram](http://www.talkchess.com/forum/viewtopic.php?t=47086) by Kai Laskos, [CCC](/CCC "CCC"), February 02, 2013 [[4]](#cite_note-4)
...
- [Type I error in LOS based early stopping rule](http://www.talkchess.com/forum/viewtopic.php?t=48863) by Kai Laskos, [CCC](/CCC "CCC"), August 06, 2013 [[5]](#cite_note-5)
...
- [Houdini, much weaker engines, and Arpad Elo](http://www.talkchess.com/forum/viewtopic.php?t=50266) by Kai Laskos, [CCC](/CCC "CCC"), November 29, 2013 » [Houdini](/Houdini "Houdini"), [Pawn Advantage, Win Percentage, and Elo](/Pawn_Advantage,_Win_Percentage,_and_Elo "Pawn Advantage, Win Percentage, and Elo") [[6]](#cite_note-6)
...
- [Error margins via resampling (jackknifing)](http://www.talkchess.com/forum/viewtopic.php?t=61105) by Kai Laskos, [CCC](/CCC "CCC"), August 12, 2016  » [Statistical Analysis](/Match_Statistics#Statistical_Analysis "Match Statistics") [[7]](#cite_note-7) [[8]](#cite_note-8)
...
- [Invariance with time control of rating schemes](http://www.talkchess.com/forum/viewtopic.php?t=64683) by Kai Laskos, [CCC](/CCC "CCC"), July 22, 2017 [[9]](#cite_note-9)
...
- [ZZ-tune conclusively better than the Kiudee default for Lc0](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=75950) by Kai Laskos, [CCC](/CCC "CCC"), December 01, 2020 » [Lc0](/Leela_Chess_Zero#Lc0 "Leela Chess Zero") [[10]](#cite_note-10)

# References

1. [↑](#cite_ref-1) Photo courtesy Kai Laskos
2. [↑](#cite_ref-2) [Horia Hulubei National Institute of Physics and Nuclear Engineering](https://www.nipne.ro/about/history/)
3. [↑](#cite_ref-3) [A Gross Miscarriage of Justice in Computer Chess (part two)](https://en.chessbase.com/post/a-gro-miscarriage-of-justice-in-computer-che-part-two) by [Søren Riis](/S%C3%B8ren_Riis "Søren Riis"), [ChessBase News](/ChessBase "ChessBase"), January 03, 2012
4. [↑](#cite_ref-4) [Dendrogram from Wikipedia](https://en.wikipedia.org/wiki/Dendrogram)
5. [↑](#cite_ref-5) [Type I and type II errors from Wikipedia](https://en.wikipedia.org/wiki/Type_I_and_type_II_errors)
6. [↑](#cite_ref-6) [Arpad Elo - Wikipedia](https://en.wikipedia.org/wiki/Arpad_Elo)
7. [↑](#cite_ref-7) [Resampling (statistics) from Wikipedia](https://en.wikipedia.org/wiki/Resampling_(statistics))
8. [↑](#cite_ref-8) [Jackknife resampling from WIkipedia](https://en.wikipedia.org/wiki/Jackknife_resampling)
9. [↑](#cite_ref-9) [Normalized Elo](http://hardy.uhasselt.be/Toga/normalized_elo.pdf) (pdf) by [Michel Van den Bergh](/Michel_Van_den_Bergh "Michel Van den Bergh")
10. [↑](#cite_ref-10) [GitHub - kiudee/chess-tuning-tools](https://github.com/kiudee/chess-tuning-tools) by [Karlson Pfannschmidt](/Karlson_Pfannschmidt "Karlson Pfannschmidt")
