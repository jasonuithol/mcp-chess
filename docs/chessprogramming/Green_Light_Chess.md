...
Source: https://www.chessprogramming.org/Green_Light_Chess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Green Light Chess**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Gachala_Emerald_3526711557_849c4c7367.jpg/330px-Gachala_Emerald_3526711557_849c4c7367.jpg)](/File:Gachala_Emerald_3526711557_849c4c7367.jpg)

[Emerald green](https://en.wikipedia.org/wiki/Shades_of_green#Emerald) [[1]](#cite_note-1)

**Green Light Chess**, (Green Light, GLChess [[2]](#cite_note-2))  
a [WinBoard](/WinBoard "WinBoard") compliant chess engine by [Tim Foden](/Tim_Foden "Tim Foden"), written in [C++](/Cpp "Cpp"), version 2.09 relying on an own 32-bit [Windows](/Windows "Windows") [GUI](/GUI "GUI") [[3]](#cite_note-3).
...
The well maintained 2.18 change log gives a decent overview of features, modifications and bugfixes within the engine development, its GUI and WinBoard implementations [[4]](#cite_note-4).
...
[WCCC 2003](/WCCC_2003 "WCCC 2003"), round 5, Green Light - [Falcon](/Falcon "Falcon") [[5]](#cite_note-5)
...
- [Aurora (astronomy) from Wikipedia](https://en.wikipedia.org/wiki/Aurora_%28astronomy%29) [[6]](#cite_note-6) [[7]](#cite_note-7)

:   [![Aurora borealis over Eielson Air Force Base, Alaska.jpg](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Aurora_borealis_over_Eielson_Air_Force_Base%2C_Alaska.jpg/960px-Aurora_borealis_over_Eielson_Air_Force_Base%2C_Alaska.jpg)](/File:Aurora_borealis_over_Eielson_Air_Force_Base,_Alaska.jpg)

# References

1. [↑](#cite_ref-1) The [Gachala Emerald](https://en.wikipedia.org/wiki/Gachal%C3%A1_Emerald) from the [National Museum of Natural History](https://en.wikipedia.org/wiki/National_Museum_of_Natural_History), [Washington, D.C.](https://en.wikipedia.org/wiki/Washington,_D.C.), [Shades of green from Wikipedia](https://en.wikipedia.org/wiki/Shades_of_green)
2. [↑](#cite_ref-2) not to be confused with the [glChess](/index.php?title=GlChess&action=edit&redlink=1 "GlChess (page does not exist)") [GUI](/GUI "GUI")
3. [↑](#cite_ref-3) [Green Light Chess - WIN32 GUI](http://www.7sun.com/chess/oldversions/218/index.php#win32-gui)
4. [↑](#cite_ref-4) [changes.txt](http://kirr.homeunix.org/chess/engines/Norbert%27s%20collection/Green%20Light%20Chess%20%28Compilation%29/v2.18/changes.txt)
5. [↑](#cite_ref-5) [Graz 2003 - Chess - Round 5 - Game 7 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=2&round=5&id=7)
...
7. [↑](#cite_ref-7) [The Aurora Distributed Shared Data System](http://webdocs.cs.ualberta.ca/%7Epaullu/Aurora/aurora.html) by [Paul Lu](/Paul_Lu "Paul Lu")
