...
Source: https://www.chessprogramming.org/Flux

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Flux**

[File:Hashmask 12501 of 16384 named Flux.png](/index.php?title=Special:Upload&wpDestFile=Hashmask_12501_of_16384_named_Flux.png "File:Hashmask 12501 of 16384 named Flux.png")

Hashmask 12501 of 16384 named Flux [[1]](#cite_note-1)
...
[[2]](#cite_note-2) and runs on all available Java 7 platforms including [Windows](/Windows "Windows"), [OS X](/Mac_OS "Mac OS") and [Linux](/Linux "Linux").
...
1. [↑](#cite_ref-1) Hashmask 12501 of 16384 named Flux, an example of [hashmask image](https://www.thehashmasks.com/) that accompanies a [Non-Fungible Token (NFT)](https://en.wikipedia.org/wiki/Non-fungible_token).
...
2. [↑](#cite_ref-2) [GitHub - fluxroot/jcpi: A Java Chess Protocol Interface](https://github.com/fluxroot/jcpi)
3. [↑](#cite_ref-3) [Flux Engine - Flux Chess Project](https://web.archive.org/web/20160424120659/http://www.fluxchess.com:80/flux/) ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine))
