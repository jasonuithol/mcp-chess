...
Source: https://www.chessprogramming.org/Hashing_Dictionaries

**[Home](/Main_Page "Main Page") \* [Board Representation](/Board_Representation "Board Representation") \* [Bitboards](/Bitboards "Bitboards") \* [Sliding Piece Attacks](/Sliding_Piece_Attacks "Sliding Piece Attacks") \* Hashing Dictionaries**

This approach using associate arrays or [hash tables](/Hash_Table "Hash Table") was introduced in the [ICGA Journal](/ICGA_Journal "ICGA Journal") (June 2007) by [Sam Tannous](/Sam_Tannous "Sam Tannous") [[1]](#cite_note-ICGAJ-1). Like other [occupancy](/Occupancy "Occupancy") lookup approaches it works line-wise for ranks, files, diagonals and anti-diagonals. It uses hash arrays from an interpreted, high level language, [Python](/Python "Python"):
...
Quoted from *Avoiding Rotated Bitboards with Direct Lookup* [[1]](#cite_note-ICGAJ-1):
...
1. ↑ [1.0](#cite_ref-ICGAJ_1-0) [1.1](#cite_ref-ICGAJ_1-1) [Sam Tannous](/Sam_Tannous "Sam Tannous") (**2007**). *Avoiding Rotated Bitboards with Direct Lookup*. [ICGA Journal, Vol. 30, No. 2](/ICGA_Journal#30_2 "ICGA Journal"), [arXiv:0704.3773](https://arxiv.org/abs/0704.3773)
2. [↑](#cite_ref-2) [Donald Knuth](/Donald_Knuth "Donald Knuth") (**1998**). *The Art of Computer Programming*. Volume 3, Sorting and Searching. Addison Wesley. ISBN 0201896850
