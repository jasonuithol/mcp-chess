...
Source: https://www.chessprogramming.org/Stoofvlees

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Stoofvlees**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Ingredients_carbonade.png/330px-Ingredients_carbonade.png)](/File:Ingredients_carbonade.png)

Stoofvlees Ingredients [[1]](#cite_note-1)

**Stoofvlees**,  
an experimental chess engine by [Gian-Carlo Pascutto](/Gian-Carlo_Pascutto "Gian-Carlo Pascutto"). The [evaluation function](/Evaluation_Function "Evaluation Function") consists of a set of feature recognizers coupled to a [neural network](/Neural_Networks "Neural Networks"), which was trained with an [oracle](/Oracle "Oracle") [[2]](#cite_note-2), that is the [evaluation](/Evaluation "Evaluation") was entirely [automatically](/Automated_Tuning "Automated Tuning") [learned](/Learning "Learning") from "watching" Grandmaster games [[3]](#cite_note-3). The results were incorporated into [Deep Sjeng](/Deep_Sjeng "Deep Sjeng") [[4]](#cite_note-4). Stoofvlees played the [ICT 2007](/ICT_2007 "ICT 2007") operated by [Elke Van Vlierberghe](/Elke_Van_Vlierberghe "Elke Van Vlierberghe"), along with its relative Deep Sjeng.

# Stoofvlees II

In 2019, an updated version dubbed **Stoofvlees II** was announced to play chess at [CEGT](/CEGT "CEGT"), with [neural networks](/Neural_Networks "Neural Networks") instantiated on [Nvidia](/Nvidia "Nvidia") [GPUs](/GPU "GPU") [[5]](#cite_note-5) [[6]](#cite_note-6).
...
[ICT 2007](/ICT_2007 "ICT 2007"), round 3, [Hermann](/Hermann "Hermann") - Stoofvlees [[7]](#cite_note-7)
...
[TCEC Season 18](/TCEC_Season_18 "TCEC Season 18"), [Premier Division](/TCEC_Season_18#Premier "TCEC Season 18") [Komodo 2551.00](/Komodo "Komodo") - Stoofvlees II a14 [[8]](#cite_note-8)
...
1. [↑](#cite_ref-1) [Stoofvlees from Wikipedia.nl](https://nl.wikipedia.org/wiki/Stoofvlees) (Dutch)
2. [↑](#cite_ref-2) [Re: Chess program with Artificial Neural Networks (ANN)?](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=316511&t=31545) by [Gian-Carlo Pascutto](/Gian-Carlo_Pascutto "Gian-Carlo Pascutto"), [CCC](/CCC "CCC"), January 07, 2010
3. [↑](#cite_ref-3) [Sjeng 2.7 released](http://www.talkchess.com/forum/viewtopic.php?t=16244) by Jens, [CCC](/CCC "CCC"), September 03, 2007
4. [↑](#cite_ref-4) [Re: Chess program with Artificial Neural Networks (ANN)?](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=316769&t=31545) by [Gian-Carlo Pascutto](/Gian-Carlo_Pascutto "Gian-Carlo Pascutto"), [CCC](/CCC "CCC"), January 08, 2010
5. [↑](#cite_ref-5)  [the digital rebirth of Deep Sjeng](http://www.talkchess.com/forum3/viewtopic.php?f=6&t=70631) by [Werner Schüle](/index.php?title=Werner_Sch%C3%BCle&action=edit&redlink=1 "Werner Schüle (page does not exist)"), [CCC](/CCC "CCC"), May 01, 2019
6. [↑](#cite_ref-6) [CEGT - rating lists June 30th 2019](http://talkchess.com/forum3/viewtopic.php?f=6&t=71145) by [Werner Schüle](/index.php?title=Werner_Sch%C3%BCle&action=edit&redlink=1 "Werner Schüle (page does not exist)"), [CCC](/CCC "CCC"), June 30, 2019
7. [↑](#cite_ref-7) [Downloads | CSVN International Computerchess Tournament | Games](http://www.csvn.nl/index.php?option=com_docman&task=cat_view&gid=39&Itemid=26&lang=en&limitstart=5), [CSVN](/CSVN "CSVN") site
8. [↑](#cite_ref-8) [Komodo 2551.00 vs. Stoofvlees II a14 - TCEC - Live Computer Chess Broadcast](https://www.tcec-chess.com/archive.html?season=18&div=p&game=4)
