...
Source: https://www.chessprogramming.org/Fortran

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* [Languages](/Languages "Languages") \* Fortran**
...
[![FortranCardPROJ039.agr.jpg](https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/FortranCardPROJ039.agr.jpg/960px-FortranCardPROJ039.agr.jpg)](/File:FortranCardPROJ039.agr.jpg)

[Punched card](https://en.wikipedia.org/wiki/Punched_card) from a Fortran program: Z(1) = Y + W(1) [[1]](#cite_note-1)

# Sample Chess Code

A recursive Fortran 90 [Alpha-Beta](/Alpha-Beta "Alpha-Beta") search routine [[2]](#cite_note-2):
...
1. [↑](#cite_ref-1) [Punched card from Wikipedia](https://en.wikipedia.org/wiki/Punched_card)
2. [↑](#cite_ref-2) [chessf90.zip, Source and 64 bit Windows executable of A Fortran 90 chess program](http://cap.connx.com/chess-engines/new-approach/chessf90.zip) from [cap.connx.com](http://cap.connx.com/) by [Dann Corbit](/Dann_Corbit "Dann Corbit")
