...
Source: https://www.chessprogramming.org/Free_Software_Foundation

**[Home](/Main_Page "Main Page") \* [Organizations](/Organizations "Organizations") \* Free Software Foundation**

The **Free Software Foundation** (FSF), incorporated in [Massachusetts](https://en.wikipedia.org/wiki/Massachusetts), is a [non-profit corporation](https://en.wikipedia.org/wiki/Non-profit_corporation) founded by [Richard Stallman](https://en.wikipedia.org/wiki/Richard_Stallman) on October 04, 1985 [[1]](#cite_note-1) , to support the [free software movement](https://en.wikipedia.org/wiki/Free_software_movement). The FSF holds the copyrights on various pieces and development tools of the [GNU](https://en.wikipedia.org/wiki/GNU) [operating system](https://en.wikipedia.org/wiki/Operating_system).

# GNU

**GNU** refers to an [operating system](https://en.wikipedia.org/wiki/Operating_system) developed by the [GNU Project](https://en.wikipedia.org/wiki/GNU_Project), announced on September 27, 1983, by Stallman at [MIT](/Massachusetts_Institute_of_Technology "Massachusetts Institute of Technology") [[2]](#cite_note-2) . GNU is a [recursive](/Recursion "Recursion") acronym for “GNU's Not [Unix](/Unix "Unix")!” [[3]](#cite_note-3) .

[![Heckert GNU white.svg](https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Heckert_GNU_white.svg/250px-Heckert_GNU_white.svg.png)](http://www.gnu.org/)
...
1. [↑](#cite_ref-1) [Free Software Foundation from Wikipedia](https://en.wikipedia.org/wiki/Free_Software_Foundation)
2. [↑](#cite_ref-2) [GNU Project from Wikipedia](https://en.wikipedia.org/wiki/GNU_Project)
3. [↑](#cite_ref-3) [GNU from Wikipedidia](https://en.wikipedia.org/wiki/GNU)
