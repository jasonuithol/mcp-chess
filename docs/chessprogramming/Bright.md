...
Source: https://www.chessprogramming.org/Bright

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Bright**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/LightningVolt_Deep_Blue_Sea.jpg/330px-LightningVolt_Deep_Blue_Sea.jpg)](/File:LightningVolt_Deep_Blue_Sea.jpg)

Decreasing [brightness](https://en.wikipedia.org/wiki/Brightness) with [depth](/Depth "Depth") [[1]](#cite_note-1)
...
[Late Move Reductions](/Late_Move_Reductions "Late Move Reductions") as popularized by [Fruit](/Fruit "Fruit") and [Glaurung](/Glaurung "Glaurung") are used in Bright with different implementation details. The reductions are not [history](/History_Heuristic "History Heuristic") based, and all moves, except the first one, can be reduced by one [ply](/Ply "Ply") depending on static criteria [[2]](#cite_note-2) .

# Tournament Play

Bright played a strong [CCT11](/CCT11 "CCT11") and became runner-up along with [Fruit](/Fruit "Fruit") behind [Rybka](/Rybka "Rybka"), and after Rybka's disqualification in 2011 co-champion [[3]](#cite_note-3).
...
1. [↑](#cite_ref-1) Photo by [Lars Lentz](https://lars-lentz.pixels.com/), [Brightness from Wikipedia](https://en.wikipedia.org/wiki/Brightness)
2. [↑](#cite_ref-2) [Interview with Allard Siemelink](https://www.schach-welt.de/schach/computerschach/interviews/allard-siemelink-deng) by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky"), [Schachwelt](https://www.schach-welt.de/), January 10, 2010
3. [↑](#cite_ref-3) [CCT11: Bright by Allard Siemelink and Fruit by Fabien Letouzey are Co-Champions](https://cctchess.com/previous-events/cct-11/results/) (dead link)
