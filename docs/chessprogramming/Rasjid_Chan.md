...
Source: https://www.chessprogramming.org/Rasjid_Chan

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Rasjid Chan**

**Rasjid Chan**, [[1]](#cite_note-1)  
a Singaporean chess programmer with passion for [bit-twiddling](/Bit-Twiddling "Bit-Twiddling") and [bitboards](/Bitboards "Bitboards") [[2]](#cite_note-2).
Rasjid is author of the [Chess Engine Communication Protocol](/Chess_Engine_Communication_Protocol "Chess Engine Communication Protocol") compatible chess programs [SnailChess](/SnailChess "SnailChess") [[3]](#cite_note-3) and [Cowrie Chess](/index.php?title=Cowrie_Chess&action=edit&redlink=1 "Cowrie Chess (page does not exist)") [[4]](#cite_note-4).
...
1. [↑](#cite_ref-1) Chan Rasjid in [Big-endian](/Big-endian "Big-endian") Asian standard template [LAST NAME][FIRST NAME]
2. [↑](#cite_ref-2)  [Re: Bitboard of squares between](http://www.open-aurec.com/wbforum/viewtopic.php?f=4&t=6573#p30811) by Rasjid Chan, [Winboard Forum](/Computer_Chess_Forums "Computer Chess Forums"), June 15, 2007
3. [↑](#cite_ref-3) [Engine Download List](http://www.computer-chess.org/doku.php?id=computer_chess:wiki:download:engine_download_list) from [Ron Murawski's](/Ron_Murawski "Ron Murawski") [Computer-Chess Wiki](http://computer-chess.org/doku.php?id=home)
4. [↑](#cite_ref-4) [Private Engine List](http://computer-chess.org/doku.php?id=computer_chess:wiki:lists:private_engine_list) from [Ron Murawski's](/Ron_Murawski "Ron Murawski") [Computer-Chess Wiki](http://computer-chess.org/doku.php?id=home)
