...
Source: https://www.chessprogramming.org/Horizon

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Horizon**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/SkyView2.PNG/330px-SkyView2.PNG)](/File:SkyView2.PNG)

Horizon - Sky View [[1]](#cite_note-1)
...
Initially running atop a much-modified version of [Colin Frayn's](/Colin_Frayn "Colin Frayn") open-source [Beowulf](/Beowulf "Beowulf") infrastructure, there's very little of Beowulf that remains within Horizon and less with each release [[2]](#cite_note-2).
...
[WCRCC 2008](/WCRCC_2008 "WCRCC 2008"), round 14, Horizon - [Tornado](/Tornado "Tornado") [[4]](#cite_note-4)
...
1. [↑](#cite_ref-1) [Sky View 2](http://commons.wikimedia.org/wiki/File:SkyView2.PNG) by gierszewski, 2005, Sunrise at [Calgary](https://en.wikipedia.org/wiki/Calgary), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [Horizon Chess - Main - Acknowledgements](http://www.horizonchess.com/pmwiki.php?n=Main.HomePage)
3. [↑](#cite_ref-3) Features from [Horizon Chess - Main - Engine Technical Description](http://www.horizonchess.com/pmwiki.php?n=Main.EngineTechnicalDescription)
4. [↑](#cite_ref-4) [2008 Second Annual ACCA World Computer Chess Championships - Results - PGN-Download](http://compchess.org/ACCAWCRCC/2008ACCAWCRCC/2008WCRCCResults.html)
