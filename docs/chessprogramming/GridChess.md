...
Source: https://www.chessprogramming.org/GridChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* GridChess**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Divina_proportione.png/330px-Divina_proportione.png)](/File:Divina_proportione.png)

A grid applied within an image [[1]](#cite_note-1)
...
All processors on the same cluster node [share](/Shared_Hash_Table "Shared Hash Table") their [hash table](/Transposition_Table "Transposition Table"). New hash table entries are permanently replicated between all cluster nodes in a similar way as described for [Brutus](/Brutus "Brutus") [[2]](#cite_note-2).

# Optimistic Pondering

The asynchronous optimistic [pondering](/Pondering "Pondering") is applied not only during the opponent’s thinking time but also during the own thinking time, and schedules cluster nodes (workers) with consecutive [root-nodes](/Root "Root") along the [principal variation](/Principal_Variation "Principal Variation") (PV), which is most often available in a stable form at early stages of the search. This is based on the same observation, [David Levy](/David_Levy "David Levy") proposed his *[Multiple Extensions](/PV_Extensions#Multiple "PV Extensions")* algorithm to treat the often early stable part of a PV as a single [ply](/Ply "Ply") to achieve higher [search depths](/Depth "Depth") [[3]](#cite_note-3).
...
1. [↑](#cite_ref-1) Drawing simplified from a [woodcut](https://en.wikipedia.org/wiki/Woodcut) from the [Divina Proportione](https://en.wikipedia.org/wiki/Divina_proportione), [Luca Pacioli](https://en.wikipedia.org/wiki/Luca_Pacioli) 1509, [Venice](https://en.wikipedia.org/wiki/Venice), depicting proportions of the [human face](https://en.wikipedia.org/wiki/Face). The [golden ratio](https://en.wikipedia.org/wiki/Golden_ratio) does not appear in the drawing. [Grid (graphic design) from Wikipedia](https://en.wikipedia.org/wiki/Grid_(graphic_design)), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [Chrilly Donninger](/Chrilly_Donninger "Chrilly Donninger"), [Alex Kure](/Alex_Kure "Alex Kure"), [Ulf Lorenz](/Ulf_Lorenz "Ulf Lorenz") (**2004**). *Parallel Brutus: The First Distributed, FPGA Accelerated Chess Program*. [IPDPS’04](http://dl.acm.org/citation.cfm?id=645610&picked=prox)
3. [↑](#cite_ref-3) [David Levy](/David_Levy "David Levy") (**2003**). *The State of the Art in Man vs. “Machine” Chess*. [ICGA Journal, Vol. 26, No. 1](/ICGA_Journal#26_1 "ICGA Journal")
4. [↑](#cite_ref-4) [PhD Project of Kai Himstedt (Dipl.-Inform.)](http://www.informatik.uni-hamburg.de/TIS/index.php/de/projekte/phd-projects/79/)
5. [↑](#cite_ref-5) [Kai Himstedt](/Kai_Himstedt "Kai Himstedt") (**2012**). *[Optimistische verteilte Spielbaumsuche am Beispiel des Computerschachs](http://www.shaker.de/de/content/catalogue/index.asp?ID=8&ISBN=978-3-8440-0803-6)*. Dissertation (German)
6. [↑](#cite_ref-6) [GridChess' ICGA Tournaments](https://www.game-ai-forum.org/icga-tournaments/program.php?id=520)
7. [↑](#cite_ref-7) [Kai Himstedt](/Kai_Himstedt "Kai Himstedt") (**2012**). *GridChess: Combining Optimistic Pondering with the Young Brothers Wait Concept*. [ICGA Journal, Vol. 35, No. 2](/ICGA_Journal#35_2 "ICGA Journal")
8. [↑](#cite_ref-8) [Amsterdam 2007 - Chess - Round 8 - Game 6 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=173&round=8&id=6)
