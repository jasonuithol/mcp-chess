...
Source: https://www.chessprogramming.org/Pawny

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Pawny**

[![](/images/0/0c/PawnyLogo.jpg)](/File:PawnyLogo.jpg)

Pawny [[1]](#cite_note-Pawny-1)
...
[16x16](/Vector_Attacks#16x12 "Vector Attacks") [array](/Array "Array"), filled with [piece codes](/Pieces#PieceCoding "Pieces"), complemented with [piece lists](/Piece-Lists "Piece-Lists") as array of [linked lists](/Linked_List "Linked List") [[1]](#cite_note-Pawny-1).
**Pawny 1.0**, released in May 2013, is an entirely rewritten engine based on [bitboards](/Bitboards "Bitboards") [[2]](#cite_note-2).
...
1. ↑ [1.0](#cite_ref-Pawny_1-0) [1.1](#cite_ref-Pawny_1-1) [Pawny's Homepage](https://web.archive.org/web/20090908151549/http://pawny.netii.net:80/) ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine), September 08, 2009)
2. [↑](#cite_ref-2) [Pawny's Version History](https://web.archive.org/web/20190719112242/http://pawny.netii.net/version.html) ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine), July 19, 2019)
