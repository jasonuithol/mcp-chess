...
Source: https://www.chessprogramming.org/Ian_H._Witten

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Ian H. Witten**

[![](/images/thumb/0/09/IanHWitten.jpg/240px-IanHWitten.jpg)](https://www.cs.waikato.ac.nz/~ihw/images_scaled/people/ian-closeup.jpg)

Ian H. Witten [[1]](#cite_note-1)
...
His further contributions to research include the theory of [adaptive systems](https://en.wikipedia.org/wiki/Adaptive_system) along with [multi-armed bandit](https://en.wikipedia.org/wiki/Multi-armed_bandit) problem, already introducing [TD(0)](/Temporal_Difference_Learning#TDLamba "Temporal Difference Learning") in 1977 [[2]](#cite_note-2) [[3]](#cite_note-3), [speech synthesis](https://en.wikipedia.org/wiki/Speech_synthesis), [digital signal processing](https://en.wikipedia.org/wiki/Digital_signal_processing), [machine learning](/Learning "Learning"), [data mining](https://en.wikipedia.org/wiki/Data_mining) and [text compression](https://en.wikipedia.org/wiki/Data_compression).
Along with [Craig Nevill-Manning](/Mathematician#CNevillManning "Mathematician"), he is a co-creator of the [Sequitur algorithm](https://en.wikipedia.org/wiki/Sequitur_algorithm) [[4]](#cite_note-4).
...
- Ian H. Witten (**1973**). *Finite-Time Performance of Some Two-Armed Bandit Controllers*. [IEEE Transactions on Systems, Man, and Cybernetics](/IEEE#SMC "IEEE"), Vol. 3, No. 2 [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) [Ian H. Witten - Homepage](https://www.cs.waikato.ac.nz/~ihw/index.html)
2. [↑](#cite_ref-2) [Ian H. Witten from Wikipedia](https://en.wikipedia.org/wiki/Ian_H._Witten)
3. [↑](#cite_ref-3) Ian H. Witten (**1977**). *An Adaptive Optimal Controller for Discrete-Time Markov Environments*. [Information and Control](https://en.wikipedia.org/wiki/Information_and_Computation), Vol. 34, No. 4, [pdf](https://core.ac.uk/download/pdf/82451748.pdf)
4. [↑](#cite_ref-4) [Craig Nevill-Manning](/Mathematician#CNevillManning "Mathematician"), Ian H. Witten (**1997**). *[Identifying Hierarchical Structure in Sequences](http://www.sequitur.info/jair)*. [arXiv:cs/9709102](https://arxiv.org/abs/cs/9709102)
5. [↑](#cite_ref-5) [Ian H. Witten: List of Publications](https://www.cs.waikato.ac.nz/~ihw/publications.html)
6. [↑](#cite_ref-6) [dblp: Ian H. Witten](https://dblp.uni-trier.de/pers/hd/w/Witten:Ian_H=.html)
7. [↑](#cite_ref-7) [Multi-armed bandit from Wikipedia](https://en.wikipedia.org/wiki/Multi-armed_bandit)
8. [↑](#cite_ref-8) [Weka (machine learning) from Wikipedia](https://en.wikipedia.org/wiki/Weka_(machine_learning))
