...
Source: https://www.chessprogramming.org/Warren_D._Smith

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Warren D. Smith**

**Warren Douglas Smith**,  
an American physicist, mathematician, general theoretical scientist, and in 2005 founder of the *Center of Range Voting* [[1]](#cite_note-1).
...
under [Robert E. Tarjan](/Mathematician#RETarjan "Mathematician") and [John H. Conway](/John_H._Conway "John H. Conway") [[2]](#cite_note-2).
...
The suite is arranged in a number of files, each file being thematic by difficulty, tactical, positional and others [[3]](#cite_note-3).
...
[[4]](#cite_note-4)
[[5]](#cite_note-5),
further generalized in 2004 by [Yan Radovilsky](/Yan_Radovilsky "Yan Radovilsky") and [Solomon Eyal Shimony](/Solomon_Eyal_Shimony "Solomon Eyal Shimony") [[6]](#cite_note-6).

# Smith Notation

Warren D. Smith proposed the [Smith notation](/Algebraic_Chess_Notation#Smith "Algebraic Chess Notation") [[7]](#cite_note-7) as used in the [Internet Chess Club](/index.php?title=Internet_Chess_Club&action=edit&redlink=1 "Internet Chess Club (page does not exist)") chess server.
...
- Warren D. Smith (**1992**). *[How To Find Steiner Minimal Trees in Euclidean d-Space](https://link.springer.com/article/10.1007/BF01758756)*. [Algorithmica](https://en.wikipedia.org/wiki/Algorithmica), Vol. 7, Nos. 2-6 [[11]](#cite_note-11) [[12]](#cite_note-12)
...
- [Eric B. Baum](/Eric_B._Baum "Eric B. Baum"), Warren D. Smith (**1999**). *[Propagating Distributions Up Directed Acyclic Graphs](https://www.mitpressjournals.org/doi/abs/10.1162/089976699300016881?journalCode=neco)*. [Neural Computation](https://en.wikipedia.org/wiki/Neural_Computation_%28journal%29), Vol. 11, No. 1 [[13]](#cite_note-13)
...
- Warren D. Smith (**2006**). *[Church's thesis meets the N-body problem](https://www.rangevoting.org/WarrenSmithPages/homepage/church.sue)*. [Applied Mathematics and Computation](https://www.journals.elsevier.com/applied-mathematics-and-computation), Vol. 178, No. 1, [pdf preprint](https://www.rangevoting.org/WarrenSmithPages/homepage/church.pdf) [[14]](#cite_note-14)
- Warren D. Smith (**2007**). *[1. AES seems weak. 2. Linear time secure cryptography](https://www.rangevoting.org/WarrenSmithPages/homepage/wdsAES.abs)*. [pdf](https://www.rangevoting.org/WarrenSmithPages/homepage/wdsAES.pdf) [[15]](#cite_note-15)
...
- [Michael Larabel benches lc0 on various GPUs](https://groups.google.com/d/msg/lczero/I0lTgR-fFFU/NGC3kJDzAwAJ) by Warren D. Smith, [LCZero Forum](/Computer_Chess_Forums "Computer Chess Forums"), January 14, 2019 » [Lc0](/Leela_Chess_Zero#Lc0 "Leela Chess Zero"), [GPU](/GPU "GPU") [[16]](#cite_note-16)
...
- [high dimensional optimization](https://groups.google.com/d/msg/fishcooking/wOfRuzTSi_8/VgjN8MmSBQAJ) by Warren D. Smith, [FishCooking](/Computer_Chess_Forums "Computer Chess Forums"), December 27, 2019 [[17]](#cite_note-17)
...
:   [Re: Tcec season 18](https://groups.google.com/d/msg/fishcooking/Tc7XRkbRrSs/x9tUlRK1AgAJ) by Warren D. Smith, [FishCooking](/Computer_Chess_Forums "Computer Chess Forums"), June 28, 2020 » [Pawn Center](/Pawn_Center "Pawn Center"), [TCEC Season 18 Sufi Game 63 10... c4](/TCEC_Season_18#Sufi63 "TCEC Season 18") [[18]](#cite_note-18)
...
- [Re: Idea: use range (evalMin - evalMax) for position evaluation](https://groups.google.com/g/lczero/c/TLCMkkdm1hw/m/F9JjnN8FBQAJ) by Warren D. Smith, [LCZero Forum](/Computer_Chess_Forums "Computer Chess Forums"), May 29, 2021 [[19]](#cite_note-19)
...
1. [↑](#cite_ref-1) [Center for Range Voting - front page](https://rangevoting.org/)
2. [↑](#cite_ref-2) [The Mathematics Genealogy Project - Warren Smith](https://genealogy.math.ndsu.nodak.edu/id.php?id=87407)
3. [↑](#cite_ref-3) [Kevin J. Lang](/index.php?title=Kevin_J._Lang&action=edit&redlink=1 "Kevin J. Lang (page does not exist)"), Warren D. Smith (**1993**). *A Test Suite for Chess Programs*. [ps](https://scorevoting.net/WarrenSmithPages/homepage/testpos.ps), [ChessTest2.tar.Z](https://www.rangevoting.org/WarrenSmithPages/homepage/ChessTest2.tar.Z)
4. [↑](#cite_ref-4) [Eric B. Baum](/Eric_B._Baum "Eric B. Baum"), Warren D. Smith (**1995**). *Best Play for Imperfect Players and Game Tree Search*. Part 1 - Theory, with pseudocode appendix by [Charles Garrett](/index.php?title=Charles_Garrett&action=edit&redlink=1 "Charles Garrett (page does not exist)"), [pdf](https://pdfs.semanticscholar.org/5838/432c92c8905c7066962400c55ddc8803f11a.pdf)
5. [↑](#cite_ref-5) [Re: Interesting ideas](http://www.talkchess.com/forum/viewtopic.php?t=57560&start=14) by [Karlo Bala Jr.](/Karlo_Balla "Karlo Balla"), [CCC](/CCC "CCC"), September 09, 2015
6. [↑](#cite_ref-6) [Yan Radovilsky](/Yan_Radovilsky "Yan Radovilsky"), [Solomon Eyal Shimony](/Solomon_Eyal_Shimony "Solomon Eyal Shimony") (**2004**). *[Generalized Model for Rational Game Tree Search](https://www.semanticscholar.org/paper/Generalized-model-for-rational-game-tree-search-Radovilsky-Shimony/47a32301e705acdc46856d4b29bfc4f50d5ce000)*. [pdf](https://www.cs.bgu.ac.il/%7Eyanr/Publications/smc04.pdf)
7. [↑](#cite_ref-7) [Smith notation](https://web.archive.org/web/20160117212352/https://www.chessclub.com/chessviewer/smith.html) ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine))
8. [↑](#cite_ref-8) [dblp: Warren D. Smith](https://dblp.uni-trier.de/pers/hd/s/Smith:Warren_D=)
9. [↑](#cite_ref-9) [Online list of Warren D. Smith's works](https://www.rangevoting.org/WarrenSmithPages/homepage/works.html)
10. [↑](#cite_ref-10) [Mesh generation from Wikipedia](https://en.wikipedia.org/wiki/Mesh_generation)
11. [↑](#cite_ref-11) [Steiner tree problem from Wikipedia](https://en.wikipedia.org/wiki/Steiner_tree_problem)
12. [↑](#cite_ref-12) [Euclidean space from Wikipedia](https://en.wikipedia.org/wiki/Euclidean_space)
13. [↑](#cite_ref-13) [Re: Idea: use range (evalMin - evalMax) for position evaluation](https://groups.google.com/g/lczero/c/TLCMkkdm1hw/m/SgbGghzhBAAJ) by [Álvaro Begué](/%C3%81lvaro_Begu%C3%A9 "Álvaro Begué"), [LCZero Forum](/Computer_Chess_Forums "Computer Chess Forums"), May 28, 2021
14. [↑](#cite_ref-14) [Church–Turing thesis from Wikipedia](https://en.wikipedia.org/wiki/Church%E2%80%93Turing_thesis)
15. [↑](#cite_ref-15) [Advanced Encryption Standard from Wikipedia](https://en.wikipedia.org/wiki/Advanced_Encryption_Standard)
16. [↑](#cite_ref-16) [Phoronix Test Suite from Wikipedia](https://en.wikipedia.org/wiki/Phoronix_Test_Suite)
17. [↑](#cite_ref-17) [Yann Dauphin](/Mathematician#YDauphin "Mathematician"), [Razvan Pascanu](/Mathematician#RPascanu "Mathematician"), [Caglar Gulcehre](/Mathematician#CGulcehre "Mathematician"), [Kyunghyun Cho](/Mathematician#KCho "Mathematician"), [Surya Ganguli](/Mathematician#SGanguli "Mathematician"), [Yoshua Bengio](/Mathematician#YBengio "Mathematician") (**2014**). *Identifying and attacking the saddle point problem in high-dimensional non-convex optimization*. [arXiv:1406.2572](https://arxiv.org/abs/1406.2572)
18. [↑](#cite_ref-18) [Andrew Soltis](https://en.wikipedia.org/wiki/Andrew_Soltis) (**1976, 1995, 2013**). *Pawn Structure Chess*. Tartan Books, 1995 McKay, 2013 Batsford Chess
19. [↑](#cite_ref-19) [Eric B. Baum](/Eric_B._Baum "Eric B. Baum"), Warren D. Smith (**1999**). *[Propagating Distributions Up Directed Acyclic Graphs](https://www.mitpressjournals.org/doi/abs/10.1162/089976699300016881?journalCode=neco)*. [Neural Computation](https://en.wikipedia.org/wiki/Neural_Computation_%28journal%29), Vol. 11, No. 1
