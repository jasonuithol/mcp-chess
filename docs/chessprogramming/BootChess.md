...
Source: https://www.chessprogramming.org/BootChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* BootChess**
...
Its size of 487 (468) [[1]](#cite_note-1) bytes fits into a 512 byte [boot sector](https://en.wikipedia.org/wiki/Boot_sector) for [Windows](/Windows "Windows"), [Linux](/Linux "Linux"), [OS X](/Mac_OS "Mac OS"), [DOS](/MS-DOS "MS-DOS") and [BSD](/Unix "Unix") [[2]](#cite_note-2). [Castling](/Castling "Castling"), [minor promotions](/Promotions#MinorPromotion "Promotions") and [en passant](/En_passant "En passant") are not implemented.
...
who took the BootChess challenge with 481 bytes and a 3-ply search [[3]](#cite_note-3).
...
:   [Smallest engine in the world...](http://www.talkchess.com/forum/viewtopic.php?t=55149) by [Marco Costalba](/Marco_Costalba "Marco Costalba"), [CCC](/CCC "CCC"), January 29, 2015
...
1. [↑](#cite_ref-1) 468 bytes without rank/file indicators of the board display
2. [↑](#cite_ref-2) [BootChess by Red Sector Inc. :: pouët.net](http://www.pouet.net/prod.php?which=64962)
3. [↑](#cite_ref-3) [Re: BootChess (minimal chess engine)](http://www.talkchess.com/forum/viewtopic.php?t=55125&start=9) by [Óscar Toledo Gutiérrez](/%C3%93scar_Toledo_Guti%C3%A9rrez "Óscar Toledo Gutiérrez"), [CCC](/CCC "CCC"), January 31, 2015
