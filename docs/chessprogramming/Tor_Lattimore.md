...
Source: https://www.chessprogramming.org/Tor_Lattimore

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Tor Lattimore**

[![](/images/8/89/TorLattimore.jpg)](http://tor-lattimore.com/)

Tor Lattimore [[1]](#cite_note-1)
...
As a chess player, and former computer chess programmer, Tor Lattimore is author of the [Chess Engine Communication Protocol](/Chess_Engine_Communication_Protocol "Chess Engine Communication Protocol") compatible chess engine [SEE](/SEE "SEE") [[2]](#cite_note-2), which participated at various [Australasian National Computer Chess Championship](/Australasian_National_Computer_Chess_Championship "Australasian National Computer Chess Championship") and [CCT Tournaments](/CCT_Tournaments "CCT Tournaments").
...
1. [↑](#cite_ref-1) [Tor Lattimore - Homepage](http://tor-lattimore.com/)
2. [↑](#cite_ref-2) [SEE - the chess engine](http://home.netspeed.com.au/lattimore/)
3. [↑](#cite_ref-3) [Tor Lattimore Publications](http://tor-lattimore.com/publications/)
4. [↑](#cite_ref-4) [dblp: Tor Lattimore](https://dblp.uni-trier.de/pers/hd/l/Lattimore:Tor.html)
5. [↑](#cite_ref-5) [No free lunch in search and optimization - Wikipedia](https://en.wikipedia.org/wiki/No_free_lunch_in_search_and_optimization)
6. [↑](#cite_ref-6) [Occam's razor from Wikipedia](https://en.wikipedia.org/wiki/Occam%27s_razor)
7. [↑](#cite_ref-7) [Markov decision process from Wikipedia](https://en.wikipedia.org/wiki/Markov_decision_process)
