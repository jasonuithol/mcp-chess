...
Source: https://www.chessprogramming.org/LTChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* LTChess**
...
LTChess may be compiled using either [Turbo Pascal](/Pascal#TurboPascal "Pascal"), [Free Pascal](https://en.wikipedia.org/wiki/Free_Pascal) or [Virtual Pascal](https://en.wikipedia.org/wiki/Virtual_Pascal) compilers [[1]](#cite_note-1).
...
LTChess 2, released in December 2016, changed to [NegaMax](/Negamax "Negamax"), added [piece-lists](/Piece-Lists "Piece-Lists") to 0x88, now using [copy/make](/Copy-Make "Copy-Make") instead of [make](/Make_Move "Make Move")/[unmake](/Unmake_Move "Unmake Move") [[2]](#cite_note-2) .
...
1. [↑](#cite_ref-1) [LTChess - Home](https://ltchess.weebly.com/)
2. [↑](#cite_ref-2) [LTchess 2](http://www.talkchess.com/forum/viewtopic.php?t=62365) by [Laurie Tunnicliffe](/Laurie_Tunnicliffe "Laurie Tunnicliffe"), [CCC](/CCC "CCC"), December 03, 2016
