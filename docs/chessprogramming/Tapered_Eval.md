...
**[Home](/Main_Page "Main Page") \* [Evaluation](/Evaluation "Evaluation") \* Tapered Eval**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Ad_Parnassum_%28originaler%2C_gefasster_Holzrahmen%29%2C_Paul_Klee_%281932%29.jpg/330px-Ad_Parnassum_%28originaler%2C_gefasster_Holzrahmen%29%2C_Paul_Klee_%281932%29.jpg)](/File:Ad_Parnassum_(originaler,_gefasster_Holzrahmen),_Paul_Klee_(1932).jpg)

[Paul Klee](/Category:Paul_Klee "Category:Paul Klee") - Ad Parnassum, 1932 [[1]](#cite_note-1) [[2]](#cite_note-2)
...
Though Tapered Eval has been used for many years (for example [The King](/The_King "The King"), as [described](/The_King#Description "The King") in 1991 [[3]](#cite_note-3) and [Phalanx](/Phalanx "Phalanx")), and was already mentioned by [Hans Berliner](/Hans_Berliner "Hans Berliner") in 1979 [[4]](#cite_note-4), the technique gained massive popularity only during the past few years, with the release of [Fruit](/Fruit "Fruit") and the growing awareness among programmers of the sensitivity of the evaluation function to discontinuity. [[5]](#cite_note-5). [Zurichess](/Zurichess "Zurichess") by [Alexandru Moșoi](/Alexandru_Mosoi "Alexandru Mosoi") uses the [TensorFlow](https://en.wikipedia.org/wiki/TensorFlow) library for [automated tuning](/Automated_Tuning "Automated Tuning") - in a two layers [neural network](/Neural_Networks "Neural Networks"), the second layer is for phasing endgame and middlegame scores [[6]](#cite_note-6).
...
1. [↑](#cite_ref-1) [Paul Klee](/Category:Paul_Klee "Category:Paul Klee") - [Ad Parnassum](https://en.wikipedia.org/wiki/File:Polyphony2.JPG), 1932, oil colors, stamped lines, dots stamped in white color and later repainted, on casein paint on canvas on stretcher frame, [Museum of Fine Arts Berne](https://en.wikipedia.org/wiki/Museum_of_Fine_Arts_Berne), [Paul Klee from Wikipedia](https://en.wikipedia.org/wiki/Paul_Klee)
2. [↑](#cite_ref-2) [Gradus ad Parnassum - Wikipedia](https://en.wikipedia.org/wiki/Gradus_ad_Parnassum)
3. [↑](#cite_ref-3) [Don Beal](/Don_Beal "Don Beal") (**1991**). *Report on the [11th World Microcomputer Chess Championship](/WMCCC_1991 "WMCCC 1991")*. [ICCA Journal, Vol. 14, No. 2](/ICGA_Journal#14_2 "ICGA Journal")
4. [↑](#cite_ref-4) [Hans Berliner](/Hans_Berliner "Hans Berliner") (**1979**). *[On the Construction of Evaluation Functions for Large Domains](http://www.bkgm.com/articles/Berliner/EvaluationFunctionsLargeDomains/)*. [III. Smoothness](http://www.bkgm.com/articles/Berliner/EvaluationFunctionsLargeDomains/#sec-3), [IJCAI 1979](/Conferences#IJCAI1979 "Conferences"), Tokyo, Vol. 1
5. [↑](#cite_ref-5) [Re: Secrets of Rybka and Fruit from my point of view](https://www.stmintz.com/ccc/index.php?id=470681) by [Stuart Cracraft](/Stuart_Cracraft "Stuart Cracraft"), [CCC](/CCC "CCC"), December 15, 2005
6. [↑](#cite_ref-6) [Re: Deep Learning Chess Engine ?](http://www.talkchess.com/forum/viewtopic.php?t=60883&start=1) by [Alexandru Mosoi](/Alexandru_Mosoi "Alexandru Mosoi"), [CCC](/CCC "CCC"), July 21, 2016
