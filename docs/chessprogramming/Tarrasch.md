...
Source: https://www.chessprogramming.org/Tarrasch

**[Home](/Main_Page "Main Page") \* [User Interface](/User_Interface "User Interface") \* [GUI](/GUI "GUI") \* Tarrasch**  
**[Home](/Main_Page "Main Page") \* [Software](/Software "Software") \* [Databases](/Databases "Databases") \* Tarrasch**

**Tarrasch**,  
a free, [UCI](/UCI "UCI") compliant, [cross platform](https://en.wikipedia.org/wiki/Cross-platform) [open source](https://en.wikipedia.org/wiki/Open-source_software) chess GUI [[1]](#cite_note-1), written by [Bill Forster](/index.php?title=Bill_Forster&action=edit&redlink=1 "Bill Forster (page does not exist)") in [C++](/Cpp "Cpp") using [wxWidgets](https://en.wikipedia.org/wiki/WxWidgets), released under the [MIT license](/Massachusetts_Institute_of_Technology#License "Massachusetts Institute of Technology"), first published in 2011 [[2]](#cite_note-2).
...
[![Tarrasch gui.png](/images/b/b9/Tarrasch_gui.png)](https://triplehappy.com/Home.html)

Tarrasch GUI [[3]](#cite_note-3)
...
1. [↑](#cite_ref-1) [GitHub - billforsternz/tarrasch-chess-gui: A portable, simple, desktop workbench for chess players and analysts](https://github.com/billforsternz/tarrasch-chess-gui)
2. [↑](#cite_ref-2) [The Tarrasch Chess GUI - News](https://triplehappy.com/News.html)
3. [↑](#cite_ref-3) [The Tarrasch Chess GUI](https://triplehappy.com/Home.html)
