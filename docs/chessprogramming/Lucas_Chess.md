...
Source: https://www.chessprogramming.org/Lucas_Chess

**[Home](/Main_Page "Main Page") \* [User Interface](/User_Interface "User Interface") \* [GUI](/GUI "GUI") \* Lucas Chess**

**Lucas Chess**, (LucasChess)   
a free, [UCI](/UCI "UCI") compliant cross platform chess GUI by [Lucas Monge](/index.php?title=Lucas_Monge&action=edit&redlink=1 "Lucas Monge (page does not exist)") and contributors [[1]](#cite_note-1),
...
and further uses [python-chess](/Python-chess "Python-chess") by [Niklas Fiekas](/Niklas_Fiekas "Niklas Fiekas") [[2]](#cite_note-2).

# Screenshot

[![LucasChess.png](/images/1/13/LucasChess.png)](http://omgchess.blogspot.com/2015/08/a-great-hidden-feature-in-lucas-chess.html)

Lucas Chess - Move Tree [[3]](#cite_note-3)
...
and various [e-boards](/Sensory_Board "Sensory Board") [[4]](#cite_note-4).
...
1. [↑](#cite_ref-1) [Lucas Chess - Thanks](https://lucaschess.pythonanywhere.com/thanks)
2. [↑](#cite_ref-2) [GitHub - lukasmonk/lucaschessR: Chess GUI](https://github.com/lukasmonk/lucaschessR#readme)
3. [↑](#cite_ref-3) Screenshot from [OMGChess: A Great Hidden Feature in Lucas Chess](http://omgchess.blogspot.com/2015/08/a-great-hidden-feature-in-lucas-chess.html)
4. [↑](#cite_ref-4) [New DGT driver and updated eBoard drivers (Windows/Linux)](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=77783) by [Graham O'Neill](/index.php?title=Graham_O%27Neill&action=edit&redlink=1 "Graham O'Neill (page does not exist)"), [CCC](/CCC "CCC"), July 23, 2021
