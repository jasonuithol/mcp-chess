...
Source: https://www.chessprogramming.org/Turbo_Chess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Turbo Chess**

[![](/images/7/75/GameWorks.jpg)](http://openlibrary.org/b/OL2753290M/Turbo_GameWorks)

Turbo Gameworks [[1]](#cite_note-1)

**Turbo Chess**,  
an didactic chess program by [Kaare Danielsen](/Kaare_Danielsen "Kaare Danielsen") [[2]](#cite_note-2),
written in [Turbo Pascal](/Pascal#TurboPascal "Pascal") and published as source code in 1985 on disk along with the [book](#book) *Turbo GameWorks* by [Borland International](https://en.wikipedia.org/wiki/Borland). Borland later translated the program into [C++](/Cpp "Cpp") and used it as an example program for the for the Borland C++ compiler [[3]](#cite_note-3).
...
- [Pre-processed](/Oracle#Pre-processing "Oracle") [Piece-Square Tables](/Piece-Square_Tables "Piece-Square Tables") considering [[5]](#cite_note-5)
...
- [Turbo Chess](/Turbo_Chess_(GB) "Turbo Chess (GB)") by [Chris A. Thornton](/Chris_A._Thornton "Chris A. Thornton") [[6]](#cite_note-6)
...
1. [↑](#cite_ref-1) [Kaare Danielsen](/Kaare_Danielsen "Kaare Danielsen") (**1985**). *[Turbo GameWorks](http://openlibrary.org/b/OL2753290M/Turbo_GameWorks)*. [Borland International](https://en.wikipedia.org/wiki/Borland)
2. [↑](#cite_ref-2) [Resume for Kaare Danielsen](http://www.danielsen.com/resume.shtml)
3. [↑](#cite_ref-3) [Re: origin of Chess from old Turbo Pascal Turbo GameWorks](https://groups.google.com/d/msg/borland.public.delphi.non-technical/vhpzc1kmNF4/FJ9mxPVsAwAJ) by [Kaare Danielsen](/Kaare_Danielsen "Kaare Danielsen"), [borland.public.delphi.non-technical](https://groups.google.com/forum/#!forum/borland.public.delphi.non-technical), February 29, 2016
4. [↑](#cite_ref-4) Features are based on the description in the [book](#book)
5. [↑](#cite_ref-5) The tables are calculated at the beginning of the search using the evaluation function described earlier, [book](#book) pp. 69
6. [↑](#cite_ref-6) [Turbo Chess - World of Spectrum](http://www.worldofspectrum.org/infoseekid.cgi?id=0005457)
