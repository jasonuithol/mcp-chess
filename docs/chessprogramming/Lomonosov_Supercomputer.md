...
Source: https://www.chessprogramming.org/Lomonosov_Supercomputer

**[Home](/Main_Page "Main Page") \* [Hardware](/Hardware "Hardware") \* Lomonosov Supercomputer**

[![](/images/thumb/4/49/MSU_T-Platforms.jpg/300px-MSU_T-Platforms.jpg)](http://www.nvidia.in/object/nvidia-russia-supercomputer-press-20110615-in.html)

Lomonosov Supercomputer [[1]](#cite_note-1)
...
As of 2012, the Lomonosov Supercomputer has 52,168 [x86-64](/X86-64 "X86-64") and 954,840 [GPU](/GPU "GPU") cores [[2]](#cite_note-2) with 92 [TiB](https://en.wikipedia.org/wiki/Tebibyte) of triple-channel [DDR3 SD](https://en.wikipedia.org/wiki/DDR3_SDRAM) [memory](/Memory "Memory") modules, resulting in a peak performance of 1.7 [PFlops](https://en.wikipedia.org/wiki/FLOPS), and a [Linpack performance](https://en.wikipedia.org/wiki/LINPACK_benchmarks) of 901.9 TFlops. [Operating system](https://en.wikipedia.org/wiki/Operating_system) is the [Linux](/Linux "Linux") based *ClustrX* [[3]](#cite_note-3) . The Lomonosov supercomputer includes a three-tier storage with high-speed [disks](https://en.wikipedia.org/wiki/Disk_storage) of 500 TB running under the [Lustre](https://en.wikipedia.org/wiki/Lustre_%28file_system%29) [parallel file system](https://en.wikipedia.org/wiki/Clustered_file_system#Distributed_file_systems), a high-speed, highly-reliable 300TB disk storage, and a 1PB [robotic tape storage](https://en.wikipedia.org/wiki/Computer_data_storage#Robotic_storage).

# Lomonosov Tablebases

One scientific as well as commercial research application using the Lomonosov Supercomputer was the generation of the [7-men](/Endgame_Tablebases#7-men "Endgame Tablebases") [Lomonosov Tablebases](/Lomonosov_Tablebases "Lomonosov Tablebases") [[4]](#cite_note-4) headed by [Victor Zakharov](/Victor_Zakharov "Victor Zakharov") and [Vladimir Makhnychev](/Vladimir_Makhnychev "Vladimir Makhnychev") [[5]](#cite_note-5) . As of December 31, 2013, the tablebases are commercially available online through [ChessOK](/ChessOK "ChessOK") [products](/ChessOK#Products "ChessOK") [[6]](#cite_note-6) .
...
- [President of Russia: Meeting with Lomonosov Moscow State University Rector Viktor Sadovnichy](http://eng.kremlin.ru/news/4279), August 9, 2012 [[7]](#cite_note-7) [[8]](#cite_note-8)
...
1. [↑](#cite_ref-1) [Russia Accelerates Scientific Innovation with GPU Supercomputers|NVIDIA](http://www.nvidia.in/object/nvidia-russia-supercomputer-press-20110615-in.html)
2. [↑](#cite_ref-2) [T-Platforms](https://en.wikipedia.org/wiki/T-Platforms) (**2012**). *Lomonosov Supercomputer*.
3. [↑](#cite_ref-3) Clustrx HPC software by [T-Platforms](https://en.wikipedia.org/wiki/T-Platforms)
4. [↑](#cite_ref-4) [Endgame tablebase from Wikipedia - Background](https://en.wikipedia.org/wiki/Endgame_tablebase#Background)
5. [↑](#cite_ref-5) [7-man TB](https://plus.google.com/100454521496393505718/posts) - [Google+](https://en.wikipedia.org/wiki/Google%2B)
6. [↑](#cite_ref-6) [Lomonosov Endgame Tablebases](http://chessok.com/?page_id=27966) - [ChessOK](/ChessOK "ChessOK")
7. [↑](#cite_ref-7) [Vladimir Putin from Wikipedia](https://en.wikipedia.org/wiki/Vladimir_Putin)
8. [↑](#cite_ref-8) [Viktor Sadovnichiy from Wikipedia](https://en.wikipedia.org/wiki/Viktor_Sadovnichiy)
