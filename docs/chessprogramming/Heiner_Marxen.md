...
Source: https://www.chessprogramming.org/Heiner_Marxen

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Heiner Marxen**

[![](/images/thumb/9/92/HeinerMarxen.jpg/240px-HeinerMarxen.jpg)](http://www.quarkchess.de/belct/body_index.html)

Heiner Marxen at [BELCT 2001](/BELCT_2001 "BELCT 2001") [[1]](#cite_note-1)

**Heiner Marxen**,  
a German computer scientist and software engineer, M.Sc. in computer science from [Technical University of Berlin](https://en.wikipedia.org/wiki/Technical_University_of_Berlin) in 1986, and author of [Chest](/Chest "Chest"), a Program for Solving Orthodox [Chess Problems](/Chess_Problems,_Compositions_and_Studies "Chess Problems, Compositions and Studies") [[2]](#cite_note-2).
Heiner is a well known [Busy Beaver](https://en.wikipedia.org/wiki/Busy_beaver) expert [[3]](#cite_note-3).
Additionally he introduced a method to compute [Rook Paths Puzzles](https://en.wikipedia.org/wiki/Rook%27s_graph) [[4]](#cite_note-4) [[5]](#cite_note-5).
In 1973, he has written the first precursor of Chest in [Fortran-II](/Fortran "Fortran") (no [recursion](/Recursion "Recursion")) to solve [mate-in-two problems](https://en.wikipedia.org/wiki/Chess_problem#Types_of_problem) [[6]](#cite_note-6).
It did not need or use any tapes and ran on an [IBM-1130](https://en.wikipedia.org/wiki/IBM_1130) with 32 K bytes, and took half an hour for one job [[7]](#cite_note-7).
...
- Roland Mueller, H.D. Doll, I.J. Donasch, Heiner Marxen, [Holger Pause](/index.php?title=Holger_Pause&action=edit&redlink=1 "Holger Pause (page does not exist)") (**1991**). *[A new man-machine-interface at BESSY](https://ieeexplore.ieee.org/document/164617)*. [IEEE](/IEEE "IEEE") Conference on Particle Accelerator [[9]](#cite_note-9)
...
1. [↑](#cite_ref-1) [BELCT 2001 Berlin is worth a trip !](http://www.quarkchess.de/belct/) photos by [Thomas Mayer](/Thomas_Mayer "Thomas Mayer")
2. [↑](#cite_ref-2) [Chest: A Program for Solving Orthodox Chess Problems](http://turbotm.de/~heiner/Chess/chest.html)
3. [↑](#cite_ref-3) [Heiner Marxen - Busy Beaver](http://turbotm.de/~heiner/BB/index.html)
4. [↑](#cite_ref-4) [Rook Paths Puzzles](http://www.iwriteiam.nl/Crook_path.html)
5. [↑](#cite_ref-5) [Heiner Marxen's Method to compute the Rook Paths Puzzle](http://turbotm.de/~heiner/Rookpath/method.html)
6. [↑](#cite_ref-6) [CHEST: A Program for Solving Orthodox Chess Problems](http://turbotm.de/~heiner/Chess/chest.html)
7. [↑](#cite_ref-7) [Re: Perft(3) from 1978, with a twist!](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=41373&start=5) by Heiner Marxen, [CCC](/CCC "CCC"), December 09, 2011
8. [↑](#cite_ref-8) [dblp: Heiner Marxen](https://dblp.org/pid/02/4081.html)
9. [↑](#cite_ref-9) [BESSY from Wikipedia](https://en.wikipedia.org/wiki/BESSY)
