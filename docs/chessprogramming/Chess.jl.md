...
Source: https://www.chessprogramming.org/Chess.jl

**[Home](/Main_Page "Main Page") \* [Software](/Software "Software") \* [Utilities](/Utilities "Utilities") \* Chess.jl**

**Chess.jl**,  
a chess programming library by [Tord Romstad](/Tord_Romstad "Tord Romstad"), written in the [Julia](/index.php?title=Julia&action=edit&redlink=1 "Julia (page does not exist)") programming language [[1]](#cite_note-1).
...
on the [board](/Chessboard "Chessboard") (aka [Bitboards](/Bitboards "Bitboards") [[2]](#cite_note-2)).
...
create [opening books](/Opening_Book "Opening Book"), and interact with [UCI chess engines](/Category:UCI "Category:UCI") [[3]](#cite_note-3),
...
The SquareSet aka Bitboard API [[4]](#cite_note-4)
...
Using a chess board object through a [Pluto](https://en.wikipedia.org/wiki/Julia_(programming_language)#Interaction) [[5]](#cite_note-5) or [Jupyter notebook](https://en.wikipedia.org/wiki/Project_Jupyter#Jupyter_Notebook),
...
1. [↑](#cite_ref-1) [Julia (programming language) from Wikipedia](https://en.wikipedia.org/wiki/Julia_(programming_language))
2. [↑](#cite_ref-2) [Re: Is cloning a hobby?](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=75040&start=74) by [Tord Romstad](/Tord_Romstad "Tord Romstad"), [CCC](/CCC "CCC"), September 21, 2020
3. [↑](#cite_ref-3) [Home · Chess.jl](https://romstad.github.io/Chess.jl/dev/#Introduction-1)
4. [↑](#cite_ref-4) [API Reference · Chess.jl](https://romstad.github.io/Chess.jl/dev/api/#Square-Sets-1)
5. [↑](#cite_ref-5) [GitHub - fonsp/Pluto.jl: 🎈 Simple reactive notebooks for Julia](https://github.com/fonsp/Pluto.jl)
