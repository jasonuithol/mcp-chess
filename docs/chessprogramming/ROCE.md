...
Source: https://www.chessprogramming.org/ROCE

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* ROCE**
...
which is also applied to the [evaluation](/Evaluation "Evaluation") [score](/Score "Score"). It initially [generated legal moves](/Move_Generation#Legal "Move Generation") only, and switched to [pseudo legal](/Move_Generation#PseudoLegal "Move Generation") later [[2]](#cite_note-2).
...
and a [quiescence search](/Quiescence_Search "Quiescence Search") considering [MVV/LVA](/MVV-LVA "MVV-LVA") to [order moves](/Move_Ordering "Move Ordering") [[3]](#cite_note-3).
...
1. [↑](#cite_ref-1) [A few informations regarding perft/divide](http://www.rocechess.ch/perft.html)
2. [↑](#cite_ref-2) [Re: Legal or Pseudo-Legal Move generation](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=35586&start=5) by [Roman Hartmann](/Roman_Hartmann "Roman Hartmann"), [CCC](/CCC "CCC"), July 27, 2010
3. [↑](#cite_ref-3) Description based on [ROCE - Roman's Own Chess Engine - A few technical details](http://www.rocechess.ch/rocee.html)
