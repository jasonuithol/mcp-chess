...
Source: https://www.chessprogramming.org/KnightCap

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* KnightCap**

[![](/images/a/aa/Thingone.gif)](http://www.samba.org/KnightCap/)

KnightCap's [3D Board](/3D_Graphics_Board "3D Graphics Board") [[1]](#cite_note-1)

**KnightCap**,  
a [XBoard](/XBoard "XBoard") compliant [open source chess engine](/Category:Open_Source "Category:Open Source") under the [GNU General Public License](/Free_Software_Foundation#GPL "Free Software Foundation") by [Andrew Tridgell](/Andrew_Tridgell "Andrew Tridgell") [[2]](#cite_note-2), [Jonathan Baxter](/Jonathan_Baxter "Jonathan Baxter") and [Lex Weaver](/Lex_Weaver "Lex Weaver").
To [tune](/Automated_Tuning "Automated Tuning") it's [evaluation](/Evaluation "Evaluation") in game play, it uses [temporal difference learning](/Temporal_Difference_Learning "Temporal Difference Learning") applied to [minimax](/Minimax "Minimax") search in chess, [TDLeaf](/Temporal_Difference_Learning#TDLeaf "Temporal Difference Learning") [[3]](#cite_note-3) [[4]](#cite_note-4). KnightCap features an own [GUI](/GUI "GUI") with an optional [3D Graphics Board](/3D_Graphics_Board "3D Graphics Board") [[5]](#cite_note-5), and played multiple [Australasian National Computer Chess Championships](/Australasian_National_Computer_Chess_Championship "Australasian National Computer Chess Championship"), and won two times, last one the [NC3 2006](/NC3_2006 "NC3 2006").
...
- [Index of /pub/KnightCap](https://ftp.samba.org/pub/KnightCap/) [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) [Welcome to the KnightCap home page](http://samba.anu.edu.au/KnightCap/)
2. [↑](#cite_ref-2) [Andrew Tridgell](/Andrew_Tridgell "Andrew Tridgell") (**1997**). *KnightCap — a parallel chess program on the AP1000+*.
3. [↑](#cite_ref-3) [Jonathan Baxter](/Jonathan_Baxter "Jonathan Baxter"), [Andrew Tridgell](/Andrew_Tridgell "Andrew Tridgell"), [Lex Weaver](/Lex_Weaver "Lex Weaver") (**1997**) *Knightcap: A chess program that learns by combining td(λ) with minimax search*. 15th International Conference on Machine Learning
4. [↑](#cite_ref-4) [Re: Bit Board Bonkers?? - other alternatives](https://groups.google.com/group/rec.games.chess.computer/msg/4d6c328e8e8e0cd4) by [Andrew Tridgell](/Andrew_Tridgell "Andrew Tridgell"), [rgcc](/Computer_Chess_Forums "Computer Chess Forums"), August 9, 1997
5. [↑](#cite_ref-5) [Re: Going commercial, maybe](https://groups.google.com/group/rec.games.chess.computer/msg/ded7e4e4304d8d4e) by [Andrew Tridgell](/Andrew_Tridgell "Andrew Tridgell"), [rgcc](/Computer_Chess_Forums "Computer Chess Forums"), March 9, 1997
6. [↑](#cite_ref-6) [Jonathan Baxter](/Jonathan_Baxter "Jonathan Baxter"), [Andrew Tridgell](/Andrew_Tridgell "Andrew Tridgell"), [Lex Weaver](/Lex_Weaver "Lex Weaver") (**1997**) *Knightcap: A chess program that learns by combining td(λ) with minimax search*. 15th International Conference on Machine Learning
7. [↑](#cite_ref-7) [Re: KnightCap source code](http://www.talkchess.com/forum/viewtopic.php?t=59304&start=1) by [Jim Ablett](/Jim_Ablett "Jim Ablett"), [CCC](/CCC "CCC"), February 19, 2016
