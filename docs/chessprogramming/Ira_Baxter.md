...
Source: https://www.chessprogramming.org/Ira_Baxter

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Ira Baxter**

[![](/images/5/56/IraBaxter.JPG)](https://www.youtube.com/watch?v=C-_dw9iEzhA)

Ira Baxter [[1]](#cite_note-1)
...
[[2]](#cite_note-2)
[[3]](#cite_note-3)
of *Semantic Designs* [[4]](#cite_note-4).
He is the principal architect of Semantic Designs' *Design Maintenance System* (DMS) [[5]](#cite_note-5),
principal designer and compiler implementer of *PARLANSE* [[6]](#cite_note-6),
a parallel [programming language](/Languages "Languages") [[7]](#cite_note-7),
and architect and principal engineer on *CloneDR* [[8]](#cite_note-8), an [AST](https://en.wikipedia.org/wiki/Abstract_syntax_tree)-based [Clone Detection](https://en.wikipedia.org/wiki/Duplicate_code) technology.
...
and the chess program [SD Chess](/SD_Chess "SD Chess") written in compiled [Basic](/Basic "Basic") to run on a [6800](/6800 "6800") based microcomputer [[9]](#cite_note-9), A program called **Chess D** by Ira Baxter was on the Stand-By list of the [WCCC 1983](/WCCC_1983 "WCCC 1983") in [New York](https://en.wikipedia.org/wiki/New_York_City) [[10]](#cite_note-10).
...
- Chris Morgan (**1978**). *[The Second West Coast Computer Faire](http://blog.modernmechanix.com/the-second-west-coast-computer-faire/1/#mmGal)*. [BYTE, Vol. 3, No. 7](/Byte_Magazine#BYTE301 "Byte Magazine") [[12]](#cite_note-12) » [MCCT 1978](/MCCT_1978 "MCCT 1978"), [Sargon](/Sargon "Sargon")
...
1. [↑](#cite_ref-1) Image from [DMS: Software Tool Infrastructure](#DMS)
2. [↑](#cite_ref-2) [Semantic Designs People: Ira D. Baxter, Ph.D.](http://www.semdesigns.com/Company/People/idbaxter/)
3. [↑](#cite_ref-3) [Martin Wirsing](https://www.sosy-lab.org/people/wirsing/), [Rémi Ronchaud](http://emergences.inria.fr/2011/newsletter_n17/L17_ICTLABS) (eds.) (**2004**). *Report on the EU/NSF Strategic Workshop on Engineering Software-Intensive Systems*. May 22-23, 2004, [Edinburgh](https://en.wikipedia.org/wiki/Edinburgh), [GB](https://en.wikipedia.org/wiki/Kingdom_of_Great_Britain), [pdf](https://www.ercim.eu/EU-NSF/sis.pdf)
4. [↑](#cite_ref-4) [Program Transformation Wiki / Ira Baxter](http://www.program-transformation.org/Transform/IraBaxter)
5. [↑](#cite_ref-5) [Program Transformation Wiki / DMSSoftware Reengineering Toolkit](http://www.program-transformation.org/Transform/DMSSoftwareReengineeringToolkit)
6. [↑](#cite_ref-6) [Semantic Designs: PARLANSE Parallel Programming Language for Windows Pentium/80x86](http://www.semdesigns.com/Products/Parlanse/index.html)
7. [↑](#cite_ref-7) [multithreading - Threads in x86 assembler (using the GNU assember: as)](https://stackoverflow.com/questions/714905/is-it-possible-to-create-threads-without-system-calls-in-linux-x86-gas-assembly) - [Stack Overflow](https://en.wikipedia.org/wiki/Stack_Overflow)
8. [↑](#cite_ref-8) [Semantic Designs, Inc: Clone Doctor](http://www.semdesigns.com/Products/Clone/)
9. [↑](#cite_ref-9) [Douglas Penrod](/Douglas_Penrod "Douglas Penrod") (ed.) (**1977**). *[Computer Chess Newsletter, Issue 2](https://www.computerhistory.org/chess/doc-431614f6d6b8e/)*. p. 9
10. [↑](#cite_ref-10) *The Fourth World Computer Chess Championship*, [pdf](http://www.sci.brooklyn.cuny.edu/%7Ekopec/Publications/Publications/O_36_C.pdf) courtesy [Danny Kopec](/Danny_Kopec "Danny Kopec")
11. [↑](#cite_ref-11) [dblp: Ira D. Baxter](https://dblp.uni-trier.de/pers/hd/b/Baxter:Ira_D=.html)
12. [↑](#cite_ref-12) hosted by [Modern Mechanix](http://blog.modernmechanix.com/), Photo 4: Ira Baxter’s [chess playing system](/SD_Chess "SD Chess") display, which competed in the [Microcomputer Chess Tournament](/MCCT_1978 "MCCT 1978") at the Faire. The level of play was impressive, and the winning program, called [SARGON](/Sargon "Sargon"), was a 16 K byte [Z-80](/Z80 "Z80") [assembler](/Assembly "Assembly") program written by a husband and wife team, [Kathe](/Kathe_Spracklen "Kathe Spracklen") and [Dan Spracklen](/Dan_Spracklen "Dan Spracklen").
