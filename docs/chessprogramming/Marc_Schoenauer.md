...
Source: https://www.chessprogramming.org/Marc_Schoenauer

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Marc Schoenauer**

[![](/images/3/3d/Marc-schoenauer.jpg)](https://www.lri.fr/~marc/)

Marc Schoenauer [[1]](#cite_note-1)

**Marc Schoenauer**,  
a French mathematician and computer scientist, along with [Michèle Sebag](/Mich%C3%A8le_Sebag "Michèle Sebag") head of the *TAO Project Team* [[2]](#cite_note-2)
...
Schoenauer has been working in the field of [evolutionary computation](/Genetic_Programming#EvolutionaryComputation "Genetic Programming") (EC) and [genetic programming](/Genetic_Programming "Genetic Programming") since the early 90s, more particularly at the interface between EC and [machine learning](/Learning "Learning") [[3]](#cite_note-3).
...
- [Ilya Loshchilov](/Ilya_Loshchilov "Ilya Loshchilov"), Marc Schoenauer, [Michèle Sebag](/Mich%C3%A8le_Sebag "Michèle Sebag") (**2011**). *Adaptive coordinate descent.* [GECCO 2011](https://dblp.org/db/conf/gecco/gecco2011.html), [pdf](http://www.loshchilov.com/publications/GECCO2011_AdaptiveCoordinateDescent.pdf) [[8]](#cite_note-8)
...
- [Ilya Loshchilov](/Ilya_Loshchilov "Ilya Loshchilov"), Marc Schoenauer, [Michèle Sebag](/Mich%C3%A8le_Sebag "Michèle Sebag") (**2012**). *Self-Adaptive Surrogate-Assisted Covariance Matrix Adaptation Evolution Strategy*. [arXiv:1204.2356](https://arxiv.org/abs/1204.2356) [[9]](#cite_note-9)
...
1. [↑](#cite_ref-1) [Home page of Marc Schoenauer, head of TAO team](https://www.lri.fr/~marc/)
2. [↑](#cite_ref-2) [TikiWiki | People](https://tao.lri.fr/tiki-index.php?page=People)
3. [↑](#cite_ref-3) [Short CV of Marc Schoenauer, Nov. 2008](http://www.lri.fr/%7Emarc/bio_short.html)
4. [↑](#cite_ref-4) [Marc Schoenauer - Selected Publications](https://www.lri.fr/~marc/selectedBib.html)
5. [↑](#cite_ref-5) [dblp: Marc Schoenauer](https://dblp.uni-trier.de/pers/hd/s/Schoenauer:Marc)
6. [↑](#cite_ref-6) [Marc Schoenauer - Google Scholar Citations](https://scholar.google.com/citations?user=GrCk6WoAAAAJ&hl=en)
7. [↑](#cite_ref-7) [Multi-objective optimization from Wikipedia](https://en.wikipedia.org/wiki/Multi-objective_optimization)
8. [↑](#cite_ref-8) [Adaptive coordinate descent from Wikipedia](https://en.wikipedia.org/wiki/Adaptive_coordinate_descent)
