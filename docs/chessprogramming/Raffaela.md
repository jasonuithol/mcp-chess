...
Source: https://www.chessprogramming.org/Raffaela

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Raffaela**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Raffaello_Sanzio.jpg/250px-Raffaello_Sanzio.jpg)](/File:Raffaello_Sanzio.jpg)

Raphael [[1]](#cite_note-1)

**Raffaela**,  
a [WinBoard](/WinBoard "WinBoard") compatible chess program by [Stefano Gemma](/Stefano_Gemma "Stefano Gemma") with an own [GUI](/GUI "GUI"), first announced in August 1996, and [Windows](/Windows "Windows") successor of Stefano's former [DOS](/MS-DOS "MS-DOS") program [Drago](/Drago "Drago") from the early 90s. The chess playing algorithm is implemented in [8086](/8086 "8086") [assembly](/Assembly "Assembly") with impressive [nodes per second](/Nodes_per_Second "Nodes per Second") [[2]](#cite_note-2) due to very fast [move generation](/Move_Generation "Move Generation") with indirect jumps and branching on multiple processor flags,
which was further used in Stefano's later program [Freccia](/Freccia "Freccia") [[3]](#cite_note-3). Raffaela uses Stefano Gemma's reinvention of [Alpha-Beta](/Alpha-Beta "Alpha-Beta"), dubbed **AlfaGemma** [[4]](#cite_note-4), but lacks [quiescence search](/Quiescence_Search "Quiescence Search") [[5]](#cite_note-5).
Raffaela was likely the first Italian program able to play on the Internet [[6]](#cite_note-6). It played multiple [Italian Computer Chess Championships](/Italian_Computer_Chess_Championship "Italian Computer Chess Championship") from [2001](/CIPS_2001 "CIPS 2001") until [2008](/CCC_2008 "CCC 2008"), and had its best result at [CIPS 2007](/CIPS_2007 "CIPS 2007") with 2½/6.

# Screenshot

[![RaffaelaGUI.jpg](/images/6/6f/RaffaelaGUI.jpg)](/File:RaffaelaGUI.jpg)

Raffaela [GUI](/GUI "GUI")

# Selected Games

[CIPS 2002](/CIPS_2002 "CIPS 2002"), round 5, Raffaela - [LarsenVB](/LarsenVB "LarsenVB") [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) Self-portrait of Raphael, aged approximately 23, between 1504 and 1506, [Uffizi](https://en.wikipedia.org/wiki/Uffizi), [Raphael from Wikipedia](https://en.wikipedia.org/wiki/Raphael), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [Golem's Page](http://www.oocities.org/gmasciulli/indexOld.html) by [Gianluigi Masciulli](/Gianluigi_Masciulli "Gianluigi Masciulli") (archived)
...
4. [↑](#cite_ref-4) [AlfaGemma is back](http://www.talkchess.com/forum/viewtopic.php?t=61024) by [Stefano Gemma](/Stefano_Gemma "Stefano Gemma"), [CCC](/CCC "CCC"), August 03, 2016
5. [↑](#cite_ref-5) [Drago](https://www.stmintz.com/ccc/index.php?id=130537) by [Carmelo Calzerano](/Carmelo_Calzerano "Carmelo Calzerano"), [CCC](/CCC "CCC"), September 25, 2000
6. [↑](#cite_ref-6) [Golem's Page](http://www.oocities.org/gmasciulli/indexOld.html) by [Gianluigi Masciulli](/Gianluigi_Masciulli "Gianluigi Masciulli") (archived)
7. [↑](#cite_ref-7) [2′ Campionato Italiano « G 6](https://www.g-sei.org/2-campionato-italiano/)
