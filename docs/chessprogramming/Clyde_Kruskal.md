...
Source: https://www.chessprogramming.org/Clyde_Kruskal

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Clyde Kruskal**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/ClydeKruskal2019.png/250px-ClydeKruskal2019.png)](/File:ClydeKruskal2019.png)

Clyde Kruskal in 2019 [[1]](#cite_note-1)
...
Beside [parallel architectures](https://en.wikipedia.org/wiki/Parallel_computing) and [parallel algorithms](https://en.wikipedia.org/wiki/Parallel_algorithm), his research interests include [stochastic games](https://en.wikipedia.org/wiki/Stochastic_game), in particular the games of [Can't Stop](https://en.wikipedia.org/wiki/Can%27t_Stop_(board_game)) and [Domineering](/index.php?title=Domineering&action=edit&redlink=1 "Domineering (page does not exist)") [[2]](#cite_note-2) [[3]](#cite_note-3).
...
1. [↑](#cite_ref-1) [Kruskal](https://commons.wikimedia.org/wiki/File:ClydeKruskal2019.png) on September 30, 2019, by Idespisemayonnaise, [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [Domineering from Wikipedia](https://en.wikipedia.org/wiki/Domineering)
3. [↑](#cite_ref-3) [Sahil Bahri](/index.php?title=Sahil_Bahri&action=edit&redlink=1 "Sahil Bahri (page does not exist)"), Clyde Kruskal *Standard Domineering*. [pdf](http://www.cs.umd.edu/~kruskal/Standard_V2.pdf)
4. [↑](#cite_ref-4) [dblp: Clyde P. Kruskal](https://dblp.uni-trier.de/pers/hd/k/Kruskal:Clyde_P=.html)
