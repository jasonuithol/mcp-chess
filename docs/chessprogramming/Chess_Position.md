...
**[Home](/Main_Page "Main Page") \* [Chess](/Chess "Chess") \* Position**

[![](/images/6/6d/DuchampGlassBoard.jpg)](http://www.slu.edu/sluma-home/past-exhibitions/2009/duchamp)

[Marcel Duchamp](/Category:Marcel_Duchamp "Category:Marcel Duchamp") [[1]](#cite_note-1) [[2]](#cite_note-2)

The **Chess Position** describes how [pieces](/Pieces "Pieces") are placed on the [chessboard](/Chessboard "Chessboard"), as printed as chess diagram, image or photograph from a [game of chess](/Chess_Game "Chess Game"). In 1996 [Shirish Chinchalkar](/Shirish_Chinchalkar "Shirish Chinchalkar") determined 1046 as upper bound for the number of reachable chess positions [[3]](#cite_note-3). The [maximum number of moves](/Encoding_Moves#MoveIndex "Encoding Moves") in any reachable chess position is 218 [[4]](#cite_note-4)[[5]](#cite_note-5).
...
- [Re: sri-unix.444: compact representation of chess positions](http://quux.org:70/Archives/usenet-a-news/NET.chess/82.01.07_duke.1593_net.chess.txt) by [Tom Truscott](/Tom_Truscott "Tom Truscott"), [net.chess](http://quux.org:70/Archives/usenet-a-news/NET.chess), January 7, 1982 » [Zobrist Hashing](/Zobrist_Hashing "Zobrist Hashing") [[6]](#cite_note-6)
...
:   [Re: number of moves in position](https://www.stmintz.com/ccc/index.php?id=69704) by [Leonid](/Leonid_Liberman "Leonid Liberman"), [CCC](/CCC "CCC"), September 21, 1999
...
- [Counting endgame positions](http://www.talkchess.com/forum/viewtopic.php?t=50832) by [Kirill Kryukov](/Kirill_Kryukov "Kirill Kryukov"), [CCC](/CCC "CCC"), January 08, 2014 [[7]](#cite_note-7)
...
:   [Re: On the number of chess positions](https://www.talkchess.com/forum3/viewtopic.php?f=7&t=77685&start=42) by [Peter Österlund](/Peter_%C3%96sterlund "Peter Österlund"), [CCC](/CCC "CCC"), April 03, 2022 » [Retrograde Analysis](/Retrograde_Analysis "Retrograde Analysis")
...
1. [↑](#cite_ref-1) Photo by [Arnold T. Rosenberg](https://en.wikipedia.org/wiki/Arnold_T._Rosenberg), [Marcel Duchamp](/Category:Marcel_Duchamp "Category:Marcel Duchamp") playing chess on a sheet of Glass, 1958, see [Francis M. Naumann](https://en.wikipedia.org/wiki/Francis_Naumann), [Bradley Bailey](https://www.slu.edu/arts-and-sciences/fine-and-performing-arts/faculty/bailey-bradley.php) (**2009**). *[Marcel Duchamp: The Art of Chess](http://www.francisnaumann.com/Chess%20Book/)*
2. [↑](#cite_ref-2) [Marcel Duchamp: Chess Master](http://www.slu.edu/sluma-home/past-exhibitions/2009/duchamp) [Saint Louis University Museum of Art](https://www.slu.edu/sluma-home) [Saint Louis University : SLU](https://en.wikipedia.org/wiki/Saint_Louis_University)
3. [↑](#cite_ref-3) [Shirish Chinchalkar](/Shirish_Chinchalkar "Shirish Chinchalkar") (**1996**). *An Upper Bound for the Number of Reachable Positions*. [ICCA Journal, Vol. 19, No. 3](/ICGA_Journal#19_3 "ICGA Journal")
4. [↑](#cite_ref-4) [Subject: Maximum Number of Legal Moves](https://www.stmintz.com/ccc/index.php?id=424966) by [Andrew Shapira](/Andrew_Shapira "Andrew Shapira"), [CCC](/CCC "CCC"), May 08, 2005
5. [↑](#cite_ref-5) [Why a position can't have more than 218 moves.](https://lichess.org/@/Tobs40/blog/why-a-position-cant-have-more-than-218-moves/a5xdxeqs) by Tobs40, [Lichess](/index.php?title=Lichess&action=edit&redlink=1 "Lichess (page does not exist)"), May 7, 2024
6. [↑](#cite_ref-6) [Re: Hashing function for board positions](http://groups.google.com/group/rec.games.chess.computer/browse_frm/thread/a0a82ffbb59b7ced) post 4 by [Jim Gillogly](/James_Gillogly "James Gillogly"), [rgcc](/Computer_Chess_Forums "Computer Chess Forums"), May 12, 1997
7. [↑](#cite_ref-7) [NULP in chess endgames](http://kirill-kryukov.com/chess/nulp/) by [Kirill Kryukov](/Kirill_Kryukov "Kirill Kryukov")
