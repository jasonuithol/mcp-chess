...
Source: https://www.chessprogramming.org/ECE

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* ECE**

[File:Newcomen atmospheric engine animation.gif](/index.php?title=Special:Upload&wpDestFile=Newcomen_atmospheric_engine_animation.gif "File:Newcomen atmospheric engine animation.gif")

[Newcomen](https://en.wikipedia.org/wiki/Thomas_Newcomen) [ECE](https://en.wikipedia.org/wiki/External_combustion_engine) [[1]](#cite_note-1)

**ECE**, (Easy Chess Engine)  
an [UCI](/UCI "UCI") compliant chess engine by [Luigino Viscione](/index.php?title=Luigino_Viscione&action=edit&redlink=1 "Luigino Viscione (page does not exist)"), written in [C++](/Cpp "Cpp"), first released in February 2004 [[2]](#cite_note-2).
...
Further, ECE supports the [PolyGlot](/PolyGlot "PolyGlot") [opening book](/Opening_Book "Opening Book") format [[3]](#cite_note-3). ECE played the [3rd Chess Computer Cup 2008](/CCC_2008 "CCC 2008") with 4/6,
...
1. [↑](#cite_ref-1) Animation showing the operation of a [Newcomen atmospheric engine](https://en.wikipedia.org/wiki/Newcomen_atmospheric_engine), a precursor of the [steam engine](https://en.wikipedia.org/wiki/Steam_engine), March 2006, drawn using [XaraX software](https://en.wikipedia.org/wiki/Xara_Photo_%26_Graphic_Designer) by [Emoscopes](https://commons.wikimedia.org/wiki/User:Emoscopes), [External combustion engine from Wikipedia](https://en.wikipedia.org/wiki/External_combustion_engine), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [ECE](http://web.archive.org/web/20080704173259/http://wbec-ridderkerk.nl/html/details1/ECE.html) from [WBEC Ridderkerk](/WBEC "WBEC") ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine), July 04, 2008)
3. [↑](#cite_ref-3) [Luigino Viscione Chess Page - Dimitri 5 - ECE 20](http://lesgames.altervista.org/faq.html)
