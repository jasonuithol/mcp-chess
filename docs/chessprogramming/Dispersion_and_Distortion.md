...
Source: https://www.chessprogramming.org/Dispersion_and_Distortion

**[Home](/Main_Page "Main Page") \* [Board Representation](/Board_Representation "Board Representation") \* [Bitboards](/Bitboards "Bitboards") \* [Pawn Pattern and Properties](/Pawn_Pattern_and_Properties "Pawn Pattern and Properties") \* Dispersion and Distortion**

[![](/images/4/46/SamuelBakLuna.jpg)](http://chgs.elevator.umn.edu/asset/viewAsset/57f3b6787d58ae5f74bf8ba9#57f3b6d77d58ae5574bf8bb7)

[Samuel Bak](/Category:Samuel_Bak "Category:Samuel Bak") - Luna [[1]](#cite_note-1)

**Dispersion** and **Distortion**,  
are [Kmoch's](/Hans_Kmoch "Hans Kmoch") terms [[2]](#cite_note-2) [[3]](#cite_note-3) for [pawn structure](/Pawn_Structure "Pawn Structure") [weaknesses](/Weak_Pawns "Weak Pawns") due to vertical or horizontal splitting caused by [captures](/Captures "Captures") or [advancement](/Pawn_Push "Pawn Push"). The proposed functions may be used via an additional scaling or indirection, f.i. to index a table with concrete penalties.
...
1. [↑](#cite_ref-1) [Chess in the Art of Samuel Bak](http://chgs.elevator.umn.edu/asset/viewAsset/57f3b6787d58ae5f74bf8ba9#57f3b6d77d58ae5574bf8bb7), [Center for Holocaust & Genocide Studies](http://www.chgs.umn.edu/), [University of Minnesota](/University_of_Minnesota "University of Minnesota")
