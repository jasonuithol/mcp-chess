...
Source: https://www.chessprogramming.org/Lazy_SMP

**[Home](/Main_Page "Main Page") \* [Search](/Search "Search") \* [Parallel Search](/Parallel_Search "Parallel Search") \* Lazy SMP**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Our_living_world_%28Full_Page_Illustration%29_%286076989366%29.jpg/330px-Our_living_world_%28Full_Page_Illustration%29_%286076989366%29.jpg)](/File:Our_living_world_(Full_Page_Illustration)_(6076989366).jpg)

Sloths traversing a tree [[1]](#cite_note-1)

**Lazy SMP**,  
based on the [shared hash table](/Shared_Hash_Table "Shared Hash Table") approach of a parallel search to profit from probing hash entries written by other instances of the search, as already used by [Vincent David's](/Vincent_David "Vincent David") αβ\* [[2]](#cite_note-2). Multiple [processes](/Process "Process") or [threads](/Thread "Thread") search the same [root position](/Root "Root"), but are launched with different [depths](/Depth "Depth"), and/or varying [move ordering](/Move_Ordering "Move Ordering") at the root node, to statistically improve the gains from the effect of nondeterminism, otherwise depending on random timing fluctuations [[3]](#cite_note-3). The term **Lazy SMP** was coined by [Julien Marcel](/Julien_Marcel "Julien Marcel") end of 2012 [[4]](#cite_note-4) with further elaborations by [Daniel Homan](/Daniel_Homan "Daniel Homan") [[5]](#cite_note-5) [[6]](#cite_note-6), [Martin Sedlak](/Martin_Sedlak "Martin Sedlak") and others. Today, many chess programs use this easy to implement parallel search approach, which [scales](https://en.wikipedia.org/wiki/Scalability) surprisingly well up to 8 cores and beyond [[7]](#cite_note-7), not only in [nodes per second](/Nodes_per_Second "Nodes per Second") (as expected), but in [playing strength](/Playing_Strength "Playing Strength"), while it seems worse than [YBW](/Young_Brothers_Wait_Concept "Young Brothers Wait Concept") in [speedup](https://en.wikipedia.org/wiki/Speedup) concerning time to [depth](/Depth "Depth") [[8]](#cite_note-8). Notably [Stockfish 7](/Stockfish "Stockfish"), released in January 2016, switched from YBW to lazy SMP [[9]](#cite_note-9) [[10]](#cite_note-10) [[11]](#cite_note-11).

# Cheng's Pseudo Code

Pseudo Code of Lazy SMP in [Cheng](/Cheng "Cheng") as given by its author [Martin Sedlak](/Martin_Sedlak "Martin Sedlak") [[12]](#cite_note-12):
...
Modern engines use a technique called Thread Voting to increase the accuracy from Lazy SMP searches. Every thread cast a "vote" on their own best move. The votes are weighed on certain criteria, most commonly, depth and difference from worst score.

## Berserk's Implementation of Thread Voting
...
## Voting On Multiple Moves

A thread voting scheme introduced by Patrick Leonhardt in PlentyChess. Under this method, worker threads can vote on multiple best moves found in Iterative Deepening loop.
...
- [lazy smp using ms vs2015 c++11 std::async](http://www.talkchess.com/forum/viewtopic.php?t=60979) by [Edward Yu](/index.php?title=Edward_Yu&action=edit&redlink=1 "Edward Yu (page does not exist)"), [CCC](/CCC "CCC"), July 29, 2016 » [Thread](/Thread "Thread") [[13]](#cite_note-13)
...
1. [↑](#cite_ref-1) [Three-toed sloth](https://en.wikipedia.org/wiki/Three-toed_sloth), [Image](https://commons.wikimedia.org/wiki/File:Our_living_world_(Full_Page_Illustration)_(6076989366).jpg?uselang=en) by [Friedrich Specht](https://en.wikipedia.org/wiki/Friedrich_Specht) in [Joseph Bassett Holder](https://en.wikipedia.org/wiki/Joseph_Bassett_Holder), [John George Wood](https://en.wikipedia.org/wiki/John_George_Wood) (**1885**). *[Our living world; an artistic edition of the Rev. J. G. Wood's Natural history of animate creation](http://www.biodiversitylibrary.org/bibliography/49480#/summary)*. New York : Selmar Hess, [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2)  [Vincent David](/Vincent_David "Vincent David") (**1993**). *[Algorithmique parallèle sur les arbres de décision et raisonnement en temps contraint. Etude et application au Minimax](http://cat.inist.fr/?aModele=afficheN&cpsidt=161774)* = Parallel algorithm for heuristic tree searching and real-time reasoning. Study and application to the Minimax, Ph.D. Thesis, [École nationale supérieure de l'aéronautique et de l'espace](https://en.wikipedia.org/wiki/%C3%89cole_nationale_sup%C3%A9rieure_de_l%27a%C3%A9ronautique_et_de_l%27espace), [Toulouse](https://en.wikipedia.org/wiki/Toulouse), [France](https://en.wikipedia.org/wiki/France)
3. [↑](#cite_ref-3) [Re: Lazy SMP - how it works](http://www.talkchess.com/forum/viewtopic.php?t=59389&start=5) by [Evert Glebbeek](/Evert_Glebbeek "Evert Glebbeek"), [CCC](/CCC "CCC"), October 19, 2016
4. [↑](#cite_ref-4) [Lazy SMP](http://www.talkchess.com/forum/viewtopic.php?t=46597) by [Julien Marcel](/Julien_Marcel "Julien Marcel"), [CCC](/CCC "CCC"), December 27, 2012
5. [↑](#cite_ref-5) [Lazy SMP, part 2](http://www.talkchess.com/forum/viewtopic.php?t=46858) by [Daniel Homan](/Daniel_Homan "Daniel Homan"), [CCC](/CCC "CCC"), January 12, 2013
6. [↑](#cite_ref-6) [Lazy SMP and Work Sharing](http://www.talkchess.com/forum/viewtopic.php?t=48536) by [Daniel Homan](/Daniel_Homan "Daniel Homan"), [CCC](/CCC "CCC"), July 03, 2013
7. [↑](#cite_ref-7) [Re: A new chess engine : m8 (comming not so soon)](http://www.talkchess.com/forum/viewtopic.php?t=55170&start=11) by [Peter Österlund](/Peter_%C3%96sterlund "Peter Österlund"), [CCC](/CCC "CCC"), February 01, 2015
8. [↑](#cite_ref-8) [Time to depth concerns](http://www.talkchess.com/forum/viewtopic.php?t=61131) by [Carl Bicknell](/index.php?title=Carl_Bicknell&action=edit&redlink=1 "Carl Bicknell (page does not exist)"), [CCC](/CCC "CCC"), August 15, 2016
9. [↑](#cite_ref-9) [Stockfish 7](http://www.talkchess.com/forum/viewtopic.php?t=58779) by [Joona Kiiski](/Joona_Kiiski "Joona Kiiski"), [CCC](/CCC "CCC"), January 02, 2016
10. [↑](#cite_ref-10) [Threads test incl. Stockfish 7](http://www.talkchess.com/forum/viewtopic.php?t=58887) by [Andreas Strangmüller](/Andreas_Strangm%C3%BCller "Andreas Strangmüller"), [CCC](/CCC "CCC"), January 11, 2016
11. [↑](#cite_ref-11) [Stockfish 7 progress](http://www.talkchess.com/forum/viewtopic.php?t=58935) by Carl Lumma, [CCC](/CCC "CCC"), January 16, 2016
12. [↑](#cite_ref-12) [Lazy SMP in Cheng](http://www.talkchess.com/forum/viewtopic.php?t=55188) by [Martin Sedlak](/Martin_Sedlak "Martin Sedlak"), [CCC](/CCC "CCC"), February 02, 2015 » [Cheng](/Cheng "Cheng")
13. [↑](#cite_ref-13) [std::async - cppreference.com](http://en.cppreference.com/w/cpp/thread/async)
