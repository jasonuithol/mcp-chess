...
Source: https://www.chessprogramming.org/Paul_E._Utgoff

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Paul E. Utgoff**

[![](/images/5/52/Utgoff.gif)](http://people.cs.umass.edu/~utgoff/)

Paul E. Utgoff [[1]](#cite_note-1)

**Paul Everett Utgoff**, (1951 - 2008)  
was an American computer scientist and professor at Department of Computer and Information Science, [University of Massachusetts](https://en.wikipedia.org/wiki/University_of_Massachusetts_Amherst) [Amherst](https://en.wikipedia.org/wiki/Amherst,_Massachusetts). He is recognized as a pioneer in [machine learning](/Learning "Learning"), [data mining](https://en.wikipedia.org/wiki/Data_mining), and [decision theory](https://en.wikipedia.org/wiki/Decision_theory), where he contributed to [incremental decision tree](https://en.wikipedia.org/wiki/Incremental_decision_tree) induction, multivariate decision trees [[2]](#cite_note-2), and problem representation. He received his Ph.D. in 1984 from [Rutgers–New Brunswick](https://en.wikipedia.org/wiki/Rutgers%E2%80%93New_Brunswick) on [inductive bias](https://en.wikipedia.org/wiki/Inductive_bias) in machine learning under supervision of [Tom Mitchell](/Tom_Mitchell "Tom Mitchell") and [Saul Amarel](https://en.wikipedia.org/wiki/Saul_Amarel) [[3]](#cite_note-3). In 1993, he designed the *Incremental Tree Inducer* (**ITI**) program and a new algorithm called *Direct-Metric Tree Inducer* (**DMTI**) made feasible by the ability to restructure trees efficiently [[4]](#cite_note-4).

Paul E. Utgoff died on October 11, 2008 at the age of 57 due to complications from surgery that he elected to undergo as part of his battle against [appendiceal cancer](https://en.wikipedia.org/wiki/Appendix_cancer) [[5]](#cite_note-5).
...
- Paul E. Utgoff (**1988**). *[ID5: An incremental ID3](http://dl.acm.org/citation.cfm?id=896712)*. [ML 1988](http://dblp.uni-trier.de/db/conf/icml/ml1988.html#Utgoff88) [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) [Paul Utgoff](http://people.cs.umass.edu/~utgoff/)
2. [↑](#cite_ref-2) [Carla E. Brodley](http://scholar.google.com/citations?user=sQ8u6h4AAAAJ), Paul E. Utgoff (**1995**). *Multivariate Decision Trees*. [Machine Learning](https://en.wikipedia.org/wiki/Machine_Learning_%28journal%29), Vol. 19, No. 1
3. [↑](#cite_ref-3) Paul E. Utgoff (**1984**). *Shift of Bias for Inductive Concept Learning*. Ph.D. thesis, [Rutgers University, New Brunswick](https://en.wikipedia.org/wiki/Rutgers%E2%80%93New_Brunswick)
4. [↑](#cite_ref-4) [Machine Learning Laboratory - Incremental Decision Tree Induction](http://people.cs.umass.edu/~lrn/iti/index.html)
5. [↑](#cite_ref-5) [In Memoriam: Paul Utgoff (1951 - 2008) | School of Computer Science](https://www.cs.umass.edu/news/latest-news/memoriam-paul-utgoff-1951-2008)
6. [↑](#cite_ref-6) [dblp: Paul E. Utgoff](http://dblp.uni-trier.de/pers/hd/u/Utgoff:Paul_E=)
7. [↑](#cite_ref-7) [Iterative Dichotomiser 3](https://en.wikipedia.org/wiki/ID3_algorithm) by [Ross Quinlan](/Ross_Quinlan "Ross Quinlan")
