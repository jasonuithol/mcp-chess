...
- Java has **no unsigned long** data type that is e.g. used by [bitboards](/Bitboards "Bitboards"). Thus one has to use [unsigned right shift operator >>>](https://chessprogramming.wikispaces.com/General+Setwise+Operations#Shifting%20Bitboards) [[2]](#cite_note-2) [[3]](#cite_note-3).
...
- [Category:Java](/Category:Java "Category:Java") [[4]](#cite_note-4):
...
- [Liwu Li](/Liwu_Li "Liwu Li") (**2005**). *[Implementing the π-Calculus in Java](http://www.jot.fm/issues/issue_2005_03/article5/)*. [Journal of Object Technology](https://en.wikipedia.org/wiki/The_Journal_of_Object_Technology), Vol. 4, No. 2 [[5]](#cite_note-5)
...
- [Mark Watson](/Mark_Watson "Mark Watson") (**2016**). *Practical Artificial Intelligence Programming With Java*. Sixth Edition [[6]](#cite_note-6) » [Artificial Intelligence](/Artificial_Intelligence "Artificial Intelligence")
...
1. [↑](#cite_ref-1) [TIOBE Index](http://www.tiobe.com/index.php/content/paperinfo/tpci/index.html)
2. [↑](#cite_ref-2) [Re: Java chess program?](https://groups.google.com/d/msg/rec.games.chess.computer/o3AMPvhmY3o/1yZhMk3_VlIJ) by [Moritz Berger](/Moritz_Berger "Moritz Berger"), [rgcc](/Computer_Chess_Forums "Computer Chess Forums"), May 29, 1997 » [Shifting Bitboards](/General_Setwise_Operations#ShiftingBitboards "General Setwise Operations")
3. [↑](#cite_ref-3) [Bitboards and Java](http://www.talkchess.com/forum/viewtopic.php?t=65724) by [Fred Hamilton](/index.php?title=Fred_Hamilton&action=edit&redlink=1 "Fred Hamilton (page does not exist)"), [CCC](/CCC "CCC"), November 14, 2017
4. [↑](#cite_ref-4) [java engines](http://www.talkchess.com/forum/viewtopic.php?t=58080) by [Gabor Szots](/Gabor_Szots "Gabor Szots"), [CCC](/CCC "CCC"), October 28, 2015
5. [↑](#cite_ref-5) [π-calculus from Wikipedia](https://en.wikipedia.org/wiki/%CE%A0-calculus)
6. [↑](#cite_ref-6) [Mark Watson · GitHub](https://github.com/mark-watson)
