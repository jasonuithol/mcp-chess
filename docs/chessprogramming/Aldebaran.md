...
Source: https://www.chessprogramming.org/Aldebaran

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Aldebaran**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Taurus_constellation_map.svg/330px-Taurus_constellation_map.svg.png)](/File:Taurus_constellation_map.svg)

Aldebaran in the [Taurus constellation](https://en.wikipedia.org/wiki/Taurus_%28constellation%29) [[1]](#cite_note-1)

**Aldebaran**,  
a [WinBoard](/WinBoard "WinBoard") compliant chess program by [Mauro Scarpa](/index.php?title=Mauro_Scarpa&action=edit&redlink=1 "Mauro Scarpa (page does not exist)"), written in [C](/C "C") [[2]](#cite_note-2),
...
1. [↑](#cite_ref-1) The position of Aldebaran in the [Taurus constellation](https://en.wikipedia.org/wiki/Taurus_%28constellation%29), [Aldebaran from Wikipedia](https://en.wikipedia.org/wiki/Aldebaran)
2. [↑](#cite_ref-2) [Golem's Page - G6](http://www.oocities.org/gmasciulli/indexOld.html#G6)
