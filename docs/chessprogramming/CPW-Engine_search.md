...
Source: https://www.chessprogramming.org/CPW-Engine_search

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* [CPW-Engine](/CPW-Engine "CPW-Engine") \* Search**

For function definitions, see [CPW-Engine\_search\_h](/CPW-Engine_search_h "CPW-Engine search h"). On storing [Lower Bound](/Lower_Bound "Lower Bound"), [Upper Bound](/Upper_Bound "Upper Bound") and [Exact Score](/Exact_Score "Exact Score") into the [Transposition Table](/Transposition_Table "Transposition Table") at search\_root and Search, see the discussions in [CCC](/CCC "CCC") [[1]](#cite_note-1) [[2]](#cite_note-2).
...
1. [↑](#cite_ref-1) [Re: Debugging a transposition table](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=67599&start=2) by [Vivien Clauzon](/Vivien_Clauzon "Vivien Clauzon"), [CCC](/CCC "CCC"), May 30, 2018
2. [↑](#cite_ref-2) [Re: Plea for a computerchess beginners forum or FAQ](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=76574&start=5) by [Marcel Vanthoor](/Marcel_Vanthoor "Marcel Vanthoor"), [CCC](/CCC "CCC"), March 09, 2021
