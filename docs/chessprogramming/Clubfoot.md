...
Source: https://www.chessprogramming.org/Clubfoot

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Clubfoot**

[![](/images/2/2f/Clubfoot-Logo.jpg)](https://github.com/zd3nik/Clubfoot/blob/master/Clubfoot-Logo.png)

Clubfoot logo [[1]](#cite_note-1)
...
It was started as a real-world example of how to implement a UCI chess engine using the [Senjo](/index.php?title=Senjo&action=edit&redlink=1 "Senjo (page does not exist)") UCI adapter [[2]](#cite_note-2).
...
This engine is available as source code [[3]](#cite_note-3), and [Dann Corbit](/Dann_Corbit "Dann Corbit") has provided binaries [[4]](#cite_note-4).
Links to 32 and 64 bit binaries for [Windows](/Windows "Windows") and [Linux](/Linux "Linux") are also available in the Clubfoot README, found in the github source repository [[5]](#cite_note-5).
...
1. [↑](#cite_ref-1) Compressed Logo (9KB) captured from [Clubfoot/Clubfoot-Logo.png at master · zd3nik](https://github.com/zd3nik/Clubfoot/blob/master/Clubfoot-Logo.png) (415 KB)
2. [↑](#cite_ref-2) [zd3nik/SenjoUCIAdapter · GitHub](https://github.com/zd3nik/SenjoUCIAdapter)
3. [↑](#cite_ref-3) [Clubfoot source code on github.](https://github.com/zd3nik/Clubfoot)
4. [↑](#cite_ref-4) [Re: Clubfoot (UCI) by Shawn Chidester](http://www.talkchess.com/forum/viewtopic.php?t=55584&start=2) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCC](/CCC "CCC"), March 10, 2015
5. [↑](#cite_ref-5) [Clubfoot source code on github](https://github.com/zd3nik/Clubfoot)
