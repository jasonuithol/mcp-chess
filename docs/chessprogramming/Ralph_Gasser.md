...
Source: https://www.chessprogramming.org/Ralph_Gasser

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Ralph Gasser**

**Ralph Gasser**,  
a Swiss computer scientist and software engineer at [Google](/index.php?title=Google&action=edit&redlink=1 "Google (page does not exist)") [[1]](#cite_note-1). He holds a Ph.D. in 1995 from [ETH Zurich](/ETH_Zurich "ETH Zurich") under [Jürg Nievergelt](/J%C3%BCrg_Nievergelt "Jürg Nievergelt"), where he researched on [exhaustive search](/Search "Search") and [retrograde analysis](/Retrograde_Analysis "Retrograde Analysis") in [computer games](/Games "Games"), that is forward and backward search. In 1993, he solved the game [Nine Men’s Morris](/Nine_Men%E2%80%99s_Morris "Nine Men’s Morris") that way, using retrograde analysis searching from the [terminal nodes](/Terminal_Node "Terminal Node") and [alpha-beta](/Alpha-Beta "Alpha-Beta") from the [root](/Root "Root") [[2]](#cite_note-2). His Nine Men’s Morris program [Bushy](https://www.game-ai-forum.org/icga-tournaments/program.php?id=441) already won the Gold medal at the [3rd Computer Olympiad, Maastricht 1991](/3rd_Computer_Olympiad#NineMensMorris "3rd Computer Olympiad").
...
1. [↑](#cite_ref-1) [Ralph Gasser | LinkedIn](https://www.linkedin.com/in/ralphgasser)
2. [↑](#cite_ref-2) [Nine Men's Morris is a DRAW](http://www.ics.uci.edu/~eppstein/cgt/morris.html) by Ralph Gasser, [rec.games.chess, rec.games.go, rec.games.abstract](/Computer_Chess_Forums "Computer Chess Forums"), November 23, 1993
3. [↑](#cite_ref-3) [ICGA Reference Database](/ICGA_Journal#RefDB "ICGA Journal")
4. [↑](#cite_ref-4) [dblp: Ralph Gasser](https://dblp.uni-trier.de/pers/hd/g/Gasser:Ralph)
