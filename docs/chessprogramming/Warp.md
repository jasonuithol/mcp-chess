...
Source: https://www.chessprogramming.org/Warp

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Warp**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Wormhole_travel_as_envisioned_by_Les_Bossinas_for_NASA.jpg/330px-Wormhole_travel_as_envisioned_by_Les_Bossinas_for_NASA.jpg)](/File:Wormhole_travel_as_envisioned_by_Les_Bossinas_for_NASA.jpg)

Warp drive [[1]](#cite_note-1)
...
from [2003 National Computer Chess Championship](/NC3_2003 "NC3 2003") [[2]](#cite_note-2)

```
Warp is a follow on from my previous chess program called LambChop, the name was changed when I re-wrote much of the low level code handling move generation, tree traversal etc. Warp has a relatively knowledgable evaluation function in the style of its predecessor, but has an increased emphasis on pruning irrelevant variations from the search tree. This means that Warp searches quite deeply despite a comparatively low nodes per second speed.
```
...
[WCCC 2002](/WCCC_2002 "WCCC 2002"), round 2, Warp - [Diep](/Diep "Diep") [[3]](#cite_note-3) [[4]](#cite_note-4) [[5]](#cite_note-5)
...
[WCCC 2002](/WCCC_2002 "WCCC 2002"), round 3, [Quest](/Quest "Quest") - Warp [[6]](#cite_note-6) [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) [Wormhole](https://en.wikipedia.org/wiki/Wormhole) [travel](https://en.wikipedia.org/wiki/Wormhole#Traversable_wormholes) as envisioned by Les Bossinas (Cortez III Service Corp.), 1998 for [NASA](https://en.wikipedia.org/wiki/NASA), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons), [Warp-Antrieb – Wikipedia.de](https://de.wikipedia.org/wiki/Warp-Antrieb) (German)
2. [↑](#cite_ref-2) [2003 National Computer Chess Championships | List of Entries](http://users.cecs.anu.edu.au/~shaun/chess/NC3_-_List_of_Entries.html)
3. [↑](#cite_ref-3) [Maastricht 2002 - Chess - Round 2 - Game 8 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=20&round=2&id=8)
4. [↑](#cite_ref-4)  [WCCC 2002: Round 2 - WARP vs. DIEP (my analysis)](https://www.stmintz.com/ccc/index.php?id=238978) by [Eduard Nemeth](/index.php?title=Eduard_Nemeth&action=edit&redlink=1 "Eduard Nemeth (page does not exist)"), [CCC](/CCC "CCC"), July 07, 2002
5. [↑](#cite_ref-5) [Warp - Diep, WCCC](https://www.stmintz.com/ccc/index.php?id=268444) by [Peter McKenzie](/Peter_McKenzie "Peter McKenzie"), [CCC](/CCC "CCC"), December 02, 2002
6. [↑](#cite_ref-6) [Maastricht 2002 - Chess - Round 3 - Game 6 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=20&round=3&id=6)
7. [↑](#cite_ref-7) [WCCC Round 3: Quest vs Warp [maybe draw?](https://www.stmintz.com/ccc/index.php?id=239026)] by [Kurt Utzinger](/Kurt_Utzinger "Kurt Utzinger"), [CCC](/CCC "CCC"), July 07, 2002
