...
1. [↑](#cite_ref-1) [Re: list of our chess computers, let's share it](http://hiarcs.net/forums/viewtopic.php?t=204&start=34) by [Craig Barnes](/Craig_Barnes "Craig Barnes"), [Hiarcs Forum](/Computer_Chess_Forums "Computer Chess Forums"), October 17, 2010
2. [↑](#cite_ref-2) [SciSys Sensor Chess](http://www.schach-computer.info/wiki/index.php/Scisys_Sensor_Chess) from [Schachcomputer.info - Wiki](http://www.schach-computer.info/wiki/index.php/Hauptseite_En)
