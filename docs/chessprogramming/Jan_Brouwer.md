...
Source: https://www.chessprogramming.org/Jan_Brouwer

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Jan Brouwer**

**Jan Brouwer**,  
a Dutch computer chess programmer and author of the [UCI](/UCI "UCI") compliant chess engine [Rotor](/Rotor "Rotor"), first released in early 2007 [[1]](#cite_note-1).
...
calculated the relative [jump](https://en.wikipedia.org/wiki/Branch_(computer_science)) offsets, and [poked](https://en.wikipedia.org/wiki/PEEK_and_POKE) the program into [memory](/Memory "Memory"), to run it [[2]](#cite_note-2).
...
1. [↑](#cite_ref-1) [ChessRotor](https://sites.google.com/site/chessrotor/)
2. [↑](#cite_ref-2) [Re: Your first chess program](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=43381&start=7) by Jan Brouwer, [CCC](/CCC "CCC"), April 20, 2012
