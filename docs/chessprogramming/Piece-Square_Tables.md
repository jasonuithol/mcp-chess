...
**[Home](/Main_Page "Main Page") \* [Evaluation](/Evaluation "Evaluation") \* Piece-Square Tables**

[![](/images/d/d3/CageChessPieces.jpg)](http://www.artnet.com/magazineus/reviews/davis/davis11-1-05_detail.asp?picnum=2)

[John Cage](/Category:John_Cage "Category:John Cage"), Chess Pieces, ca. 1944 [[1]](#cite_note-1)
...
The same technique can be used for a more subtle evaluation terms, instead of one fixed value for, say, an [isolated pawn](/Isolated_Pawn "Isolated Pawn"). It is also possible to use piece-square tables for [move ordering](/Move_Ordering "Move Ordering"), though [history heuristic](/History_Heuristic "History Heuristic") tends to perform better. Some programs, like [Rebel](/Rebel "Rebel"), use the combination of the two [[2]](#cite_note-2).
...
Older programs, running on slow hardware and reaching low depths, used an [oracle approach](/Oracle "Oracle") to speed up their evaluation by initializing the piece-square tables at the [beginning of each search](/Root "Root"), taking into account complex characteristics of position, influence of [pawn structure](/Pawn_Structure "Pawn Structure"), distance to the enemy king etc [[3]](#cite_note-3). Pre-processing, also dubbed **Pre Scan Heuristics** as applied in [Kittinger](/David_Kittinger "David Kittinger") programs [[4]](#cite_note-4), most notably the [Super Constellation](/Super_Constellation "Super Constellation") [[5]](#cite_note-5), were used by [Kaare Danielsen](/Kaare_Danielsen "Kaare Danielsen") [[6]](#cite_note-6), [Richard Lang](/Richard_Lang "Richard Lang") [[7]](#cite_note-7), [Don Dailey](/Don_Dailey "Don Dailey"), who even developed a little language so that [Larry Kaufman](/Larry_Kaufman "Larry Kaufman") could express evaluation concepts in a more natural way [[8]](#cite_note-8), [Chrilly Donninger](/Chrilly_Donninger "Chrilly Donninger") with [Nimzo 3](/Nimzo "Nimzo"), and [Frans Morsch](/Frans_Morsch "Frans Morsch") and [Mathias Feist](/Mathias_Feist "Mathias Feist") with [Fritz 3](/Fritz "Fritz"), to name a few, the latter even with user modifiable rules or tables. However, the idea already originated from the program [Tech](/Tech "Tech") by [James Gillogly](/James_Gillogly "James Gillogly") in the late 1960's [[9]](#cite_note-9).

With today's search depth this approach seems to be impractical, since the difference between the root and leaf position may be very big. There also might be a problem with re-using hash scores from the previous entries. About the only recent chess program that sticks with pre-processing for good or bad is [RomiChess](/RomiChess "RomiChess") [[10]](#cite_note-10) [[11]](#cite_note-11).
...
- [Fruit and Crafty Bishop PSTs](http://rybkaforum.net/cgi-bin/rybkaforum/topic_show.pl?tid=22635) by [michiguel](/Miguel_A._Ballicora "Miguel A. Ballicora"), [Rybka Forum](/Computer_Chess_Forums "Computer Chess Forums"), August 12, 2011 [[12]](#cite_note-12) [[13]](#cite_note-13)
...
- Cage. Music, art, chess - Film by Brian Brandt with [Margaret Leng Tan](https://en.wikipedia.org/wiki/Margaret_Leng_Tan) and [Larry List](https://www.linkedin.com/in/larry-list-937b888), [Noguchi Museum](https://en.wikipedia.org/wiki/Noguchi_Museum) [[14]](#cite_note-14) [[15]](#cite_note-15) [[16]](#cite_note-16), 2006, [YouTube](https://en.wikipedia.org/wiki/YouTube) Video

# References

1. [↑](#cite_ref-1) [John Cage - Chess Pieces, Ca. 1944](http://www.artnet.com/magazineus/reviews/davis/davis11-1-05_detail.asp?picnum=2), Courtesy [The John Cage Trust](http://johncagetrust.blogspot.com/) from [artnet Magazine - We Are Duchampians](http://www.artnet.com/magazineus/reviews/davis/davis11-1-05.asp) by Ben Davis
2. [↑](#cite_ref-2) [Ed Schröder](/Ed_Schroder "Ed Schroder") *How REBEL Plays Chess* as [pdf](http://members.home.nl/matador/Inside%20Rebel.pdf), see page 1,2 [Move Ordering](/Move_Ordering "Move Ordering")
3. [↑](#cite_ref-3) [Re: What is "pre-processing"](https://www.stmintz.com/ccc/index.php?id=18181) by [Don Dailey](/Don_Dailey "Don Dailey"), [CCC](/CCC "CCC"), May 07, 1998
4. [↑](#cite_ref-4) [PSH](http://www.schach-computer.info/wiki/index.php/PSH) from [Schachcomputer.info Wiki](http://www.schach-computer.info/wiki/index.php/Hauptseite_En) (German)
5. [↑](#cite_ref-5) [Novag Super Constellation](http://www.schach-computer.info/wiki/index.php/Novag_Super_Constellation) from [Schachcomputer.info - Wiki](http://www.schach-computer.info/wiki/index.php/Hauptseite_En) (German)
6. [↑](#cite_ref-6) "[This approach](/Oracle#Donninger "Oracle") seems to have been invented by [Kaare Danielsen](/Kaare_Danielsen "Kaare Danielsen") for his program [CXG Advanced Star Chess](/CXG_Star_Chess#Advanced "CXG Star Chess")" from [Chrilly Donninger](/Chrilly_Donninger "Chrilly Donninger") (**1996**). *CHE: A Graphical Language for Expressing Chess Knowledge*. [ICCA Journal, Vol. 19, No. 4](/ICGA_Journal#19_4 "ICGA Journal")
7. [↑](#cite_ref-7) [Re: Some thoughts on QS](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=475574&t=44507) by [Ed Schröder](/Ed_Schroder "Ed Schroder"), [CCC](/CCC "CCC"), July 25, 2012
8. [↑](#cite_ref-8) [Re: Some thoughts on QS](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=475603&t=44507) by [Don Dailey](/Don_Dailey "Don Dailey"), [CCC](/CCC "CCC"), July 25, 2012
9. [↑](#cite_ref-9) [David Kittinger](/David_Kittinger "David Kittinger") and [Scott McDonald](/Scott_McDonald "Scott McDonald") (**1984**). *Report from the U.S. Open*. [Computer Chess Digest Annual 1984](/Computer_Chess_Reports "Computer Chess Reports") pp. 15-33
10. [↑](#cite_ref-10) [Re: What is "pre-processing"](https://www.stmintz.com/ccc/index.php?id=18203) by [Ulrich Türke](/Ulrich_T%C3%BCrke "Ulrich Türke"), [CCC](/CCC "CCC"), May 08, 1998
11. [↑](#cite_ref-11) [Re: What is "pre-processing"](https://www.stmintz.com/ccc/index.php?id=18213) by [Amir Ban](/Amir_Ban "Amir Ban"), [CCC](/CCC "CCC"), May 08, 1998
12. [↑](#cite_ref-12) [Crafty accused of copying Fruit PST](http://www.talkchess.com/forum/viewtopic.php?t=40047) by William O, [CCC](/CCC "CCC"), August 13, 2011
13. [↑](#cite_ref-13) [Crafty \*NOT\* accused of copying Fruit PST](http://www.talkchess.com/forum/viewtopic.php?t=40085) by [Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora"), [CCC](/CCC "CCC"), August 17, 2011
14. [↑](#cite_ref-14) [The Imagery of Chess Revisited](https://shop.noguchi.org/imofchre.html)
15. [↑](#cite_ref-15) [Discovering The Imagery of Chess featuring Larry List](https://www.youtube.com/watch?v=vegmCb9j4kE), 2017, [YouTube](https://en.wikipedia.org/wiki/YouTube) Video
16. [↑](#cite_ref-16) [The Imagery of Chess -Surrealism and Chess](http://www.edochess.ca/batgirl/Imagery_of_Chess3.html)
