...
Source: https://www.chessprogramming.org/Robert_Holte

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Robert Holte**

[![](/images/thumb/4/4b/RobertHolte2.jpg/240px-RobertHolte2.jpg)](http://webdocs.cs.ualberta.ca/%7Eholte/)

Robert Holte[[1]](#cite_note-1)
...
He holds a B.Sc. (1977) and M.Sc. (1980) in Computer Science from [University of Manitoba](https://en.wikipedia.org/wiki/University_of_Manitoba), and a Ph.D. from [Brunel University London](https://en.wikipedia.org/wiki/Brunel_University_London) [[2]](#cite_note-2).
...
Robert Holte was member of the *University of Alberta Computer Poker Research Group* (CPRG) [[3]](#cite_note-3) .
...
- [Chris Drummond](/Mathematician#CDrummond "Mathematician"), Robert Holte (**2003**). *C4.5, Class Imbalance, and Cost Sensitivity: Why Under-Sampling beats Over-Sampling*. [ICML 2003 Workshop on Learning from Imbalanced Data Sets (II)](https://www.site.uottawa.ca/~nat/Workshop2003/workshop2003.html), [pdf](https://www.site.uottawa.ca/~nat/Workshop2003/drummondc.pdf) [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) [Robert Holte](http://webdocs.cs.ualberta.ca/~holte/)
2. [↑](#cite_ref-2) [Robert Holte - Personal Information](http://webdocs.cs.ualberta.ca/%7Eholte/cv20180802.pdf) (pdf)
3. [↑](#cite_ref-3) [CPRG Past Members](http://webdocs.cs.ualberta.ca/~games/poker/past_members.html)
4. [↑](#cite_ref-4) [Rob Holte - Publications](http://webdocs.cs.ualberta.ca/~holte/Publications/index.html)
5. [↑](#cite_ref-5) [dblp: Robert C. Holte](https://dblp.uni-trier.de/pers/h/Holte:Robert_C=.html)
6. [↑](#cite_ref-6) [Receiver operating characteristic from Wikipedia](https://en.wikipedia.org/wiki/Receiver_operating_characteristic)
7. [↑](#cite_ref-7) [C4.5 algorithm from Wikipedia](https://en.wikipedia.org/wiki/C4.5_algorithm) » [Ross Quinlan](/Ross_Quinlan "Ross Quinlan")
8. [↑](#cite_ref-8) [Iterative deepening A\* from Wikipedia](https://en.wikipedia.org/wiki/Iterative_deepening_A*)
