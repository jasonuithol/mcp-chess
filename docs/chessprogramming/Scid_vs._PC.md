...
Source: https://www.chessprogramming.org/Scid_vs._PC

**[Home](/Main_Page "Main Page") \* [User Interface](/User_Interface "User Interface") \* [GUI](/GUI "GUI") \* Scid vs. PC**  
**[Home](/Main_Page "Main Page") \* [Software](/Software "Software") \* [Databases](/Databases "Databases") \* Scid vs. PC**

[![](/images/b/b0/Scidvspclogo.jpg)](http://scidvspc.sourceforge.net/images/)

Scid vs. PC Logo [[1]](#cite_note-1)
...
It is a fork of [Shane Hudson's](/Shane_Hudson "Shane Hudson") Chess Information Database ([SCID](/SCID "SCID")), started in 2009 by [Steven Atkinson](/Steven_Atkinson "Steven Atkinson"), and requires installation of [Tcl/Tk](/index.php?title=Tcl-Tk&action=edit&redlink=1 "Tcl-Tk (page does not exist)") [[2]](#cite_note-2). Scid vs. PC runs under [Linux](/Linux "Linux"), [Mac OS](/Mac_OS "Mac OS") and [Windows](/Windows "Windows") computers, supporting [Chess Engine Communication Protocol](/Chess_Engine_Communication_Protocol "Chess Engine Communication Protocol") and [UCI](/UCI "UCI") compliant engines.
...
[![Scidvspc.jpg](/images/6/6c/Scidvspc.jpg)](http://scidvspc.sourceforge.net/images/scidvspc.png)
...
1. [↑](#cite_ref-1) Images from [Scid vs. PC - Index of /images](http://scidvspc.sourceforge.net/images/)
2. [↑](#cite_ref-2) [Tcl/Tk](https://www.activestate.com/products/activetcl/downloads/)
