...
Source: https://www.chessprogramming.org/Computer_Chess_Reports

**[Home](/Main_Page "Main Page") \* [Periodical](/Periodical "Periodical") \* Computer Chess Reports**
...
Quote from [rec.games.chess.computer](/Computer_Chess_Forums "Computer Chess Forums") FAQ: [[1]](#cite_note-1):

```
Computer Chess Reports published quarterly by ICD Corporation, 21 Walt Whitman Road, Huntington Station, NY 11746.  Phone 800-645-4710.  Subscriptions are $18/year.  Focuses on computer chess, and rates dedicated chess-playing computers and software. This is worth looking at.
```
...
1. [↑](#cite_ref-1) [rec.games.chess.compute FAQ (1/3)](http://www.faqs.org/faqs/games/chess/computer/part1/) covers IDC's Computer Chess Reports
