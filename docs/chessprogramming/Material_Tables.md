...
Source: https://www.chessprogramming.org/Material_Tables

**[Home](/Main_Page "Main Page") \* [Evaluation](/Evaluation "Evaluation") \* [Material](/Material "Material") \* Material Tables**
...
Material tables along with imbalance tables, first appeared in [Jury Osipov's](/Jury_Osipov "Jury Osipov") disputed [[1]](#cite_note-1) [open source engine](/Category:Open_Source "Category:Open Source") [Strelka 2.0](/Strelka "Strelka"), apparently [reverse engineered](https://en.wikipedia.org/wiki/Reverse_engineering) from [Rybka 1.0](/Rybka "Rybka") [[2]](#cite_note-2) [[3]](#cite_note-3). Indices were initialized that way - with [bitboards](/Bitboards "Bitboards") even the [population count](/Population_Count "Population Count") of a [board-definition](/Bitboard_Board-Definition "Bitboard Board-Definition") is used:
...
In 2010, [Harm Geert Muller](/Harm_Geert_Muller "Harm Geert Muller") proposed a similar, cache friendlier scheme for common minor piece exchanges, by altering rooks, bishops and knights with appropriate offsets [[4]](#cite_note-4) .
...
1. [↑](#cite_ref-1) [Strelka controversy from Wikipedia](https://en.wikipedia.org/wiki/Rybka#Strelka_controversy)
2. [↑](#cite_ref-2) [Strelka 2.0](http://rybkaforum.net/cgi-bin/rybkaforum/topic_show.pl?tid=3006) by [Vasik Rajlich](/Vasik_Rajlich "Vasik Rajlich"), [Rybka Forum](/Computer_Chess_Forums "Computer Chess Forums"), January 11, 2008
3. [↑](#cite_ref-3) [A Material Base for everybody](http://www.top-5000.nl/mb.htm) from [Home of the Dutch Rebel](http://www.top-5000.nl/) by [Ed Schröder](/Ed_Schroder "Ed Schroder")
4. [↑](#cite_ref-4) [Cache-friendier material index](http://www.talkchess.com/forum/viewtopic.php?t=33561) by [Harm Geert Muller](/Harm_Geert_Muller "Harm Geert Muller"), [CCC](/CCC "CCC"), March 31, 2010
