...
Source: https://www.chessprogramming.org/Chess_Assistant

**[Home](/Main_Page "Main Page") \* [User Interface](/User_Interface "User Interface") \* [GUI](/GUI "GUI") \* Chess Assistant**  
**[Home](/Main_Page "Main Page") \* [Software](/Software "Software") \* [Databases](/Databases "Databases") \* Chess Assistant**

[![](/images/thumb/e/ef/CA13_2.jpg/300px-CA13_2.jpg)](http://chessok.com/?page_id=27628)

Chess Assistant Screen [[1]](#cite_note-1)

**Chess Assistant**,  
a chess [GUI](/GUI "GUI") and [database](/Databases "Databases") developed by a team around [Victor Zakharov](/Victor_Zakharov "Victor Zakharov") since 1988 [[2]](#cite_note-2), commercially distributed via [ChessOK](/ChessOK "ChessOK"), a brand name of Convekta Ltd., early versions running under [MS-DOS](/MS-DOS "MS-DOS"), subsequent versions under [Windows](/Windows "Windows"). The sophisticated GUI allows to search and edit games in a database, probe endgame tablebases, to edit games for web publishing, and is also [front end](https://en.wikipedia.org/wiki/Front_and_back_ends) for playing chess online.

Chess Assistant 24 is bundled with [Rybka 4](/Rybka "Rybka") , [Stockfish 16](/Stockfish "Stockfish"), a database of millions of games, and a trial subscription to Chess King learn courses[[3]](#cite_note-3).
...
- [ChessAssistant is also available on runway 24](https://talkchess.com/forum3/viewtopic.php?f=2&t=83004) by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky"), [CCC](/CCC "CCC"), December 12, 2023

# External Links

- [Chess Assistant 24 - ChessOK.com](https://shop.chessok.com/index.php?main_page=product_info&cPath=7_54&products_id=979)
...
1. [↑](#cite_ref-1) [Chess Assistant 17 with Houdini 5: ChessOK](http://chessok.com/?page_id=27628)
2. [↑](#cite_ref-2) [About - ChessOK.com](http://chessok.com/?page_id=262)
3. [↑](#cite_ref-3) [Chess Assistant 24 - ChessOK.com](https://shop.chessok.com/index.php?main_page=product_info&cPath=7_54&products_id=979)
