...
Source: https://www.chessprogramming.org/JS_Schach

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* JS Schach**
...
1. [↑](#cite_ref-1) [GitHub - rchastain/moustique: UCI chess engine derived from a didactic program by Jürgen Schlottke](https://github.com/rchastain/moustique)
2. [↑](#cite_ref-2) [Re: JS Schach's alpha-beta approximation](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=75478&start=11) [Rasmus Althoff](/Rasmus_Althoff "Rasmus Althoff"), [CCC](/CCC "CCC"), October 21, 2020
3. [↑](#cite_ref-3) [moustique/schach.txt at master · rchastain/moustique · GitHub | maxwertung](https://github.com/rchastain/moustique/blob/master/original/schach.txt#L551)
