...
Source: https://www.chessprogramming.org/Type_B_Strategy

**[Home](/Main_Page "Main Page") \* [Search](/Search "Search") \* Type B Strategy**

The **Type B Strategy**, proposed in 1949 by [Claude Shannon](/Claude_Shannon "Claude Shannon") in his groundbreaking publication *Programming a Computer for Playing Chess* [[1]](#cite_note-1), is a [selective](/Selectivity "Selectivity") approach to search [minimax](/Minimax "Minimax") [trees](/Search_Tree "Search Tree") considering only a subset of plausible moves in contrast to the [brute-force](/Brute-Force "Brute-Force") [Type A strategy](/Type_A_Strategy "Type A Strategy").
