...
Source: https://www.chessprogramming.org/Nicu_Ionita

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Nicu Ionita**

[![](/images/e/e6/NicuIonita.jpg)](https://github.com/nionita)

Nicu Ionita [[1]](#cite_note-1)
...
He is now author of the [UCI](/UCI "UCI") compliant [open source chess engines](/Category:Open_Source "Category:Open Source") [Abulafia](/Abulafia "Abulafia") [[2]](#cite_note-2) and [Barbarossa](/Barbarossa "Barbarossa") [[3]](#cite_note-3),
and of *chessNet* to connect chess engines to an UCI compatible [GUI](/GUI "GUI") via [TCP/IP](https://en.wikipedia.org/wiki/Internet_protocol_suite) [[4]](#cite_note-4), all written in [Haskell](/index.php?title=Haskell&action=edit&redlink=1 "Haskell (page does not exist)").
...
1. [↑](#cite_ref-1) [nionita (Nicu Ionita) · GitHub](https://github.com/nionita)
2. [↑](#cite_ref-2) [Abulafia, chess, Haskell and some (new?) ideas](http://www.talkchess.com/forum/viewtopic.php?t=43384) by Nicu Ionita, [CCC](/CCC "CCC"), April 20, 2012
3. [↑](#cite_ref-3) [Barbarossa 0.1.0](http://www.talkchess.com/forum/viewtopic.php?t=50213) by Nicu Ionita, [CCC](/CCC "CCC"), November 24, 2013
4. [↑](#cite_ref-4) [nionita/chessNet · GitHub](https://github.com/nionita/chessNet)
