...
1. [↑](#cite_ref-1) Symmetric Multiprocessor System, [image](https://commons.wikimedia.org/wiki/File:SMP_-_Symmetric_Multiprocessor_System.svg) by Ferry24.Milan, November 01, 2011, [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons), [Symmetric multiprocessing from Wikipedia](https://en.wikipedia.org/wiki/Symmetric_multiprocessing)
2. [↑](#cite_ref-2) [Symmetric Multiprocessing - OSDev Wiki](http://wiki.osdev.org/Symmetric_Multiprocessing)
3. [↑](#cite_ref-3) [NUMA Frequently Asked Questions - 9. Why should I use NUMA? What are the benefits of NUMA?](http://lse.sourceforge.net/numa/faq/)
