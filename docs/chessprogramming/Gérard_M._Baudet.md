...
Source: https://www.chessprogramming.org/Gérard_M._Baudet

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Gérard M. Baudet**

[![](/images/thumb/a/ae/Gerardbaudet1.jpg/200px-Gerardbaudet1.jpg)](https://www.cs.uri.edu/about-us/people/gerard-baudet/)

Gérard M. Baudet [[1]](#cite_note-1)
...
in [Paris-Rocquencourt](https://en.wikipedia.org/wiki/Rocquencourt). He holds a Ph.D. from [Carnegie Mellon University](/Carnegie_Mellon_University "Carnegie Mellon University") in 1978 on *The Design and Analysis of Algorithms for Asynchronous Multiprocessors* [[2]](#cite_note-2), and researched on [Alpha-Beta](/Alpha-Beta "Alpha-Beta") and [Parallel Search](/Parallel_Search "Parallel Search").
...
- Gérard M. Baudet (**1978**). *[Asynchronous Iterative Methods for Multiprocessors](https://www.semanticscholar.org/paper/Asynchronous-Iterative-Methods-for-Multiprocessors-Baudet/aeb50872722ccd2e606640cac1c46b684ed34136)*. [Journal of the ACM](/ACM#Journal "ACM"), Vol. 25, No. 2 [[4]](#cite_note-4)
...
1. [↑](#cite_ref-1)  [Associate Professor Gerard Baudet](https://www.cs.uri.edu/about-us/people/gerard-baudet/) from [University of Rhode Island](https://en.wikipedia.org/wiki/University_of_Rhode_Island)
2. [↑](#cite_ref-2) Gérard M. Baudet (**1978**). *The Design and Analysis of Algorithms for Asynchronous Multiprocessors*. Ph.D. thesis, [Carnegie Mellon University](/Carnegie_Mellon_University "Carnegie Mellon University"), advisor [Hsiang-Tsung Kung](/Mathematician#Kung "Mathematician")
3. [↑](#cite_ref-3) [dblp: Gérard M. Baudet](https://dblp.uni-trier.de/pers/hd/b/Baudet:G=eacute=rard_M=)
4. [↑](#cite_ref-4) [Journal of the ACM Bibliography - Gérard M. Baudet](http://projects.csail.mit.edu/jacm/References/baudet1978:226.html)
