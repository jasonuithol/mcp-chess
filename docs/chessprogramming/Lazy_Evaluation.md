...
1. [↑](#cite_ref-1) [Heinrich Kley](/Category:Heinrich_Kley "Category:Heinrich Kley") - Das Kränzchen. Federzeichnung (aus: Skizzenbuch I, 1909)
2. [↑](#cite_ref-2) In general computer programming, [Lazy evaluation](https://en.wikipedia.org/wiki/Lazy_evaluation) refers a technique of delaying a computation until the result is required.
