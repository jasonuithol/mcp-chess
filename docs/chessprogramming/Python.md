...
Source: https://www.chessprogramming.org/Python

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* [Languages](/Languages "Languages") \* Python**
...
Python features a [dynamic type system](https://en.wikipedia.org/wiki/Type_system#Dynamic_type-checking_and_runtime_type_information) and automatic [memory management](/Memory#Management "Memory") and has a large [standard library](https://en.wikipedia.org/wiki/Standard_library) [[1]](#cite_note-1).
While used as [scripting language](https://en.wikipedia.org/wiki/Scripting_language) along with a Python interpreter available for many operating systems, Python code can be packaged into standalone executable programs [[2]](#cite_note-2).
...
- [LMR at CUT nodes can be arbitrarily bad!](http://www.talkchess.com/forum/viewtopic.php?t=48356) by [Michel Van den Bergh](/Michel_Van_den_Bergh "Michel Van den Bergh"), [CCC](/CCC "CCC"), June 20, 2013 » [Late Move Reductions](/Late_Move_Reductions "Late Move Reductions"), [Node Types](/Node_Types "Node Types") [[3]](#cite_note-3)
...
- [Package chess](http://www.sdragons.org/Software/Python/chess.html) by [Hugh S. Myers](/Hugh_S._Myers "Hugh S. Myers") [[5]](#cite_note-5)

# References

1. [↑](#cite_ref-1) [The Python Standard Library — Python 3.7.4 documentation](https://docs.python.org/3.7/library/index.html)
2. [↑](#cite_ref-2) [Python (programming language) from Wikipedia](https://en.wikipedia.org/wiki/Python_%28programming_language%29)
3. [↑](#cite_ref-3) [Aggressive LMR at predicted CUT nodes but not at predicted ALL nodes in Python](http://hardy.uhasselt.be/Toga/random_LMR_at_CUT_nodes.py)
4. [↑](#cite_ref-4) [Connect 4 AlphaZero implemented using Python...](http://www.talkchess.com/forum/viewtopic.php?t=66443) by [Steve Maughan](/Steve_Maughan "Steve Maughan"), [CCC](/CCC "CCC"), January 29, 2018
5. [↑](#cite_ref-5) [chess.py.txt](http://www.sdragons.org/Software/Python/chess.py.txt)
