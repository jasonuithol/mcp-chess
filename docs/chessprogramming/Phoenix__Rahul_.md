...
Source: https://www.chessprogramming.org/Phoenix_(Rahul)

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Phoenix (Rahul)**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Planter_des_platanes_pour_attirer_le_Phoenix.JPG/330px-Planter_des_platanes_pour_attirer_le_Phoenix.JPG)](/File:Planter_des_platanes_pour_attirer_le_Phoenix.JPG)

Phoenix Plant Sculpture [[1]](#cite_note-1)
...
After 1000 games [[2]](#cite_note-2), the modified engine Phoenix apparently outperformed its parent CuckooChess with a rating of 2546 (an increase of 19 points) [[3]](#cite_note-3).
After investigations by the original CuckooChess author, he found Phoenix played all games with White! Further, by using the published piece-square tables, Peter Österlund found the modified version around 400 elo weaker than the original, assuming [Hanlon's razor](https://en.wikipedia.org/wiki/Hanlon's_razor) applied [[4]](#cite_note-4).
...
3. [↑](#cite_ref-3)  [Phoenix: A Self-Learning Chess Engine](http://rahular.com/phoenix/) - 4.3: Results
4. [↑](#cite_ref-4) [Re: PHOENIX=CuckooChess with learning function in Falcon style](http://www.talkchess.com/forum/viewtopic.php?t=55476&start=4) by [Peter Österlund](/Peter_%C3%96sterlund "Peter Österlund"), [CCC](/CCC "CCC"), March 20, 2016
