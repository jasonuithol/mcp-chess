...
Source: https://www.chessprogramming.org/WChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* WChess**

**WChess**,  
a commercial chess program by [David Kittinger](/David_Kittinger "David Kittinger"), running on [x86](/X86 "X86") [PCs](/IBM_PC "IBM PC") in 32-bit [real mode](https://en.wikipedia.org/wiki/Real_mode) under the [MS-DOS](/MS-DOS "MS-DOS") operating system. WChess participated at the [ACM 1994](/ACM_1994 "ACM 1994"), the [Harvard Cup 1994](/Harvard_Cup_1994 "Harvard Cup 1994") with sensational 5/6, the [UPCCC 1994](/UPCCC_1994 "UPCCC 1994") winning ahead of [HIARCS](/HIARCS "HIARCS") and [MChess](/MChess "MChess"), and the [WCCC 1995](/WCCC_1995 "WCCC 1995"). WChess is the chess engine of [Sierra's](/Sierra "Sierra") [Power Chess](/Power_Chess "Power Chess") [[1]](#cite_note-1), market since 1996 as [Windows 95](/Windows "Windows") program [[2]](#cite_note-2), and of [Interplay's](/index.php?title=Interplay&action=edit&redlink=1 "Interplay (page does not exist)") [USCF Chess](/USCF_Chess "USCF Chess") from 1998 [[3]](#cite_note-3).

# Screenshot

[![Wchess 10.gif](/images/7/7f/Wchess_10.gif)](http://www.schachcomputer.info/forum/f10/geschwindigkeits-vergleiche-4059.html)

WChess inside [DOSBox](https://en.wikipedia.org/wiki/DOSBox) [[4]](#cite_note-4)

# Descriptions

## 1995

given in 1995 from the [ICGA](/ICGA "ICGA") tournament site [[5]](#cite_note-5):
...
1. [↑](#cite_ref-1) [Meet the Authors](http://www.rebel.nl/authors.htm) by [Ed Schröder](/Ed_Schroder "Ed Schroder")
2. [↑](#cite_ref-2) [Power Chess from Wikipedia](https://en.wikipedia.org/wiki/Power_Chess)
3. [↑](#cite_ref-3) [USCF Chess for Windows (1998) - MobyGames](http://www.mobygames.com/game/uscf-chess)
4. [↑](#cite_ref-4) [Studie: Geschwindigkeits Vergleiche - Schachcomputer.info Community](http://www.schachcomputer.info/forum/f10/geschwindigkeits-vergleiche-4059.html) by [Spacious Mind](/The_Spacious_Mind "The Spacious Mind"), November 12, 2011 (German)
5. [↑](#cite_ref-5) [WChess' ICGA Tournaments](https://www.game-ai-forum.org/icga-tournaments/program.php?id=184)
6. [↑](#cite_ref-6) [Re: Hello all](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=462584&t=43447) by [David Kittinger](/David_Kittinger "David Kittinger"), [CCC](/CCC "CCC"), April 25, 2012
7. [↑](#cite_ref-7) [Re: Hello all](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=462734&t=43447) by [Dave Kittinger](/David_Kittinger "David Kittinger"), [CCC](/CCC "CCC"), April 27, 2012
8. [↑](#cite_ref-8) [Hoyle Majestic Chess Review - GameSpot.com](http://www.gamespot.com/hoyle-majestic-chess/reviews/hoyle-majestic-chess-review-6074888/)
9. [↑](#cite_ref-9) [Disney's Aladdin Chess Adventures for Windows (2004) - MobyGames](http://www.mobygames.com/game/disneys-aladdin-chess-adventures)
