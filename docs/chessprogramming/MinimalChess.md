...
Source: https://www.chessprogramming.org/MinimalChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* MinimalChess**

[![](https://upload.wikimedia.org/wikipedia/commons/2/2a/ELEMENT_LVIII-Animation_Alfio_Guiffrida-AG_Sinnwerke.gif)](/File:ELEMENT_LVIII-Animation_Alfio_Guiffrida-AG_Sinnwerke.gif)

ELEMENT LVIII-Animation [[1]](#cite_note-1)

**MinimalChess**,  
an [UCI](/UCI "UCI") compliant, didactic [open source chess program](/Category:Open_Source "Category:Open Source") by [Thomas Jahn](/Thomas_Jahn "Thomas Jahn"), written in [C#](/C_sharp "C sharp"), and first released as MinimalChess **0.2** in February 2021 [[2]](#cite_note-2).
...
1. [↑](#cite_ref-1) [Alfio Giuffrida](/index.php?title=Category:Alfio_Giuffrida&action=edit&redlink=1 "Category:Alfio Giuffrida (page does not exist)") - [AG Sinnwerke, ELEMENT LVIII-Animation](https://commons.wikimedia.org/wiki/File:ELEMENT_LVIII-Animation_Alfio_Guiffrida-AG_Sinnwerke.gif), [Category:Minimalism](https://commons.wikimedia.org/wiki/Category:Minimalism), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [MinimalChess 0.2 released](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=76560) by [Thomas Jahn](/Thomas_Jahn "Thomas Jahn"), [CCC](/CCC "CCC"), February 12, 2021
3. [↑](#cite_ref-3) [GitHub - lithander/MinimalChessEngine](https://github.com/lithander/MinimalChessEngine)
