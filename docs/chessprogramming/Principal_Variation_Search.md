...
**[Home](/Main_Page "Main Page") \* [Search](/Search "Search") \* Principal Variation Search**

[![](/images/b/ba/Cage-variations-iii-14-small.jpg)](https://en.wikipedia.org/wiki/File:Cage-variations-iii-14-small.jpg)

[John Cage](/Category:John_Cage "Category:John Cage") - Variations III, No. 14 [[1]](#cite_note-1)
...
Often, programmers template PVS to a pure [PV-node](/Node_Types#PV "Node Types") search and a separate [scout search](/Scout "Scout") with [null windows](/Null_Window "Null Window").
