...
Source: https://www.chessprogramming.org/Brainless_(Forth)
...
[[1]](#cite_note-1).
Brainless is written in [ANS Forth](/Forth "Forth") [[2]](#cite_note-2), and uses the Forth terminal via [ANSI](https://en.wikipedia.org/wiki/ANSI_escape_code) [color terminals](https://en.wikipedia.org/wiki/Computer_terminal#Graphical_terminals) and [Unicode](/2D_Graphics_Board#Unicode "2D Graphics Board") chess piece glyphs for [quasi-graphical display](/Graphics_Programming "Graphics Programming") to [interact with the user](/User_Interface "User Interface").
...
1. [↑](#cite_ref-1) [brainless - Browse Files at SourceForge.net](https://sourceforge.net/projects/forth-brainless/files/)
2. [↑](#cite_ref-2) [Using ANS Forth](http://www.forth.org/ansforth/ansforth.html)
