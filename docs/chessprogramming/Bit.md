...
Source: https://www.chessprogramming.org/Bit

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* [Data](/Data "Data") \* Bit**

[![](/images/6/6b/Flipflop6as.jpg)](http://ljkrakauer.com/LJK/essays/bits.htm)

[PDP-6](/PDP-6 "PDP-6") [flip-flop](/Memory#FlipFlop "Memory") stores one bit [[1]](#cite_note-1)
...
by [Claude Shannon](/Claude_Shannon "Claude Shannon") in *A Mathematical Theory of Communication* 1948 [[2]](#cite_note-2):
...
:   [Least Significant One Bit](/General_Setwise_Operations#TheLeastSignificantOneBitLS1B "General Setwise Operations")
:   [Most Significant One Bit](/General_Setwise_Operations#TheMostSignificantOneBitMS1B "General Setwise Operations")
...
2. [↑](#cite_ref-2) [Claude Shannon](/Claude_Shannon "Claude Shannon") (**1948**). *A Mathematical Theory of Communication*, [pdf reprint](http://cm.bell-labs.com/cm/ms/what/shannonday/shannon1948.pdf)
