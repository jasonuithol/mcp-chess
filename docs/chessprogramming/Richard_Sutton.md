...
Source: https://www.chessprogramming.org/Richard_Sutton

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Richard Sutton**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Richard_Sutton%2C_October_27%2C_2016.jpg/250px-Richard_Sutton%2C_October_27%2C_2016.jpg)](/File:Richard_Sutton,_October_27,_2016.jpg)

Richard Sutton [[1]](#cite_note-1)

**Richard Stuart Sutton**,  
an American computer scientist and [AI](/Artificial_Intelligence "Artificial Intelligence")-researcher. Since 2003, Richard S. Sutton is a professor in the Department of Computing Science [[2]](#cite_note-2) at the [University of Alberta](/University_of_Alberta "University of Alberta") and is principal investigator of the [Reinforcement Learning](/Reinforcement_Learning "Reinforcement Learning") and [Artificial Intelligence](/Artificial_Intelligence "Artificial Intelligence") (RLAI) [[3]](#cite_note-3) group. Rich's research interests center on the [learning](/Learning "Learning") problems facing a decision-maker interacting with its environment, which he sees as central to artificial intelligence. He is the author of the original paper on [Temporal Difference Learning](/Temporal_Difference_Learning "Temporal Difference Learning") [[4]](#cite_note-4) and, with [Andrew Barto](/Andrew_Barto "Andrew Barto"), of the textbook *Reinforcement Learning: An Introduction* [[5]](#cite_note-5) . He is also interested in animal learning psychology, in [connectionist](https://en.wikipedia.org/wiki/Connectionism) networks, and generally in systems that continually improve their representations and models of the world [[6]](#cite_note-6) .
...
1. [↑](#cite_ref-1) Richard Sutton, October 27, 2016, Image source [Deep Thinkers on Deep Learning](https://www.flickr.com/photos/jurvetson/29973061793/), Author [Jurvetson](https://www.flickr.com/people/44124348109@N01Steve), [Menlo Park](https://en.wikipedia.org/wiki/Menlo_Park,_California), USA
2. [↑](#cite_ref-2) [Home | Department of Computing Science](http://www.cs.ualberta.ca/)
3. [↑](#cite_ref-3) [Reinforcement Learning and Artificial Intelligence (RLAI)](http://rlai.cs.ualberta.ca/RLAI/ualberta.html)
4. [↑](#cite_ref-4) Richard Sutton (**1988**). *Learning to Predict by the Methods of Temporal Differences*. [Machine Learning](https://en.wikipedia.org/wiki/Machine_Learning_(journal)), Vol. 3, No. 1
5. [↑](#cite_ref-5) [Reinforcement Learning: An Introduction](http://incompleteideas.net/book/the-book.html) ebook by Richard Sutton and [Andrew Barto](/Andrew_Barto "Andrew Barto")
6. [↑](#cite_ref-6) [Brief Biography for Richard Sutton](http://incompleteideas.net/BriefBio.html)
7. [↑](#cite_ref-7) [dblp: Richard S. Sutton](http://dblp.uni-trier.de/pers/hd/s/Sutton:Richard_S=)
