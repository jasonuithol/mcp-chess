...
Source: https://www.chessprogramming.org/David_E._Moriarty

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* David E. Moriarty**

**David Eric Moriarty**,  
an American computer scientist an Ph.D. alumni from [University of Texas at Austin](https://en.wikipedia.org/wiki/University_of_Texas_at_Austin) [[1]](#cite_note-1).
During the 90s, along with his advisor, [Risto Miikkulainen](/Risto_Miikkulainen "Risto Miikkulainen"), David E. Moriarty worked on [reinforcement learning](/Reinforcement_Learning "Reinforcement Learning") by [Symbiotic](https://en.wikipedia.org/wiki/Symbiosis), Adaptive [NeuroEvolution](https://en.wikipedia.org/wiki/Neuroevolution) dubbed SANE, also topic of his Ph.D. thesis [[2]](#cite_note-2).
...
performing following basic steps in one generation [[3]](#cite_note-3):
...
In the [alpha-beta](/Alpha-Beta "Alpha-Beta") search of the Othello experiment, the neural network [orders the moves](/Move_Ordering "Move Ordering"), and further controls whether moves are [pruned forward](/Pruning "Pruning") [[4]](#cite_note-4).
...
- David E. Moriarty, [Risto Miikkulainen](/Risto_Miikkulainen "Risto Miikkulainen") (**1996**). *[Efficient Reinforcement Learning through Symbiotic Evolution](http://nn.cs.utexas.edu/?moriarty:mlj96)*. [Machine Learning](https://en.wikipedia.org/wiki/Machine_Learning_(journal)), Vol. 22 [[6]](#cite_note-6)
...
1. [↑](#cite_ref-1) [NNRG People - David E. Moriarty](http://nn.cs.utexas.edu/?moriarty)
2. [↑](#cite_ref-2) David E. Moriarty (**1997**). *[Symbiotic Evolution of Neural Networks in Sequential Decision Tasks](http://nn.cs.utexas.edu/?moriarty:phd97)*. Ph.D. thesis, [University of Texas at Austin](https://en.wikipedia.org/wiki/University_of_Texas_at_Austin), advisor [Risto Miikkulainen](/Risto_Miikkulainen "Risto Miikkulainen")
3. [↑](#cite_ref-3) David E. Moriarty, [Risto Miikkulainen](/Risto_Miikkulainen "Risto Miikkulainen") (**1996**). *[Efficient Reinforcement Learning through Symbiotic Evolution](http://nn.cs.utexas.edu/?moriarty:mlj96)*. [Machine Learning](https://en.wikipedia.org/wiki/Machine_Learning_(journal)), Vol. 22
4. [↑](#cite_ref-4) David E. Moriarty, [Risto Miikkulainen](/Risto_Miikkulainen "Risto Miikkulainen") (**1994**). *[Evolving Neural Networks to focus Minimax Search](http://nn.cs.utexas.edu/?moriarty:aaai94)*. [AAAI-94](/Conferences#AAAI-94 "Conferences")
5. [↑](#cite_ref-5) [dblp: David E. Moriarty](https://dblp.uni-trier.de/pers/hd/m/Moriarty:David_E=)
6. [↑](#cite_ref-6) [Inverted pendulum from Wikipedia](https://en.wikipedia.org/wiki/Inverted_pendulum)
