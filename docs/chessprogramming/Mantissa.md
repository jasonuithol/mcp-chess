...
Source: https://www.chessprogramming.org/Mantissa

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Mantissa**

[![](/images/thumb/c/cc/Mantissa_logo_minimal.png/300px-Mantissa_logo_minimal.png)](/File:Mantissa_logo_minimal.png)

Mantissa's Logo [[1]](#cite_note-1) [[2]](#cite_note-2)
...
licensed under the [GPL v3.0](/Free_Software_Foundation#GPL "Free Software Foundation"), first released in September 2021 [[3]](#cite_note-3).
...
1. [↑](#cite_ref-1) [mantissa/mantissa\_logo\_minimal.png at master · jtheardw/mantissa · GitHub](https://github.com/jtheardw/mantissa/blob/master/logos/mantissa_logo_minimal.png)
2. [↑](#cite_ref-2) [NaN from Wikipedia](https://en.wikipedia.org/wiki/NaN)
3. [↑](#cite_ref-3) [New Engine: Mantissa](https://kirill-kryukov.com/chess/discussion-board/viewtopic.php?t=13339) by [Jeremy Wright](/index.php?title=Jeremy_Wright&action=edit&redlink=1 "Jeremy Wright (page does not exist)"), [CCRL Discussion Board](/Computer_Chess_Forums "Computer Chess Forums"), September 19, 2021
4. [↑](#cite_ref-4) [mantissa/README.md at master · jtheardw/mantissa · GitHub](https://github.com/jtheardw/mantissa/blob/master/README.md)
