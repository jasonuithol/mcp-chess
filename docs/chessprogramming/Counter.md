...
Source: https://www.chessprogramming.org/Counter

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Counter**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/CountersMechanical.agr.jpg/330px-CountersMechanical.agr.jpg)](/File:CountersMechanical.agr.jpg)

Mechanical Counters [[1]](#cite_note-1)

**Counter**, (Счетчик)  
an [UCI](/UCI "UCI") compliant chess engine by [Vadim Chizhov](/index.php?title=Vadim_Chizhov&action=edit&redlink=1 "Vadim Chizhov (page does not exist)"), initially written in [C#](/C_sharp "C sharp") to run under [Windows](/Windows "Windows") [.Net](https://en.wikipedia.org/wiki/.NET_Framework), available since early 2007 [[2]](#cite_note-2).
Counter 0.8 played a strong [CCCCISC 2008](/CCCCISC_2008 "CCCCISC 2008") over the board. Counter was then ported to the [Go programming language](/Go_(Programming_Language) "Go (Programming Language)") and released in May 2017 as [open source](/Category:Open_Source "Category:Open Source") at [GitHub](https://en.wikipedia.org/wiki/GitHub), dubbed [CounterGo](#CounterGo) [[3]](#cite_note-3).

# Counter C#

According to the *sdchess description*, Counter is based on [bitboards](/Bitboards "Bitboards") using [Pradu Kannan's](/Pradu_Kannan "Pradu Kannan") [magic bitboard](/Magic_Bitboards "Magic Bitboards") implementation to [generate moves](/Move_Generation "Move Generation") [[4]](#cite_note-4),
while the Counter 1.2 readme claims a hybrid [board representation](/Board_Representation "Board Representation") consisting of a [10x12 board](/10x12_Board "10x12 Board") and bitboards for pawns [[5]](#cite_note-5).
...
- [Dense Bitboard Board Definition](/Bitboard_Board-Definition#SixTwo "Bitboard Board-Definition") [[6]](#cite_note-6)
- [Magic Bitboards](/Magic_Bitboards "Magic Bitboards")

## [Search](/Search "Search")

- [Lazy SMP](/Lazy_SMP "Lazy SMP") [[7]](#cite_note-7) using Goroutines [[8]](#cite_note-8)
...
[CCCCISC 2008](/CCCCISC_2008 "CCCCISC 2008"), round 5, Counter - [SmarThink](/SmarThink "SmarThink") [[9]](#cite_note-9)
...
1. [↑](#cite_ref-1) Three mechanical counters by [Arnold Reinhold](https://commons.wikimedia.org/wiki/User:ArnoldReinhold), April 20, 2009, [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons), [Counter (digital) from Wikipedia](https://en.wikipedia.org/wiki/Counter_(digital))
2. [↑](#cite_ref-2) [Counter 1.2 Updated](http://www.talkchess.com/forum/viewtopic.php?t=32564) by [Swaminathan](/Swaminathan_Natarajan "Swaminathan Natarajan"), [CCC](/CCC "CCC"), February 12, 2010
3. [↑](#cite_ref-3) [New version of Counter (in Go language)](http://www.talkchess.com/forum/viewtopic.php?t=64099) by [Günther Simon](/G%C3%BCnther_Simon "Günther Simon"), [CCC](/CCC "CCC"), May 27, 2017
4. [↑](#cite_ref-4) [Counter by Вадим Чижов (Vadim Chizhov), Russia!](http://www.sdchess.ru/Counter.htm) from [sdchess.ru](http://www.sdchess.ru/)
5. [↑](#cite_ref-5) Counter\_12 - readme.txt
6. [↑](#cite_ref-6) [CounterGo/types.go at master · ChizhovVadim/CounterGo · GitHub](https://github.com/ChizhovVadim/CounterGo/blob/master/common/types.go)
7. [↑](#cite_ref-7) [CounterGo/search.go at master · ChizhovVadim/CounterGo · GitHub](https://github.com/ChizhovVadim/CounterGo/blob/master/engine/search.go)
8. [↑](#cite_ref-8) [Effective Go - The Go Programming Language - Concurrency](https://golang.org/doc/effective_go.html#concurrency)
9. [↑](#cite_ref-9) [The The First championship of the CIS (Первый официальный чемпионат СНГ)](http://www.sdchess.ru/Tournaments/Cis_official_1.htm) from [sdchess.ru](http://www.sdchess.ru/)
