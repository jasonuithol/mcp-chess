...
Source: https://www.chessprogramming.org/GNU_Chess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* GNU Chess**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Heckert_GNU_white.svg/330px-Heckert_GNU_white.svg.png)](/File:Heckert_GNU_white.svg)

A Bold GNU Head [[1]](#cite_note-1)

**GNU Chess**,  
the [open source chess engine](/Category:Open_Source "Category:Open Source") of the [Free Software Foundation](/Free_Software_Foundation "Free Software Foundation"). GNU Chess was initially written by [Stuart Cracraft](/Stuart_Cracraft "Stuart Cracraft") in the mid 80s, joined by [John Stanback](/John_Stanback "John Stanback") who contributed his [own code](/SCP "SCP") to GNU Chess 2 and 3 which was laboriously and meticulously well-written [[2]](#cite_note-2). Dozens of developers have enhanced GNU Chess over the times. Version 5 was a complete rewrite by [Chua Kong Sian](/Chua_Kong_Sian "Chua Kong Sian"), incorporating his chess program [Cobalt](/Cobalt "Cobalt") and Cracraft's [Gazebo](/Gazebo "Gazebo") [[3]](#cite_note-3). [Fabien Letouzey](/Fabien_Letouzey "Fabien Letouzey") is the primary author of GNU Chess 6, based on [Fruit 2.1](/Fruit "Fruit") [[4]](#cite_note-4).

# Fidelity Match

In 1990, GNU Chess 1.55 with [Hans Eric Sandström's](/index.php?title=Hans_Eric_Sandstr%C3%B6m&action=edit&redlink=1 "Hans Eric Sandström (page does not exist)") fast [move generator](/Table-driven_Move_Generation#GNUChess "Table-driven Move Generation") defeats [Fidelity](/Fidelity "Fidelity") in a 10 game match [[5]](#cite_note-5) [[6]](#cite_note-6):
...
1. [↑](#cite_ref-1) [GNU Project - Free Software Foundation - A Bold GNU Head](https://www.gnu.org/graphics/heckert_gnu.html) by [Aurelio A. Heckert](http://wiki.colivre.net/Aurium/)
2. [↑](#cite_ref-2) [Re: request ...](https://groups.google.com/d/msg/gnu.chess/KChQhVPAACA/ApFk4OeWlcYJ) by [Stuart Cracraft](/Stuart_Cracraft "Stuart Cracraft"), [gnu.chess](/GNU_Chess#NewsGroup "GNU Chess"), June 16, 1995
3. [↑](#cite_ref-3) [gnuchess/common.h at master · heisencoder/gnuchess · GitHub](https://github.com/heisencoder/gnuchess/blob/master/src/common.h)
4. [↑](#cite_ref-4) [GNU Chess - Free Software Foundation](http://www.gnu.org/software/chess/chess.html)
5. [↑](#cite_ref-5) [GNU's Bulletin, vol. 1 no. 8 - GNU Project - Free Software Foundation (FSF) | GNUs Flashes](http://www.gnu.org/bulletins/bull8.html#SEC7)
6. [↑](#cite_ref-6) [GNU Chess 1.55 vs. Fidelity Mach 3](http://groups.google.com/group/gnu.chess/msg/583f6ed4f648bf90) by [Stuart Cracraft](/Stuart_Cracraft "Stuart Cracraft"), [gnu.chess](/GNU_Chess#NewsGroup "GNU Chess"), January 3, 1990
