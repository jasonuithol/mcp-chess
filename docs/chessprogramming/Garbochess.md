...
Source: https://www.chessprogramming.org/Garbochess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Garbochess**

[File:Garbo in Inspiration.jpg](/index.php?title=Special:Upload&wpDestFile=Garbo_in_Inspiration.jpg "File:Garbo in Inspiration.jpg")

Garbo in Inspiration [[1]](#cite_note-1)

**Garbochess**,  
an [UCI](/UCI "UCI") compliant [open source chess engine](/Category:Open_Source "Category:Open Source") by [Gary Linscott](/Gary_Linscott "Gary Linscott"). Starting with a [0x88](/0x88 "0x88") board representation in [C#](/C_sharp "C sharp"), which later evolved to the [JavaScript](/JavaScript "JavaScript") version [Garbochess-JS](/Garbochess-JS "Garbochess-JS") [[2]](#cite_note-2) aka *Ajax chess* [[3]](#cite_note-3), and was also incorporated in *Silverlight Chess* [[4]](#cite_note-4) for the [Microsoft](/Microsoft "Microsoft") [Silverlight](https://en.wikipedia.org/wiki/Microsoft_Silverlight) framework, Version 2 was a complete rewrite in [C++](/Cpp "Cpp") using [bitboards](/Bitboards "Bitboards") [[5]](#cite_note-5).
...
1. [↑](#cite_ref-1) Greta Garbo in a publicity still for [Inspiration](https://en.wikipedia.org/wiki/Inspiration_%281931_film%29) (1931), author: [Metro-Goldwyn-Mayer](https://en.wikipedia.org/wiki/Metro-Goldwyn-Mayer), [Greta Garbo from Wikipedia](https://en.wikipedia.org/wiki/Greta_Garbo)
2. [↑](#cite_ref-2) [glinscott/Garbochess-JS · GitHub](https://github.com/glinscott/Garbochess-JS)
3. [↑](#cite_ref-3) [Ajax chess](http://www.talkchess.com/forum/viewtopic.php?p=332081) by [Gary](/Gary_Linscott "Gary Linscott"), [CCC](/CCC "CCC"), February 20, 2010
...
5. [↑](#cite_ref-5) [Garbochess v2 released](http://www.talkchess.com/forum/viewtopic.php?t=19933) by Gary, [CCC](/CCC "CCC"), March 01, 2008
6. [↑](#cite_ref-6) based on [Garbochess-3/GarboChess3 at master · glinscott/Garbochess-3 · GitHub](https://github.com/glinscott/Garbochess-3/tree/master/GarboChess3)
