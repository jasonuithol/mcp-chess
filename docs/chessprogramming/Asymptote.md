...
Source: https://www.chessprogramming.org/Asymptote

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Asymptote**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Asymptote02_vectorial.svg/330px-Asymptote02_vectorial.svg.png)](/File:Asymptote02_vectorial.svg)

Asymptotic Intersections [[1]](#cite_note-1)
...
- [Lazy SMP](/Lazy_SMP "Lazy SMP") using [Threads](/Thread "Thread") [[3]](#cite_note-3)
...
1. [↑](#cite_ref-1) [Example](https://commons.wikimedia.org/wiki/File:Asymptote02_vectorial.svg) of a curve with its asymptote shows that the curve may intersect the asymptote, in this case an infinite amount of times, by Guillaume Jacquenot, March 20, 2013, [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [asymptote/search.rs at master · malu/asymptote · GitHub](https://github.com/malu/asymptote/blob/master/src/search.rs)
3. [↑](#cite_ref-3) [Asymptote 0.5 (with SMP)](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=70387) by [Maximilian Lupke](/Maximilian_Lupke "Maximilian Lupke"), [CCC](/CCC "CCC"), April 02, 2019
4. [↑](#cite_ref-4) [asymptote/eval.rs at master · malu/asymptote · GitHub](https://github.com/malu/asymptote/blob/master/src/eval.rs)
