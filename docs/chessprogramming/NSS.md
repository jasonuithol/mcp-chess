...
Source: https://www.chessprogramming.org/NSS

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* NSS Chess Program**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Johnniac.jpg/330px-Johnniac.jpg)](https://en.wikipedia.org/wiki/File:Johnniac.jpg)

Johnniac [[1]](#cite_note-1)

**NSS Chess Program**, (Newell, Shaw, and Simon, also mentioned as Newell CP [[2]](#cite_note-2))  
...
artificial intelligence and chess software. The NSS program ran on the [Johnniac](https://en.wikipedia.org/wiki/JOHNNIAC) computer ... [[3]](#cite_note-3)

# Description

given by [Paul Rushton](/Paul_Rushton "Paul Rushton") and [Tony Marsland](/Tony_Marsland "Tony Marsland") in 1973 [[4]](#cite_note-4) :
...
[Bill Wall](/index.php?title=Bill_Wall&action=edit&redlink=1 "Bill Wall (page does not exist)") [[5]](#cite_note-5)
...
- [Allen Newell](/Allen_Newell "Allen Newell"), [Cliff Shaw](/Cliff_Shaw "Cliff Shaw"), [Herbert Simon](/Herbert_Simon "Herbert Simon") (**1959**). *Report on a general problem-solving program*. Proceedings of the International Conference on Information Processing, pp. 256-264 [[6]](#cite_note-6)
...
1. [↑](#cite_ref-1) Johnniac computer, [The Computer History Museum](/The_Computer_History_Museum "The Computer History Museum"), California, by Andrew Lih, [JOHNNIAC from Wikipedia](https://en.wikipedia.org/wiki/JOHNNIAC)
2. [↑](#cite_ref-2) [Classic Computer Chess - ... The programs of yesteryear](http://web.archive.org/web/20071221115817/http://classicchess.googlepages.com/Chess.htm) by [Carey](/Carey_Bloodworth "Carey Bloodworth"), hosted by the [Internet Archive](https://en.wikipedia.org/wiki/Internet_Archive)
3. [↑](#cite_ref-3) [Aritificial Intelligence pioneers Allen Newell (right) and Herbert Simon 1958](http://www.computerhistory.org/chess/full_record.php?iid=stl-431e1a07cf7a1) Courtesy of [Carnegie Mellon University](/Carnegie_Mellon_University "Carnegie Mellon University"), [The Computer History Museum](/The_Computer_History_Museum "The Computer History Museum")
...
5. [↑](#cite_ref-5) [Computer Chess History](http://www.oocities.org/siliconvalley/lab/7378/comphis.htm) by [Bill Wall](/index.php?title=Bill_Wall&action=edit&redlink=1 "Bill Wall (page does not exist)")
6. [↑](#cite_ref-6) [General Problem Solver from Wikipedia](https://en.wikipedia.org/wiki/General_Problem_Solver)
