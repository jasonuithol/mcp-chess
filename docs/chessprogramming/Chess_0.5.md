...
Source: https://www.chessprogramming.org/Chess_0.5

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Chess 0.5**

[![](/images/0/01/223-front.gif)](https://archive.org/details/byte-magazine-1978-10)

[BYTE, Vol. 3, No. 10](/Byte_Magazine#BYTE310 "Byte Magazine") [[1]](#cite_note-1)

**Chess 0.5**,  
a program by [Larry Atkin](/Larry_Atkin "Larry Atkin") and [Peter W. Frey](/Peter_W._Frey "Peter W. Frey") for didactic purposes, written in the [ETH Zurich](/ETH_Zurich "ETH Zurich") dialect of [Pascal](/Pascal "Pascal") for the [CDC 6600](/CDC_6600 "CDC 6600") series of mainframes, published 1978/1979 in [Byte Magazine](/Byte_Magazine "Byte Magazine"), and re-published on-line in 2005, available from Scott A. Moore's [[2]](#cite_note-2) sites, unfortunately with some [OCR](https://en.wikipedia.org/wiki/Optical_character_recognition)-errors such as syntactical correct replacement of '\*' by '+' with score factor by side (XTMV, ±1) in some places [[3]](#cite_note-3) . Chess 0.5 may be compiled with [GNU Pascal](/Pascal#GNUPascal "Pascal") for recent hardware. Due to non-local [goto](https://en.wikipedia.org/wiki/Goto) statements over procedure or function boundaries compiling with [Free Pascal](/Pascal#FreePascal "Pascal") is not possible [[4]](#cite_note-4) .

Larry Atkin is co-author of the famous [Northwestern University](/Northwestern_University "Northwestern University") [Chess](/Chess_(Program) "Chess (Program)") line of programs. At the time of the article, Chess was at about version 4.6 [[5]](#cite_note-5) . Chess 0.5 is based on his intimate knowledge of that program, but is a seperate program designed for pedagogical purposes to play chess vaguely well [[6]](#cite_note-6) using Chess 4.x like structures of a [Shannon Type A](/Type_A_Strategy "Type A Strategy") approach with [alpha-beta](/Alpha-Beta "Alpha-Beta") and [quiescence search](/Quiescence_Search "Quiescence Search"), [bitboards](/Bitboards "Bitboards") and [incremental updated](/Incremental_Updates "Incremental Updates") [attack tables](/Attack_and_Defend_Maps "Attack and Defend Maps").

# Blueprint

As encouraged by Frey and Atkin in their article "The reader with an interest in chess and programming should use this listing as starting point for developing a program" [[7]](#cite_note-7) , Chess 0.5 was origin of at least three other competing programs, the Austrian [Merlin](/Merlin "Merlin") by [Hermann Kaindl](/Hermann_Kaindl "Hermann Kaindl"), [Helmut Horacek](/Helmut_Horacek "Helmut Horacek"), [Marcus Wagner](/Marcus_Wagner "Marcus Wagner") and [Roland Schreier](/index.php?title=Roland_Schreier&action=edit&redlink=1 "Roland Schreier (page does not exist)"), further developed in Pascal except some time critical, often called routines, which were re-written in [CDC](/CDC_6600 "CDC 6600") [assembly](/Assembly "Assembly") by Wagner [[8]](#cite_note-8) [[9]](#cite_note-9) , the Dutch [Chess 0.5X](/Chess_0.5X "Chess 0.5X") by [Wim Elsenaar](/Wim_Elsenaar "Wim Elsenaar"), a [PDP-11](/PDP-11 "PDP-11") assembly port, and according to postings in [rgcc](/Computer_Chess_Forums "Computer Chess Forums") [[10]](#cite_note-10) , the Finnish [Shy](/Shy "Shy") by [Juha Kasanen](/Juha_Kasanen "Juha Kasanen"), [Mika Korhonen](/Mika_Korhonen "Mika Korhonen") and [Timo Saari](/Timo_Saari "Timo Saari"), written in [Algol](/Algol "Algol").
...
:   [Chess05GNU.pas](http://www.andreadrian.de/schach/Chess05GNU.pas)

# References

1. [↑](#cite_ref-1) [Byte Vol. 3, No. 10, October 1978](https://archive.org/details/byte-magazine-1978-10) from the [Internet Archive](https://en.wikipedia.org/wiki/Internet_Archive)
2. [↑](#cite_ref-2) [Scott A. Moore's site](http://www.moorecad.com/standardpascal/scottmoore.html)
3. [↑](#cite_ref-3) [Byte Chess 0.5 source code](http://www.moorecad.com/standardpascal/Chess05.pas) (OCR-Errors!)
4. [↑](#cite_ref-4) [Re: Need a little help from a Pascal guru (Chess05 Frey/Atkin)](http://www.talkchess.com/forum/viewtopic.php?t=41896&start=1) by [Steven Edwards](/Steven_Edwards "Steven Edwards"), [CCC](/CCC "CCC"), January 09, 2012
5. [↑](#cite_ref-5) [Chess 4.6 source code](http://www.computerhistory.org/chess/full_record.php?iid=sft-431614f455002), gift of [David Slate](/David_Slate "David Slate"), from [The Computer History Museum](/The_Computer_History_Museum "The Computer History Museum"), [pdf](http://archive.computerhistory.org/projects/chess/related_materials/software/3-3.Chess_4.6_Sourcecode.102645430/chess_4-6.sourcecode.102645430.pdf)
6. [↑](#cite_ref-6) [Chess 0.5, Release 1 - 2005-05-30](http://www.moorecad.com/standardpascal/ByteChess.txt)
7. [↑](#cite_ref-7) [Peter W. Frey](/Peter_W._Frey "Peter W. Frey"), [Larry Atkin](/Larry_Atkin "Larry Atkin") (**1978**). *[Creating a Chess Player, Part 3: Chess 0.5 (continued)](https://archive.org/stream/byte-magazine-1978-12/1978_12_BYTE_03-12_Life#page/n141/mode/2up)*. [BYTE, Vol. 3, No. 12](/Byte_Magazine#BYTE312 "Byte Magazine")
8. [↑](#cite_ref-8) [Werner DePauli-Schimanovich](/Werner_Schimanovich "Werner Schimanovich") (**2006**). *Europolis 6*. Informatik für Spiele und Verkehr. Extension der Mengenlehre, Herausgeber: Franz Pichler, Universitätsverlag Rudolf Trauner, ISBN 978-3-85487-946-6, (SG7) Merlin (ein ComputerChess-Programm) s. 171 (German), [Google Books](http://books.google.com/books?id=Gf4WibmHVbcC&pg=PA175&lpg=PA175&source=bl&ots=YPtaHAp3Z4&sig=DNRPh11heo8Q1zS3UOBe0qoCF-8&hl=en&ei=0GmnTMX1GMfJswaL-NivDA&sa=X&oi=book_result&ct=result&resnum=1&ved=0CBgQ6AEwAA#v=onepage&q&f=false)
9. [↑](#cite_ref-9) [Helmut Horacek](/Helmut_Horacek "Helmut Horacek"), [Marcus Wagner](/Marcus_Wagner "Marcus Wagner") (**1981**). *Das Schachprogramm Merlin, Verbesserung von Laufzeit-Effizient, Eröffnungsbibliothek und Bewertungsfunktion.* 4. Tagung "Berichte aus Informatik-Instituten" (German)
10. [↑](#cite_ref-10) [Re: Byte Chess 0.5 finally available. From Byte Magazine 1978](https://groups.google.com/d/msg/rec.games.chess.computer/3iSe8NsM024/DrW8Dzsr2tYJ) by I Forget, [rgcc](/Computer_Chess_Forums "Computer Chess Forums"), June 02, 2005
