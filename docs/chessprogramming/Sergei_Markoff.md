...
Source: https://www.chessprogramming.org/Sergei_Markoff

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Sergei Markoff**

[![](/images/4/42/SergeiMarkoff.jpg)](https://www.facebook.com/sergei.markoff)

Sergei S. Markoff [[1]](#cite_note-1)

**Sergei S. Markoff**, [[2]](#cite_note-2)  
a Russian computer scientist, computer chess and games programmer. He is author of the chess program [SmarThink](/SmarThink "SmarThink") [[3]](#cite_note-3) [[4]](#cite_note-4). In 2003 Sergei introduced the [Botvinnik-Markoff Extension](/Botvinnik-Markoff_Extension "Botvinnik-Markoff Extension") [[5]](#cite_note-5). Sergei working in Sberbank leading a workgroup that focused on development of bank AI/ML systems especially in the area of speech technologies.[[6]](#cite_note-6).
...
1. [↑](#cite_ref-1) [Sergei Markoff - Facebook](https://www.facebook.com/sergei.markoff)
2. [↑](#cite_ref-2) Due to different, but equally valid ways of [transliterating](https://en.wikipedia.org/wiki/Transliteration) [Cyrillic](https://en.wikipedia.org/wiki/Cyrillic_alphabet), also **Sergei Markov**, see [Markov number from Wikipedia](https://en.wikipedia.org/wiki/Markov_number)
3. [↑](#cite_ref-3) [SmarThink by Sergei Markoff, Russia](http://www.sdchess.ru/smarthink.htm) from [sdchess.ru](http://www.sdchess.ru/)
4. [↑](#cite_ref-4) [Some SmarThink details](http://www.aigroup.narod.ru/detailse.htm)
5. [↑](#cite_ref-5) [The "same threat extension" as effective way to resolve horizon problem](https://www.stmintz.com/ccc/index.php?id=318833), Sergei Markoff introduced the extension, [CCC](/CCC "CCC"), October 01, 2003
6. [↑](#cite_ref-6) [Sergei Markoff - Russian Federation | LinkedIn](http://ru.linkedin.com/pub/sergei-markoff/2b/94/360?trk=pub-pbmap)
