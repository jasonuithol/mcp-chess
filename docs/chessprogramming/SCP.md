...
Source: https://www.chessprogramming.org/SCP

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* SCP**

**SCP**, (Stanback Chess Program, also mentioned as JSCP)  
an [open source chess program](/Category:Open_Source "Category:Open Source") by [John Stanback](/John_Stanback "John Stanback"), written in [C](/C "C") and published in May 1987 at [comp.sources.games](/Computer_Chess_Forums "Computer Chess Forums") [[1]](#cite_note-1). SCP later evolved to [GNU Chess 2-4](/GNU_Chess "GNU Chess"), and was also ported to the [Amiga](/Amiga "Amiga") as *Chess* and *Chess 2.0*, the latter with a mouse-driven [GUI](/GUI "GUI") [[2]](#cite_note-2). A [WinBoard](/WinBoard "WinBoard") compatible version of SCP was most recently updated by [Jim Ablett](/Jim_Ablett "Jim Ablett") [[3]](#cite_note-3), hosted by [Kirill Kryukov](/Kirill_Kryukov "Kirill Kryukov") [[4]](#cite_note-4).
...
SCP seems to originate the [repetition](/Repetitions "Repetitions") counting algorithm, also found in some [GNU Chess](/GNU_Chess "GNU Chess") versions, [TSCP](/TSCP "TSCP") [[5]](#cite_note-5), and [Belzebub](/Belzebub "Belzebub"). It may detect false repetitions in case of exchanging two unequal pieces [[6]](#cite_note-6).
...
1. [↑](#cite_ref-1) [v01i023: chess - C source for chess](https://groups.google.com/d/msg/comp.sources.games/zs_1mrpdseE/YL2yGrzoXrEJ) by [John Stanback](/John_Stanback "John Stanback"), [comp.sources.games](/Computer_Chess_Forums "Computer Chess Forums"), May 21, 1987
2. [↑](#cite_ref-2) [Chess 2.0 for Amiga (1989)](http://www.mobygames.com/game/amiga/chess-20), [MobyGames](https://en.wikipedia.org/wiki/MobyGames)
3. [↑](#cite_ref-3) [SCP/Gnuchess 2.02 JA by John Stanback - Update](http://www.talkchess.com/forum/viewtopic.php?t=29106) by [Jim Ablett](/Jim_Ablett "Jim Ablett"), [CCC](/CCC "CCC"), July 25, 2009
4. [↑](#cite_ref-4) [SCP](http://kirr.homeunix.org/chess/engines/Jim%20Ablett/SCP/) maintained and updated by [Jim Ablett](/Jim_Ablett "Jim Ablett"), hosted by [Kirill Kryukov](/Kirill_Kryukov "Kirill Kryukov")
5. [↑](#cite_ref-5) [Re: Detecting three-fold repetition?](https://www.stmintz.com/ccc/index.php?id=119911) by [John Stanback](/John_Stanback "John Stanback"), [CCC](/CCC "CCC"), July 17, 2000
6. [↑](#cite_ref-6) [Re: Move Tables - explain as if I'm five](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=490672&t=45846) by [Karlo Bala Jr.](/Karlo_Balla "Karlo Balla"), [CCC](/CCC "CCC"), November 05, 2012
