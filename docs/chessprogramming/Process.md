...
Source: https://www.chessprogramming.org/Process

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* Process**
...
[![Process states.svg](https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Process_states.svg/960px-Process_states.svg.png)](/File:Process_states.svg)

Seven [process states](https://en.wikipedia.org/wiki/Process_state) in a [State diagram](https://en.wikipedia.org/wiki/State_diagram) [[1]](#cite_note-1)
...
1. [↑](#cite_ref-1) [Process state from Wikipedia](https://en.wikipedia.org/wiki/Process_state)
