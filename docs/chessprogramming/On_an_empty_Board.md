...
**[Home](/Main_Page "Main Page") \* [Board Representation](/Board_Representation "Board Representation") \* [Bitboards](/Bitboards "Bitboards") \* [Sliding Piece Attacks](/Sliding_Piece_Attacks "Sliding Piece Attacks") \* On an empty Board**
...
The [generalized shift](/General_Setwise_Operations#GeneralizedShift "General Setwise Operations") version for [diagonals](/Diagonals "Diagonals") and [antidiagonals](/Anti-Diagonals "Anti-Diagonals") as introduced by [Thomas Jahn](/Thomas_Jahn "Thomas Jahn") [[1]](#cite_note-1) produces shorter and faster code on modern [x86-64](/X86-64 "X86-64") processors due to [BMI2](/BMI2 "BMI2") shift instructions not affecting the flags [[2]](#cite_note-2):
...
1. [↑](#cite_ref-1) [Re: [Question] Efficiently generate ray masks?](https://www.talkchess.com/forum3/viewtopic.php?f=7&t=79140&start=10) by [Thomas Jahn](/Thomas_Jahn "Thomas Jahn"), [CCC](/CCC "CCC"), January 17, 2022
2. [↑](#cite_ref-2) [SARX/SHLX/SHRX — Shift Without Affecting Flags](https://www.felixcloutier.com/x86/sarx:shlx:shrx)
