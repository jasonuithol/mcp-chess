...
Source: https://www.chessprogramming.org/Toni_Helminen

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Toni Helminen**

**Toni Helminen**, (JohnWoe)  
a Finnish IT freelancer, and computer games and computer chess programmer. He is author of multiple [open source](/Category:Open_Source "Category:Open Source") chess and chess variant engines [[1]](#cite_note-1),
the [Shogi](/Shogi "Shogi") engine [RubyShogi](/index.php?title=RubyShogi&action=edit&redlink=1 "RubyShogi (page does not exist)"), the chess variant engine [Shuriken](/index.php?title=Shuriken&action=edit&redlink=1 "Shuriken (page does not exist)"), the [Gothic Chess](/index.php?title=Gothic_Chess&action=edit&redlink=1 "Gothic Chess (page does not exist)") engine [Havoc](/index.php?title=Havoc&action=edit&redlink=1 "Havoc (page does not exist)"), and the chess playing engines [Sapeli](/Sapeli "Sapeli") and [Mayhem](/Mayhem "Mayhem"), the latter featuring [NNUE](/NNUE "NNUE") [[2]](#cite_note-2).

# Publications

- Toni Helminen (**2022**). *[Lazy sorting algorithm](https://github.com/SamuraiDangyo/lazy-sorting-algorithm)*. [[3]](#cite_note-3)
...
1. [↑](#cite_ref-1) [SamuraiDangyo (Toni Helminen) · GitHub](https://github.com/SamuraiDangyo)
2. [↑](#cite_ref-2) [Mayhem NNUE - New NN engine](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=75500) by JohnWoe, [CCC](/CCC "CCC"), October 22, 2020
3. [↑](#cite_ref-3) [Lazy sorting algorithm - Sorting on steroids](https://www.talkchess.com/forum3/viewtopic.php?f=7&t=79279) by JohnWoe, [CCC](/CCC "CCC"), February 03, 2022
