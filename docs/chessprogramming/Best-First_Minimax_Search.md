...
Source: https://www.chessprogramming.org/Best-First_Minimax_Search

**[Home](/Main_Page "Main Page") \* [Search](/Search "Search") \* Best-First Minimax Search**

**Best-First Minimax Search**, **(BFMMS)**  
is a [Best-First search](/Best-First "Best-First") algorithm based on [Best-First](/Best-First "Best-First") and a shallow [alpha-beta](/Alpha-Beta "Alpha-Beta") [depth-first-search](/Depth-First "Depth-First") proposed by [Richard Korf](/Richard_Korf "Richard Korf") and [Max Chickering](/Max_Chickering "Max Chickering") [[1]](#cite_note-1).
...
- [KomodoMCTS](/KomodoMCTS "KomodoMCTS")
...
- [Re: MCTS vs Alpha-beta](https://talkchess.com/viewtopic.php?p=967038#p967038) by [Srdja Matovic](/Srdja_Matovic "Srdja Matovic"), [CCC](/CCC "CCC"), August 03, 2024
