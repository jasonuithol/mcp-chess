...
Source: https://www.chessprogramming.org/Clarabit

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Clarabit**
...
dedicated to his daughter Clara [[1]](#cite_note-1).
The development of Clarabit started in summer 2006, and it was first public released in February 2008 [[2]](#cite_note-2).
...
as acknowledged to [Pradu Kannan](/Pradu_Kannan "Pradu Kannan") in the Readme.txt file [[3]](#cite_note-3).

## Search

Clarabit's [search](/Search "Search") performs and uses [[4]](#cite_note-4):
...
1. [↑](#cite_ref-1) [Clarabit Chess Engine](http://sites.google.com/site/sapabe/)
2. [↑](#cite_ref-2) [Clarabit first release](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=19514) by [Salvador Pallares Bejarano](/Salvador_Pallares_Bejarano "Salvador Pallares Bejarano"), [CCC](/CCC "CCC"), February 09, 2008
3. [↑](#cite_ref-3) [Clarabit Chess Engine - downloads](http://sites.google.com/site/sapabe/downloads)
4. [↑](#cite_ref-4) [Clarabit Chess Engine - Technical Info](http://sites.google.com/site/sapabe/technicalinfo)
