...
Source: https://www.chessprogramming.org/Jürg_Nievergelt

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Jürg Nievergelt**

[![](/images/7/79/Nievergelt.jpg)](http://www.jn.inf.ethz.ch/index.html)

Jürg Nievergelt [[1]](#cite_note-1)

**Jürg Nievergelt**,  
a Swiss mathematician and computer scientist. Jürg Nievergelt has been full Professor of Computer Science at the [ETH Zurich](/ETH_Zurich "ETH Zurich") from 1975 until his retirement in 2003. His research interests covers [algorithms](/Algorithms "Algorithms") and [data structures](/Data "Data"), interactive systems, [user interfaces](https://en.wikipedia.org/wiki/User_interface), heuristic and [exhaustive search](/Brute-Force "Brute-Force"), and [parallel computation](https://en.wikipedia.org/wiki/Parallel_computing) [[2]](#cite_note-2).
...
- [Yew Jin Lim](/Yew_Jin_Lim "Yew Jin Lim"), Jürg Nievergelt (**2004**). *Computing Tigers and Goats.* [ICGA Journal, Vol. 27, No. 3](/ICGA_Journal#27_3 "ICGA Journal"), [pdf](http://www.yewjin.com/storage/papers/Computing_Tigers_And_Goats.pdf) [[6]](#cite_note-6) [[7]](#cite_note-7)
...
1. [↑](#cite_ref-1) [Jürg Nievergelt Homepage](http://www.jn.inf.ethz.ch/index.html)
2. [↑](#cite_ref-2) [Prof. Jürg Nievergelt - Research](http://www.jn.inf.ethz.ch/research.html)
3. [↑](#cite_ref-3) [ICGA Reference Database](/ICGA_Journal#RefDB "ICGA Journal")
4. [↑](#cite_ref-4) [Beats Biblionetz - Personen: Jürg Nievergelt](http://beat.doebe.li/bibliothek/p01118.html)
5. [↑](#cite_ref-5) [dblp: Jürg Nievergelt](https://dblp.uni-trier.de/pers/hd/n/Nievergelt:J=uuml=rg)
6. [↑](#cite_ref-6) [Rules for Tigers and Goats](http://www.mastersgames.com/rules/tigers-goats-rules.htm)
7. [↑](#cite_ref-7) [Bagh-Chal from Wikipedia](https://en.wikipedia.org/wiki/Bagh-Chal)
