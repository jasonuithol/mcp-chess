...
Source: https://www.chessprogramming.org/WyldChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* WyldChess**
...
Origin of ideas and implementations are documented inside the source code, e.g. [tapered eval](/Tapered_Eval "Tapered Eval") [SIMD](/SIMD_and_SWAR_Techniques "SIMD and SWAR Techniques") [score](/Score "Score") [[1]](#cite_note-1), or [SEE](/SEE_-_The_Swap_Algorithm "SEE - The Swap Algorithm") from [Stockfish](/Stockfish "Stockfish").
Since version 1.5, released in June 2017, WyldChess supports [Syzygy Bases](/Syzygy_Bases "Syzygy Bases") [[2]](#cite_note-2).
...
- [Iterative Deepening](/Iterative_Deepening "Iterative Deepening") [[3]](#cite_note-3)
...
1. [↑](#cite_ref-1) [WyldChess/defs.h at master · Mk-Chan/WyldChess · GitHub](https://github.com/Mk-Chan/WyldChess/blob/master/src/defs.h)
2. [↑](#cite_ref-2) [WyldChess 1.5 released](http://www.talkchess.com/forum/viewtopic.php?t=64174) by [Manik Charan](/Manik_Charan "Manik Charan"), [CCC](/CCC "CCC"), June 04, 2017
3. [↑](#cite_ref-3) Evaluation and Search Features mostly based on [WyldChess/README.md at master · Mk-Chan/WyldChess · GitHub](https://github.com/Mk-Chan/WyldChess/blob/master/README.md)
