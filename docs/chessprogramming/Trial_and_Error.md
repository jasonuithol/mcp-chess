...
Source: https://www.chessprogramming.org/Trial_and_Error

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* [Algorithms](/Algorithms "Algorithms") \* Trial and Error**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Monkey-typing.jpg/330px-Monkey-typing.jpg)](/File:Monkey-typing.jpg)

[Chimpanzee](https://en.wikipedia.org/wiki/Chimpanzee) is giving it a try [[1]](#cite_note-1)
...
1. [↑](#cite_ref-1) Given enough time, a hypothetical monkey typing at random would, as part of its output, [almost surely](https://en.wikipedia.org/wiki/Almost_surely) produce all of [Shakespeare's](https://en.wikipedia.org/wiki/William_Shakespeare) plays. In this image a [chimpanzee](https://en.wikipedia.org/wiki/Chimpanzee) is giving it a try, [Infinite monkey theorem from Wikipedia](https://en.wikipedia.org/wiki/Infinite_monkey_theorem), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
