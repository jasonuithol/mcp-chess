...
Source: https://www.chessprogramming.org/Combusken

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Combusken**

**Combusken**,   
an [UCI](/UCI "UCI") compliant [open source chess engine](/Category:Open_Source "Category:Open Source") by [Marcin Henryk Bartkowiak](/Marcin_Henryk_Bartkowiak "Marcin Henryk Bartkowiak"), written in the [Go programming language](/Go_(Programming_Language) "Go (Programming Language)"), first released in February 2020 under the [GPL 3](/Free_Software_Foundation#GPL "Free Software Foundation") [[1]](#cite_note-1).
Already playing since April 2019 at [Lichess](/index.php?title=Lichess&action=edit&redlink=1 "Lichess (page does not exist)") [[2]](#cite_note-2), it had its tournament debut at [TCEC Season 18](/TCEC_Season_18 "TCEC Season 18").
...
The author mentions following engines and their authors for implementation details and tuning positions [[5]](#cite_note-5):
...
1. [↑](#cite_ref-1) [Re: New engine releases 2020](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=72613&start=80) by [Marcin Henryk Bartkowiak](/Marcin_Henryk_Bartkowiak "Marcin Henryk Bartkowiak"), [CCC](/CCC "CCC"), February 23, 2020
2. [↑](#cite_ref-2)  [ombuskengine • lichess.org](https://lichess.org/@/combuskengine)
3. [↑](#cite_ref-3) [combusken/engine at master · mhib/combusken · GitHub](https://github.com/mhib/combusken/tree/master/engine)
4. [↑](#cite_ref-4) [combusken/evaluation at master · mhib/combusken · GitHub](https://github.com/mhib/combusken/tree/master/evaluation)
5. [↑](#cite_ref-5) [GitHub - mhib/combusken: A chess engine](https://github.com/mhib/combusken)
