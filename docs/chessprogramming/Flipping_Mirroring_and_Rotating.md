...
**[Home](/Main_Page "Main Page") \* [Board Representation](/Board_Representation "Board Representation") \* [Bitboards](/Bitboards "Bitboards") \* Flipping, Mirroring and Rotating**

[![](/images/thumb/8/88/Forever_IV.jpg/300px-Forever_IV.jpg)](http://www.barbaramittman.com/Site/Fore_4.html)

[Barbara Mittman](/Category:Barbara_Mittman "Category:Barbara Mittman"), Forever IV [[1]](#cite_note-1)
...
Using the [x86-64](/X86-64 "X86-64") [\_byteswap\_uint64](/X86-64#gpinstructions "X86-64") or bswap64 intrinsics only takes one processor instruction in 64-bit mode.
...
3. [↑](#cite_ref-3) [\_rotl, \_rotl64, \_rotr\_rotr64](http://msdn.microsoft.com/en-us/library/5cc576c4.aspx) Visual C++ Developer Center - Run-Time Library Reference
4. [↑](#cite_ref-4) [Donald Knuth](/Donald_Knuth "Donald Knuth") (**2009**). *[The Art of Computer Programming](http://www-cs-faculty.stanford.edu/%7Eknuth/taocp.html), Volume 4, Fascicle 1: Bitwise tricks & techniques*, as [Pre-Fascicle 1a postscript](http://www-cs-faculty.stanford.edu/%7Eknuth/fasc1a.ps.gz)
5. [↑](#cite_ref-5) [reverse.c](http://www.hackersdelight.org/hdcodetxt/reverse.c.txt) from [C code for most of the programs that appear in HD](http://www.hackersdelight.org/hdcode.htm) by [Henry S. Warren, Jr.](/Henry_S._Warren,_Jr. "Henry S. Warren, Jr.")
6. [↑](#cite_ref-6) [Demystifying the Magic Multiplier?](https://chessprogramming.wikispaces.com/share/view/64439740)
7. [↑](#cite_ref-7) [Smoke and mirrors (disambiguation)](https://en.wikipedia.org/wiki/Smoke_and_mirrors_%28disambiguation%29)
8. [↑](#cite_ref-8) [Shorter front view version with interviews](https://www.youtube.com/watch?v=vsmlkrBiok0)
