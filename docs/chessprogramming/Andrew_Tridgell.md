...
Source: https://www.chessprogramming.org/Andrew_Tridgell

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Andrew Tridgell**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Andrew_Tridgell.jpg/330px-Andrew_Tridgell.jpg)](/File:Andrew_Tridgell.jpg)

Andrew Tridgell [[1]](#cite_note-1)

**Andrew Tridgell**,  
an Australian programmer, primary author of the [TD-learning](/Temporal_Difference_Learning "Temporal Difference Learning") chess program [KnightCap](/KnightCap "KnightCap") [[2]](#cite_note-2) and best known as the major developer of the [Samba](https://en.wikipedia.org/wiki/Samba_%28software%29) software. His Ph.D. thesis *Efficient Algorithms for Sorting and Synchronization* [[3]](#cite_note-3) at the [Australian National University](/Australian_National_University "Australian National University") was based on his work on the [rsync](https://en.wikipedia.org/wiki/Rsync) algorithm.
...
1. [↑](#cite_ref-1) Photo by [Gopal Vijayaraghavan](https://www.flickr.com/people/46888841@N00), January 28, 2006, [Category:Andrew Tridgell - Wikimedia Commons](https://commons.wikimedia.org/wiki/Category:Andrew_Tridgell)
2. [↑](#cite_ref-2) [Welcome to the KnightCap home page](http://samba.org/KnightCap/)
3. [↑](#cite_ref-3) Andrew Tridgell (**1999**). *Efficient Algorithms for Sorting and Synchronization*. Ph.D. thesis, The [Australian National University](/Australian_National_University "Australian National University"), advisor [Richard P. Brent](/Mathematician#Brent "Mathematician"), [pdf](http://samba.org/~tridge/phd_thesis.pdf)
4. [↑](#cite_ref-4) [dblp: Andrew Tridgell](http://dblp.org/pers/hd/t/Tridgell:Andrew.html)
