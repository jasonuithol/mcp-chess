...
Source: https://www.chessprogramming.org/CPW_King

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* [CPW-Engine](/CPW-Engine "CPW-Engine") \* CPW\_King**
...
We need to add the following function to the eval\_init.cpp, in order to define squares which are considered worthwhile to attack:
