...
Source: https://www.chessprogramming.org/Gunnar_Andersson

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Gunnar Andersson**
...
on the topic of [approximation algorithms](https://en.wikipedia.org/wiki/Approximation_algorithm) for [optimization versions](https://en.wikipedia.org/wiki/Optimization_problem) of [NP-complete](https://en.wikipedia.org/wiki/NP-completeness) [decision problems](https://en.wikipedia.org/wiki/Decision_problem) [[1]](#cite_note-1) .
...
1. [↑](#cite_ref-1) Gunnar Andersson (**2000**). *Some New Randomized Approximation Algorithms*. Ph.D. thesis, Department of Numerical Analysis and Computer Science, [Royal Institute of Technology](https://en.wikipedia.org/wiki/Royal_Institute_of_Technology), [pdf](http://radagast.se/thesis.pdf)
2. [↑](#cite_ref-2) [Zebra](http://radagast.se/othello/zebra.html)
3. [↑](#cite_ref-3) [Download WZebra](http://radagast.se/othello/download.html)
4. [↑](#cite_ref-4) [bitboard mobility](http://radagast.se/othello/bitmob.c) Copyright (c) 2003, Gunnar Andersson
5. [↑](#cite_ref-5) bitbmob.c in [zebra.tar.gz](http://radagast.se/othello/zebra.tar.gz)
6. [↑](#cite_ref-6) [Gunnar Andersson, Research](http://radagast.se/papers.html)
7. [↑](#cite_ref-7) [dblp: Gunnar Andersson](https://dblp.uni-trier.de/pers/hd/a/Andersson:Gunnar)
