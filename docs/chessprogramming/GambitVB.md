...
Source: https://www.chessprogramming.org/GambitVB

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* GambitVB**

[![](/images/thumb/9/96/GambitVB.PNG/300px-GambitVB.PNG)](/File:GambitVB.PNG)

GambitVB [GUI](/GUI "GUI"), a [Windows](/Windows "Windows") [Forms](https://en.wikipedia.org/wiki/Windows_Forms) collection [[1]](#cite_note-1)
...
The original GambitVB.info site is no longer available, **VBChess 4.4.rar** is hosted by [Ron Murawski](/Ron_Murawski "Ron Murawski") [[2]](#cite_note-2),
...
1. [↑](#cite_ref-1) Screenshot from no longr avaibale GambitVB sitde - Last Version - Free game and code
2. [↑](#cite_ref-2) [Native Engine List](http://computer-chess.org/doku.php?id=computer_chess:wiki:lists:native_engine_list) from [Ron Murawski's](/Ron_Murawski "Ron Murawski") [Computer-Chess Wiki](http://computer-chess.org/doku.php?id=home)
