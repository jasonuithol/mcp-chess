...
Source: https://www.chessprogramming.org/Andreas_L._Opdahl

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Andreas L. Opdahl**

[![](/images/0/06/AndreasLOpdahl.jpg)](https://www.uib.no/en/persons/Andreas.Opdahl)

Andreas L. Opdahl [[1]](#cite_note-1)
...
- Andreas L. Opdahl, [Brian Henderson-Sellers](https://en.wikipedia.org/wiki/Brian_Henderson-Sellers) (**2002**). *[Ontological Evaluation of the UML Using the Bunge-Wand-Weber Model](https://link.springer.com/article/10.1007/s10270-002-0003-9)*. [Software and Systems Modeling](https://en.wikipedia.org/wiki/Software_and_Systems_Modeling), Vol. 1, No. 1 [[5]](#cite_note-5)
...
- Andreas L. Opdahl (**2010**). *[Incorporating UML Class and Activity Constructs into UEML](https://link.springer.com/chapter/10.1007%2F978-3-642-16385-2_31)*. [ER Workshops 2010](https://dblp.uni-trier.de/db/conf/er/erw2010.html#Opdahl10) [[6]](#cite_note-6)
...
1. [↑](#cite_ref-1) [Andreas Lothe Opdahl | University of Bergen](https://www.uib.no/en/persons/Andreas.Opdahl)
2. [↑](#cite_ref-2) Andreas L. Opdahl, [Bjørnar Tessem](/Bj%C3%B8rnar_Tessem "Bjørnar Tessem") (**1994**). *Long-Term Planning in Computer Chess*. [Advances in Computer Chess 7](/Advances_in_Computer_Chess_7 "Advances in Computer Chess 7")
3. [↑](#cite_ref-3) [ICGA Reference Database](/ICGA_Journal#RefDB "ICGA Journal")
4. [↑](#cite_ref-4) [dblp: Andreas L. Opdahl](https://dblp.uni-trier.de/pid/12/256.html)
5. [↑](#cite_ref-5) [Unified Modeling Language from Wikipedia](https://en.wikipedia.org/wiki/Unified_Modeling_Language)
6. [↑](#cite_ref-6) [Extended Enterprise Modeling Language](https://en.wikipedia.org/wiki/Extended_Enterprise_Modeling_Language)
