...
Source: https://www.chessprogramming.org/Optimization

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* Optimization**
...
As a warning on premature optimization a quote by [Donald Knuth](/Donald_Knuth "Donald Knuth") [[1]](#cite_note-1):
...
1. [↑](#cite_ref-1) [Donald Knuth](/Donald_Knuth "Donald Knuth") (**1974**).*Structured Programming with go to Statements*. [ACM Computing Surveys](/ACM#Surveys "ACM"), Vol. 6, No. 4, [pdf](http://cs.sjsu.edu/~mak/CS185C/KnuthStructuredProgrammingGoTo.pdf)
