...
Source: https://www.chessprogramming.org/Syzygy_Bases

**[Home](/Main_Page "Main Page") \* [Knowledge](/Knowledge "Knowledge") \* [Endgame Tablebases](/Endgame_Tablebases "Endgame Tablebases") \* Syzygy Bases**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Three_Planets_Dance_Over_La_Silla.jpg/330px-Three_Planets_Dance_Over_La_Silla.jpg)](/File:Three_Planets_Dance_Over_La_Silla.jpg)
...
| Men | WDL | DTZ | Total |
| --- | --- | --- | --- |
| 3-5 | 378.1 [MiB](https://en.wikipedia.org/wiki/Mebibyte) | 561.9 MiB | 939.0 MiB |
| 6 | 67.8 [GiB](https://en.wikipedia.org/wiki/Gibibyte) | 81.4 GiB | 149.2 GiB |
| 7 | 8.5 [TiB](https://en.wikipedia.org/wiki/Tebibyte) | 8.3 TiB | 16.7 TiB |

## Comparision

Syzygy EGTB is significantly smaller than any existent [DTM](/Endgame_Tablebases#DTM "Endgame Tablebases") EGTB. It is 7 times as small as Gaviota for 5 men, 8 times as small as Nalimov for 6 men, and 8 times as small as Lomonosov for 7 men. However, when all DTM EGTBs have full data from two sides, Syzygy EGTB omits data from one side for DTZ data to save space. [Ronald de Man](/Ronald_de_Man "Ronald de Man") estimated if we keep them all, Syzygy's 6 men size may increase by 158 GB, become 307 GB in total, double in size, and be 4 times as small as Nalimov's 6 men.
...
After the completion of the 7-man, some people were curious about the feasibility of building the 8-man. Ronald de Man estimated that without modifying much the generator, the task requires computers with 64 TB RAM and 2000 TB hard disks[[10]](#cite_note-10) (cost about $640K and $40K respectively in 2020 [[11]](#cite_note-11)). The generator can be modified to work on much cheaper computers with 64 GB RAM but that may need a few thousand years of computing[[12]](#cite_note-12).
...
During the [search](/Search "Search"), with the WDL tables stored on [SSD](https://en.wikipedia.org/wiki/Solid-state_drive) [[13]](#cite_note-13), it is possible to probe the tables at all [depths](/Depth "Depth") without much slowdown. They have been tested in Ronald de Man's engine [Sjaak](/Sjaak "Sjaak") (playing on [FICS](/index.php?title=FICS&action=edit&redlink=1 "FICS (page does not exist)") as TrojanKnight(C)) for a couple of months quite successfully, don't probe in [quiescence search](/Quiescence_Search "Quiescence Search").

## At the Root

At the [root](/Root "Root"), since pure DTZ50-optimal play (i.e. minimaxing the number of moves to the next [capture](/Captures "Captures") or [pawn move](/Pawn_Push "Pawn Push") by either side) can be very unnatural, it might be desirable to let the engine search on the winning moves until it becomes clear that insufficient progress is being made and only then switch to DTZ-optimal play (e.g. by detecting [repetitions](/Repetitions "Repetitions") and monitoring the [halfmove clock](/Halfmove_Clock "Halfmove Clock")) [[14]](#cite_note-14).
...
[Jon Dart](/Jon_Dart "Jon Dart") has a fork of Fathom with some bug fixes and enhancements [[19]](#cite_note-19), also supporting 7-man [[20]](#cite_note-20).

## Pyrrhic

**Pyrrhic** is a cleaned up Fathom by [Andrew Grant](/Andrew_Grant "Andrew Grant"), introduced in August 2020 [[21]](#cite_note-21) [[22]](#cite_note-22).

# Elo gained by Stockfish

## Stockfish with Classical [Evaluation](/Evaluation "Evaluation")

[Fishtest](/Stockfish#Fishtest "Stockfish") team revealed a test with [Stockfish](/Stockfish "Stockfish") (SF10dev) at 10+0.1, with all Syzygy WDL files on RAM, testing using none(0), 4, 5, and 6 men TB in a round-robin tournament[[23]](#cite_note-23).
...
Elo gains by Stockfish NNUE with Sygyzy 6 men have decreased[[24]](#cite_note-24). With version 15, it gains only 2.7 Elo.

[![Stockfish-syzygy-elo-gain.png](/images/thumb/e/ef/Stockfish-syzygy-elo-gain.png/1024px-Stockfish-syzygy-elo-gain.png)](/File:Stockfish-syzygy-elo-gain.png)

# Support other chess variants

With the request by Yunus Emre Ayhan on September 2024, [Ronald de Man](/Ronald_de_Man "Ronald de Man") modified Syzygy to support Shatranj, a chess variant. Using that code, [Bojun Guo](/Bojun_Guo "Bojun Guo") has generated all 6-man EGTB[[25]](#cite_note-25).

# Quotes

by [Ronald de Man](/Ronald_de_Man "Ronald de Man") in a reply to [Guy Haworth](/Guy_Haworth "Guy Haworth"), April 06, 2013 [[26]](#cite_note-26) :

```
I create both WDL and DTZ in one go, so I don't use WDL in the creation of DTZ. The algorithm used is the grandfather algorithm with 2 plies per iteration (I think HGM calls this leapfrogging, but I might be wrong). I tried the outcounting method, but it didn't seem to be competitive (and it makes things more complicated). [27] [28]
A pure WDL/DTZ pair is not of much use for creating WDL50+/DTZ50+. I create tables in RAM that have all the information necessary for WDL50+ and DTZ50+, then permute them to different indexing schemes and compress them. I do test runs on subsets of the data to find good permutations. (The idea to try permutations is from Jesper Torp Kristensen's master thesis.) [29] [30]
```

[Ronald de Man](/Ronald_de_Man "Ronald de Man") explained some advantages of Syzyzy over [Nalimov Tablebases](/Nalimov_Tablebases "Nalimov Tablebases"), July 06, 2019 [[31]](#cite_note-31) :
...
In addition, 7-man syzygy TBs are now available. With SSDs becoming cheaper and cheaper, having 7-men WDL TBs on SSD starts to become a practical possibility (unfortunately RAM prices are lagging behind).
```

[Ronald de Man](/Ronald_de_Man "Ronald de Man") in a reply to [Nguyen Pham](/Pham_Hong_Nguyen "Pham Hong Nguyen"), April 15, 2020 [[32]](#cite_note-32) :
...
[Morgan Houppin](/Morgan_Houppin "Morgan Houppin") explained why his chess engine [Stash](/Stash "Stash") doesn't have Syzygy probe code, March 25, 2021 [[33]](#cite_note-33) :
...
In his 2014 *Chess Endgame News* in [ICGA Journal, Vol. 37, No. 2](/ICGA_Journal#37_2 "ICGA Journal") [[34]](#cite_note-34) , [Guy Haworth](/Guy_Haworth "Guy Haworth") classified Syzygy Bases as **new** data in **three** ways:
...
- [New 6-piece tablebases](http://www.talkchess.com/forum/viewtopic.php?t=47681) by [Ronald de Man](/Ronald_de_Man "Ronald de Man"), [CCC](/CCC "CCC"), April 01, 2013 [[35]](#cite_note-35)
...
- [Problem with 6-piece syzygy-bases using wine](http://www.talkchess.com/forum/viewtopic.php?t=50337) by [Bernhard Bauer](/index.php?title=Bernhard_Bauer&action=edit&redlink=1 "Bernhard Bauer (page does not exist)"), [CCC](/CCC "CCC"), December 05, 2013 [[36]](#cite_note-36)
...
- [Re: Squash anyone?](http://www.talkchess.com/forum/viewtopic.php?t=59175&start=4) by [Ronald de Man](/Ronald_de_Man "Ronald de Man"), [CCC](/CCC "CCC"), February 07, 2016 [[37]](#cite_note-37)
...
- [Almost perfect DTM tablebase](https://talkchess.com/forum3/viewtopic.php?f=7&t=73598) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCC](/CCC "CCC"), April 08, 2020
- [What is the best way to obtain the 7-piece tablebases?](https://talkchess.com/forum3/viewtopic.php?f=2&t=74185) by [Mark Thellen](/index.php?title=Mark_Thellen&action=edit&redlink=1 "Mark Thellen (page does not exist)"), [CCC](/CCC "CCC"), June 15, 2020
- [Pyrrhic, Fathom for Humanoids](https://talkchess.com/forum3/viewtopic.php?f=7&t=74809) by [Andrew Grant](/Andrew_Grant "Andrew Grant"), [CCC](/CCC "CCC"), August 16, 2020 » [Pyrrhic](#Pyrrhic)
- [EGTB compression](https://talkchess.com/forum3/viewtopic.php?f=7&t=75396) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCC](/CCC "CCC"), October 14, 2020 [[38]](#cite_note-38) [[39]](#cite_note-39)
- [Syzygy bases ... question to "Syzygy Probe Depth"](https://talkchess.com/forum3/viewtopic.php?f=2&t=75487) by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky"), [CCC](/CCC "CCC"), October 21, 2020
- [Fathom and 7-men](https://talkchess.com/forum3/viewtopic.php?f=7&t=75906) by [Joshua Shriver](/index.php?title=Joshua_Shriver&action=edit&redlink=1 "Joshua Shriver (page does not exist)"), [CCC](/CCC "CCC"), November 24, 2020 » [Fathom](#Fathom)
- [Problem with Syzygy tablebase](https://talkchess.com/forum3/viewtopic.php?f=7&t=75973) by [Elias Nilsson](/index.php?title=Elias_Nilsson&action=edit&redlink=1 "Elias Nilsson (page does not exist)"), [CCC](/CCC "CCC"), December 03, 2020
- [Can EGTB storage requirements be reduced using this scheme?](https://talkchess.com/forum3/viewtopic.php?f=7&t=76010) by mmt, [CCC](/CCC "CCC"), December 07, 2020

**2021**

- [Syzygy Tablebase Names: A very stupid exercise](https://talkchess.com/forum3/viewtopic.php?f=7&t=77267) by [Andrew Grant](/Andrew_Grant "Andrew Grant"), [CCC](/CCC "CCC"), May 08, 2021
- [syzygy implementation](https://talkchess.com/forum3/viewtopic.php?f=7&t=77358) by [Desperado](/Michael_Hoffmann "Michael Hoffmann"), [CCC](/CCC "CCC"), May 23, 2021
- [When will 8 piece tablebase be ready?](https://talkchess.com/forum3/viewtopic.php?f=2&t=77400) by [Agustin Jorge Pichardo](/index.php?title=Agustin_Jorge_Pichardo&action=edit&redlink=1 "Agustin Jorge Pichardo (page does not exist)"), [CCC](/CCC "CCC"), May 29, 2021
- [Syzygy bases from memory](https://talkchess.com/forum3/viewtopic.php?f=7&t=77499) by [Ed Schröder](/Ed_Schroder "Ed Schroder"), [CCC](/CCC "CCC"), June 16, 2021 » [KPK](/KPK "KPK")
- [Syzygy benefit for current SF](https://talkchess.com/forum3/viewtopic.php?f=2&t=78080) by [Jouni](/index.php?title=Jouni&action=edit&redlink=1 "Jouni (page does not exist)"), [CCC](/CCC "CCC"), September 02, 2021

**2022**

- [Definite occurance ranking of 7-Man EGTB](https://talkchess.com/forum3/viewtopic.php?f=7&t=79938) by [Daniel Infuehr](/index.php?title=Daniel_Infuehr&action=edit&redlink=1 "Daniel Infuehr (page does not exist)"), [CCC](/CCC "CCC"), May 24, 2022
- [Fathom, munmap issue](https://talkchess.com/forum3/viewtopic.php?f=7&t=80522) by [Pawel Osikowski](/index.php?title=Pawel_Osikowski&action=edit&redlink=1 "Pawel Osikowski (page does not exist)"), [CCC](/CCC "CCC"), August 19, 2022
- [Are tablebases useless for Stockfish15?](https://talkchess.com/forum3/viewtopic.php?f=2&t=80608) by [Jouni](/index.php?title=Jouni&action=edit&redlink=1 "Jouni (page does not exist)"), [CCC](/CCC "CCC"), September 02, 2022
- [endgame table generation](https://talkchess.com/forum3/viewtopic.php?f=7&t=80696) by [Dave Gomboc](/Dave_Gomboc "Dave Gomboc"), [CCC](/CCC "CCC"), September 17, 2022

**2023**

- [very strange behavior with syzygy tables](https://talkchess.com/forum3/viewtopic.php?f=7&t=82115) by [Carbec](/index.php?title=Carbec&action=edit&redlink=1 "Carbec (page does not exist)"), [CCC](/CCC "CCC"), June 02, 2023
- [EGTB encoding](https://talkchess.com/forum3/viewtopic.php?f=7&t=82613) by [Edmund](/index.php?title=Edmund&action=edit&redlink=1 "Edmund (page does not exist)"), [CCC](/CCC "CCC"), September 18, 2023
- [Need a tip for 6-man syzygy ...](https://talkchess.com/forum3/viewtopic.php?f=2&t=82937) by [Frank Quisinsky](/Frank_Quisinsky "Frank Quisinsky"), [CCC](/CCC "CCC"), December 02, 2023

**2024**

- [How is work on 8-man tablebases progressing?](https://talkchess.com/viewtopic.php?t=84220) by [Urban Koistinen](/Urban_Koistinen "Urban Koistinen"), [CCC](/CCC "CCC"), September 11, 2024
- [Porting syzgy/tb to an old version chess (shatranj)](https://talkchess.com/viewtopic.php?t=84243) by [Yunus Emre Ayhan](/index.php?title=Yunus_Emre_Ayhan&action=edit&redlink=1 "Yunus Emre Ayhan (page does not exist)"), [CCC](/CCC "CCC"), September 15, 2024
- [Problem with Syzygy bases](https://talkchess.com/viewtopic.php?t=84518) by [Rebel](/Ed_Schroder "Ed Schroder"), [CCC](/CCC "CCC"), November 21, 2024

## 2025 ...

**2025**

- [Using Neural Network or Syzygy tables](https://talkchess.com/viewtopic.php?t=85120) by [OliverBr](/Oliver_Brausch "Oliver Brausch"), [CCC](/CCC "CCC"), May 26, 2025
- [New tablebase probing/interface code (and probing tool)](https://talkchess.com/viewtopic.php?t=85522) by [syzygy](/Ronald_de_Man "Ronald de Man"), [CCC](/CCC "CCC"), October 01, 2025
...
- [OICS Chess and EGTB Tracker Statistics](http://oics.olympuschess.com/tracker/index.php) by [Joshua Shriver](/index.php?title=Joshua_Shriver&action=edit&redlink=1 "Joshua Shriver (page does not exist)") [[40]](#cite_note-40)
...
- [Chess Cloud Database Query Interface](https://www.chessdb.cn/queryc_en/) by [noobpwnftw](/Bojun_Guo "Bojun Guo") [[41]](#cite_note-41)
...
10. [↑](#cite_ref-10) [Re: What is the best way to obtain the 7-piece tablebases?](https://talkchess.com/forum3/viewtopic.php?f=2&t=74185&start=20#p848245) by [syzygy](/Ronald_de_Man "Ronald de Man"), [CCC](/CCC "CCC"), June 22, 2020
11. [↑](#cite_ref-11) [Re: What is the best way to obtain the 7-piece tablebases?](https://talkchess.com/forum3/viewtopic.php?t=74185&start=30#p848394) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCC](/CCC "CCC"), June 23, 2020
12. [↑](#cite_ref-12) [Re: How is work on 8-man tablebases progressing?](https://talkchess.com/viewtopic.php?p=968443#p968443) by [syzygy](/Ronald_de_Man "Ronald de Man"), [CCC](/CCC "CCC"), September 12, 2024
13. [↑](#cite_ref-13) [Re: SSD and the use of Tablebases](http://www.talkchess.com/forum/viewtopic.php?t=47931&start=2) by [Ronald de Man](/Ronald_de_Man "Ronald de Man"), [CCC](/CCC "CCC"), May 08, 2013
14. [↑](#cite_ref-14) [Re: New 6-piece tablebases](http://www.talkchess.com/forum/viewtopic.php?t=47681&start=8) by [Ronald de Man](/Ronald_de_Man "Ronald de Man"), [CCC](/CCC "CCC"), April 05, 2013
15. [↑](#cite_ref-15) [Endgame Turbo 4](http://shop.chessbase.com/en/products/endspiel_turbo_4) by [ChessBase](/ChessBase "ChessBase")
16. [↑](#cite_ref-16) [Syzygy Tablebases: newest, fastest, smallest](http://en.chessbase.com/post/syzygy-tablebases-newest-fastest-smallest) by [Albert Silver](/Albert_Silver "Albert Silver"), [ChessBase News](/ChessBase "ChessBase"), February 08, 2015
17. [↑](#cite_ref-17) [Gull 3 Linux+Syzygy and Fathom released](http://www.talkchess.com/forum/viewtopic.php?t=58299) by [Basil Falcinelli](/Basil_Falcinelli "Basil Falcinelli"), [CCC](/CCC "CCC"), November 20, 2015
18. [↑](#cite_ref-18) [GitHub - basil00/Fathom: Syzygy TB probe tool](https://github.com/basil00/Fathom) by [Basil Falcinelli](/Basil_Falcinelli "Basil Falcinelli")
19. [↑](#cite_ref-19) [jdart1/Fathom · GitHub](https://github.com/jdart1/Fathom) by [Jon Dart](/Jon_Dart "Jon Dart")
20. [↑](#cite_ref-20) [7-man Syzygy support in Fathom](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=70568) by [Jon Dart](/Jon_Dart "Jon Dart"), [CCC](/CCC "CCC"), April 23, 2019
21. [↑](#cite_ref-21) [Pyrrhic, Fathom for Humanoids](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=74809) by [Andrew Grant](/Andrew_Grant "Andrew Grant"), [CCC](/CCC "CCC"), August 16, 2020
22. [↑](#cite_ref-22) [GitHub - AndyGrant/Pyrrhic: Fathom, for Humanoids](https://github.com/AndyGrant/Pyrrhic/)
23. [↑](#cite_ref-23) <https://github.com/glinscott/fishtest/wiki/UsefulData> Collection of useful data concerning SF
24. [↑](#cite_ref-24) [Useful data · official-stockfish/Stockfish · GitHub](https://github.com/official-stockfish/Stockfish/wiki/Useful-data#elo-gain-using-syzygy) by [Joost VandeVondele](/Joost_VandeVondele "Joost VandeVondele"), August 26, 2023
25. [↑](#cite_ref-25) [Porting syzgy/tb to an old version chess (shatranj)](https://talkchess.com/viewtopic.php?t=84243) by [Yunus Emre Ayhan](/index.php?title=Yunus_Emre_Ayhan&action=edit&redlink=1 "Yunus Emre Ayhan (page does not exist)"), [CCC](/CCC "CCC"), September 15, 2024
26. [↑](#cite_ref-26) [Re: New 6-piece tablebase generator](http://kirill-kryukov.com/chess/discussion-board/viewtopic.php?f=6&t=6971&start=6) by [syzygy](/Ronald_de_Man "Ronald de Man"), [CCRL Discussion Board](/Computer_Chess_Forums "Computer Chess Forums"), April 06, 2013
27. [↑](#cite_ref-27) [Retrograde tablebase methods](http://www.open-chess.org/viewtopic.php?f=5&t=779) by [BB+](/Mark_Watkins "Mark Watkins"), [OpenChess Forum](/Computer_Chess_Forums "Computer Chess Forums"), November 26, 2010
28. [↑](#cite_ref-28) [Leapfrog: Retrograde Analysis](http://home.hccnet.nl/h.g.muller/EGT7/retro.html) from [Leapfrog tablebase generator](http://home.hccnet.nl/h.g.muller/EGT7/7-men.html) by [Harm Geert Muller](/Harm_Geert_Muller "Harm Geert Muller")
29. [↑](#cite_ref-29) [Jesper Torp Kristensen](/Jesper_Torp_Kristensen "Jesper Torp Kristensen") (**2005**). *[Generation and compression of endgame tables in chess with fast random access using OBDDs](https://issuu.com/jespertk/docs/master_thesis)*. Master thesis, supervisor [Peter Bro Miltersen](/Mathematician#Miltersen "Mathematician"), [Aarhus University](https://en.wikipedia.org/wiki/Aarhus_University)
30. [↑](#cite_ref-30) [OBDD - Ordered Binary Decision Diagram from Wikipedia](https://en.wikipedia.org/wiki/Binary_decision_diagram)
31. [↑](#cite_ref-31) [Re: DTM50](https://www.talkchess.com/forum3/viewtopic.php?p=804007#p804007) by [Ronald de Man](/Ronald_de_Man "Ronald de Man"), [CCRL Discussion Board](/Computer_Chess_Forums "Computer Chess Forums"), July 06, 2019
32. [↑](#cite_ref-32) [Re: Almost perfect DTM tablebase](https://talkchess.com/forum3/viewtopic.php?f=7&t=73598) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCRL Discussion Board](/Computer_Chess_Forums "Computer Chess Forums"), April 15, 2020
33. [↑](#cite_ref-33) [Re: Stash has lost 2 game because of NO EGTB](https://talkchess.com/forum3/viewtopic.php?f=2&t=76927#p888045) by [Morgan Houppin](/Morgan_Houppin "Morgan Houppin"), [CCC](/CCC "CCC"), March 25, 2021
34. [↑](#cite_ref-34) [Guy Haworth](/Guy_Haworth "Guy Haworth") (**2014**). *Chess Endgame News*. [ICGA Journal, Vol. 37, No. 2](/ICGA_Journal#37_2 "ICGA Journal")
35. [↑](#cite_ref-35) [Found an interesting research](https://plus.google.com/100454521496393505718/posts/5C252LggQQS) by [Kirill Kryukov](/Kirill_Kryukov "Kirill Kryukov"), April, 12, 2013
36. [↑](#cite_ref-36) [Wine (software) from Wikipedia](https://en.wikipedia.org/wiki/Wine_%28software%29)
37. [↑](#cite_ref-37) [N. Jesper Larsson](https://scholar.google.de/citations?user=8pKMsLMAAAAJ&hl=en), [Alistair Moffat](http://findanexpert.unimelb.edu.au/display/person13222) (**1999**). *[Offline Dictionary-Based Compression](http://dl.acm.org/citation.cfm?id=789701)*. [DCC'99](http://www.cs.brandeis.edu//~dcc/Programs/Program1999.pdf), [pdf](http://www.larsson.dogma.net/dcc99.pdf)
38. [↑](#cite_ref-38) [LZ4 (compression algorithm) from Wikipedia](https://en.wikipedia.org/wiki/LZ4_(compression_algorithm))
39. [↑](#cite_ref-39) [Zstandard from Wikipedia](https://en.wikipedia.org/wiki/Zstandard)
40. [↑](#cite_ref-40) [BitTorrent from Wikipedia](https://en.wikipedia.org/wiki/BitTorrent)
41. [↑](#cite_ref-41) [ChessDBCN](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=71764) by [noobpwnftw](/Bojun_Guo "Bojun Guo"), [CCC](/CCC "CCC"), September 09, 2019
