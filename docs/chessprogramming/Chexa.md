...
Source: https://www.chessprogramming.org/Chexa

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Chexa**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Chex-Mix-Pile.jpg/330px-Chex-Mix-Pile.jpg)](/File:Chex-Mix-Pile.jpg)

A pile of Chex Mix [[1]](#cite_note-1)

**Chexa**,  
a private [Chess Engine Communication Protocol](/Chess_Engine_Communication_Protocol "Chess Engine Communication Protocol") compliant chess engine by [Mauro Riccardi](/Mauro_Riccardi "Mauro Riccardi"), written in [C](/C "C") [[2]](#cite_note-2).
...
Mauro Riccardi is in the process to find the right balance of [passed pawn](/Passed_Pawn "Passed Pawn") and [candidate](/Candidate_Passed_Pawn "Candidate Passed Pawn") values, since too often Chexa has overestimated their good locations, and is about to introduce a table to evaluate [pawn islands](/Pawn_Islands "Pawn Islands") [[3]](#cite_note-3).

# Photos & Games

## CCC 2009

[![CCC2009ChexaBremboCE.jpg](/images/1/12/CCC2009ChexaBremboCE.jpg)](/File:CCC2009ChexaBremboCE.jpg)

[Gianluca Cisana](/Gianluca_Cisana "Gianluca Cisana") and [Mauro Riccardi](/Mauro_Riccardi "Mauro Riccardi") in front, organizer [Giuseppe Sgrò](/index.php?title=Giuseppe_Sgr%C3%B2&action=edit&redlink=1 "Giuseppe Sgrò (page does not exist)") addresses the audience [[4]](#cite_note-4)  
...
1. [↑](#cite_ref-1) [Chex Mix](https://en.wikipedia.org/wiki/Chex_Mix) Photo by [Evan-Amos](https://commons.wikimedia.org/wiki/User:Evan-Amos), November 20, 2010, [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
...
3. [↑](#cite_ref-3) [Chexa « G 6](http://www.g-sei.org/chexa/)
4. [↑](#cite_ref-4) [Chess Computer Cup 4 - Photo Gallerie 1](http://www.scaccomasco.com/foto/2009/CCC4-7_nov/album/index.html) (no longer available)
