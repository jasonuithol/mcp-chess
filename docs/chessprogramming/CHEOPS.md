...
Source: https://www.chessprogramming.org/CHEOPS

**[Home](/Main_Page "Main Page") \* [Hardware](/Hardware "Hardware") \* CHEOPS**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Kheops-Pyramid.jpg/330px-Kheops-Pyramid.jpg)](/File:Kheops-Pyramid.jpg)

Pyramid of Cheops [[1]](#cite_note-1)

**CHEOPS**,  
a **Che**ss-**O**riented **P**rocessing **S**ystem with a dedicated chess processor, developed end of the 70s at [MIT](/Massachusetts_Institute_of_Technology "Massachusetts Institute of Technology") by [John Moussouris](/John_Moussouris "John Moussouris"), [Jack Holloway](/Jack_Holloway "Jack Holloway") and [Richard Greenblatt](/Richard_Greenblatt "Richard Greenblatt"), derived from the original conception and design of a 8x8 hardware chess array instrumented by [Edward Fredkin](/Edward_Fredkin "Edward Fredkin"). CHEOPS was used by [Baisley's](/Alan_Baisley "Alan Baisley") [Tech 2](/Tech#Tech2 "Tech") and a [brute force](/Brute-Force "Brute-Force") version of [Greenblatt's](/Richard_Greenblatt "Richard Greenblatt") [Mac Hack](/Mac_Hack "Mac Hack") [[2]](#cite_note-2), but unfortunately have never competed in computer chess tournaments with this approach. According to [Joe Condon](/Joe_Condon "Joe Condon") and [Ken Thompson](/Ken_Thompson "Ken Thompson"), already working on a chess hardware for [Belle](/Belle "Belle"), the problem with CHEOPS was the lack of positional [evaluation](/Evaluation "Evaluation") support [[3]](#cite_note-3).

# Block Diagrams

[![CHEOPS block diagram](/images/thumb/7/73/Cheops.png/1024px-Cheops.png)](/File:Cheops.png "CHEOPS block diagram")
[![CHARM block diagram](/images/thumb/0/00/Charm1.png/1024px-Charm1.png)](/File:Charm1.png "CHARM block diagram")
...
- [Cheops](/Cheops_(Miller) "Cheops (Miller)") (CHEss OPponent Simulator) by [Tristan Miller](/index.php?title=Tristan_Miller&action=edit&redlink=1 "Tristan Miller (page does not exist)") [[4]](#cite_note-4)
...
1. [↑](#cite_ref-1) [Great Pyramid of Giza](https://en.wikipedia.org/wiki/Great_Pyramid_of_Giza), Photo by [Nina Aldin Thune](http://no.wikipedia.org/wiki/Bruker:Nina), March 2005, [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [John Moussouris](/John_Moussouris "John Moussouris"), [Jack Holloway](/Jack_Holloway "Jack Holloway"), [Richard Greenblatt](/Richard_Greenblatt "Richard Greenblatt") (**1979**). *[CHEOPS: A Chess-orientated Processing System](http://portal.acm.org/citation.cfm?id=61701.67028)*. [Machine Intelligence 9](http://www.doc.ic.ac.uk/~shm/MI/mi9.html), reprinted (**1988**) in [Computer Chess Compendium](/Computer_Chess_Compendium "Computer Chess Compendium")
3. [↑](#cite_ref-3) [Joe Condon](/Joe_Condon "Joe Condon"), [Ken Thompson](/Ken_Thompson "Ken Thompson") (**1982**). *Belle Chess Hardware*. [Advances in Computer Chess 3](/Advances_in_Computer_Chess_3 "Advances in Computer Chess 3"), Reprinted (**1988**) in [Computer Chess Compendium](/Computer_Chess_Compendium "Computer Chess Compendium")
4. [↑](#cite_ref-4) [CHEOPS - nothingisreal.com](http://en.nothingisreal.com/wiki/CHEOPS)
