...
A shiftless [sign extension](/Score#SignExtension "Score") might be applied by [[2]](#cite_note-2):
...
Count the Number of Trailing Zero Bits, [Trailing Zero Count](/BitScan#TrailingZeroCount "BitScan") [[3]](#cite_note-3).
...
- [AMD64 Architecture Programmer’s Manual Volume 3: General-Purpose and System Instructions](https://www.amd.com/system/files/TechDocs/24594.pdf) (pdf) [[4]](#cite_note-4)
...
1. [↑](#cite_ref-1) [AMD64 Architecture Programmer’s Manual Volume 3: General-Purpose and System Instructions](https://www.amd.com/system/files/TechDocs/24594.pdf) (pdf)
2. [↑](#cite_ref-2) [Sign Extension](http://aggregate.org/MAGIC/#Sign%20Extension) from [The Aggregate Magic Algorithms](http://aggregate.org/MAGIC) by [Hank Dietz](/Hank_Dietz "Hank Dietz")
...
4. [↑](#cite_ref-4) Moved BMI and TBM instructions from Volume 4 to Volume 3 in September 2011
