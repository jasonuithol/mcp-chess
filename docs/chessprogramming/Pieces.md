...
Source: https://www.chessprogramming.org/Pieces

**[Home](/Main_Page "Main Page") \* [Chess](/Chess "Chess") \* Pieces**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/JaquesCookStaunton.jpg/330px-JaquesCookStaunton.jpg)](/File:JaquesCookStaunton.jpg)

[Pawn](/Pawn "Pawn"), [Rook](/Rook "Rook"), [Knight](/Knight "Knight"), [Bishop](/Bishop "Bishop"). [Queen](/Queen "Queen"), and [King](/King "King") [[1]](#cite_note-1)
...
| 1 | `0000 0010` | Black |
| combined (ored with) | | |
| 2 | `0000 0100` | [Pawn](/Pawn "Pawn") |
| 3 | `0000 1000` | [Knight](/Knight "Knight") |
| 4 | `0001 0000` | [Bishop](/Bishop "Bishop") |
| 5 | `0010 0000` | [Rook](/Rook "Rook") |
| 6 | `0100 0000` | [Queen](/Queen "Queen") |
| 7 | `1000 0000` | [King](/King "King") |
...
[ASCII art](https://en.wikipedia.org/wiki/ASCII_art) chess pieces, collected by Andreas Freise [[4]](#cite_note-4):
...
[ASCII art](https://en.wikipedia.org/wiki/ASCII_art) [Staunton chess set](https://en.wikipedia.org/wiki/Staunton_chess_set) by David Moeser [[5]](#cite_note-5)
...
2. [↑](#cite_ref-2)  [Burton Wendroff](/Burton_Wendroff "Burton Wendroff") (**1985**). *Attack Detection and Move Generation on the [X-MP/48](http://www.cisl.ucar.edu/computers/gallery/cray/xmp.jsp).* [ICCA Journal](/ICGA_Journal "ICGA Journal"), Vol. 8, No. 2
3. [↑](#cite_ref-3) [Fritz Reul](/Fritz_Reul "Fritz Reul") (**2009**). *New Architectures in Computer Chess*, Ph.D. Thesis, *Chapter 2 Non-Bitboard Architectures*
4. [↑](#cite_ref-4) [chess - Ascii Art Dictionary](http://www.ascii-art.de/ascii/c/chess.txt) by [Andreas Freise](http://www.sr.bham.ac.uk/~adf/)
5. [↑](#cite_ref-5) [ASCII Chess Pieces](http://www.chessvariants.com/d.pieces/ascii.html) by [David Moeser](http://www.chessvariants.com/books.html#lotus)
