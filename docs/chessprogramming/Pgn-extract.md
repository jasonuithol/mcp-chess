...
Source: https://www.chessprogramming.org/Pgn-extract

**[Home](/Main_Page "Main Page") \* [Software](/Software "Software") \* [Utilities](/Utilities "Utilities") \* pgn-extract**
...
**pgn-extract** is capable of handling files containing millions of games and also recognises [Chess960](/Chess960 "Chess960") encodings [[1]](#cite_note-1).
...
1. [↑](#cite_ref-1) [pgn-extract: Portable Game Notation (PGN) Manipulator for Chess Games](https://www.cs.kent.ac.uk/people/staff/djb/pgn-extract/)
