...
Source: https://www.chessprogramming.org/3D_Graphics_Board

**[Home](/Main_Page "Main Page") \* [Programming](/Programming "Programming") \* [Graphics Programming](/Graphics_Programming "Graphics Programming") \* 3D Graphics Board**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Alfil.gif/330px-Alfil.gif)](/File:Alfil.gif)

A [rendered](https://en.wikipedia.org/wiki/3D_rendering) [3D animation](https://en.wikipedia.org/wiki/Computer_animation) [[1]](#cite_note-1)
...
| [Colossus Chess 4.0](/Colossus_Chess "Colossus Chess") 3D chessboard [[2]](#cite_note-2) | [Cyrus II](/Cyrus "Cyrus") 3D screen [[3]](#cite_note-3) |
...
[Chessmaster XI](/Chessmaster "Chessmaster") - House of Staunton chess sets [[4]](#cite_note-4)

## [ChessPartner](/ChessPartner "ChessPartner")

[![Chesspartner.jpg](/images/6/6f/Chesspartner.jpg)](http://www.lokasoft.nl/chesspartner.aspx)

[ChessPartner 6](/ChessPartner "ChessPartner"), 3D pieces [[5]](#cite_note-5)

## [KnightCap](/KnightCap "KnightCap")

[![Thingone.gif](/images/a/aa/Thingone.gif)](http://www.samba.org/KnightCap/)

KnightCap's 3D Board [[6]](#cite_note-6) [[7]](#cite_note-7)

## [Nemeton](/Nemeton "Nemeton")

[![Nemeton12.jpg](/images/f/f4/Nemeton12.jpg)](http://www.talkchess.com/forum/viewtopic.php?t=64177)

[Nemeton3D](/Nemeton "Nemeton") 1.51 with its 3D Graphics Board [[8]](#cite_note-8)

## [Uragano 3D](/Uragano "Uragano")

[![Uragano3d.jpg](/images/3/3d/Uragano3d.jpg)](http://www.naddei.it/uragano_3d/)

[Uragano 3D](/Uragano "Uragano") board [[9]](#cite_note-9)
...
- [Nina Amenta](http://www.cs.ucdavis.edu/%7Eamenta/), [Yong Joo Kil](http://graphics.cs.ucdavis.edu/%7Eyjkil/) (**2005**). *[Defining Point-Set Surfaces](http://graphics.cs.ucdavis.edu/%7Eyjkil/pub/defining.html)*. [pdf](http://graphics.stanford.edu/courses/cs468-05-winter/Papers/PCD/amenta_PCD.pdf) [[10]](#cite_note-10)
...
1. [↑](#cite_ref-1) Image selfmade with [Blender](https://en.wikipedia.org/wiki/Blender_%28software%29), Author: [J.A. Freyre](https://en.wikipedia.org/wiki/User:Jfreyre), January 22 2006, [CC BY-SA 2.5](https://creativecommons.org/licenses/by-sa/2.5/deed.en), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [Colossus Chess from Wikipedia](https://en.wikipedia.org/wiki/Colossus_Chess)
3. [↑](#cite_ref-3) [Cyrus II - World of Spectrum](http://www.worldofspectrum.org/infoseekid.cgi?id=0001213)
4. [↑](#cite_ref-4) [PC-Screenshots | Chessmaster XI: The Art of Learning](http://chessmaster.de.ubi.com/xi/pcScreens.php) | [Ubisoft](/index.php?title=Ubisoft&action=edit&redlink=1 "Ubisoft (page does not exist)")
5. [↑](#cite_ref-5) [ChessPartner Screen shots | ChessPartner - Lokasoft - Home of ChessPartner](http://www.lokasoft.nl/chesspartner.aspx)
6. [↑](#cite_ref-6) [Welcome to the KnightCap home page](http://samba.anu.edu.au/KnightCap/)
7. [↑](#cite_ref-7) [Re: Going commercial, maybe](https://groups.google.com/group/rec.games.chess.computer/msg/ded7e4e4304d8d4e) by [Andrew Tridgell](/Andrew_Tridgell "Andrew Tridgell"), [rgcc](/Computer_Chess_Forums "Computer Chess Forums"), March 9, 1997
8. [↑](#cite_ref-8) [Nemeton3D 1.51](http://www.talkchess.com/forum/viewtopic.php?t=64177) by [Stan Arts](/Stan_Arts "Stan Arts"), [CCC](/CCC "CCC"), June 04, 2017
9. [↑](#cite_ref-9) [Home page Uragano 3D](http://www.naddei.it/uragano_3d/)
10. [↑](#cite_ref-10) [Pointshop3D](http://graphics.ethz.ch/pointshop3d/) developed at the Computer Graphics Lab at [ETH Zurich](/ETH_Zurich "ETH Zurich")
