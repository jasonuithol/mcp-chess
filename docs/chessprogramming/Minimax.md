...
Source: https://www.chessprogramming.org/Minimax

**[Home](/Main_Page "Main Page") \* [Search](/Search "Search") \* Minimax**

[![](/images/d/d8/ConstructedbyMinimaxDadamax.jpg)](https://en.wikipedia.org/wiki/Little_Machine_Constructed_by_Minimax_Dadamax_in_Person)

[Max Ernst](/Category:Max_Ernst "Category:Max Ernst") - [Little Machine Constructed](https://en.wikipedia.org/wiki/Little_Machine_Constructed_by_Minimax_Dadamax_in_Person) by [Minimax Dadamax in Person](https://en.wikipedia.org/wiki/Little_Machine_Constructed_by_Minimax_Dadamax_in_Person), 1919-1920 [[1]](#cite_note-1)
...
[Jaap van den Herik's](/Jaap_van_den_Herik "Jaap van den Herik") thesis (1983) [[2]](#cite_note-2) contains a detailed account of the known publications on that topic. It concludes that although [John von Neumann](/John_von_Neumann "John von Neumann") is usually associated with that concept ([1928](/Timeline#1928 "Timeline")) [[3]](#cite_note-3) , [primacy](https://en.wikipedia.org/wiki/Primacy_of_mind) probably belongs to [Émile Borel](/Mathematician#Borel "Mathematician"). Further there is a conceivable claim that the first to credit should go to [Charles Babbage](/Mathematician#Babbage "Mathematician") [[4]](#cite_note-4). The original minimax as defined by Von Neumann is based on exact values from [game-terminal positions](/Terminal_Node "Terminal Node"), whereas the minimax search suggested by [Norbert Wiener](/Norbert_Wiener "Norbert Wiener") [[5]](#cite_note-5) is based on [heuristic evaluations](/Evaluation "Evaluation") from positions a few moves distant, and far from the end of the game.
...
- [John von Neumann](/John_von_Neumann "John von Neumann") (**1928**). *[Zur Theorie der Gesellschaftsspiele](http://gdz.sub.uni-goettingen.de/dms/load/img/?IDDOC=29357)*. Berlin [[6]](#cite_note-6)
...
- [Maurice Sion](/Mathematician#MSion "Mathematician") (**1958**). *[On general minimax theorems](https://projecteuclid.org/euclid.pjm/1103040253)*. [Pacific Journal of Mathematics](https://en.wikipedia.org/wiki/Pacific_Journal_of_Mathematics), Vol. 8, No. 1 [[7]](#cite_note-7)
...
- [Thiruvenkatachari Parthasarathy](/Mathematician#TParthasarathy "Mathematician") (**1970**). *[On Games Over the Unit Square](https://epubs.siam.org/doi/abs/10.1137/0119047?journalCode=smjmap)*. [SIAM Journal on Applied Mathematics](https://en.wikipedia.org/wiki/SIAM_Journal_on_Applied_Mathematics), Vol. 19, No. 2 [[9]](#cite_note-9)
...
1. [↑](#cite_ref-1) [Little Machine Constructed by Minimax Dadamax in Person from Wikipedia](https://en.wikipedia.org/wiki/Little_Machine_Constructed_by_Minimax_Dadamax_in_Person)
2. [↑](#cite_ref-2) [Jaap van den Herik](/Jaap_van_den_Herik "Jaap van den Herik") (**1983**). *Computerschaak, Schaakwereld en Kunstmatige Intelligentie*. Ph.D. thesis, [Delft University of Technology](/Delft_University_of_Technology "Delft University of Technology"). Academic Service, The Hague. ISBN 90 62 33 093 2 (Dutch)
3. [↑](#cite_ref-3) [John von Neumann](/John_von_Neumann "John von Neumann") (**1928**). *[Zur Theorie der Gesellschaftsspiele](http://gdz.sub.uni-goettingen.de/dms/load/img/?IDDOC=29357)*. Berlin
4. [↑](#cite_ref-4) [Don Beal](/Don_Beal "Don Beal") (**1999**). *The Nature of MINIMAX Search*. Ph.D. thesis, ISBN 90-62-16-6348, pp. 2, refers [Philip Morrison](/Mathematician#PhilipMorrison "Mathematician") and Emily Morrison (**1961**). *Charles Babbage and his Calculating Engines*. Dover Publ. New York
5. [↑](#cite_ref-5) [Norbert Wiener](/Norbert_Wiener "Norbert Wiener") (**1948**). *[Cybernetics or Control and Communication in the Animal and the Machine](http://www.amazon.com/gp/reader/026273009X/ref=sib_dp_pt#reader-link)* - MIT Press, Cambridge, MA.
6. [↑](#cite_ref-6) [Alexander Reinefeld](/Alexander_Reinefeld "Alexander Reinefeld") (**2005**). *Die Entwicklung der Spielprogrammierung: Von John von Neumann bis zu den hochparallelen Schachmaschinen*. [slides as pdf](http://www.informatik.hu-berlin.de/studium/ringvorlesung/ss05/slides/05-06-02.pdf), Themen der Informatik im historischen Kontext Ringvorlesung an der [HU Berlin](https://en.wikipedia.org/wiki/Humboldt_University_of_Berlin), 02.06.2005 (English paper, German title)
7. [↑](#cite_ref-7) [Sion's minimax theorem from Wikipedia](https://en.wikipedia.org/wiki/Sion%27s_minimax_theorem)
8. [↑](#cite_ref-8) see [Swap-off](/Helmut_Richter#Swapoff "Helmut Richter") by [Helmut Richter](/Helmut_Richter "Helmut Richter")
9. [↑](#cite_ref-9) [Parthasarathy's theorem from Wikipedia](https://en.wikipedia.org/wiki/Parthasarathy%27s_theorem)
