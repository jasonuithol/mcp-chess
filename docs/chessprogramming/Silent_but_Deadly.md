...
Source: https://www.chessprogramming.org/Silent_but_Deadly

**[Home](/Main_Page "Main Page") \* [Engine Testing](/Engine_Testing "Engine Testing") \* [Test-Positions](/Test-Positions "Test-Positions") \* Silent but Deadly**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Vincent_van_Gogh_-_Head_of_a_skeleton_with_a_burning_cigarette_-_Google_Art_Project.jpg/330px-Vincent_van_Gogh_-_Head_of_a_skeleton_with_a_burning_cigarette_-_Google_Art_Project.jpg)](/File:Vincent_van_Gogh_-_Head_of_a_skeleton_with_a_burning_cigarette_-_Google_Art_Project.jpg)

[Vincent van Gogh](/Category:Vincent_van_Gogh "Category:Vincent van Gogh") - [Skull of a Skeleton with Burning Cigarette](https://en.wikipedia.org/wiki/Skull_of_a_Skeleton_with_Burning_Cigarette) (1886) [[1]](#cite_note-1)

**Silent but Deadly (sbd),**   
an [EPD](/Extended_Position_Description "Extended Position Description") test by [Dann Corbit](/Dann_Corbit "Dann Corbit") that is designed to help [tune](/Automated_Tuning "Automated Tuning") chess engines, first published in [CCC](/CCC "CCC"). In August 2008, Dann found a novelty in one of the positions [[2]](#cite_note-2).

# Description

This is an EPD test that is designed to help tune chess engines. All of the positions are fairly quiet, and the best move is not a capture. The evaluation for the position is intended to be below one pawn for a one minute search. There are a few positions that have a score a bit larger than one pawn (marked polar) and there are a few positions that have more than one solution (marked Multiple solutions). I would like to see suggestions for replacements for the positions with comments attached. For each of these positions, ultra strong chess players chose the marked best move, as well as many strong chess engines (including [Rybka](/Rybka "Rybka") and [Naum](/Naum "Naum") at 150 seconds). So the test suite should be fairly well debugged. However, I will be very interested in any defects that can be discovered. The main intention is that you can use it to tune your chess engines at shallow depths for positional or otherwise quiet moves. [[3]](#cite_note-3)
...
- [Silent but deadly](http://www.talkchess.com/forum/viewtopic.php?t=21038) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCC](/CCC "CCC"), May 7, 2008
- [From the silent but deadly set, a novelty](http://www.talkchess.com/forum/viewtopic.php?t=22952) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCC](/CCC "CCC"), August 12, 2008

# References

1. [↑](#cite_ref-1) [Vincent van Gogh](/Category:Vincent_van_Gogh "Category:Vincent van Gogh") - [Skull of a Skeleton with Burning Cigarette](https://en.wikipedia.org/wiki/Skull_of_a_Skeleton_with_Burning_Cigarette) (1886), [oil on canvas](https://en.wikipedia.org/wiki/Oil_painting), [Van Gogh Museum](https://en.wikipedia.org/wiki/Van_Gogh_Museum), [Amsterdam](https://en.wikipedia.org/wiki/Amsterdam), [Vincent van Gogh from Wikipedia](https://en.wikipedia.org/wiki/Vincent_van_Gogh), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [From the silent but deadly set, a novelty](http://www.talkchess.com/forum/viewtopic.php?t=22952) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCC](/CCC "CCC"), August 12, 2008
3. [↑](#cite_ref-3) [Silent but deadly](http://www.talkchess.com/forum/viewtopic.php?t=21038) by [Dann Corbit](/Dann_Corbit "Dann Corbit"), [CCC](/CCC "CCC"), May 7, 2008
