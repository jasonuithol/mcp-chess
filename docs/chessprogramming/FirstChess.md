...
Source: https://www.chessprogramming.org/FirstChess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* FirstChess**

[![](/images/thumb/7/71/Firstchess.png/300px-Firstchess.png)](http://devwebcl.atarionline.pl/cc65/firstchess.png)

FirstChess screen [[1]](#cite_note-1)

**FirstChess**,  
a very simple [open source chess program](/Category:Open_Source "Category:Open Source") with a [command line interface](/CLI "CLI") by [Pham Hong Nguyen](/Pham_Hong_Nguyen "Pham Hong Nguyen"), written in [C](/C "C") for didactic purpose, introduced in 2002 [[2]](#cite_note-2). Since FirstChess lacks [en passant](/En_passant "En passant") and [castling](/Castling "Castling"), there is implicit invitation to improve it.
...
- [Index of /cc65](http://devwebcl.atarionline.pl/cc65/) from [atarionline.pl](http://devwebcl.atarionline.pl/) [[3]](#cite_note-3)

# References

1. [↑](#cite_ref-1) firstchess.png from [Index of /cc65](http://devwebcl.atarionline.pl/cc65/)
2. [↑](#cite_ref-2) [FirstChess - a crazy project!](https://www.stmintz.com/ccc/index.php?id=242289) by [Pham Hong Nguyen](/Pham_Hong_Nguyen "Pham Hong Nguyen"), [CCC](/CCC "CCC"), July 24, 2002
3. [↑](#cite_ref-3) oups, better replace "unsigned char" by "int"
