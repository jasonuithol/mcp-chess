...
Source: https://www.chessprogramming.org/ChessBase

**[Home](/Main_Page "Main Page") \* [Organizations](/Organizations "Organizations") \* ChessBase (Company)**

[![](/images/b/b5/Chessbase.JPG)](http://www.chessbase.com/Home)

ChessBase logo [[1]](#cite_note-1)

**ChessBase** [GmbH](https://en.wikipedia.org/wiki/Gesellschaft_mit_beschr%C3%A4nkter_Haftung) is a German chess software company located in [Hamburg](https://en.wikipedia.org/wiki/Hamburg). ChessBase is marketing chess software, maintaining a chess news site [[2]](#cite_note-2) and is operating [Playchess](/index.php?title=Playchess&action=edit&redlink=1 "Playchess (page does not exist)"), a server to play chess online [[3]](#cite_note-3) [[4]](#cite_note-4) .

*For the Chess database see main article [ChessBase (Database)](/ChessBase_(Database) "ChessBase (Database)").*

# History and Products

ChessBase was founded in 1986 by Physicist [Matthias Wüllenweber](/Matthias_W%C3%BCllenweber "Matthias Wüllenweber") and Journalist [Frederic Friedel](/Frederic_Friedel "Frederic Friedel") [[5]](#cite_note-5), eponymous was the [chess game database](/ChessBase_(Database) "ChessBase (Database)") developed by Wüllenweber for [Atari ST](/Atari_ST "Atari ST") computers. End of the 80s the chess database program was ported by [Mathias Feist](/Mathias_Feist "Mathias Feist") to the [IBM PC](/IBM_PC "IBM PC") and [MS-DOS](/MS-DOS "MS-DOS") operating system, released as ChessBase 3.0 for Atari and PC. ChessBase 4.0 was the last Atari release, and already included the chess playing program [Fritz](/Fritz "Fritz") [[6]](#cite_note-6), based on the program [Quest](/Quest "Quest") by [Frans Morsch](/Frans_Morsch "Frans Morsch"), which was also market as stand alone product.

## Fritz Family

In the early 90s ChessBase focused on [Microsoft](/Microsoft "Microsoft") operating systems, MS-DOS and since 1994 [Windows](/Windows "Windows"), notably as *ChessBase for Windows* and *Fritz 4*, not only the engine but also a [Graphical User Interface](/GUI "GUI") for other chess-playing programs of the "Fritz Family" by various top commercial authors, most notably [Junior](/Junior "Junior"), [HIARCS](/HIARCS "HIARCS"), [Shredder](/Shredder "Shredder"), [Chess Tiger](/Chess_Tiger "Chess Tiger"), the [Zappa](/Zappa "Zappa") version *Zap!Chess*, since 2008 [Rybka](/Rybka "Rybka") [[7]](#cite_note-7), since November 2012 [Houdini](/Houdini "Houdini") [[8]](#cite_note-8) [[9]](#cite_note-9), since November 2013 **Deep Fritz 14** with [Gyula Horváth](/Gyula_Horv%C3%A1th "Gyula Horváth") [[10]](#cite_note-10), in November 2015, 2016 **Fritz 15/16** with [Vasik Rajlich](/Vasik_Rajlich "Vasik Rajlich"), and in November 2019 **Fritz 17** with [Frank Schneider](/Frank_Schneider "Frank Schneider") as engine authors, since September 2014, [Komodo](/Komodo "Komodo") [[11]](#cite_note-11).
...
In May 2000, ChessBase released a CD with seven different amateur chess programs dubbed *Young Talents*, able to natively communicate with the proprietary [Fritz](/Fritz#FritzGUI "Fritz") or [ChessBase](/ChessBase_(Database)#GUI "ChessBase (Database)") [GUI](/GUI "GUI") [[12]](#cite_note-12) [[13]](#cite_note-13):
...
ChessBase is also publishing company of chess games, various chess multimedia products, such as the chess teaching software [Fritz & Chesster](https://en.wikipedia.org/wiki/Fritz_%28chess%29#Fritz_and_Chesster) [[14]](#cite_note-14) , chess opening monographs, and the Music composing software Ludwig [[15]](#cite_note-15) [[16]](#cite_note-16) [[17]](#cite_note-17) , developed by Matthias Wüllenweber.
...
[ICCA Journal, Vol. 22, No. 3](/ICGA_Journal#22_3 "ICGA Journal"), *Many Changes* [[18]](#cite_note-18) :
...
- [ChessBase is 25 – everything 25% off in our shop](https://en.chessbase.com/post/chebase-is-25-everything-25-off-in-our-shop) from ChessBase News, May 19, 2011 [[19]](#cite_note-19)
...
1. [↑](#cite_ref-1) [ChessBase News > Home](http://www.chessbase.com/Home)
2. [↑](#cite_ref-2) [ChessBase news](http://www.chessbase.com/)
3. [↑](#cite_ref-3) [Playchess from Wikipedia](https://en.wikipedia.org/wiki/Playchess)
4. [↑](#cite_ref-4) [Play chess online](http://www.playchess.com/)
5. [↑](#cite_ref-5) [Christmas dinner on a train – meet the ChessBase team](http://en.chessbase.com/home/TabId/211/PostId/4001376), ChessBase News, December 23, 2003
6. [↑](#cite_ref-6) [Fritz (chess) from Wikipedia](https://en.wikipedia.org/wiki/Fritz_%28chess%29)
7. [↑](#cite_ref-7) [ChessBase Shop - Chess Programs](http://chessbase-shop.com/en/categories/39)
8. [↑](#cite_ref-8) [Houdini 3 Standard multiprocessor version](http://chessbase-shop.com/en/products/houdini_3_standard_multiprocessor_version), ChessBase Shop
9. [↑](#cite_ref-9) [Houdini 3 Pro mulitprocessor version](http://chessbase-shop.com/en/products/houdini_3_pro_multiprocessor_version), ChessBase Shop
10. [↑](#cite_ref-10) [New Fritz author?](http://www.talkchess.com/forum/viewtopic.php?t=50149) by John Hartmann, [CCC](/CCC "CCC"), November 19, 2013
11. [↑](#cite_ref-11) [Komodo 8](http://shop.chessbase.com/en/products/komodo_chess_8) - ChessBase Shop, September 10, 2014
12. [↑](#cite_ref-12) [Young Talents](https://web.archive.org/web/20030225014243/http://www.chessbase.com/support/support.asp?pid=100), Support - ChessBase, May 28, 2000 ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine))
13. [↑](#cite_ref-13) [Young Talents, Teil 2](http://scleinzell.schachvereine.de/p_spielprogramme/youngtal_b.shtml) by [Peter Schreiner](/Peter_Schreiner "Peter Schreiner"), Mai 2000, hosted by [Schachclub Leinzell](http://scleinzell.schachvereine.de/home/news.shtml) (German)
14. [↑](#cite_ref-14) [Fritz & Chesster Part 3 – Review in USA Today](http://www.chessbase.com/newsdetail.asp?newsid=3640)
15. [↑](#cite_ref-15) [Music Software Ludwig](http://www.komponieren.de/)
16. [↑](#cite_ref-16) [Ludwig from ChessBase](http://chessbase-shop.com/en/categories/57)
17. [↑](#cite_ref-17) [Smudo, Vaile, Vladimir and Ludwig – when chess meets music](http://en.chessbase.com/home/TabId/211/PostId/4004001)
18. [↑](#cite_ref-18) [ICCA Journal, Vol. 22, No. 3](/ICGA_Journal#22_3 "ICGA Journal")
19. [↑](#cite_ref-19) [Schach-Datenbank-Marktführer Chessbase: Der Gründer programmiert selbst](http://www.taz.de/1/sport/artikel/1/der-gruender-programmiert-selbst/) - [taz.de](https://en.wikipedia.org/wiki/Die_Tageszeitung), by [Hartmut Metz](http://www.scr-kuppenheim.de/meko/index.html), May 19, 2011 (German)
