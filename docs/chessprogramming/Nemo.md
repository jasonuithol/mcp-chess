...
Source: https://www.chessprogramming.org/Nemo

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Nemo**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/20000_Nemo_South_Pole_flag.jpg/330px-20000_Nemo_South_Pole_flag.jpg)](/File:20000_Nemo_South_Pole_flag.jpg)

Nemo searching the Horizon [[1]](#cite_note-1)

**Nemo**,  
an [UCI](/UCI "UCI") compatible chess engine by [Michael Hoffmann](/Michael_Hoffmann "Michael Hoffmann"), written in [C](/C "C").
Nemo is a [bitboard](/Bitboards "Bitboards") engine using the [Obstruction Difference](/Obstruction_Difference "Obstruction Difference") to determine [sliding piece attacks](/Sliding_Piece_Attacks "Sliding Piece Attacks"), and the [SEE Swap Algorithm](/SEE_-_The_Swap_Algorithm "SEE - The Swap Algorithm") [[2]](#cite_note-2).
Further development was supported by [Sven Schüle](/Sven_Sch%C3%BCle "Sven Schüle") [[3]](#cite_note-3).
Nemo 1.0 Beta was released to the public in January 2012 [[4]](#cite_note-4) .
...
- [Computer Chess Wiki - Engine: Nemo](http://www.computer-chess.org/doku.php?id=computer_chess:engines:nemo:index) hosted by [Ron Murawski](/Ron_Murawski "Ron Murawski") [[5]](#cite_note-5)
