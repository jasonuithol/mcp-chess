...
Source: https://www.chessprogramming.org/Cmcchess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Cmcchess**

**Cmcchess**,  
an [UCI](/UCI "UCI") compatible chess engine written by [Chao Ma](/Chao_Ma "Chao Ma"). Its development started in 2009 and Cmcchess v1.06 was released in 2010. Cmcchess applies a [parallel SMP search](/Parallel_Search "Parallel Search"), using [MTD(f)](/MTD(f) "MTD(f)") as basic search algorithm [[1]](#cite_note-1).
...
1. [↑](#cite_ref-1) [Welcome to Cmcchess' website](https://web.archive.org/web/20130509162856/http://people.oregonstate.edu/~machao/Cmcchess_site/) ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine))
