...
Source: https://www.chessprogramming.org/Gaviota

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Gaviota**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Dolphin_Gull_-_Leucophaeus_scoresbii_on_rock.jpg/330px-Dolphin_Gull_-_Leucophaeus_scoresbii_on_rock.jpg)](/File:Dolphin_Gull_-_Leucophaeus_scoresbii_on_rock.jpg)

Gaviota austral [[1]](#cite_note-1) [[2]](#cite_note-2)

**Gaviota**,  
a [Chess Engine Communication Protocol](/Chess_Engine_Communication_Protocol "Chess Engine Communication Protocol") and [UCI](/UCI "UCI") compatible chess engine written by [FM](https://en.wikipedia.org/wiki/FIDE_titles#FIDE_Master_.28FM.29) [Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora") in the [C](/C "C") programming language. When It was released in 2001, it was the first Argentinian engine available. Gaviota supports its [own endgame tablebases](/Gaviota_Tablebases "Gaviota Tablebases"), [book](/Opening_Book "Opening Book"), and can use several processors ([SMP](/SMP "SMP")). It has the ability to [learn](/Book_Learning "Book Learning") by remembering book lines and positions that were not good. Gaviota avoids them in following games. There are versions for [Linux](/Linux "Linux"), [Android](/Android "Android"), [Windows](/Windows "Windows"), and [Mac OS](/Mac_OS "Mac OS") (0.86) [[3]](#cite_note-3). The Gaviota team is completed by tester [Adam Hair](/Adam_Hair "Adam Hair") [[4]](#cite_note-4).

# Features

based on Gaviota's change log until **v1.0** [[5]](#cite_note-5) and [Forum Posts](/Computer_Chess_Forums "Computer Chess Forums")

## Board Representation

- [Bitboards](/Bitboards "Bitboards")
- [BitScan with De Bruijn Multiplication](/BitScan#DeBruijnMultiplation "BitScan") [[6]](#cite_note-6)
- [Fill Algorithm](/Dumb7Fill "Dumb7Fill") for [Sliding Piece Attacks](/Sliding_Piece_Attacks "Sliding Piece Attacks") [[7]](#cite_note-7)
...
[Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora") on the name of his program [[8]](#cite_note-8):
...
[WCRCC 2013](/WCRCC_2013 "WCRCC 2013"), [EXchess](/EXchess "EXchess") - Gaviota [[9]](#cite_note-9)
...
- [Great article for people who wants to write a chess engine](https://www.stmintz.com/ccc/index.php?id=221364) by [Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora"), [CCC](/CCC "CCC"), April 03, 2002 [[10]](#cite_note-10)
...
:   [Re: Insanity... or Tal style?](http://www.talkchess.com/forum/viewtopic.php?t=27266&postdays=0&postorder=asc&topic_view=&start=11) by [Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora"), [CCC](/CCC "CCC"), April 02, 2009 » [Automated Tuning](/Automated_Tuning "Automated Tuning") [[11]](#cite_note-11)
...
- [Interview with Miguel Ballicora | Chessdom](http://www.chessdom.com/interview-with-miguel-ballicora/), February 23, 2013 [[12]](#cite_note-12) [[13]](#cite_note-13)
...
1. [↑](#cite_ref-1) [Laridae from Wikipedia.es](http://es.wikipedia.org/wiki/Laridae)
2. [↑](#cite_ref-2) [Gull from Wikipedia](https://en.wikipedia.org/wiki/Gull)
3. [↑](#cite_ref-3) [New Gaviota 0.86 (Linux, Android, Windows, and now Mac!)](http://www.talkchess.com/forum/viewtopic.php?t=46977) by [Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora"), [CCC](/CCC "CCC"), January 23, 2013
4. [↑](#cite_ref-4) [Gaviota v1.0 (engine) - gaviota chess engine](https://sites.google.com/site/gaviotachessengine/Home/releases/gaviotav10)
5. [↑](#cite_ref-5) [Change Log - gaviota chess engine](https://sites.google.com/site/gaviotachessengine/Home/change-log)
6. [↑](#cite_ref-6) [Acknowledgments - gaviota chess engine](https://sites.google.com/site/gaviotachessengine/Home/acknowledgments)
7. [↑](#cite_ref-7) [Yet another bitboard attack generator](http://www.talkchess.com/forum/viewtopic.php?t=30356) by [Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora"), [CCC](/CCC "CCC"), October 28, 2009
8. [↑](#cite_ref-8) [Re: Programmers: what's the story behind the name of your engine](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=410892&t=39407) by [Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora"), [CCC](/CCC "CCC"), June 20, 2011
9. [↑](#cite_ref-9) [Insane move](http://www.talkchess.com/forum/viewtopic.php?t=48702) by [Miguel A. Ballicora](/Miguel_A._Ballicora "Miguel A. Ballicora"), [CCC](/CCC "CCC"), July 20, 2013
10. [↑](#cite_ref-10) [Tony Marsland](/Tony_Marsland "Tony Marsland") (**1992**). *Computer Chess and Search.* Encyclopedia of Artificial Intelligence (2nd ed.) (ed. S.C. Shapiro) pp. 224-241. John Wiley & Sons, Inc., New York, NY. ISBN 0-471-50305-3. [pdf](http://webdocs.cs.ualberta.ca/~tony/RecentPapers/encyc.mac-1991.pdf)
11. [↑](#cite_ref-11) [The texel evaluation function optimization algorithm](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=555522&t=50823) by [Peter Österlund](/Peter_%C3%96sterlund "Peter Österlund"), [CCC](/CCC "CCC"), January 31, 2014 » [Texel's Tuning Method](/Texel%27s_Tuning_Method "Texel's Tuning Method")
12. [↑](#cite_ref-12) [TCEC computer chess LIVE!](http://www.chessdom.com/tcec-computer-chess-live/)
13. [↑](#cite_ref-13) [TCEC - Thoresen Chess Engines Competition | Facebook](https://www.facebook.com/tcec.chess)
