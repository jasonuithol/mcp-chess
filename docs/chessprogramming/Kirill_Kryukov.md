...
Source: https://www.chessprogramming.org/Kirill_Kryukov

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Kirill Kryukov**

[![](/images/thumb/c/cd/Kirr_bicycle_helmet.jpg/116px-Kirr_bicycle_helmet.jpg)](http://kirill-kryukov.com/kirr/)

Kirill Kryukov [[1]](#cite_note-1)
...
He has written various tools and scripts for DNA data and [FASTA format](https://en.wikipedia.org/wiki/FASTA_format) [[2]](#cite_note-2).
...
In 2004, Kirill [solved](https://en.wikipedia.org/wiki/Solved_game) [3x3 Chess](https://en.wikipedia.org/wiki/Minichess#3%C3%973_and_3%C3%974_boards) [[3]](#cite_note-3), and in 2010, 3x4 Chess [[4]](#cite_note-4). He further maintains the [KCEC](/KCEC "KCEC") [engine rating list](/Engine_Rating_Lists "Engine Rating Lists") (*Kirr's Chess Engine Comparison*) [[5]](#cite_note-5), and is administrator of the Russian [KasparovChess computer chess forum](/Computer_Chess_Forums "Computer Chess Forums").
...
- [Counting endgame positions](http://www.talkchess.com/forum/viewtopic.php?t=50832) by Kirill Kryukov, [CCC](/CCC "CCC"), January 08, 2014 [[10]](#cite_note-10)
...
1. [↑](#cite_ref-1) [Kirr's homepage](http://kirill-kryukov.com/kirr/)
2. [↑](#cite_ref-2) [Kirr's homepage](http://kirill-kryukov.com/kirr/)
3. [↑](#cite_ref-3) [3x3 Chess](http://kirr.homeunix.org/chess/3x3-chess/)
4. [↑](#cite_ref-4) [3x4 Chess](http://kirr.homeunix.org/chess/3x4-chess/)
5. [↑](#cite_ref-5) [KCEC - Kirr's Chess Engine Comparison](http://kirill-kryukov.com/chess/kcec/about.html)
6. [↑](#cite_ref-6) [dblp Kirill Kryukov](https://dblp.uni-trier.de/pers/hd/k/Kryukov:Kirill)
7. [↑](#cite_ref-7) [Kirill Kryukov's research works | Tokai University, Hiratsuka and other places - Researchgate](https://www.researchgate.net/scientific-contributions/2115185275_Kirill_Kryukov)
8. [↑](#cite_ref-8) [MISHIMA: Multiple Sequence Alignment](http://kirill-kryukov.com/study/mishima/)
9. [↑](#cite_ref-9) [Jōmon people from Wikipedia](https://en.wikipedia.org/wiki/J%C5%8Dmon_people)
10. [↑](#cite_ref-10) [NULP (Number of Unique Legal Positions) in chess endgames](http://kirill-kryukov.com/chess/nulp/) by Kirill Kryukov
