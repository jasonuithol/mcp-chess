...
Source: https://www.chessprogramming.org/WildCat

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* WildCat**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Lydekker_cat_fawn.png/330px-Lydekker_cat_fawn.png)](/File:Lydekker_cat_fawn.png)

Wildcat killing a Deer fawn [[1]](#cite_note-1)
...
WildCat keeps two best moves in the [transposition table](/Transposition_Table "Transposition Table"), and considers [checks](/Check "Check") at the first [ply](/Ply "Ply") of the [quiescence search](/Quiescence_Search "Quiescence Search") [[2]](#cite_note-2).
...
[CCCCISC 2008](/CCCCISC_2008 "CCCCISC 2008"), round 5, WildCat - [Booot](/Booot "Booot") [[3]](#cite_note-3)
...
1. [↑](#cite_ref-1) Sketch of a [European wildcat](https://en.wikipedia.org/wiki/European_wildcat) killing a [deer fawn](https://en.wikipedia.org/wiki/Deer), source: [Richard Lydekker](https://en.wikipedia.org/wiki/Richard_Lydekker) (**1916**). *Wild life of the world : a descriptive survey of the geographical distribution of animals*. Vol. I, [Wildcat from Wikipedia](https://en.wikipedia.org/wiki/Wildcat)
2. [↑](#cite_ref-2) [WildCat/v8/history.txt](http://kirr.homeunix.org/chess/engines/Norbert%27s%20collection/WildCat%20%28Compilation%29/v8/history.txt)
3. [↑](#cite_ref-3) [Новости за февраль - март 2008 года, 29 февраля 2008 г.](http://www.sdchess.ru/febr_march_08.htm) from [sdchess.ru](http://www.sdchess.ru/)
