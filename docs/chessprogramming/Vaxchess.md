...
Source: https://www.chessprogramming.org/Vaxchess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Vaxchess**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/DEC_MicroVAX_CPU_die.JPG/330px-DEC_MicroVAX_CPU_die.JPG)](/File:DEC_MicroVAX_CPU_die.JPG)

DEC MicroVAX CPU die [[1]](#cite_note-1)
...
Vaxchess was written in [C](/C "C") and [assembly](/Assembly "Assembly") [[2]](#cite_note-2), and searched about 1K [nodes per second](/Nodes_per_Second "Nodes per Second") [[3]](#cite_note-3).

# Selected Games

## Vaxchess - Lachex

The game Vaxchess vs [Lachex](/Lachex "Lachex"), round 3 [[4]](#cite_note-4), [WCCC 1986](/WCCC_1986 "WCCC 1986") was mentioned by commentator [GM Vlastimil Hort](https://en.wikipedia.org/wiki/Vlastimil_Hort), who announced three different Mate threats with no adequate defence, which somehow did not occur [[5]](#cite_note-5):
...
[WCCC 1986](/WCCC_1986 "WCCC 1986"), round 5, Vaxchess - [Chat](/Chat "Chat") [[6]](#cite_note-6)
...
1. [↑](#cite_ref-1) Die shot of DEC [MicroVAX 78032-GD](https://en.wikipedia.org/wiki/MicroVAX_78032) microprocessor from [VAXstation2000](https://en.wikipedia.org/wiki/VAXstation#VAXstation_2000) with chip number DC333R and part number 21-20887-05 on heatsink. Image by [Pauli Rautakorpi](https://commons.wikimedia.org/wiki/User:Birdman86), August 23, 2013,
2. [↑](#cite_ref-2) [VAX Macro from Wikipedia](https://en.wikipedia.org/wiki/VAX_Macro)
3. [↑](#cite_ref-3) [The ACM's Seventeenth North American Computer Chess Championship and The Sixth World Microcomputer Chess Championship](http://www.computerhistory.org/chess/full_record.php?iid=doc-431614f6ca4a7) from [The Computer History Museum](/The_Computer_History_Museum "The Computer History Museum")
4. [↑](#cite_ref-4) [Cologne 1986 - Chess - Round 3 - Game 8 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=62&round=3&id=8)
5. [↑](#cite_ref-5) [Helmut Horacek](/Helmut_Horacek "Helmut Horacek") (**1986**). *The Fifth World Computer Chess Championship Cologne, 1986*. Research Unit for Information Science and Artificial Intelligence, [University of Hamburg](/University_of_Hamburg "University of Hamburg"), from [Kings Move - Welcome to the 1989 AGT World Computer Chess Championship.](https://www.computerhistory.org/chess/doc-434fea055cbb3/) p 21, hosted by [The Computer History Museum](/The_Computer_History_Museum "The Computer History Museum")
6. [↑](#cite_ref-6) [Cologne 1986 - Chess - Round 5 - Game 8 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=62&round=5&id=8)
