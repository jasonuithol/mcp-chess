...
Source: https://www.chessprogramming.org/GopherCheck

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* GopherCheck**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Pocket_gopher.jpg/330px-Pocket_gopher.jpg)](/File:Pocket_gopher.jpg)

Pocket Gopher [[1]](#cite_note-1)

**GopherCheck**,  
an [UCI](/UCI "UCI") compliant [open source chess engine](/Category:Open_Source "Category:Open Source") by [Stephen Lovell](/index.php?title=Stephen_Lovell&action=edit&redlink=1 "Stephen Lovell (page does not exist)"), written in the [Go programming language](/Go_(Programming_Language) "Go (Programming Language)"), first released in June 2016 [[2]](#cite_note-2) under the [MIT license](/Massachusetts_Institute_of_Technology#License "Massachusetts Institute of Technology").
GopherCheck supports a [parallel search](/Parallel_Search "Parallel Search"), defaulting to one search goroutine, a type of [light-weight process](https://en.wikipedia.org/wiki/Light-weight_process) [[3]](#cite_note-3)
per logical core. GopherCheck is [bitboard](/Bitboards "Bitboards") based and determines [sliding piece attacks](/Sliding_Piece_Attacks "Sliding Piece Attacks") with [magic bitboards](/Magic_Bitboards "Magic Bitboards") with plain, homogenous arrays, which performed better than the common [fancy implementations](/Magic_Bitboards#Fancy "Magic Bitboards") whith individual table sizes, thus less memory but variable shift while calculating the index [[4]](#cite_note-4).
...
- [GitHub - stephenjlovell/gopher\_check: Concurrent UCI Chess Engine written in Go](https://github.com/stephenjlovell/gopher_check)
...
1. [↑](#cite_ref-1) Pocket gopher, [Yellowstone National Park](https://en.wikipedia.org/wiki/Yellowstone_National_Park), [Gillian Bowser](https://source.colostate.edu/research-scientist-gillian-bowser-lauded-commitment-diversity-science/), 1990, [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2)  [GopherCheck 0.1.0 released](http://www.talkchess.com/forum/viewtopic.php?t=60378) by [Stephen Lovell](/index.php?title=Stephen_Lovell&action=edit&redlink=1 "Stephen Lovell (page does not exist)"), [CCC](/CCC "CCC"), June 06, 2016
3. [↑](#cite_ref-3) [Effective Go - The Go Programming Language - Concurrency](https://golang.org/doc/effective_go.html#concurrency)
4. [↑](#cite_ref-4) [gopher\_check/bitboard\_magic.go at master · stephenjlovell/gopher\_check · GitHub](https://github.com/stephenjlovell/gopher_check/blob/master/bitboard_magic.go)
5. [↑](#cite_ref-5) [gopher\_check/readme.md at master · stephenjlovell/gopher\_check · GitHub](https://github.com/stephenjlovell/gopher_check/blob/master/readme.md)
