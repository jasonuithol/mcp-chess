...
Source: https://www.chessprogramming.org/Armageddon

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Armageddon**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Jheronimus_Bosch_097_central_panel_02_detail_04.jpg/330px-Jheronimus_Bosch_097_central_panel_02_detail_04.jpg)](/File:Jheronimus_Bosch_097_central_panel_02_detail_04.jpg)

[The Last Judgment](https://en.wikipedia.org/wiki/The_Last_Judgment_%28Bosch_triptych%29) [[1]](#cite_note-1)

**Armageddon**,  
a Polish chess program, a [WinBoard](/WinBoard "WinBoard") compliant engine, optionally with an own [GUI](/GUI "GUI"), written by [Grzegorz Sidorowicz](/Grzegorz_Sidorowicz "Grzegorz Sidorowicz"). Its first release comes from [December 31](https://en.wikipedia.org/wiki/December_31), 1999, and the name is a pun based on prediction that the [world](https://en.wikipedia.org/wiki/World) would [end](https://en.wikipedia.org/wiki/End_time) in [2000](/Timeline#2000 "Timeline") [[2]](#cite_note-2) .
...
[PCCC 2002](/PCCC_2002 "PCCC 2002"), round 6, [Belzebub](/Belzebub "Belzebub") - Armageddon [[3]](#cite_note-3)
...
1. [↑](#cite_ref-1) [Hieronymus Bosch](/index.php?title=Category:Hieronymus_Bosch&action=edit&redlink=1 "Category:Hieronymus Bosch (page does not exist)") - [The Last Judgment](https://en.wikipedia.org/wiki/The_Last_Judgment_%28Bosch_triptych%29) (detail), after 1482
2. [↑](#cite_ref-2) [Year 2000 problem from Wikipedia](https://en.wikipedia.org/wiki/Year_2000_problem)
