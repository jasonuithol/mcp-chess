...
Source: https://www.chessprogramming.org/Rafael_B._Andrist

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Rafael B. Andrist**

**Rafael Benedikt Andrist**,  
a Swiss computer scientist and mathematician affiliated with the [University of Wuppertal](https://en.wikipedia.org/wiki/University_of_Wuppertal) [[1]](#cite_note-1). In 2011, he defended his Ph.D. thesis on *Topics in Complex Geometry* at [University of Bern](https://en.wikipedia.org/wiki/University_of_Bern). Rafael B. Andrist is author of the chess program [Wilhelm](/Wilhelm "Wilhelm"), which knows about [corresponding squares](/Corresponding_Squares "Corresponding Squares") in [pawn endgames](/Pawn_Endgame "Pawn Endgame") with completly blocked pawns, and solves the [Lasker-Reichhelm Position](/Lasker-Reichhelm_Position "Lasker-Reichhelm Position") instantly [[2]](#cite_note-2) [[3]](#cite_note-3). It further utilizes [Endgame Tablebases](/Endgame_Tablebases "Endgame Tablebases") to build statistics and to search for special features.
...
- Rafael B. Andrist (**2008**). *[Stein Spaces Characterized by their Endomorphisms](http://paperstatistics.appspot.com/0809.3919)*. [[5]](#cite_note-5)
- Rafael B. Andrist, [Erlend Fornæss Wold](http://www.mn.uio.no/math/english/people/aca/erlendfw/index.html) (**2011**). *[Riemann surfaces in Stein manifolds with density property](http://paperstatistics.appspot.com/1106.4416)*. [[6]](#cite_note-6)
...
1. [↑](#cite_ref-1) [Bergische Universität Wuppertal - Dr. Rafael Benedikt Andrist](http://www.kana.uni-wuppertal.de/mitarbeiter/dr-r-andrist.html)
2. [↑](#cite_ref-2) [chess program "Wilhelm" released](https://www.stmintz.com/ccc/index.php?id=184365) by Rafael B. Andrist, [CCC](/CCC "CCC"), August 19, 2001
3. [↑](#cite_ref-3) [Re: Fine 70 same 7 engines (more)](https://www.stmintz.com/ccc/index.php?id=188484) by Rafael B. Andrist, [CCC](/CCC "CCC"), September 11, 2001
4. [↑](#cite_ref-4) [Paper statistics - Rafael B. Andrist](http://paperstatistics.appspot.com/Rafael-B.-Andrist)
5. [↑](#cite_ref-5) [Stein manifold from Wikipedia](https://en.wikipedia.org/wiki/Stein_manifold)
6. [↑](#cite_ref-6) [Riemann surface from Wikipedia](https://en.wikipedia.org/wiki/Riemann_surface)
