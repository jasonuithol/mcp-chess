...
Source: https://www.chessprogramming.org/Lachex

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Lachex**

[![](/images/thumb/b/bf/Lachex.JPG/380px-Lachex.JPG)](http://en.wikipedia.org/wiki/Los_Alamos_National_Laboratory)

Los Alamos [[1]](#cite_note-1) Chess Experiment
...
from the [WCCC 1989](/WCCC_1989 "WCCC 1989") booklet [[4]](#cite_note-4):
...
Further, something which reminds on [fill algorithms](/Fill_Algorithms "Fill Algorithms") like [Dumb7Fill](/Dumb7Fill "Dumb7Fill") was used as described by Wendroff [[5]](#cite_note-5) :
...
1. [↑](#cite_ref-1) [Los Alamos National Laboratory from Wikipedia](https://en.wikipedia.org/wiki/Los_Alamos_National_Laboratory)
2. [↑](#cite_ref-2) [Lachex's ICGA Tournaments](https://www.game-ai-forum.org/icga-tournaments/program.php?id=227)
3. [↑](#cite_ref-3) [Cologne 1986 - Chess - Round 1 - Game 3 (ICGA Tournaments)](https://www.game-ai-forum.org/icga-tournaments/round.php?tournament=62&round=1&id=3)
...
5. [↑](#cite_ref-5) [Burton Wendroff](/Burton_Wendroff "Burton Wendroff") (**1985**). *Attack Detection and Move Generation on the X-MP/48.* [ICCA Journal, Vol. 8, No. 2](/ICGA_Journal#8_2 "ICGA Journal")
6. [↑](#cite_ref-6) [Tony Warnock](/Tony_Warnock "Tony Warnock"), [Burton Wendroff](/Burton_Wendroff "Burton Wendroff") (**1988**). *Search Tables in Computer Chess*. [ICCA Journal, Vol. 11, No. 1](/ICGA_Journal#11_1 "ICGA Journal")
7. [↑](#cite_ref-7) [Tony Marsland](/Tony_Marsland "Tony Marsland") (**1986**). *A Review of Game-Tree Pruning.* [ICCA Journal, Vol. 9, No. 1](/ICGA_Journal#9_1 "ICGA Journal")
8. [↑](#cite_ref-8) [Harry Nelson](/Harry_Nelson "Harry Nelson") (**1985**). *Hash Tables in [Cray Blitz](/Cray_Blitz "Cray Blitz")*. [ICCA Journal, Vol. 8, No. 1](/ICGA_Journal#8_1 "ICGA Journal")
