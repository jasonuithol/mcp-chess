...
Source: https://www.chessprogramming.org/Hank_Dietz

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Hank Dietz**

[![](/images/b/bd/Hankdietz070411.jpg)](http://aggregate.org/hankd/)

Hank Dietz [[1]](#cite_note-1)
...
and maintains the SWAR site [[3]](#cite_note-3) along with the collection of *The Aggregate Magic Algorithms* [[4]](#cite_note-4).
Hank Dietz is further author of the early [Go](/Go "Go") playing program *Jim* [[5]](#cite_note-5).
...
1. [↑](#cite_ref-1) [Professor Hank Dietz](http://aggregate.org/hankd/)
2. [↑](#cite_ref-2) [SPIE | Henry Gordon Dietz](https://spie.org/profile/Henry.Dietz-31450?SSO=1)
3. [↑](#cite_ref-3) [The Aggregate: SWAR, SIMD Within A Register](http://www.aggregate.org/SWAR/)
4. [↑](#cite_ref-4) [The Aggregate Magic Algorithms](http://aggregate.org/MAGIC/)
5. [↑](#cite_ref-5) [Details of Program: Jim](http://www.computer-go.info/db/oprog.php?a=Jim) from [computer-go.info](http://www.computer-go.info/)
6. [↑](#cite_ref-6) [dblp: Henry G. Dietz](https://dblp.uni-trier.de/pers/hd/d/Dietz:Henry_G=)
7. [↑](#cite_ref-7) [Barrier (computer science) from Wikipedia](https://en.wikipedia.org/wiki/Barrier_(computer_science))
8. [↑](#cite_ref-8) [The Aggregate: Aggregate Function Networks](http://aggregate.org/AFN/)
9. [↑](#cite_ref-9) [Anaglyph 3D from Wikipedia](https://en.wikipedia.org/wiki/Anaglyph_3D)
