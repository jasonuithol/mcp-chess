...
Source: https://www.chessprogramming.org/Mac_OS

**[Home](/Main_Page "Main Page") \* [Software](/Software "Software") \* Mac OS**

**Mac OS**,  
is a series of [GUI](https://en.wikipedia.org/wiki/Graphical_user_interface) based [operating systems](https://en.wikipedia.org/wiki/Operating_system) developed, marketed and sold by [Apple Inc.](/index.php?title=Apple&action=edit&redlink=1 "Apple (page does not exist)") for their [Macintosh](/Macintosh "Macintosh") line of computer systems since 1984, with its range of processors from [68000](/68000 "68000"), [PowerPC](/PowerPC "PowerPC"), [x86](/X86 "X86") and [x86-64](/X86-64 "X86-64") [[1]](#cite_note-1). Mac [OS X](https://en.wikipedia.org/wiki/OS_X), released in 2002, developed from Mac OS classic family, and [NeXTSTEP](https://en.wikipedia.org/wiki/NeXTSTEP), was [UNIX](/Unix "Unix")-based.
...
[![SigmaMAC.jpg](/images/9/95/SigmaMAC.jpg)](http://www.hiarcs.com/mac_chess_hiarcs.htm)

[Macintosh](/Macintosh "Macintosh") [Sigma Chess 6.2](/index.php?title=Sigma_Chess&action=edit&redlink=1 "Sigma Chess (page does not exist)") with [HIARCS](/HIARCS "HIARCS") [[2]](#cite_note-2)

### XBoard

[![XBoardMac.JPG](/images/e/ea/XBoardMac.JPG)](http://www.open-aurec.com/wbforum/viewtopic.php?f=19&t=52964)

[XBoard](/XBoard "XBoard") port with native [Quarz](https://en.wikipedia.org/wiki/Quartz_%28graphics_layer%29) interface, so that [X11/XQuartz](https://en.wikipedia.org/wiki/X11.app) is no longer needed [[3]](#cite_note-3) [[4]](#cite_note-4)
...
- [OS X](http://www.talkchess.com/forum/viewtopic.php?t=59601) by [Robert Hyatt](/Robert_Hyatt "Robert Hyatt"), [CCC](/CCC "CCC"), March 22, 2016 [[5]](#cite_note-5)
...
1. [↑](#cite_ref-1) [Apple's transition to Intel processors](https://en.wikipedia.org/wiki/Apple%27s_transition_to_Intel_processors)
2. [↑](#cite_ref-2) [Macintosh Chess: Sigma Chess HIARCS Chess Software Program](http://www.hiarcs.com/prev-prod/MacH13-DJ12/mac_chess_hiarcs1.htm)
3. [↑](#cite_ref-3) [OSX Xboard 4.7.2 .app](http://www.talkchess.com/forum/viewtopic.php?t=49729) by [Joshua Pettus](/index.php?title=Joshua_Pettus&action=edit&redlink=1 "Joshua Pettus (page does not exist)"), [CCC](/CCC "CCC"), October 16, 2013
4. [↑](#cite_ref-4) [XBoard native Mac App](http://hiarcs.net/forums/viewtopic.php?t=6492) by [Harm Geert Muller](/Harm_Geert_Muller "Harm Geert Muller"), [Hiarcs Forum](/Computer_Chess_Forums "Computer Chess Forums"), December 18, 2013
5. [↑](#cite_ref-5) [Xcode from Wikipedia](https://en.wikipedia.org/wiki/Xcode)
