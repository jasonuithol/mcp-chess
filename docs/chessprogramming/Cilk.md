...
Cilk-5.4.6 is the latest official MIT Cilk released under the [GNU General Public License](/Free_Software_Foundation#GPL "Free Software Foundation") [[2]](#cite_note-2).
...
This is how an [alpha-beta](/Alpha-Beta "Alpha-Beta") search routine was implemented with Cilk-5 [[3]](#cite_note-3), using the five keywords **cilk**, **spawn**, **sync**, **inlet** and **abort**:
...
by [Vincent Diepeveen](/Vincent_Diepeveen "Vincent Diepeveen") after [WCCC 1999](/WCCC_1999 "WCCC 1999") [[4]](#cite_note-4):
...
[![ParallelExperts1999.jpg](/images/6/6e/ParallelExperts1999.jpg)](/File:ParallelExperts1999.jpg)
...
In July 2009 [Intel Corporation](/Intel "Intel") acquired *Cilk Arts* [[5]](#cite_note-5) [[6]](#cite_note-6). Intel Cilk Plus adopts simplifications, proposed by *Cilk Arts* in Cilk++, to eliminate the need for several of the original Cilk keywords while adding the ability to spawn functions and to deal with variables involved in reduction operations. Intel Cilk Plus differs from Cilk and Cilk++ by adding array extensions, being incorporated in a commercial compiler, and compatibility with existing debuggers [[7]](#cite_note-7).
...
1. [↑](#cite_ref-1) [Intel® Cilk™ Plus Specification - Intel® Software Network](http://software.intel.com/en-us/articles/intel-cilk-plus-specification/)
2. [↑](#cite_ref-2) [cilk-5.4.6.tar.gz](http://supertech.csail.mit.edu/cilk/cilk-5.4.6.tar.gz)
3. [↑](#cite_ref-3) [Don Dailey](/Don_Dailey "Don Dailey"), [Charles E. Leiserson](/Charles_Leiserson "Charles Leiserson") (**2001**). *Using Cilk to Write Multiprocessor Chess Programs*, [Advances in Computer Games 9](/Advances_in_Computer_Games_9 "Advances in Computer Games 9"), [pdf](http://supertech.csail.mit.edu/papers/icca99.pdf)
4. [↑](#cite_ref-4) [DIEP parallel in Paderborn - technical and detailed story](https://www.stmintz.com/ccc/index.php?id=58505) by [Vincent Diepeveen](/Vincent_Diepeveen "Vincent Diepeveen"), [CCC](/CCC "CCC"), June 28, 1999
5. [↑](#cite_ref-5) [Intel Acquires Cilk++ Technology](http://www.ddj.com/cpp/218900367), [Dr. Dobb's](http://www.ddj.com/), August 01, 2009
6. [↑](#cite_ref-6) [Intel Cilk Plus from Wikipedia](https://en.wikipedia.org/wiki/Intel_Cilk_Plus)
7. [↑](#cite_ref-7) [Cilk from Wikipedia](https://en.wikipedia.org/wiki/Cilk)
8. [↑](#cite_ref-8) [SuperTech Paper Listing](http://supertech.csail.mit.edu/papers.html)
9. [↑](#cite_ref-9) [Work stealing from Wikipedia](https://en.wikipedia.org/wiki/Work_stealing)
