...
Source: https://www.chessprogramming.org/Stockfish-js

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* [Stockfish](/Stockfish "Stockfish") \* Stockfish-js**
...
**Stockfish.js** is a fork of Stockfish-js [[1]](#cite_note-1),
synced with Stockfish 11 [[2]](#cite_note-2).
...
1. [↑](#cite_ref-1) [stockfish-js/Readme.md at master · exoticorn/stockfish-js · GitHub](https://github.com/exoticorn/stockfish-js/blob/master/Readme.md)
2. [↑](#cite_ref-2) [stockfish.js/Readme.md at master · nmrugg/stockfish.js · GitHub](https://github.com/nmrugg/stockfish.js/blob/master/Readme.md)
