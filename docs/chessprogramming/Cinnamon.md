...
Source: https://www.chessprogramming.org/Cinnamon

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Cinnamon**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Cinnamomum_verum_spices.jpg/330px-Cinnamomum_verum_spices.jpg)](/File:Cinnamomum_verum_spices.jpg)

Cinnamon [[1]](#cite_note-1)
...
Cinnamon was first released in February 2013 [[2]](#cite_note-2) under that name, while former versions of the engine were called [Butterfly](/index.php?title=Butterfly&action=edit&redlink=1 "Butterfly (page does not exist)").
...
1. [↑](#cite_ref-1) Cinnamon: sticks ([ceylon cinnamon](https://en.wikipedia.org/wiki/Cinnamomum_verum) from [Sri Lanka](https://en.wikipedia.org/wiki/Sri_Lanka)), powder, and flowers. Created from 31 images stacked with [CombineZP](https://en.wikipedia.org/wiki/CombineZ), by [Simon A. Eugster](https://commons.wikimedia.org/wiki/User:LivingShadow), [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons), [Cinnamomum from Wikipedia](https://en.wikipedia.org/wiki/Cinnamomum)
2. [↑](#cite_ref-2) [Cinnamon](http://www.g-sei.org/cinnamon/) « [G 6](/G_6 "G 6")
3. [↑](#cite_ref-3) [GitHub - gekomad/Cinnamon: C++ UCI chess engine](https://github.com/gekomad/Cinnamon)
