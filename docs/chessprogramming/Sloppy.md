...
Source: https://www.chessprogramming.org/Sloppy

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Sloppy**

[![](/images/thumb/b/bf/Sloppy_reading_tree.tiff.png/300px-Sloppy_reading_tree.tiff.png)](https://en.wikipedia.org/wiki/Sloppy_identity)

Sloppy Reading Tree [[1]](#cite_note-1)

**Sloppy**,  
an [open source chess engine](/Category:Open_Source "Category:Open Source") by [Ilari Pihlajisto](/Ilari_Pihlajisto "Ilari Pihlajisto"), written in [C](/C "C") to build executables to run under [Windows](/Windows "Windows"), [Linux](/Linux "Linux") and [OS X](/Mac_OS "Mac OS"), compliant with the [Chess Engine Communication Protocol](/Chess_Engine_Communication_Protocol "Chess Engine Communication Protocol"). Sloppy is released under the [GPLv3](/Free_Software_Foundation#GPL "Free Software Foundation") license, and was first published in October, 2007 [[2]](#cite_note-2).
Sloppy is full of [low-level trickery](/Bit-Twiddling "Bit-Twiddling") with [bitwise operators](/General_Setwise_Operations "General Setwise Operations"), efficient [data structures](/Data "Data") and [algorithms](/Algorithms "Algorithms"). Starting with [rotated bitboards](/Rotated_Bitboards "Rotated Bitboards") [[3]](#cite_note-3),
it uses [magic bitboards](/Magic_Bitboards "Magic Bitboards") based on [Pradu Kannan's](/Pradu_Kannan "Pradu Kannan") implementation [[4]](#cite_note-4) to determine [sliding piece attacks](/Sliding_Piece_Attacks "Sliding Piece Attacks").
Sloppy **0.2.0**, released in February 2008, supports [Daniel Shawul's](/Daniel_Shawul "Daniel Shawul") [Scorpio Bitbases](/Scorpio_Bitbases "Scorpio Bitbases") [[5]](#cite_note-5).
...
1. [↑](#cite_ref-1) Image made by Dcstrosh to show the sloppy reading of a sentence, [Sloppy identity from Wikipedia](https://en.wikipedia.org/wiki/Sloppy_identity), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [Sloppy : Home](http://ilaripih.mbnet.fi/sloppy/index.html)
3. [↑](#cite_ref-3) [sloppy/CHANGES at master · cutechess/sloppy · GitHub](https://github.com/cutechess/sloppy/blob/master/CHANGES)
4. [↑](#cite_ref-4) [sloppy/magicmoves.c at master · cutechess/sloppy · GitHub](https://github.com/cutechess/sloppy/blob/master/src/magicmoves.c)
5. [↑](#cite_ref-5) [Sloppy 0.2.0 released](http://www.talkchess.com/forum/viewtopic.php?t=19432) by [Ilari Pihlajisto](/Ilari_Pihlajisto "Ilari Pihlajisto"), [CCC](/CCC "CCC"), February 06, 2008
6. [↑](#cite_ref-6) Features based on [sloppy/src at master · cutechess/sloppy · GitHub](https://github.com/cutechess/sloppy/tree/master/src)
