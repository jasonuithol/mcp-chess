...
**[Home](/Main_Page "Main Page") \* [Board Representation](/Board_Representation "Board Representation") \* [Bitboards](/Bitboards "Bitboards") \* King Pattern**

[![](/images/4/41/Moore_d.gif)](http://en.wikipedia.org/wiki/File:Moore_d.gif)

Moore neighborhood [[1]](#cite_note-1)
...
Now it is about filling south-west and south-east rank(kingSquare) times, which finally results in the desired set of catchable passers. Special handling is required for the doubles pushes [[2]](#cite_note-2):
...
The **squaresAreConnected** flood-fill [[3]](#cite_note-3) algorithm was introduced by [Steffan Westcott](/Steffan_Westcott "Steffan Westcott") [[4]](#cite_note-4).
...
1. [↑](#cite_ref-1) [Moore neighborhood from Wikipedia](https://en.wikipedia.org/wiki/Moore_neighborhood)
2. [↑](#cite_ref-2) Thanks to Thomas Herges for pointing out a bug if kings are on the eighth rank
3. [↑](#cite_ref-3) [Flood Fill from Wikipedia](https://en.wikipedia.org/wiki/Flood_fill)
4. [↑](#cite_ref-4) [Re: algorithm question](https://www.stmintz.com/ccc/index.php?id=251180.) answer by [Steffan Westcott](/Steffan_Westcott "Steffan Westcott") in [CCC](/CCC "CCC") September 09, 2002
