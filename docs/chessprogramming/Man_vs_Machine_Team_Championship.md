# Man vs Machine Team Championship

Source: https://www.chessprogramming.org/Man_vs_Machine_Team_Championship

**[Home](/Main_Page "Main Page") \* [Tournaments & Matches](/Tournaments_and_Matches "Tournaments and Matches") \* Man vs Machine Team Championship**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Bilbao_City_Hall_001.jpg/330px-Bilbao_City_Hall_001.jpg)](/File:Bilbao_City_Hall_001.jpg)

[Casa Consistorial de Bilbao](https://en.wikipedia.org/wiki/Bilbao_City_Hall) [[1]](#cite_note-1)

The **Man vs Machine Team Championship**, October 6 to 9, [2004](/Timeline#2004 "Timeline"), and its follow up, the **People vs Computers World Chess Team Match**, November 20 to 23, [2005](/Timeline#2005 "Timeline"), both held in [Bilbao](https://en.wikipedia.org/wiki/Bilbao), [Spain](https://en.wikipedia.org/wiki/Spain), were sanctioned by the [ICGA](/ICGA "ICGA") [[2]](#cite_note-2) . The organization was led by [Andoni Madariaga](https://plus.google.com/104455284198887587274/posts), contacts to the chess world ([FIDE](/FIDE "FIDE")) and the computer chess world ([ICGA](/ICGA "ICGA")) were performed by [Leontxo Garcia](https://en.wikipedia.org/wiki/Leontxo_Garc%C3%ADa). The arbitrary selection of the three programs raised some discussions [[3]](#cite_note-3) .

# Man vs Machine Team Championship 2004

[Hydra](/Hydra "Hydra"), [Fritz 8](/Fritz "Fritz") and [Deep Junior](/Junior "Junior") played [Veselin Topalov](https://en.wikipedia.org/wiki/Veselin_Topalov), [Ruslan Ponomariov](https://en.wikipedia.org/wiki/Ruslan_Ponomariov) and [Sergey Karjakin](https://en.wikipedia.org/wiki/Sergey_Karjakin) [[4]](#cite_note-4) .

| Silicon / Carbon | Ponomariov | Karjakin | Topalov | Sum Silicon |
| --- | --- | --- | --- | --- |
| Hydra | 1w 1b | 1w | ½b | 3½ |
| Fritz 8 | ½b | 1w 1b | 1w | 3½ |
| Deep Junior | ½w | 0b | ½w ½b | 1½ |
| Sum Carbon | 1 | 1 | 1½ | 8½ - 3½ |
...
| Silicon / Carbon | Kasimdzhanov | Ponomariov | Khalifman | Sum Silicon |
| --- | --- | --- | --- | --- |
| Hydra | 1w ½b | 1w | ½b | 3 |
| Deep Junior | ½b | 1w ½b | 1w | 3 |
| Fritz 9 | ½w | 0b | 1w ½b | 2 |
| Sum Carbon | 1½ | 1½ | 1 | 8 - 4 |
...
1. [↑](#cite_ref-1) [Casa Consistorial de Bilbao](https://en.wikipedia.org/wiki/Bilbao_City_Hall), where the 2004 opening ceremony took place, [Casa Consistorial de Bilbao - Wikipedia.es](http://es.wikipedia.org/wiki/Casa_Consistorial_de_Bilbao)
2. [↑](#cite_ref-2) [Jaap van den Herik](/Jaap_van_den_Herik "Jaap van den Herik") (**2004**). *The World Chess Team Championship Man vs. Machine*. [ICGA Journal, Vol. 27, No. 4](/ICGA_Journal#27_4 "ICGA Journal")
3. [↑](#cite_ref-3) [Ch. Donninger at Bilbao (original in German)](https://www.stmintz.com/ccc/index.php?id=384988) by Franz Hagra, [CCC](/CCC "CCC"), August 29, 2004
4. [↑](#cite_ref-4) [Man vs Machine World Team Championship (2004–2005) - Wikipedia](https://en.wikipedia.org/wiki/Human%E2%80%93computer_chess_matches#Man_vs_Machine_World_Team_Championship_.282004.E2.80.932005.29)
