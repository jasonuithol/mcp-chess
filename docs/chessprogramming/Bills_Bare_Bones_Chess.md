...
Source: https://www.chessprogramming.org/Bills_Bare_Bones_Chess

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Bills Bare Bones Chess**
...
[[1]](#cite_note-1), written in [C++](/Cpp "Cpp"). With some modifications, Bills Bare Bones Chess was later released as **Basic-Chess** on [GitHub](https://en.wikipedia.org/wiki/GitHub) [[2]](#cite_note-2), licensed under the [GPL version 3](/Free_Software_Foundation#GPL "Free Software Foundation"), along with an e-Book explaining the program [[3]](#cite_note-3).
...
1. [↑](#cite_ref-1) [Awesome Chess Program, Chess Tuition (2016)](http://web.archive.org/web/20161012202911/http://chess-tuition.com/awesome.html) ([Wayback Machine](https://en.wikipedia.org/wiki/Wayback_Machine))
2. [↑](#cite_ref-2) [GitHub - billjordanchess/Basic-Chess: A simple chess program for teaching purposes](https://github.com/billjordanchess/Basic-Chess)
3. [↑](#cite_ref-3) [Bill Jordan](/Bill_Jordan "Bill Jordan") (**2019**). *How to Write a Chess Program*. [amazon](https://www.amazon.com/gp/product/B07SVX1V73/ref=dbs_a_def_rwt_hsch_vapi_tkin_p1_i0)
