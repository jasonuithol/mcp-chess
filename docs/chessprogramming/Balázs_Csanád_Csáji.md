...
Source: https://www.chessprogramming.org/Balázs_Csanád_Csáji

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Balázs Csanád Csáji**

[![](/images/c/ca/BalazsCsaji.jpg)](https://igor.xen.emi.sztaki.hu/~csaji/)

Balázs Csanád Csáji [[1]](#cite_note-1)
...
[MASPV 2002](/MASPV_2002 "MASPV 2002"), [Pandora - Hector](/Pandora#HectorPandora "Pandora"), [Gyula Horváth](/Gyula_Horv%C3%A1th "Gyula Horváth"), Balázs Csanád Csáji, [Csaba Jergler](/Csaba_Jergler "Csaba Jergler"), [László Lindner](/L%C3%A1szl%C3%B3_Lindner "László Lindner") [[2]](#cite_note-2)
...
- Balázs Csanád Csáji, [Raphaël M. Jungers](https://dblp.dagstuhl.de/pers/hd/j/Jungers:Rapha=euml=l_M=), [Vincent D. Blondel](https://dblp.dagstuhl.de/pers/hd/b/Blondel:Vincent_D=) (**2010**). *[PageRank Optimization in Polynomial Time by Stochastic Shortest Path Reformulation](https://link.springer.com/chapter/10.1007/978-3-642-16108-7_11)*. [ALT 2010](https://dblp.dagstuhl.de/db/conf/alt/alt2010.html) [[4]](#cite_note-4)
...
- Balázs Csanád Csáji (**2018**). *Score Permutation Based Finite Sample Inference for Generalized AutoRegressive Conditional Heteroskedasticity (GARCH) Models*. [arXiv:1807.08390](https://arxiv.org/abs/1807.08390) [[5]](#cite_note-5)
...
1. [↑](#cite_ref-1)  [Balázs Csanád Csáji's Homepage](https://igor.xen.emi.sztaki.hu/~csaji/)
2. [↑](#cite_ref-2) [MASPV 2002 photos](http://titanic.nyme.hu/~wyx/maspv2002/images.htm)
3. [↑](#cite_ref-3) [dblp: Balázs Csanád Csáji](https://dblp.dagstuhl.de/pers/hd/c/Cs=aacute=ji:Bal=aacute=zs_Csan=aacute=d.html)
4. [↑](#cite_ref-4) [PageRank from Wikipedia](https://en.wikipedia.org/wiki/PageRank)
5. [↑](#cite_ref-5) [Autoregressive conditional heteroskedasticity - Wikipedia](https://en.wikipedia.org/wiki/Autoregressive_conditional_heteroskedasticity)
