...
after winning the [Fredkin Intermediate Prize](/Edward_Fredkin#Prize "Edward Fredkin") for Deep Thought's Grandmaster-level performance. [[2]](#cite_note-2)

# Eval tuning in Deep Thought

[Eval Tuning in Deep Thought](/Eval_Tuning_in_Deep_Thought "Eval Tuning in Deep Thought"), quote by [Tim Mann](/Tim_Mann "Tim Mann") [[3]](#cite_note-3):
...
1. [↑](#cite_ref-1) [Menschliche Ehre gerettet](http://www.spiegel.de/spiegel/print/d-13500222.html), [Der Spiegel](https://en.wikipedia.org/wiki/Der_Spiegel) 44/1989, October 30, 1989 (German)
2. [↑](#cite_ref-2) [Deep Thought team with Fredkin Intermediate Prize](http://www.computerhistory.org/chess/stl-430b9bbd52f71/) 1988, Gift of [Feng-hsiung Hsu](/Feng-hsiung_Hsu "Feng-hsiung Hsu") hosted by [The Computer History Museum](/The_Computer_History_Museum "The Computer History Museum")
3. [↑](#cite_ref-3) [Deep Thought from Tim Mann's Chess Pages](http://www.tim-mann.org/deepthought.html)
