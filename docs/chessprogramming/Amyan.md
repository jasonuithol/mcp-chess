...
Source: https://www.chessprogramming.org/Amyan

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Amyan**

[![](/images/7/7a/Amyane.jpg)](http://www.pincha.cl/amyan/amyane.jpg)

Amyan 1.522 [GUI](/GUI "GUI") [[1]](#cite_note-1)
...
Amyan was first released in 2000, the still available Amyan 1.522 Version released in 2002 comes with an own [GUI](/GUI "GUI"). The program is written in [C++](/Cpp "Cpp"), a ported [Java](/Java "Java") [applet](https://en.wikipedia.org/wiki/Java_applet) is able to run in a [Web browser](https://en.wikipedia.org/wiki/Web_browser) using a [Java virtual machine](https://en.wikipedia.org/wiki/Java_virtual_machine) [[2]](#cite_note-2).
...
[ACCA 2006](/ACCA_2006 "ACCA 2006"), round 2, Amyan - [Crafty](/Crafty "Crafty") [[4]](#cite_note-4)
...
1. [↑](#cite_ref-1) [Amyan <- Antonio Diéguez](http://www.pincha.cl/amyan/amyane.html), Amyan [1.522 screenshot](http://www.pincha.cl/amyan/amyane.jpg)
2. [↑](#cite_ref-2) [Amyan ...](http://www.pincha.cl/jueguitos/amyanjava/applete.html)
3. [↑](#cite_ref-3) Description loosely based on readme.txt, Amyan 1.72, [Amyan <- Antonio Diéguez](http://www.pincha.cl/amyan/amyane.html)
4. [↑](#cite_ref-4) [The 2006 First Annual ACCA Americas' Computer Chess Championships - Results - PGN download](http://compchess.org/2006ACCCResults.html)
