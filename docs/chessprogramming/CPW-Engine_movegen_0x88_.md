# CPW-Engine movegen(0x88)

Source: https://www.chessprogramming.org/CPW-Engine_movegen(0x88)

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* [CPW-Engine](/CPW-Engine "CPW-Engine") \* movegen(0x88)**

This page holds the movegenerator of the engine CPW. For function definitions see [CPW-Engine\_movegen\_h](/CPW-Engine_movegen_h "CPW-Engine movegen h").
