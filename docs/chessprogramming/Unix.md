...
[![Unix timeline.en.svg](https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Unix_timeline.en.svg/960px-Unix_timeline.en.svg.png)](/File:Unix_timeline.en.svg)

Unix genealogy tree [[3]](#cite_note-3)
...
- [Hiroyuki Iida](/Hiroyuki_Iida "Hiroyuki Iida") (**2011**). *The 2011 Japan Prize Awarded to Unix Pioneers*. [ICGA Journal](/ICGA_Journal "ICGA Journal") Vol. 34, No. 1 [[5]](#cite_note-5)
...
1. [↑](#cite_ref-1) [Unix from Wikipedia](https://en.wikipedia.org/wiki/Unix)
2. [↑](#cite_ref-2) [The X-Windows Disaster - How to make a 50-MIPS Workstation Run Like a 4.77MHz IBM PC](http://www.molgen.mpg.de/~wwwutz/Unix_Haters/old/x-windows.html), Chapter 7 of the [UNIX-HATERS Handbook](https://en.wikipedia.org/wiki/The_UNIX-HATERS_Handbook). The X-Windows Disaster chapter was written by [Don Hopkins](https://en.wikipedia.org/wiki/Don_Hopkins)
3. [↑](#cite_ref-3) [Unix wars from Wikipedia](https://en.wikipedia.org/wiki/Unix_wars)
4. [↑](#cite_ref-4) [Early UNIX Documents - Ancient UNIX - Blog - This Old Micro](http://www.thisoldmicro.com/show/ancient-unix/post/50/early-unix-documents)
5. [↑](#cite_ref-5) [Ken Thompson, Dennis Ritchie win Japan 'Nobel' Prize](http://www.chessbase.com/newsdetail.asp?newsid=6970), [ChessBase News](/ChessBase "ChessBase"), January 26, 2011
