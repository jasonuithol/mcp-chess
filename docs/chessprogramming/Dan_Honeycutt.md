...
Source: https://www.chessprogramming.org/Dan_Honeycutt

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Dan Honeycutt**
...
when he wrote a little chess program in [Basic](/Basic "Basic"), pure [minimax](/Minimax "Minimax") with an [evaluation](/Evaluation "Evaluation") consisting of [material](/Material "Material") and [center proximity](/Center_Distance "Center Distance") [[1]](#cite_note-1).
...
- [MT or KISS ?](http://www.talkchess.com/forum/viewtopic.php?t=43910) by Dan Honeycutt, [CCC](/CCC "CCC"), June 02, 2012 » [Zobrist Hashing](/Zobrist_Hashing "Zobrist Hashing") [[2]](#cite_note-2) [[3]](#cite_note-3) [[4]](#cite_note-4)
...
1. [↑](#cite_ref-1) [Your first chess program](http://www.talkchess.com/forum/viewtopic.php?t=43381) by Dan Honeycutt, [CCC](/CCC "CCC"), April 20, 2012
2. [↑](#cite_ref-2) [Mersenne twister from Wikipedia](https://en.wikipedia.org/wiki/Mersenne_twister)
3. [↑](#cite_ref-3) [64-bit KISS RNGs](http://compgroups.net/comp.lang.fortran/64-bit-kiss-rngs/601519) by [George Marsaglia](/Mathematician#GMarsaglia "Mathematician"), [comp.lang.fortran | Computer Group](http://compgroups.net/comp.lang.fortran/), February 28, 2009
4. [↑](#cite_ref-4) [RKISS](/Bob_Jenkins#RKISS "Bob Jenkins") by [Bob Jenkins](/Bob_Jenkins "Bob Jenkins")
