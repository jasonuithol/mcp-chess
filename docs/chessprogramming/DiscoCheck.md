...
Source: https://www.chessprogramming.org/DiscoCheck

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* DiscoCheck**

[![](https://upload.wikimedia.org/wikipedia/commons/2/29/Disco_ball4.jpg)](/File:Disco_ball4.jpg)

Disco ball [[1]](#cite_note-1)
...
DiscoCheck is [UCI](/UCI "UCI") compatible and can be compiled for [Linux](/Linux "Linux"), [Android](/Android "Android") [[2]](#cite_note-2) , [Windows](/Windows "Windows"), and [Mac OS X](/Mac_OS "Mac OS").
...
1. [↑](#cite_ref-1) [Disco ball](https://en.wikipedia.org/wiki/Disco_ball), [Image](https://commons.wikimedia.org/wiki/File:Disco_ball4.jpg) by [Sarah](https://www.flickr.com/people/8978957@N07?rb=1), February 24, 2010, [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/deed.en), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [UCI and XBoard Engines for Android](http://www.aartbik.com/MISC/eng.html) maintained by [Aart Bik](/Aart_Bik "Aart Bik")
3. [↑](#cite_ref-3) [Double/DiscoCheck](http://wbec-ridderkerk.nl/html/details1/DoubleCheck.html) from [WBEC Ridderkerk](/WBEC "WBEC")
4. [↑](#cite_ref-4) [New DiscoCheck is cooking](http://www.talkchess.com/forum/viewtopic.php?t=64173) by Lucas Braesch, [CCC](/CCC "CCC"), June 04, 2017
5. [↑](#cite_ref-5) [GitHub - lucasart/Demolito: UCI Chess Engine](https://github.com/lucasart/Demolito)
