...
Source: https://www.chessprogramming.org/Spector

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Spector**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Double-alaskan-rainbow.jpg/330px-Double-alaskan-rainbow.jpg)](/File:Double-alaskan-rainbow.jpg)

Double Rainbow [[1]](#cite_note-1)
...
[Steven Edwards](/Steven_Edwards "Steven Edwards") on how it started with Spector [[2]](#cite_note-2):
...
Spector at [ACM 1994](/ACM_1994 "ACM 1994"): [C](/C "C"), [PC Clone](/IBM_PC "IBM PC") [486](/X86 "X86") 66Mhz with 256kb level two cache, 11 [mips](https://en.wikipedia.org/wiki/Instructions_per_second#Million_instructions_per_second), executable code 200k, 3 meg for data, [book 200k](/Opening_Book "Opening Book") positions, 3k [nodes per second](/Nodes_per_Second "Nodes per Second") [[3]](#cite_note-3).
...
1. [↑](#cite_ref-1) Full featured double rainbow in [Wrangell-St. Elias National Park](https://en.wikipedia.org/wiki/Wrangell%E2%80%93St._Elias_National_Park_and_Preserve), [Alaska](https://en.wikipedia.org/wiki/Alaska), by [Eric Rolph](https://en.wikipedia.org/wiki/User:Ericrolph), October 2005, [Rainbow from Wikipedia](https://en.wikipedia.org/wiki/Rainbow)
2. [↑](#cite_ref-2) [For chess program source collectors](http://www.chesscircle.net/forums/archive/index.php/t-37436.html) by [Steven Edwards](/Steven_Edwards "Steven Edwards"), Chess Circle, August 13, 2006
3. [↑](#cite_ref-3) [ACM Tournament - Specs](https://groups.google.com/d/msg/rec.games.chess/P9WW8L3gq9U/YRX_mZAjv-wJ) by Jim Bumgardner, [rgc](/Computer_Chess_Forums "Computer Chess Forums"), June 28, 1994
4. [↑](#cite_ref-4) [ACM 1994: Spector's games](https://groups.google.com/d/msg/rec.games.chess/KzylHYi4mH0/2_lsGXtxZocJ) by [Steven J. Edwards](/Steven_Edwards "Steven Edwards"), [rgc](/Computer_Chess_Forums "Computer Chess Forums"), June 29, 1994
5. [↑](#cite_ref-5) refers to the published 1996 version
6. [↑](#cite_ref-6) Courtesy [Steven Edwards](/Steven_Edwards "Steven Edwards")
