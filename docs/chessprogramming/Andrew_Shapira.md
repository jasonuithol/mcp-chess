...
Source: https://www.chessprogramming.org/Andrew_Shapira

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Andrew Shapira**

**Andrew Shapira**,  
an American computer scientist, software and game developer, and principal engineer at [Amazon.com](https://en.wikipedia.org/wiki/Amazon.com) [[1]](#cite_note-1).
...
- Andrew Shapira (**1997**). *[An Exact Performance Bound for an O(m+n) Greedy Matching Procedure](https://www.combinatorics.org/ojs/index.php/eljc/article/view/v4i1r25)*. [The Electronic Journal of Combinatorics](https://en.wikipedia.org/wiki/Electronic_Journal_of_Combinatorics), Vol. 4, No. 1 [[4]](#cite_note-4)
...
1. [↑](#cite_ref-1) [Andrew Shapira | LinkedIn](https://www.linkedin.com/in/andrewshapira/)
2. [↑](#cite_ref-2) [dblp: Andrew Shapira](http://www.informatik.uni-trier.de/~ley/pers/hd/s/Shapira:Andrew.html)
3. [↑](#cite_ref-3) [onezero » Research, Software, and Papers](http://onezero.org/research-software-and-papers)
4. [↑](#cite_ref-4) [Greedy algorithm from Wikipedia](https://en.wikipedia.org/wiki/Greedy_algorithm)
