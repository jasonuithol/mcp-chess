...
Source: https://www.chessprogramming.org/Bitboard_Serialization

**[Home](/Main_Page "Main Page") \* [Board Representation](/Board_Representation "Board Representation") \* [Bitboards](/Bitboards "Bitboards") \* Bitboard Serialization**

[![](/images/d/da/EschersEncounter.jpg)](http://www.mcescher.com/Gallery/back-bmp/LW331.jpg)

[M. C. Escher](/Category:M._C._Escher "Category:M. C. Escher"), Encounter, 1944 [[1]](#cite_note-1)
...
[Rein Halbersma](/Rein_Halbersma "Rein Halbersma") has written a prototype of a [generic](/Generic_Programming "Generic Programming") [C++11](/Cpp "Cpp") bitset [template](/Cpp#Template "Cpp") that can be used to traverse a set in [STL iterator](https://en.wikipedia.org/wiki/Iterator#C.2B.2B) style, hiding bitscan and reset [[4]](#cite_note-4) [[5]](#cite_note-5) ...
...
... which yields in following [X86-64](/X86-64 "X86-64") [assembly](/Assembly "Assembly"), almost identical for the iterator loop and std::copy [[6]](#cite_note-6):
...
Similar to the idea to hash occupancies in [kindergarten bitboards](/Kindergarten_Bitboards "Kindergarten Bitboards") and [magic bitboards](/Magic_Bitboards "Magic Bitboards"), one may hash certain move-target subsets of one piece in one run, to lookup tables with pre-calculated moves-lists [[7]](#cite_note-7) . Sounds like doing up to eight bitscans in parallel. The idea is to muliply-shift-lookup a move-target bitboard, to do an almost branch-less [move-generation](/Move_Generation "Move Generation") with pre-calculated moves inside [move-lists](/Move_List "Move List"). For instance king- and knight-moves [[8]](#cite_note-8) as well as moves of sliding pieces per line:
...
2. [↑](#cite_ref-2) [CPW bitscan with reset could someone explain this line?](http://www.talkchess.com/forum3/viewtopic.php?f=7&t=70202) by [Mahmoud Uthman](/index.php?title=Mahmoud_Uthman&action=edit&redlink=1 "Mahmoud Uthman (page does not exist)"), [CCC](/CCC "CCC"), March 14, 2019
3. [↑](#cite_ref-3) [Re: Alternatives to History Heuristics](http://www.talkchess.com/forum/viewtopic.php?topic_view=threads&p=289344&t=29611&sid=74848128f12e45f8883a87c3e6729f75) by [Robert Hyatt](/Robert_Hyatt "Robert Hyatt"), [CCC](/CCC "CCC"), September 02, 2009
4. [↑](#cite_ref-4) [LiveWorkSpace(IDE online): C++-3.2 (clang++): 41EaZl](http://liveworkspace.org/code/41EaZl$203)
5. [↑](#cite_ref-5) [Re: C vs ASM](http://www.talkchess.com/forum/viewtopic.php?t=47414&start=4) by [Rein Halbersma](/Rein_Halbersma "Rein Halbersma"), [CCC](/CCC "CCC"), March 05, 2013
6. [↑](#cite_ref-6) [GCC Explorer](http://gcc.godbolt.org/) with g++ 4.7 compiler, options -std=c++11 -O3 -march=k8-sse3 -fverbose-asm
7. [↑](#cite_ref-7) [Subject: sliding move generation idea with bitboards](https://www.stmintz.com/ccc/index.php?id=487844) by [Gerd Isenberg](/Gerd_Isenberg "Gerd Isenberg"), [CCC](/CCC "CCC"), February 19, 2006
8. [↑](#cite_ref-8) [Magic Knight- and King-Move Generation](http://www.open-aurec.com/wbforum/viewtopic.php?f=4&t=6099) by [Gerd Isenberg](/Gerd_Isenberg "Gerd Isenberg"), [Winboard Forum](/Computer_Chess_Forums "Computer Chess Forums"), Januar 11, 2007
