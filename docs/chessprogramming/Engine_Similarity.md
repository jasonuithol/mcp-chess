...
Source: https://www.chessprogramming.org/Engine_Similarity

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Similarity**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Phylogenetic_tree.svg/330px-Phylogenetic_tree.svg.png)](/File:Phylogenetic_tree.svg)

A [dendrogram](https://en.wikipedia.org/wiki/Dendrogram) of the [Tree of Life](https://en.wikipedia.org/wiki/Tree_of_life) [[1]](#cite_note-1)
...
A relative high similarity measure between two engines [[2]](#cite_note-2) could be a symptom of using similar evaluation ideas, features and weights, along with [automated tuning](/Automated_Tuning "Automated Tuning") (or trainig), or even code copying aka [cloning](/Category:Clone "Category:Clone").
...
In December 2010, [Don Dailey](/Don_Dailey "Don Dailey") published **SIM03** to test the similary with a set of [UCI](/UCI "UCI") compliant engines with **8238** in-build positions - still freely available from the [Komodo](/Komodo "Komodo") site [[3]](#cite_note-3).
...
**SIMEX** is a more user friendly successor by [Ed Schröder](/Ed_Schroder "Ed Schroder") [[4]](#cite_note-4) using external [EPD](/Extended_Position_Description "Extended Position Description")-files.
Overall similarity of multiple engines may be visualized as [hierarchical clustering](https://en.wikipedia.org/wiki/Hierarchical_clustering) [dendrogram](https://en.wikipedia.org/wiki/Dendrogram) [[5]](#cite_note-5).
...
:   [Re: This test is not scientific!](https://www.stmintz.com/ccc/index.php?id=40948) by [Don Dailey](/Don_Dailey "Don Dailey"), [CCC](/CCC "CCC"), January 26, 1999
:   [Comparing Bionic-Impakt vs Bionic](https://www.stmintz.com/ccc/index.php?id=41059) by [Albrecht Heeffer](/Albrecht_Heeffer "Albrecht Heeffer"), [CCC](/CCC "CCC"), January 27, 1999 » [Bionic Impakt](/Bionic_Impakt "Bionic Impakt"), [Bionic](/Bionic "Bionic")
...
2. [↑](#cite_ref-2) i.e. > 65% in SIM03
3. [↑](#cite_ref-3) [Komodo Chess Engine - Official Site](https://komodochess.com/downloads.htm) with Similary tester version 03 download
4. [↑](#cite_ref-4) [SIMEX 2.1](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=71709) provided by [Ed Schröder](/Ed_Schroder "Ed Schroder"), [CCC](/CCC "CCC"), September 01, 2019
5. [↑](#cite_ref-5) [How to measure overall similarity](http://www.talkchess.com/forum3/viewtopic.php?f=2&t=70390) by [Ferdinand Mosca](/Ferdinand_Mosca "Ferdinand Mosca"), [CCC](/CCC "CCC"), April 02, 2019
6. [↑](#cite_ref-6) [Pairwise Analysis of Chess Engine Move Selections](http://www.talkchess.com/forum/viewtopic.php?t=38772) by [Adam Hair](/Adam_Hair "Adam Hair"), [CCC](/CCC "CCC"), April 17, 2011
