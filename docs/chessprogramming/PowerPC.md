...
Source: https://www.chessprogramming.org/PowerPC

**[Home](/Main_Page "Main Page") \* [Hardware](/Hardware "Hardware") \* PowerPC**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Motorola_PowerPC_603_die.JPG/330px-Motorola_PowerPC_603_die.JPG)](/File:Motorola_PowerPC_603_die.JPG)

Die shot of PowerPC 603 [[1]](#cite_note-1)
...
- [Linux](/Linux "Linux") [[10]](#cite_note-10)
...
1. [↑](#cite_ref-1) [Die](https://en.wikipedia.org/wiki/Die_%28integrated_circuit%29) shot of [Motorola](/index.php?title=Motorola&action=edit&redlink=1 "Motorola (page does not exist)") [PowerPC 603](https://en.wikipedia.org/wiki/PowerPC_600#PowerPC_603) microprocessor (XPC603FE75-2B), by [Pauli Rautakorpi](https://commons.wikimedia.org/wiki/User:Birdman86), April 29 2014, [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/deed.en), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [IBM PowerPC assembly](https://www.ibm.com/developerworks/library/l-ppc/)
3. [↑](#cite_ref-3) [PowerPC Assembly tutorial](http://www.csd.uwo.ca/~mburrel/stuff/ppc-asm.html)
4. [↑](#cite_ref-4) [A data point for PowerPC bitboard program authors](https://www.stmintz.com/ccc/index.php?id=425020) by [Steven Edwards](/Steven_Edwards "Steven Edwards"), [CCC](/CCC "CCC"), May 09, 2005
5. [↑](#cite_ref-5) [IBM Knowledge Center - cntlzd (Count Leading Zeros Double Word) instruction](https://www.ibm.com/support/knowledgecenter/ssw_aix_61/com.ibm.aix.alangref/idalangref_cntlzd_inst.htm)
6. [↑](#cite_ref-6) [PowerPC 620 - Vorlesung Rechnerarchitektur, Heidelberg University](http://ra.ziti.uni-heidelberg.de/pages/lectures/fss10/ra/ext_info/powerpc620.pdf) (pdf)
7. [↑](#cite_ref-7) [x86 equivalent for LWARX and STWCX](http://stackoverflow.com/questions/1147904/x86-equivalent-for-lwarx-and-stwcx) - [Stack Overflow](https://en.wikipedia.org/wiki/Stack_Overflow)
8. [↑](#cite_ref-8) [PowerPC from Wikipedia](https://en.wikipedia.org/wiki/PowerPC)
9. [↑](#cite_ref-9) [PowerPC G4 from Wikipedia](https://en.wikipedia.org/wiki/PowerPC_G4)
10. [↑](#cite_ref-10) [MkLinux from Wikipedia](https://en.wikipedia.org/wiki/MkLinux)
