...
Source: https://www.chessprogramming.org/Cyclone

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* [Fruit](/Fruit "Fruit") \* [Toga](/Toga "Toga") \* Cyclone**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Low_pressure_system_over_Iceland.jpg/330px-Low_pressure_system_over_Iceland.jpg)](/File:Low_pressure_system_over_Iceland.jpg)

Polar cyclone [[1]](#cite_note-1)
...
licensed under the [GPL 3.0](/Free_Software_Foundation#GPL "Free Software Foundation") [[2]](#cite_note-2)
[[3]](#cite_note-3).
...
uses a configuration file to obtain more than 150 evaluation, material, search, and transposition table parameters [[4]](#cite_note-4).
...
1. [↑](#cite_ref-1) [Polar cyclone](https://en.wikipedia.org/wiki/Polar_vortex) near [Iceland](https://en.wikipedia.org/wiki/Iceland) on September 4, 2003,
