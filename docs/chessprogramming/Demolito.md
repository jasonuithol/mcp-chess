...
Source: https://www.chessprogramming.org/Demolito

**[Home](/Main_Page "Main Page") \* [Engines](/Engines "Engines") \* Demolito**

[File:Hydraulicke demolicni nuzky na podvozku CAT 330.jpg](/index.php?title=Special:Upload&wpDestFile=Hydraulicke_demolicni_nuzky_na_podvozku_CAT_330.jpg "File:Hydraulicke demolicni nuzky na podvozku CAT 330.jpg")

Being Demolished [[1]](#cite_note-1)

**Demolito**,  
an [UCI](/UCI "UCI") compliant [open source chess engine](/Category:Open_Source "Category:Open Source") by Lucas Braesch, licensed under the [GNU General Public License](/Free_Software_Foundation#GPL "Free Software Foundation"), written in [C](/C "C"), first announced at [OpenChess](/Computer_Chess_Forums "Computer Chess Forums") in January 2017 [[2]](#cite_note-2), a revised stable release published in June 2017 as completely rewritten new [DiscoCheck](/DiscoCheck "DiscoCheck") featuring [SMP](/Parallel_Search "Parallel Search") and [Chess960](/Chess960 "Chess960") [[3]](#cite_note-3), with executables available for [Linux](/Linux "Linux"), [Mac OS](/Mac_OS "Mac OS") and [Android](/Android "Android").
...
- [Dense Piece-Color Board-Definition](/Bitboard_Board-Definition#SixTwo "Bitboard Board-Definition") [[4]](#cite_note-4)
...
- [Principal Variation Search](/Principal_Variation_Search "Principal Variation Search") [[5]](#cite_note-5)
...
:   [Pawn Chain](/Defended_Pawns_(Bitboards) "Defended Pawns (Bitboards)")
...
1. [↑](#cite_ref-1) [High Reach Demolition Excavator](https://en.wikipedia.org/wiki/Long_reach_excavator) - Hydraulic demolition scissors on chassis CAT 365B L. Arm is 30 m long, [Image](https://commons.wikimedia.org/wiki/File:Hydraulicke_demolicni_nuzky_na_podvozku_CAT_330.jpg) by [Michal Maňas](https://commons.wikimedia.org/wiki/User:Snek01), June 21, 2006, [CC BY-SA 2.5](https://creativecommons.org/licenses/by-sa/2.5/deed.en), [Wikimedia Commons](https://en.wikipedia.org/wiki/Wikimedia_Commons)
2. [↑](#cite_ref-2) [New UCI Engine: Demolito](http://www.open-chess.org/viewtopic.php?f=7&t=3069) by lucasart, [OpenChess Forum](/Computer_Chess_Forums "Computer Chess Forums"), January 14, 2017
3. [↑](#cite_ref-3) [New DiscoCheck is cooking](http://www.talkchess.com/forum/viewtopic.php?t=64173) by Lucas Braesch, [CCC](/CCC "CCC"), June 04, 2017
4. [↑](#cite_ref-4) [Demolito/types.h at master · lucasart/Demolito · GitHub](https://github.com/lucasart/Demolito/blob/master/src/types.h)
5. [↑](#cite_ref-5) [Demolito/recurse.h at master · lucasart/Demolito · GitHub](https://github.com/lucasart/Demolito/blob/master/src/recurse.h)
