...
Source: https://www.chessprogramming.org/Depth-First

**[Home](/Main_Page "Main Page") \* [Search](/Search "Search") \* Depth-First**

[![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Depth-first-tree.svg/330px-Depth-first-tree.svg.png)](/File:Depth-first-tree.svg)

Depth-First Node order [[1]](#cite_note-1)
...
Breadth-First Node order [[2]](#cite_note-2)
...
1. [↑](#cite_ref-1) [Depth-first search from Wikipedia](https://en.wikipedia.org/wiki/Depth-first_search)
2. [↑](#cite_ref-2) [Breadth-first search from Wikipedia](https://en.wikipedia.org/wiki/Breadth-first_search)
3. [↑](#cite_ref-3) quoted by [Hans Berliner](/Hans_Berliner "Hans Berliner"), [Gordon Goetsch](/Gordon_Goetsch "Gordon Goetsch") (**1985**). *A Study of Search Methods : The Effect of Constraint Satisfaction and Adventurousness*. [pdf](https://www.ijcai.org/Proceedings/85-2/Papers/083.pdf)
4. [↑](#cite_ref-4) Paper is mentioned by [Richard Korf](/Richard_Korf#JudeaPearl "Richard Korf") at [Judea Pearl Symposium](/Judea_Pearl#Symposium "Judea Pearl"), 2010
5. [↑](#cite_ref-5) [Dovetailing (computer science) from Wikipedia](https://en.wikipedia.org/wiki/Dovetailing_%28computer_science%29)
