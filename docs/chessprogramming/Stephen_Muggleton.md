...
Source: https://www.chessprogramming.org/Stephen_Muggleton

**[Home](/Main_Page "Main Page") \* [People](/People "People") \* Stephen Muggleton**

[![](/images/3/3e/Stephen_muggleton_photo_in_2010.jpg)](http://wp.doc.ic.ac.uk/shm/)

Stephen Muggleton [[1]](#cite_note-1)

**Stephen H. Muggleton**,  
a British computer scientist, professor and head of *Computational Bioinformatics Laboratory* at *Department of Computing* [[2]](#cite_note-2), [Imperial College London](https://en.wikipedia.org/wiki/Imperial_College_London).
He received his B.Sc. in computer science at [University of Edinburgh](/University_of_Edinburgh "University of Edinburgh") in 1982, and his Ph.D research on the topic *Inductive Acquisition of Expert Knowledge* was carried out at Edinburgh under the supervision of [Donald Michie](/Donald_Michie "Donald Michie") [[3]](#cite_note-3).
In 1991, Stephen Muggleton introduced [Inductive logic programming](https://en.wikipedia.org/wiki/Inductive_logic_programming) as a field of [machine learning](/Learning "Learning") [[4]](#cite_note-4), which is particularly useful in [bioinformatics](https://en.wikipedia.org/wiki/Bioinformatics) and [natural language processing](https://en.wikipedia.org/wiki/Natural_language_processing), also applied to certain [chess endgames](/Endgame "Endgame") like [KRK](/KRK "KRK").
Since July 2000, Muggleton is Editor-in-chief of the *Machine Intelligence Series* [[5]](#cite_note-5), founded by Michie who convened the first International Machine Intelligence Workshop at Edinburgh in 1965.
...
1. [↑](#cite_ref-1) [Stephen H. Muggleton](http://wp.doc.ic.ac.uk/shm/)
2. [↑](#cite_ref-2) [Computational Bioinformatics Laboratory](http://www.doc.ic.ac.uk/bioinformatics/)
3. [↑](#cite_ref-3) [Profile of Professor Stephen H. Muggleton](http://www.doc.ic.ac.uk/%7Eshm/profile.html)
4. [↑](#cite_ref-4) Stephen Muggleton (**1991**). *[Inductive Logic Programming](https://link.springer.com/article/10.1007/BF03037089)*. [New Generation Computing](https://link.springer.com/journal/354/8/4/page/1), Vol. 8, No. 4
5. [↑](#cite_ref-5) [The Machine Intelligence series](http://www.doc.ic.ac.uk/~shm/MI/mi.html)
6. [↑](#cite_ref-6) [ICGA Reference Database](/ICGA_Journal#RefDB "ICGA Journal")
7. [↑](#cite_ref-7) [Stephen Muggleton's publications](http://www.doc.ic.ac.uk/~shm/pub.html)
8. [↑](#cite_ref-8) [dblp: Stephen Muggleton](https://dblp.uni-trier.de/pers/hd/m/Muggleton:Stephen.html)
9. [↑](#cite_ref-9) [First-order logic from Wikipedia](https://en.wikipedia.org/wiki/First-order_logic)
