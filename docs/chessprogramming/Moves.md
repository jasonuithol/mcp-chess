...
Source: https://www.chessprogramming.org/Moves

**[Home](/Main_Page "Main Page") \* [Chess](/Chess "Chess") \* Moves**

[![](/images/4/45/ChessMove.JPG)](http://www.irvingamen.com/works/ChessMove.htm)

[Irving Amen](/Category:Irving_Amen "Category:Irving Amen"), Chess Move, 1977 [[1]](#cite_note-1)
...
- [Barak Oshri](/Barak_Oshri "Barak Oshri"), [Nishith Khandwala](/Nishith_Khandwala "Nishith Khandwala") (**2015**). *Predicting Moves in Chess using Convolutional Neural Networks*. [pdf](http://vision.stanford.edu/teaching/cs231n/reports/2015/pdfs/ConvChess.pdf) [[2]](#cite_note-2) » [Deep Learning](/Deep_Learning "Deep Learning"), [Neural Networks](/Neural_Networks "Neural Networks")
...
1. [↑](#cite_ref-1) [Lithographs by Irving Amen](http://www.irvingamen.com/lithograph.htm)
2. [↑](#cite_ref-2) [GitHub - BarakOshri/ConvChess: Predicting Moves in Chess Using Convolutional Neural Networks](https://github.com/BarakOshri/ConvChess)
